...
.field public final e:Lri/a;

.field public final f:Landroid/net/ConnectivityManager;

.field public final g:Lj2/d$b;
...
.method public static constructor <clinit>()V
    ...
    sput-object v0, Lj2/d;->m:Ljava/lang/String;
...
.method public constructor <init>(Lcom/android/camera/ActivityBase;)V
    ...
    iput-boolean v0, p0, Lj2/d;->j:Z

    new-instance v0, Ljava/util/HashMap;

    invoke-direct {v0}, Ljava/util/HashMap;-><init>()V

    iput-object v0, p0, Lj2/d;->c:Ljava/util/HashMap;
    ...
    iput-object v0, p0, Lj2/d;->l:Lcom/android/camera/dualvideo/remote/setupwizard/a;

    new-instance v0, Lri/a;

    new-instance v1, Lj2/d$a;

    invoke-direct {v1, p0}, Lj2/d$a;-><init>(Lj2/d;)V

    invoke-direct {v0, p1, v1}, Lri/a;-><init>(Landroid/content/Context;Lri/a$b$a;)V

    iput-object v0, p0, Lj2/d;->e:Lri/a;
    ...
    iput-object v0, p0, Lj2/d;->f:Landroid/net/ConnectivityManager;

    new-instance v0, Lj2/d$b;

    invoke-direct {v0}, Lj2/d$b;-><init>()V

    iput-object v0, p0, Lj2/d;->g:Lj2/d$b;

    const/4 v0, 0x2

    invoke-static {p1, v0}, Lui/c;->p(Landroid/content/Context;I)Lui/c;

    move-result-object p1

    iput-object p1, p0, Lj2/d;->d:Lui/c;

    return-void
.end method

.method public static m()Lj2/d;
    .locals 1
...
# virtual methods
.method public final declared-synchronized A(I)Lj2/c;
    .locals 3
    ...
    :try_start_0
    iget-object v0, p0, Lj2/d;->c:Ljava/util/HashMap;
...
.method public final B()Ljava/util/Optional;
    ...
    iget-object p0, p0, Lj2/d;->l:Lcom/android/camera/dualvideo/remote/setupwizard/a;
...
.method public final declared-synchronized H(Ljava/util/HashSet;)I
    .locals 6
    ...
    iget v4, v3, Lj2/c;->h:I

    const/4 v5, 0x1

    if-ne v4, v5, :cond_0

    sget-object v4, Lj2/d;->m:Ljava/lang/String;

    invoke-virtual {v3}, Lj2/c;->toString()Ljava/lang/String;
    ...
    :cond_1
    sget-object p1, Lj2/d;->m:Ljava/lang/String;
...
.method public final declared-synchronized U(Lj2/c;Z)V
    .locals 1
    .param p1    # Lj2/c;
        .annotation build Landroidx/annotation/Nullable;
        .end annotation
    ...
    :try_start_0
    iget-boolean v0, p0, Lj2/d;->j:Z

    if-eq v0, p2, :cond_0

    iput-boolean p2, p0, Lj2/d;->j:Z

    if-nez p2, :cond_0

    if-eqz p1, :cond_0

    iget-object p2, p0, Lj2/d;->b:Lj2/b;

    if-eqz p2, :cond_0

    invoke-interface {p2, p1}, Lj2/b;->onConnectivityStateChanged(Lj2/c;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public final declared-synchronized W()V
    ...
    :try_start_0
    iget-object v0, p0, Lj2/d;->d:Lui/c;
...
.method public final declared-synchronized X(Ljava/lang/String;Landroid/view/Surface;)V
    .locals 14
    ...
    sget-object v7, Ll2/b1;->e:Landroid/util/Size;
    ...
    sget-object v3, Lj2/d;->m:Ljava/lang/String;
    ...
    iput-object v0, v1, Lj2/d;->h:Ltv/danmaku/ijk/media/player/IjkMediaPlayer;
    ...
    iget-object v0, v1, Lj2/d;->h:Ltv/danmaku/ijk/media/player/IjkMediaPlayer;
    ...
    iput v6, v1, Lj2/d;->k:I

    iput-boolean v9, v1, Lj2/d;->i:Z
    :try_end_2
    ...
    :try_start_3
    sget-object v2, Lj2/d;->m:Ljava/lang/String;

    const-string v3, "startStreaming failed: "

    invoke-static {v2, v4, v3, v0}, Lxi/a;->c(Ljava/lang/String;ILjava/lang/String;Ljava/lang/Exception;)V
    :try_end_3
...
.method public final declared-synchronized f0()V
    ...
    :try_start_1
    iget-object v0, p0, Lj2/d;->h:Ltv/danmaku/ijk/media/player/IjkMediaPlayer;
    ...
    iput-object v0, p0, Lj2/d;->h:Ltv/danmaku/ijk/media/player/IjkMediaPlayer;
    :try_end_1
    ...
    :try_start_2
    sget-object v1, Lj2/d;->m:Ljava/lang/String;

    const-string v3, "stopStreaming failed: "

    invoke-static {v1, v2, v3, v0}, Lxi/a;->c(Ljava/lang/String;ILjava/lang/String;Ljava/lang/Exception;)V
    :try_end_2
    .catchall {:try_start_2 .. :try_end_2} :catchall_0
...
.method public final declared-synchronized l(I)V
    ...
    :try_start_0
    invoke-virtual {p0, p1}, Lj2/d;->A(I)Lj2/c;
    ...
    iget-object v2, p0, Lj2/d;->b:Lj2/b;

    if-eqz v2, :cond_0

    invoke-interface {v2, v1}, Lj2/b;->onConnectivityStateChanged(Lj2/c;)V

    :cond_0
    iget-object v1, p0, Lj2/d;->d:Lui/c;
    ...
    invoke-virtual {v0, v1, p1}, Lpj/f;->g(II)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public final declared-synchronized onConnectionResult(IILjava/lang/String;I)V
    ...
    invoke-static {p3}, Lj2/c;->a(Ljava/lang/String;)Ljava/lang/String;
    ...
    :cond_0
    iget-object p2, p0, Lj2/d;->c:Ljava/util/HashMap;
    ...
    :cond_1
    :goto_0
    invoke-virtual {p0, p2}, Lj2/d;->A(I)Lj2/c;
    ...
    sget-object p3, Lj2/c;->j:Ljava/lang/String;

    invoke-static {v1, p3, p2}, Landroid/util/Log;->println(ILjava/lang/String;Ljava/lang/String;)I

    :goto_2
    iput-object v4, p1, Lj2/c;->e:Ljava/lang/String;

    iput v3, p1, Lj2/c;->f:I
...
.method public final declared-synchronized onDisconnection(II)V
    ...
    iput-object p2, p1, Lj2/c;->e:Ljava/lang/String;

    const/4 p2, -0x1

    iput p2, p1, Lj2/c;->f:I
...
.method public final declared-synchronized onEndpointFound(IILjava/lang/String;[B)V
    ...
    :cond_0
    iget-object p4, p0, Lj2/d;->c:Ljava/util/HashMap;
    ...
    invoke-direct {p4, p2, p3}, Lj2/c;-><init>(ILjava/lang/String;)V
    ...
    :cond_1
    invoke-static {p3}, Lj2/c;->b(Ljava/lang/String;)Ljava/lang/String;

    move-result-object p1

    iput-object p1, p4, Lj2/c;->d:Ljava/lang/String;
    ...
    iput-wide p1, p4, Lj2/c;->g:J

    const/4 p1, 0x1

    iput p1, p4, Lj2/c;->h:I

    iget-object p1, p0, Lj2/d;->a:Lj2/a;

    if-eqz p1, :cond_2

    invoke-interface {p1, p4}, Lj2/a;->onAvailabilityStateChanged(Lj2/c;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public final declared-synchronized onEndpointLost(IILjava/lang/String;)V
    ...
    invoke-direct {v0, p2, p3}, Lj2/c;-><init>(ILjava/lang/String;)V
    ...
    iput-wide p1, v0, Lj2/c;->g:J

    const/4 p1, 0x2

    iput p1, v0, Lj2/c;->h:I

    iget-object p1, p0, Lj2/d;->a:Lj2/a;

    if-eqz p1, :cond_2

    invoke-interface {p1, v0}, Lj2/a;->onAvailabilityStateChanged(Lj2/c;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public final declared-synchronized onPayloadReceived(II[B)V
    ...
    invoke-static {v1}, Lj2/c;->c(Ljava/lang/String;)I
    ...
    sget-object p2, Lj2/d;->m:Ljava/lang/String;
...
.method public final registerProtocol()V
    ...
    iget-object v0, p0, Lj2/d;->e:Lri/a;

    invoke-virtual {v0}, Lri/a;->a()V

    iget-object v0, p0, Lj2/d;->f:Landroid/net/ConnectivityManager;
    ...
    iget-object v2, p0, Lj2/d;->g:Lj2/d$b;
    ...
    invoke-virtual {v0, p0}, Lui/c;->n(Lui/b;)V

    iget-object v0, p0, Lj2/d;->d:Lui/c;

    invoke-virtual {v0}, Lui/c;->i()V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public final declared-synchronized t(I)V
    ...
    iget-object v1, p0, Lj2/d;->b:Lj2/b;

    if-eqz v1, :cond_0

    invoke-interface {v1, v0}, Lj2/b;->onConnectivityStateChanged(Lj2/c;)V
...
.method public final unRegisterProtocol()V
    ...
    invoke-virtual {p0}, Lj2/d;->f0()V

    invoke-virtual {p0}, Lj2/d;->Z()V
    ...
    iget-object v1, v0, Lri/a;->c:Lri/a$a;

    const/4 v2, 0x0

    if-eqz v1, :cond_0

    iget-object v3, v0, Lri/a;->a:Landroid/content/Context;

    invoke-virtual {v3, v1}, Landroid/content/Context;->unregisterReceiver(Landroid/content/BroadcastReceiver;)V

    iput-object v2, v0, Lri/a;->c:Lri/a$a;
    ...
    iget-object v1, p0, Lj2/d;->g:Lj2/d$b;
    ...
    iget-object v1, v0, Lui/c;->l:Ljava/util/LinkedList;
    ...
    :cond_2
    :goto_0
    iget-object v0, p0, Lj2/d;->l:Lcom/android/camera/dualvideo/remote/setupwizard/a;

    iput-object v2, v0, Lcom/android/camera/dualvideo/remote/setupwizard/a;->a:Lcom/android/camera/ActivityBase;

    iput-object v2, p0, Lj2/d;->l:Lcom/android/camera/dualvideo/remote/setupwizard/a;
    :try_end_4
