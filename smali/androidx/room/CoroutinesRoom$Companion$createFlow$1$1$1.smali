...
.field final synthetic $resultChannel:Lzp/f;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Lzp/f<",
            "TR;>;"
...
# direct methods
.method public constructor <init>(Landroidx/room/RoomDatabase;Landroidx/room/CoroutinesRoom$Companion$createFlow$1$1$observer$1;Lzp/f;Ljava/util/concurrent/Callable;Lzp/f;Lgp/d;)V
    .locals 0
    ...
    iput-object p3, p0, Landroidx/room/CoroutinesRoom$Companion$createFlow$1$1$1;->$observerChannel:Lzp/f;

    iput-object p4, p0, Landroidx/room/CoroutinesRoom$Companion$createFlow$1$1$1;->$callable:Ljava/util/concurrent/Callable;

    iput-object p5, p0, Landroidx/room/CoroutinesRoom$Companion$createFlow$1$1$1;->$resultChannel:Lzp/f;
...
.method public final create(Ljava/lang/Object;Lgp/d;)Lgp/d;
    ...
    iget-object v3, p0, Landroidx/room/CoroutinesRoom$Companion$createFlow$1$1$1;->$observerChannel:Lzp/f;

    iget-object v4, p0, Landroidx/room/CoroutinesRoom$Companion$createFlow$1$1$1;->$callable:Ljava/util/concurrent/Callable;

    iget-object v5, p0, Landroidx/room/CoroutinesRoom$Companion$createFlow$1$1$1;->$resultChannel:Lzp/f;

    move-object v0, p1

    move-object v6, p2

    invoke-direct/range {v0 .. v6}, Landroidx/room/CoroutinesRoom$Companion$createFlow$1$1$1;-><init>(Landroidx/room/RoomDatabase;Landroidx/room/CoroutinesRoom$Companion$createFlow$1$1$observer$1;Lzp/f;Ljava/util/concurrent/Callable;Lzp/f;Lgp/d;)V
...
.method public bridge synthetic invoke(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-virtual {p0, p1, p2}, Landroidx/room/CoroutinesRoom$Companion$createFlow$1$1$1;->invoke(Lxp/z;Lgp/d;)Ljava/lang/Object;
...
.method public final invoke(Lxp/z;Lgp/d;)Ljava/lang/Object;
    ...
    invoke-virtual {p0, p1, p2}, Landroidx/room/CoroutinesRoom$Companion$createFlow$1$1$1;->create(Ljava/lang/Object;Lgp/d;)Lgp/d;
...
.method public final invokeSuspend(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    :try_start_2
    iget-object p1, p0, Landroidx/room/CoroutinesRoom$Companion$createFlow$1$1$1;->$observerChannel:Lzp/f;

    invoke-interface {p1}, Lzp/s;->iterator()Lzp/h;
    ...
    invoke-interface {p1, p0}, Lzp/h;->a(Lip/c;)Ljava/lang/Object;
    ...
    iget-object v4, p0, Landroidx/room/CoroutinesRoom$Companion$createFlow$1$1$1;->$resultChannel:Lzp/f;
    ...
    invoke-interface {v4, p1, p0}, Lzp/t;->d(Ljava/lang/Object;Lgp/d;)Ljava/lang/Object;
