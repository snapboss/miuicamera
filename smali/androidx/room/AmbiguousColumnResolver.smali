...
.method private final dfs(Ljava/util/List;Ljava/util/List;ILop/l;)V
    .locals 2
    ...
    invoke-static {p2}, Ldp/q;->a0(Ljava/lang/Iterable;)Ljava/util/List;

    move-result-object p0

    invoke-interface {p4, p0}, Lop/l;->invoke(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-direct {v0, p1, p2, v1, p4}, Landroidx/room/AmbiguousColumnResolver;->dfs(Ljava/util/List;Ljava/util/List;ILop/l;)V
    ...
    invoke-static {p2}, Lnt/c;->p(Ljava/util/List;)I
...
.method public static synthetic dfs$default(Landroidx/room/AmbiguousColumnResolver;Ljava/util/List;Ljava/util/List;ILop/l;ILjava/lang/Object;)V
    .locals 0
    ...
    :cond_1
    invoke-direct {p0, p1, p2, p3, p4}, Landroidx/room/AmbiguousColumnResolver;->dfs(Ljava/util/List;Ljava/util/List;ILop/l;)V

    return-void
.end method

.method private final rabinKarpSearch(Ljava/util/List;[Ljava/lang/String;Lop/q;)V
    .locals 5
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-interface {p3, p2, v3, v4}, Lop/q;->invoke(Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
...
.method public static final resolve([Ljava/lang/String;[[Ljava/lang/String;)[[I
    ...
    invoke-static {v2, v7}, Ldp/o;->K(Ljava/util/Collection;[Ljava/lang/Object;)V
    ...
    :cond_4
    invoke-static {v2}, Lbq/l;->e(Lep/f;)Lep/f;
    ...
    invoke-virtual {v2, v9}, Lep/f;->contains(Ljava/lang/Object;)Z
    ...
    invoke-virtual {v4, v11}, Lep/a;->add(Ljava/lang/Object;)Z
    ...
    invoke-direct {v10, v4, v8, v11}, Landroidx/room/AmbiguousColumnResolver;->rabinKarpSearch(Ljava/util/List;[Ljava/lang/String;Lop/q;)V
    ...
    invoke-direct {v13}, Lep/a;-><init>()V

    invoke-virtual {v4}, Lep/a;->iterator()Ljava/util/Iterator;
    ...
    check-cast v15, Lep/a$a;

    invoke-virtual {v15}, Lep/a$a;->hasNext()Z

    move-result v16

    if-eqz v16, :cond_9

    invoke-virtual {v15}, Lep/a$a;->next()Ljava/lang/Object;
    ...
    invoke-virtual {v13, v5}, Lep/a;->add(Ljava/lang/Object;)Z
    ...
    :cond_9
    invoke-static {v13}, Lnt/c;->j(Lep/a;)Lep/a;

    invoke-virtual {v13}, Lep/a;->isEmpty()Z
    ...
    invoke-static {v0, v11, v1}, Landroidx/appcompat/widget/g;->b(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static/range {v11 .. v17}, Landroidx/room/AmbiguousColumnResolver;->dfs$default(Landroidx/room/AmbiguousColumnResolver;Ljava/util/List;Ljava/util/List;ILop/l;ILjava/lang/Object;)V
    ...
    invoke-direct {v10, v0}, Landroidx/room/AmbiguousColumnResolver$resolve$4;-><init>(Lkotlin/jvm/internal/x;)V

    const/4 v11, 0x6

    const/4 v12, 0x0

    invoke-static/range {v6 .. v12}, Landroidx/room/AmbiguousColumnResolver;->dfs$default(Landroidx/room/AmbiguousColumnResolver;Ljava/util/List;Ljava/util/List;ILop/l;ILjava/lang/Object;)V
