...
.method public final notifyByTableInvalidStatus$room_runtime_release(Ljava/util/Set;)V
    ...
    invoke-virtual {v2, v5}, Lep/f;->add(Ljava/lang/Object;)Z
...
.method public final notifyByTableNames$room_runtime_release([Ljava/lang/String;)V
    ...
    invoke-static {v9, v5, v2}, Lvp/i;->L(Ljava/lang/String;Ljava/lang/String;Z)Z

    move-result v10

    if-eqz v10, :cond_0

    invoke-virtual {v1, v9}, Lep/f;->add(Ljava/lang/Object;)Z
    ...
    :cond_2
    invoke-static {v1}, Lbq/l;->e(Lep/f;)Lep/f;
    ...
    invoke-static {v5, v6, v2}, Lvp/i;->L(Ljava/lang/String;Ljava/lang/String;Z)Z
