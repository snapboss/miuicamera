...
.method public static final dropFtsSyncTriggers(Landroidx/sqlite/db/SupportSQLiteDatabase;)V
    ...
    invoke-virtual {v0, v3}, Lep/a;->add(Ljava/lang/Object;)Z
    ...
    invoke-static {v1, v2}, Lho/n;->c(Ljava/io/Closeable;Ljava/lang/Throwable;)V

    invoke-static {v0}, Lnt/c;->j(Lep/a;)Lep/a;

    invoke-virtual {v0}, Lep/a;->iterator()Ljava/util/Iterator;
    ...
    invoke-virtual {v1}, Lep/a$a;->hasNext()Z

    move-result v2

    if-eqz v2, :cond_2

    invoke-virtual {v1}, Lep/a$a;->next()Ljava/lang/Object;
    ...
    invoke-static {v1, v2, v4}, Lvp/i;->S(Ljava/lang/String;Ljava/lang/String;Z)Z
    ...
    invoke-static {v1, p0}, Lho/n;->c(Ljava/io/Closeable;Ljava/lang/Throwable;)V
...
.method private static final processForeignKeyCheckFailure(Landroid/database/Cursor;)Ljava/lang/String;
    ...
    invoke-static {v0, v3, v1, v4, v2}, La3/c;->e(Ljava/lang/StringBuilder;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
...
.method public static final readVersion(Ljava/io/File;)I
    ...
    invoke-static {p0, v1}, Lho/n;->c(Ljava/io/Closeable;Ljava/lang/Throwable;)V
