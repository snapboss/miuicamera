...
# instance fields
.field private final _currentStateFlow:Laq/j;
...
.method private constructor <init>(Landroidx/lifecycle/LifecycleOwner;Z)V
    ...
    :cond_0
    invoke-direct {p1, p2}, Laq/o;-><init>(Ljava/lang/Object;)V

    .line 8
    iput-object p1, p0, Landroidx/lifecycle/LifecycleRegistry;->_currentStateFlow:Laq/j;
...
.method private final calculateTargetState(Landroidx/lifecycle/LifecycleObserver;)Landroidx/lifecycle/Lifecycle$State;
    ...
    invoke-static {v0, v1}, Landroidx/appcompat/app/b;->e(Ljava/util/ArrayList;I)Ljava/lang/Object;
...
.method private final sync()V
    ...
    iget-object v0, p0, Landroidx/lifecycle/LifecycleRegistry;->_currentStateFlow:Laq/j;

    invoke-virtual {p0}, Landroidx/lifecycle/LifecycleRegistry;->getCurrentState()Landroidx/lifecycle/Lifecycle$State;

    move-result-object p0

    invoke-interface {v0, p0}, Laq/j;->setValue(Ljava/lang/Object;)V
...
.method public getCurrentStateFlow()Laq/n;
    ...
    iget-object p0, p0, Landroidx/lifecycle/LifecycleRegistry;->_currentStateFlow:Laq/j;

    new-instance v0, Laq/k;

    invoke-direct {v0, p0}, Laq/k;-><init>(Laq/n;)V
