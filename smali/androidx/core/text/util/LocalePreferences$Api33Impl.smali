...
.method public static getResolvedTemperatureUnit(Ljava/util/Locale;)Ljava/lang/String;
    ...
    invoke-static {}, Landroidx/core/app/i;->b()Landroid/icu/number/UnlocalizedNumberFormatter;
    ...
    invoke-static {v0, v1}, Landroidx/core/text/util/b;->b(Landroid/icu/number/UnlocalizedNumberFormatter;Landroid/icu/util/MeasureUnit;)Landroid/icu/number/NumberFormatterSettings;

    move-result-object v0

    check-cast v0, Landroid/icu/number/UnlocalizedNumberFormatter;

    invoke-static {v0, p0}, Landroidx/core/text/util/c;->b(Landroid/icu/number/UnlocalizedNumberFormatter;Ljava/util/Locale;)Landroid/icu/number/LocalizedNumberFormatter;

    move-result-object p0

    invoke-static {p0}, Landroidx/core/text/util/d;->a(Landroid/icu/number/LocalizedNumberFormatter;)Landroid/icu/number/FormattedNumber;
