...
.method public notifyHorizontalEdgeReached(I)V
    ...
    iget-object v0, p0, Landroidx/recyclerview/widget/RemixRecyclerView$ViewFlinger;->mOverScroller:Lgs/d;
    ...
    iget-object v1, v0, Lgs/d;->b:Lgs/b;

    const/4 v2, 0x0

    iget p0, v1, Lgs/d$a;->h:I

    if-nez p0, :cond_1

    iget-object p0, v1, Lgs/b;->r:Lgs/b$b;

    if-eqz p0, :cond_0

    invoke-virtual {v1}, Lgs/b;->h()V

    :cond_0
    iget-wide p0, v1, Lgs/d$a;->d:D
    ...
    invoke-virtual/range {v1 .. v6}, Lgs/b;->j(IIIII)V
...
.method public notifyVerticalEdgeReached(I)V
    ...
    iget-object v1, v0, Lgs/d;->c:Lgs/b;
...
.method public overFling(IIII)V
    ...
    invoke-virtual/range {v6 .. v15}, Lgs/d;->b(IIIIIIIII)V
...
.method public springBack(II)V
    ...
    iget-object v1, p0, Landroidx/recyclerview/widget/RemixRecyclerView$ViewFlinger;->mOverScroller:Lgs/d;

    neg-int p1, p1

    neg-int p2, p2

    iput v0, v1, Lgs/d;->a:I

    iget-object v0, v1, Lgs/d;->b:Lgs/b;

    const/4 v2, 0x0

    invoke-virtual {v0, v2, p1, p1}, Lgs/b;->i(III)Z

    move-result p1

    iget-object v0, v1, Lgs/d;->c:Lgs/b;

    invoke-virtual {v0, v2, p2, p2}, Lgs/b;->i(III)Z
