...
.field public o:Lag/a$a;

.field public p:I

.field public final q:Landroid/os/Handler;

.field public r:Lag/f;

.field public final s:Ljava/lang/StringBuilder;

.field public t:Z

.field public final u:Landroidx/room/c;
...
.method public constructor <init>(Ljava/lang/String;)V
    ...
    invoke-direct {v0, p1}, Lag/e;-><init>(Ljava/lang/String;)V

    invoke-direct {p0, v0}, Lag/g;-><init>(Lag/e;)V
    ...
    iput-object v0, p0, Lag/a;->q:Landroid/os/Handler;

    new-instance v0, Ljava/lang/StringBuilder;

    invoke-direct {v0}, Ljava/lang/StringBuilder;-><init>()V

    iput-object v0, p0, Lag/a;->s:Ljava/lang/StringBuilder;
    ...
    iput-object v0, p0, Lag/a;->u:Landroidx/room/c;
    ...
    iput-object p1, p0, Lag/a;->n:Ljava/lang/String;

    const/4 p1, 0x0

    iput-boolean p1, p0, Lag/a;->t:Z
...
.method public final a(Ltv/danmaku/ijk/media/player/IjkMediaPlayer;)V
    ...
    invoke-super {p0, p1}, Lag/g;->a(Ltv/danmaku/ijk/media/player/IjkMediaPlayer;)V

    iget-object p1, p0, Lag/g;->f:Ltv/danmaku/ijk/media/player/IjkMediaPlayer;
...
.method public final h(Ljava/lang/String;)V
    ...
    iget-object v2, p0, Lag/a;->n:Ljava/lang/String;
...
.method public final onError(Ltv/danmaku/ijk/media/player/IMediaPlayer;II)Z
    ...
    iget-object p1, p0, Lag/g;->j:Lag/g$a;

    if-eqz p1, :cond_0

    iget-boolean p1, p0, Lag/a;->t:Z
    ...
    iget-object p0, p0, Lag/g;->j:Lag/g$a;

    invoke-interface {p0, p2, p3}, Lag/g$a;->onError(II)Z
...
.method public final onPrepared(Ltv/danmaku/ijk/media/player/IMediaPlayer;)V
    ...
    invoke-super {p0, p1}, Lag/g;->onPrepared(Ltv/danmaku/ijk/media/player/IMediaPlayer;)V

    iget-object p1, p0, Lag/a;->q:Landroid/os/Handler;
...
.method public final onRpcResult(Ltv/danmaku/ijk/media/player/IMediaPlayer;Ljava/lang/String;)V
    ...
    invoke-static {p2}, Lri/h;->a(Ljava/lang/String;)I
    ...
    invoke-direct {p1, p0, p2}, Landroidx/room/i;-><init>(Ljava/lang/Object;I)V
...
.method public final onRtpHdrExtAvailable(Ltv/danmaku/ijk/media/player/IMediaPlayer;Ljava/nio/ByteBuffer;I)V
    ...
    iget-object p1, p0, Lag/a;->r:Lag/f;

    if-nez p1, :cond_2

    new-instance p1, Lag/f;

    invoke-direct {p1}, Lag/f;-><init>()V

    iput-object p1, p0, Lag/a;->r:Lag/f;
    ...
    iput-byte p3, p1, Lag/f;->b:B

    invoke-virtual {p2}, Ljava/nio/ByteBuffer;->get()B

    move-result p3

    iput-byte p3, p1, Lag/f;->c:B
...
.method public final onVideoSizeChanged(Ltv/danmaku/ijk/media/player/IMediaPlayer;IIII)V
    ...
    new-instance p4, Lz/a2;

    const/4 p5, 0x1

    invoke-direct {p4, p0, p2, p3, p5}, Lz/a2;-><init>(Ljava/lang/Object;III)V
