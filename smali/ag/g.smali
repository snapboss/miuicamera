...
.field public final g:Lag/e;

.field public h:J

.field public final i:Ljava/lang/StringBuilder;

.field public j:Lag/g$a;

.field public k:Lag/g$b;

.field public l:Lag/g$c;

.field public m:Lag/g$d;
...
.method public constructor <init>(Lag/e;)V
    ...
    iput-object v0, p0, Lag/g;->i:Ljava/lang/StringBuilder;

    iput-object p1, p0, Lag/g;->g:Lag/e;
    ...
    iget-object p1, p1, Lag/e;->b:Ljava/lang/String;
    ...
    iput-object p1, p0, Lag/g;->e:Ljava/lang/String;
...
.method public final b()Ljava/lang/String;
    ...
    iget-object v1, v0, Lag/g;->f:Ltv/danmaku/ijk/media/player/IjkMediaPlayer;

    invoke-virtual {v1}, Ltv/danmaku/ijk/media/player/IjkMediaPlayer;->getBitRate()J

    move-result-wide v1

    iget-object v3, v0, Lag/g;->f:Ltv/danmaku/ijk/media/player/IjkMediaPlayer;

    invoke-virtual {v3}, Ltv/danmaku/ijk/media/player/IjkMediaPlayer;->getVideoCachedBytes()J

    move-result-wide v3

    iget-object v5, v0, Lag/g;->f:Ltv/danmaku/ijk/media/player/IjkMediaPlayer;

    invoke-virtual {v5}, Ltv/danmaku/ijk/media/player/IjkMediaPlayer;->getVideoCachedPackets()J

    move-result-wide v5

    iget-object v7, v0, Lag/g;->f:Ltv/danmaku/ijk/media/player/IjkMediaPlayer;

    invoke-virtual {v7}, Ltv/danmaku/ijk/media/player/IjkMediaPlayer;->getVideoCachedDuration()J

    move-result-wide v7

    iget-object v9, v0, Lag/g;->i:Ljava/lang/StringBuilder;

    const/4 v10, 0x0

    invoke-virtual {v9, v10}, Ljava/lang/StringBuilder;->setLength(I)V

    iget-object v11, v0, Lag/g;->f:Ltv/danmaku/ijk/media/player/IjkMediaPlayer;
    ...
    const-string/jumbo v14, "video_decoder : "

    invoke-static {v9, v14, v11, v13}, Landroidx/activity/result/d;->i(Ljava/lang/StringBuilder;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
...
.method public final d()V
    ...
    iget-object v0, p0, Lag/g;->g:Lag/e;

    iget-object v0, v0, Lag/e;->a:Ljava/lang/String;
    ...
    iput-wide v1, p0, Lag/g;->h:J

    invoke-virtual {p0}, Lag/g;->e()V
    ...
    iput-object v1, p0, Lag/d;->a:Landroid/os/HandlerThread;

    invoke-virtual {v1}, Ljava/lang/Thread;->start()V

    new-instance v1, Landroid/os/Handler;

    iget-object v2, p0, Lag/d;->a:Landroid/os/HandlerThread;
    ...
    iput-object v1, p0, Lag/d;->b:Landroid/os/Handler;
    ...
    iput-object v1, p0, Lag/d;->c:Landroid/os/Handler;

    iget-object v1, p0, Lag/d;->b:Landroid/os/Handler;

    new-instance v2, Ld/b;

    const/16 v3, 0xa

    invoke-direct {v2, v3, v0, p0}, Ld/b;-><init>(ILjava/lang/String;Ljava/lang/Object;)V
...
.method public e()V
    ...
    iget-object v0, p0, Lag/d;->c:Landroid/os/Handler;

    if-eqz v0, :cond_0

    iget-object v0, p0, Lag/d;->a:Landroid/os/HandlerThread;

    if-eqz v0, :cond_0

    iget-object v1, p0, Lag/g;->f:Ltv/danmaku/ijk/media/player/IjkMediaPlayer;

    if-eqz v1, :cond_0

    iget-object v2, p0, Lag/d;->b:Landroid/os/Handler;

    new-instance v3, Lba/a2;

    const/4 v4, 0x1

    invoke-direct {v3, v4, p0, v1, v0}, Lba/a2;-><init>(ILjava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;)V

    invoke-virtual {v2, v3}, Landroid/os/Handler;->post(Ljava/lang/Runnable;)Z

    const/4 v0, 0x0

    iput-object v0, p0, Lag/g;->f:Ltv/danmaku/ijk/media/player/IjkMediaPlayer;
...
.method public final f(Landroid/view/Surface;)V
    ...
    :cond_0
    iput-object p1, p0, Lag/d;->d:Landroid/view/Surface;
...
.method public final g()V
    ...
    iput-wide v0, p0, Lag/g;->h:J

    const/4 v0, 0x0

    new-array v0, v0, [Ljava/lang/Object;

    iget-object v1, p0, Lag/g;->e:Ljava/lang/String;
...
.method public final onInfo(Ltv/danmaku/ijk/media/player/IMediaPlayer;II)Z
    ...
    :cond_2
    iget-object p1, p0, Lag/d;->c:Landroid/os/Handler;
