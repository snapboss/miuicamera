...
.method public static constructor <clinit>()V
    ...
    sput-object v0, Lx/g;->a:Landroid/graphics/PathMeasure;

    new-instance v0, Landroid/graphics/Path;

    invoke-direct {v0}, Landroid/graphics/Path;-><init>()V

    sput-object v0, Lx/g;->b:Landroid/graphics/Path;

    new-instance v0, Landroid/graphics/Path;

    invoke-direct {v0}, Landroid/graphics/Path;-><init>()V

    sput-object v0, Lx/g;->c:Landroid/graphics/Path;

    const/4 v0, 0x4

    new-array v0, v0, [F

    sput-object v0, Lx/g;->d:[F
...
.method public static a(Landroid/graphics/Path;FFF)V
    ...
    sget-object v0, Lx/g;->a:Landroid/graphics/PathMeasure;
    ...
    invoke-static {v2, v1}, Lx/f;->c(FF)I

    move-result p2

    int-to-float v2, p2

    invoke-static {p1, v1}, Lx/f;->c(FF)I
    ...
    :cond_6
    sget-object p2, Lx/g;->b:Landroid/graphics/Path;
    ...
    sget-object v5, Lx/g;->c:Landroid/graphics/Path;
