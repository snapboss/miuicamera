...
.method public constructor <init>(Lr/k;)V
    ...
    :cond_1
    invoke-interface {v0}, Lr/l;->a()Lo/a;
...
.method public final b(Lo/a$a;)V
    ...
    invoke-virtual {v0, p1}, Lo/a;->a(Lo/a$a;)V
    ...
    invoke-virtual {p0, p1}, Lo/a;->a(Lo/a$a;)V

    :cond_8
    return-void
.end method

.method public final c(Ly/c;Ljava/lang/Object;)Z
    .locals 3
    .param p1    # Ly/c;
        .annotation build Landroidx/annotation/Nullable;
        .end annotation
    ...
    sget-object v0, Ll/n;->e:Landroid/graphics/PointF;

    if-ne p2, v0, :cond_1

    iget-object p2, p0, Lo/o;->f:Lo/a;
    ...
    invoke-direct {p2, p1, v0}, Lo/p;-><init>(Ly/c;Ljava/lang/Object;)V

    iput-object p2, p0, Lo/o;->f:Lo/a;
    ...
    :cond_1
    sget-object v0, Ll/n;->f:Landroid/graphics/PointF;

    if-ne p2, v0, :cond_3

    iget-object p2, p0, Lo/o;->g:Lo/a;
    ...
    :cond_3
    sget-object v0, Ll/n;->k:Ly/d;

    if-ne p2, v0, :cond_5

    iget-object p2, p0, Lo/o;->h:Lo/a;
    ...
    :cond_5
    sget-object v0, Ll/n;->l:Ljava/lang/Float;

    const/4 v1, 0x0

    if-ne p2, v0, :cond_7

    iget-object p2, p0, Lo/o;->i:Lo/a;
    ...
    :cond_7
    sget-object v0, Ll/n;->c:Ljava/lang/Integer;

    const/16 v2, 0x64

    if-ne p2, v0, :cond_9

    iget-object p2, p0, Lo/o;->j:Lo/a;
    ...
    :cond_9
    sget-object v0, Ll/n;->y:Ljava/lang/Float;
    ...
    iput-object p2, p0, Lo/o;->m:Lo/a;

    goto :goto_0

    :cond_a
    invoke-virtual {v0, p1}, Lo/a;->j(Ly/c;)V

    goto :goto_0

    :cond_b
    sget-object v0, Ll/n;->z:Ljava/lang/Float;
    ...
    :cond_d
    sget-object v0, Ll/n;->m:Ljava/lang/Float;
    ...
    invoke-direct {p2, v0}, Lo/c;-><init>(Ljava/util/List;)V

    iput-object p2, p0, Lo/o;->k:Lo/c;

    :cond_e
    iget-object p0, p0, Lo/o;->k:Lo/c;
    ...
    :cond_f
    sget-object v0, Ll/n;->n:Ljava/lang/Float;

    if-ne p2, v0, :cond_11

    iget-object p2, p0, Lo/o;->l:Lo/c;
...
.method public final d()Landroid/graphics/Matrix;
    ...
    iget-object v1, v0, Lo/o;->a:Landroid/graphics/Matrix;

    invoke-virtual {v1}, Landroid/graphics/Matrix;->reset()V

    iget-object v2, v0, Lo/o;->g:Lo/a;
    ...
    :cond_1
    iget-object v2, v0, Lo/o;->i:Lo/a;

    if-eqz v2, :cond_3

    instance-of v4, v2, Lo/p;
    ...
    :cond_3
    iget-object v2, v0, Lo/o;->k:Lo/c;

    const/high16 v4, 0x3f800000    # 1.0f

    if-eqz v2, :cond_9

    iget-object v2, v0, Lo/o;->l:Lo/c;
    ...
    iget-object v15, v0, Lo/o;->b:Landroid/graphics/Matrix;
    ...
    iget-object v6, v0, Lo/o;->c:Landroid/graphics/Matrix;
    ...
    iget-object v2, v0, Lo/o;->d:Landroid/graphics/Matrix;
...
.method public final e(F)Landroid/graphics/Matrix;
    ...
    :cond_4
    invoke-virtual {p0}, Lo/a;->f()Ljava/lang/Object;
