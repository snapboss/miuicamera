.class public final Lcom/android/camera/effect/renders/e0;
...
.method public static constructor <clinit>()V
    ...
    sput-object v1, Lcom/android/camera/effect/renders/e0;->f:[F

    new-array v0, v0, [F

    fill-array-data v0, :array_1

    sput-object v0, Lcom/android/camera/effect/renders/e0;->g:[F
...
.method public final destroy()V
    ...
    iget-object v0, p0, Lcom/android/camera/effect/renders/e0;->d:[I
    ...
    iput-object v0, p0, Lcom/android/camera/effect/renders/e0;->d:[I
...
.method public final draw(Lp2/b;)Z
    ...
    :cond_0
    instance-of v2, v1, Lp2/a;

    if-eqz v2, :cond_11

    check-cast v1, Lp2/a;

    iget-object v2, v1, Lp2/a;->e:Lyo/b;

    if-eqz v2, :cond_11

    iget-object v5, v2, Lyo/b;->c:Lyo/b$a;

    iget-object v14, v5, Lyo/b$a;->a:Ljava/nio/ByteBuffer;

    iget-object v15, v5, Lyo/b$a;->b:Ljava/nio/ByteBuffer;

    iget-object v5, v5, Lyo/b$a;->c:Ljava/nio/ByteBuffer;

    iget v13, v2, Lyo/b;->a:I

    iget v2, v2, Lyo/b;->b:I

    iget-object v12, v0, Lcom/android/camera/effect/renders/e0;->d:[I
    ...
    iget-object v4, v0, Lcom/android/camera/effect/renders/e0;->d:[I

    iget v5, v1, Lp2/a;->c:I

    int-to-float v5, v5

    iget v6, v1, Lp2/a;->d:I

    int-to-float v6, v6

    iget-object v7, v1, Lp2/a;->f:Landroid/util/Size;
    ...
    iget-object v8, v1, Lp2/a;->f:Landroid/util/Size;
    ...
    iget-object v1, v1, Lp2/a;->b:[F

    iget v9, v0, Lcom/android/camera/effect/renders/s;->mProgram:I
    ...
    invoke-virtual {v0, v9}, Lcom/android/camera/effect/renders/s;->setBlendEnabled(Z)V
    ...
    invoke-virtual {v9, v5, v6}, Lcom/android/camera/effect/x;->g(FF)V
    ...
    iget v6, v0, Lcom/android/camera/effect/renders/e0;->a:I
    ...
    iget v6, v0, Lcom/android/camera/effect/renders/e0;->b:I
    ...
    iget v2, v0, Lcom/android/camera/effect/renders/e0;->c:I

    invoke-static {v2, v12}, Landroid/opengl/GLES20;->glUniform1i(II)V

    :cond_c
    iget v4, v0, Lcom/android/camera/effect/renders/s;->mAttributePositionH:I
    ...
    iget-object v9, v0, Lcom/android/camera/effect/renders/s;->mVertexBuffer:Ljava/nio/FloatBuffer;
    ...
    iget-object v2, v0, Lcom/android/camera/effect/renders/s;->mTexCoorBuffer:Ljava/nio/FloatBuffer;
    ...
    invoke-static {v1}, Lba/d;->o0(Lba/c;)I
    ...
    :cond_f
    iget v1, v0, Lcom/android/camera/effect/renders/e0;->e:I
...
.method public final initShader()V
    ...
    iput v0, p0, Lcom/android/camera/effect/renders/e0;->a:I
    ...
    iput v0, p0, Lcom/android/camera/effect/renders/e0;->b:I
    ...
    iput v0, p0, Lcom/android/camera/effect/renders/e0;->c:I
    ...
    iput v0, p0, Lcom/android/camera/effect/renders/e0;->e:I
    ...
    iput-object v2, p0, Lcom/android/camera/effect/renders/e0;->d:[I
    ...
    iget-object v2, p0, Lcom/android/camera/effect/renders/e0;->d:[I
    ...
    iget-object p0, p0, Lcom/android/camera/effect/renders/e0;->d:[I
    ...
    const-class v0, Lcom/android/camera/effect/renders/e0;
...
.method public final initVertexData()V
    ...
    sget-object v2, Lcom/android/camera/effect/renders/e0;->f:[F
    ...
    sget-object v1, Lcom/android/camera/effect/renders/e0;->g:[F
