...
.method public static constructor <clinit>()V
    ...
    sput-object v1, Lcom/android/camera/effect/renders/t;->b:[F

    new-array v0, v0, [F

    fill-array-data v0, :array_1

    sput-object v0, Lcom/android/camera/effect/renders/t;->c:[F
...
.method public final draw(Lp2/b;)Z
    ...
    iget-object v2, v1, Lp2/e;->d:Lqa/f;
    ...
    iget-object v7, v1, Lp2/n;->b:Landroid/graphics/Rect;

    invoke-static {v3}, Landroid/opengl/GLES20;->glUseProgram(I)V

    iget v8, v0, Lcom/android/camera/effect/renders/s;->mProgram:I
    ...
    invoke-virtual {v0, v2, v8}, Lcom/android/camera/effect/renders/s;->bindTexture(Lqa/b;I)Z
    ...
    :cond_2
    iget v8, v0, Lcom/android/camera/effect/renders/s;->mAttributePositionH:I
    ...
    iget-object v13, v0, Lcom/android/camera/effect/renders/s;->mVertexBuffer:Ljava/nio/FloatBuffer;

    invoke-static/range {v8 .. v13}, Landroid/opengl/GLES20;->glVertexAttribPointer(IIIZILjava/nio/Buffer;)V

    iget v14, v0, Lcom/android/camera/effect/renders/s;->mAttributeTexCoorH:I
    ...
    iget-boolean v8, v0, Lcom/android/camera/effect/renders/s;->mBlendEnabled:Z
    ...
    :goto_0
    invoke-virtual {v0, v4}, Lcom/android/camera/effect/renders/s;->setBlendEnabled(Z)V
    ...
    invoke-virtual {v4, v8, v10}, Lcom/android/camera/effect/x;->g(FF)V
    ...
    iget v4, v0, Lcom/android/camera/effect/renders/s;->mUniformMVPMatrixH:I

    iget-object v7, v0, Lcom/android/camera/effect/renders/o;->mGLCanvas:Lqa/g;

    check-cast v7, Lqa/a;

    iget-object v7, v7, Lqa/a;->c:Lcom/android/camera/effect/x;
    ...
    iget v4, v0, Lcom/android/camera/effect/renders/s;->mUniformSTMatrixH:I
    ...
    iget v4, v0, Lcom/android/camera/effect/renders/s;->mUniformAlphaH:I

    iget-object v6, v0, Lcom/android/camera/effect/renders/o;->mGLCanvas:Lqa/g;

    check-cast v6, Lqa/a;

    iget-object v6, v6, Lqa/a;->c:Lcom/android/camera/effect/x;

    iget v6, v6, Lcom/android/camera/effect/x;->g:F

    invoke-static {v4, v6}, Landroid/opengl/GLES20;->glUniform1f(IF)V

    iget v4, v0, Lcom/android/camera/effect/renders/s;->mUniformBlendAlphaH:I

    invoke-static {v4, v2}, Landroid/opengl/GLES20;->glUniform1f(IF)V

    iget-object v2, v1, Lp2/e;->f:Loo/a;

    sget-object v4, Loo/a;->b:Loo/a$c;

    if-ne v2, v4, :cond_6

    iget-object v1, v1, Lp2/e;->g:Loo/a;

    sget-object v2, Loo/a;->a:Loo/a$a;

    if-ne v1, v2, :cond_5

    iget v1, v0, Lcom/android/camera/effect/renders/t;->a:I
...
.method public final initShader()V
    ...
    const-class v0, Lcom/android/camera/effect/renders/t;
...
.method public final initVertexData()V
    ...
    sget-object v2, Lcom/android/camera/effect/renders/t;->b:[F
    ...
    sget-object v1, Lcom/android/camera/effect/renders/t;->c:[F
