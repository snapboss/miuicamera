...
# direct methods
.method public constructor <init>(Lqa/g;Ljava/lang/String;)V
    .locals 1

    const/16 v0, 0x10a

    invoke-direct {p0, p1, v0}, Lcom/android/camera/effect/renders/l;-><init>(Lqa/g;I)V

    invoke-virtual {p0, p2}, Lcom/android/camera/effect/renders/g;->a(Ljava/lang/String;)V
...
.method public final a(Ljava/lang/String;)V
    ...
    :pswitch_7
    iput v5, p0, Lcom/android/camera/effect/renders/g;->d:I
...
.method public final b(IZ)V
    ...
    invoke-super {p0, p2}, Lcom/android/camera/effect/renders/l;->initShaderValue(Z)V
    ...
    iget v0, p0, Lcom/android/camera/effect/renders/o;->mPreviewHeight:I
...
.method public final draw(Lp2/b;)Z
    ...
    iget-object v5, p1, Lp2/g;->b:Landroid/graphics/Rect;

    iget-boolean v6, p1, Lp2/g;->d:Z

    iget v7, p0, Lcom/android/camera/effect/renders/s;->mProgram:I

    invoke-static {v7}, Landroid/opengl/GLES20;->glUseProgram(I)V

    invoke-virtual {p0, v0, v3}, Lcom/android/camera/effect/renders/s;->bindTexture(II)Z
    ...
    invoke-virtual {v0, v3, v7}, Lcom/android/camera/effect/x;->g(FF)V
    ...
    iget-object v5, p1, Lp2/n;->b:Landroid/graphics/Rect;

    iget-boolean v6, p1, Lp2/c;->d:Z

    iget p1, p1, Lp2/c;->f:I
    ...
    invoke-virtual {v0, v7}, Lqa/b;->f(Lqa/g;)Z
    ...
    :cond_3
    invoke-virtual {p0, v0, v3}, Lcom/android/camera/effect/renders/s;->bindTexture(Lqa/b;I)Z
