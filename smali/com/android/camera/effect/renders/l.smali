.class public abstract Lcom/android/camera/effect/renders/l;
...
.method public static constructor <clinit>()V
    ...
    sput-object v1, Lcom/android/camera/effect/renders/l;->VERTICES:[F

    new-array v0, v0, [F

    fill-array-data v0, :array_1

    sput-object v0, Lcom/android/camera/effect/renders/l;->TEXTURES:[F
...
.method public draw(Lp2/b;)Z
    ...
    iget v0, p1, Lp2/g;->c:I

    iget-object v1, p1, Lp2/g;->b:Landroid/graphics/Rect;

    iget-boolean p1, p1, Lp2/g;->d:Z

    invoke-virtual {p0, v0, v1, p1}, Lcom/android/camera/effect/renders/l;->drawTexture(ILandroid/graphics/Rect;Z)V
    ...
    iget-object v0, p1, Lp2/c;->c:Lqa/b;

    iget-object v1, p1, Lp2/n;->b:Landroid/graphics/Rect;

    iget-boolean p1, p1, Lp2/c;->d:Z

    invoke-virtual {p0, v0, v1, p1}, Lcom/android/camera/effect/renders/l;->drawTexture(Lqa/b;Landroid/graphics/Rect;Z)V
...
.method public drawTexture(ILandroid/graphics/Rect;Z)V
    ...
    .line 24
    invoke-virtual {p0}, Lcom/android/camera/effect/renders/l;->bindExtraTexture()V
    ...
    .line 26
    invoke-virtual {p0, p1}, Lcom/android/camera/effect/renders/s;->setBlendEnabled(Z)V
    ...
    invoke-virtual {v0, v1, p2}, Lcom/android/camera/effect/x;->f(FF)V

    .line 36
    invoke-virtual {p0, p3}, Lcom/android/camera/effect/renders/l;->initShaderValue(Z)V
...
.method public drawTexture(Lqa/b;Landroid/graphics/Rect;Z)V
    .locals 3
    ...
    invoke-virtual {p1, v0}, Lqa/b;->f(Lqa/g;)Z
    ...
    .line 4
    invoke-virtual {p0, p1, v0}, Lcom/android/camera/effect/renders/s;->bindTexture(Lqa/b;I)Z
    ...
    .line 10
    invoke-virtual {p1}, Lcom/android/camera/effect/x;->d()V
    ...
    invoke-virtual {p1, v0, v2}, Lcom/android/camera/effect/x;->g(FF)V
    ...
    invoke-virtual {p1, v0, p2}, Lcom/android/camera/effect/x;->f(FF)V
...
.method public initShader()V
    ...
    invoke-virtual {p0}, Lcom/android/camera/effect/renders/s;->getFragShaderString()Ljava/lang/String;
...
.method public initShaderValue(Z)V
    ...
    iget v0, p0, Lcom/android/camera/effect/renders/s;->mAttributeTexCoorH:I

    invoke-static {v0}, Landroid/opengl/GLES20;->glEnableVertexAttribArray(I)V

    iget v0, p0, Lcom/android/camera/effect/renders/s;->mUniformMVPMatrixH:I
    ...
    iget v0, p0, Lcom/android/camera/effect/renders/s;->mUniformSTMatrixH:I
    ...
    iget-object v1, v1, Lcom/android/camera/effect/x;->e:[F

    invoke-static {v0, v2, v3, v1, v3}, Landroid/opengl/GLES20;->glUniformMatrix4fv(IIZ[FI)V

    iget v0, p0, Lcom/android/camera/effect/renders/s;->mUniformTextureH:I

    invoke-static {v0, v3}, Landroid/opengl/GLES20;->glUniform1i(II)V

    iget v0, p0, Lcom/android/camera/effect/renders/s;->mUniformAlphaH:I
    ...
    iget p0, p0, Lcom/android/camera/effect/x;->g:F
...
.method public initVertexData()V
    ...
    sget-object v0, Lcom/android/camera/effect/renders/l;->VERTICES:[F
    ...
    invoke-static {v1}, Lcom/android/camera/effect/renders/s;->allocateByteBuffer(I)Ljava/nio/ByteBuffer;
    ...
    sget-object v0, Lcom/android/camera/effect/renders/l;->TEXTURES:[F
    ...
    invoke-static {v2}, Lcom/android/camera/effect/renders/s;->allocateByteBuffer(I)Ljava/nio/ByteBuffer;
    ...
    iput-object v2, p0, Lcom/android/camera/effect/renders/s;->mTexCoorBuffer:Ljava/nio/FloatBuffer;
