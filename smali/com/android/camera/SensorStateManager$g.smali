...
.method public final onAccuracyChanged(Landroid/hardware/Sensor;I)V
    ...
    invoke-static {p1, p2, p0}, Landroidx/constraintlayout/core/a;->j(Ljava/lang/String;ILjava/lang/String;)V
...
.method public final onSensorChanged(Landroid/hardware/SensorEvent;)V
    ...
    iget-object v0, p0, Lcom/android/camera/SensorStateManager$g;->c:Lcom/android/camera/SensorStateManager;

    invoke-virtual {v0}, Lcom/android/camera/SensorStateManager;->b()Lcom/android/camera/SensorStateManager$p;
    ...
    :cond_0
    iget-object v2, p0, Lcom/android/camera/SensorStateManager$g;->a:[F
    ...
    iget-object v7, v0, Lcom/android/camera/SensorStateManager;->a:Ljava/lang/String;
    ...
    :cond_3
    iget v6, v0, Lcom/android/camera/SensorStateManager;->b:F
    ...
    :cond_4
    iput v5, v0, Lcom/android/camera/SensorStateManager;->b:F
    ...
    iget v5, v0, Lcom/android/camera/SensorStateManager;->b:F
    ...
    iget-boolean v5, v0, Lcom/android/camera/SensorStateManager;->d:Z
    ...
    iget v2, v0, Lcom/android/camera/SensorStateManager;->b:F

    iget-boolean v5, v0, Lcom/android/camera/SensorStateManager;->d:Z

    invoke-interface {v1, v2, v5}, Lcom/android/camera/SensorStateManager$p;->d(FZ)V

    :cond_5
    invoke-interface {v1}, Lcom/android/camera/SensorStateManager$p;->c()Z

    move-result v2

    if-eqz v2, :cond_6

    invoke-interface {v1, p1}, Lcom/android/camera/SensorStateManager$p;->onSensorChanged(Landroid/hardware/SensorEvent;)V
    ...
    :cond_7
    iget-boolean p0, v0, Lcom/android/camera/SensorStateManager;->u:Z
    ...
    invoke-interface {p0, v5, v6}, Lcom/android/camera/SensorStateManager$p;->a(D)V
