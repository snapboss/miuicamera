...
.field public p0:Lcom/android/camera/AudioMapMove$a;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    iput v0, p0, Lcom/android/camera/AudioMapMove;->n0:F

    sget-object v0, Lz/q5;->AudioMap:[I
    ...
    iput p2, p0, Lcom/android/camera/AudioMapMove;->a0:F
    ...
    iput p2, p0, Lcom/android/camera/AudioMapMove;->b0:F
    ...
    iput p2, p0, Lcom/android/camera/AudioMapMove;->j0:F
...
.method public static a(Lcom/android/camera/AudioMapMove;)V
    ...
    iget-wide v2, p0, Lcom/android/camera/AudioMapMove;->q0:J
    ...
    :cond_0
    iput-wide v0, p0, Lcom/android/camera/AudioMapMove;->q0:J
...
.method public final b(FF)V
    ...
    iget-boolean v0, p0, Lcom/android/camera/AudioMapMove;->o0:Z
    ...
    iget v0, p0, Lcom/android/camera/AudioMapMove;->i0:F

    iput v0, p0, Lcom/android/camera/AudioMapMove;->m0:F

    iget v0, p0, Lcom/android/camera/AudioMapMove;->j0:F

    iput v0, p0, Lcom/android/camera/AudioMapMove;->n0:F

    iget v0, p0, Lcom/android/camera/AudioMapMove;->b0:F

    int-to-float v1, p1

    add-float/2addr v1, v0

    iput v1, p0, Lcom/android/camera/AudioMapMove;->k0:F
    ...
    iput p1, p0, Lcom/android/camera/AudioMapMove;->h0:F
    ...
    invoke-direct {v0, p0}, Lz/f0;-><init>(Lcom/android/camera/AudioMapMove;)V
    ...
    invoke-direct {p2, v0}, Lot/e;-><init>(I)V

    invoke-virtual {p1, p2}, Landroid/animation/ValueAnimator;->setInterpolator(Landroid/animation/TimeInterpolator;)V

    iget-object p1, p0, Lcom/android/camera/AudioMapMove;->h:Landroid/animation/ValueAnimator;

    new-instance p2, Lz/g0;

    invoke-direct {p2, p0}, Lz/g0;-><init>(Lcom/android/camera/AudioMapMove;)V
...
.method public final onDraw(Landroid/graphics/Canvas;)V
    ...
    iget-boolean v1, v0, Lcom/android/camera/AudioMapMove;->o0:Z
    ...
    iget v11, v0, Lcom/android/camera/AudioMapMove;->b0:F
    ...
    iget v1, v0, Lcom/android/camera/AudioMapMove;->c0:F

    iget v8, v0, Lcom/android/camera/AudioMapMove;->b0:F
    ...
    :goto_0
    iput v10, v0, Lcom/android/camera/AudioMapMove;->c0:F
    ...
    :cond_1
    iput v1, v0, Lcom/android/camera/AudioMapMove;->d0:F
    ...
    iget v14, v0, Lcom/android/camera/AudioMapMove;->b0:F

    iget v15, v0, Lcom/android/camera/AudioMapMove;->W:F

    iget v1, v0, Lcom/android/camera/AudioMapMove;->d0:F

    iget v7, v0, Lcom/android/camera/AudioMapMove;->a0:F
    ...
    iget v7, v0, Lcom/android/camera/AudioMapMove;->b0:F

    iget v8, v0, Lcom/android/camera/AudioMapMove;->x:F
    ...
    iget v5, v0, Lcom/android/camera/AudioMapMove;->s:I
    ...
    iget v3, v0, Lcom/android/camera/AudioMapMove;->w:I
    ...
    iget v6, v0, Lcom/android/camera/AudioMapMove;->e0:F

    iget v10, v0, Lcom/android/camera/AudioMapMove;->c0:F

    cmpg-float v1, v6, v10

    if-gtz v1, :cond_2

    iput v10, v0, Lcom/android/camera/AudioMapMove;->g0:F
    ...
    :goto_1
    iget v12, v0, Lcom/android/camera/AudioMapMove;->f0:F

    iget v3, v0, Lcom/android/camera/AudioMapMove;->d0:F

    cmpg-float v1, v12, v3

    if-gtz v1, :cond_3

    iput v3, v0, Lcom/android/camera/AudioMapMove;->h0:F

    iget v2, v0, Lcom/android/camera/AudioMapMove;->W:F

    iget v4, v0, Lcom/android/camera/AudioMapMove;->a0:F
    ...
    :cond_3
    iget v11, v0, Lcom/android/camera/AudioMapMove;->W:F

    iget v13, v0, Lcom/android/camera/AudioMapMove;->a0:F
    ...
    iget v10, v0, Lcom/android/camera/AudioMapMove;->s:I
    ...
    :cond_5
    iput v1, v0, Lcom/android/camera/AudioMapMove;->c0:F
    ...
    :goto_3
    iput v7, v0, Lcom/android/camera/AudioMapMove;->d0:F
    ...
    iget v7, v0, Lcom/android/camera/AudioMapMove;->c0:F
    ...
    iget v7, v0, Lcom/android/camera/AudioMapMove;->d0:F
    ...
    iget v6, v0, Lcom/android/camera/AudioMapMove;->w:I

    aput v6, v12, v5

    iget v5, v0, Lcom/android/camera/AudioMapMove;->u:I
    ...
    iget v3, v0, Lcom/android/camera/AudioMapMove;->t:I
    ...
    iget v2, v0, Lcom/android/camera/AudioMapMove;->c0:F
    ...
    :goto_4
    iget v1, v0, Lcom/android/camera/AudioMapMove;->f0:F
    ...
    iput v2, v0, Lcom/android/camera/AudioMapMove;->h0:F
    ...
    iget v2, v0, Lcom/android/camera/AudioMapMove;->f0:F
...
.method public final onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    iget-object v1, p0, Lcom/android/camera/AudioMapMove;->p0:Lcom/android/camera/AudioMapMove$a;

    if-eqz v1, :cond_3

    iget-boolean v3, p0, Lcom/android/camera/AudioMapMove;->o0:Z
    ...
    :cond_2
    iget-object v0, p0, Lcom/android/camera/AudioMapMove;->p0:Lcom/android/camera/AudioMapMove$a;
    ...
    iget-object p0, p0, Lcom/android/camera/AudioMapMove;->p0:Lcom/android/camera/AudioMapMove$a;
...
.method public setIsHorizontal(Z)V
    ...
    iput-boolean p1, p0, Lcom/android/camera/AudioMapMove;->o0:Z
...
.method public setOnAudioMapPressAnimatorListener(Lcom/android/camera/AudioMapMove$a;)V
    ...
    iput-object p1, p0, Lcom/android/camera/AudioMapMove;->p0:Lcom/android/camera/AudioMapMove$a;
