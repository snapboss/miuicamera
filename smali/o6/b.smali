...
.method public static constructor <clinit>()V
    ...
    sput-object v0, Lo6/b;->a:Ljava/lang/String;
...
.method public static a(Lorg/xmlpull/v1/XmlSerializer;JII)V
    ...
    sget-object p2, Lo6/b;->a:Ljava/lang/String;
...
.method public static b(Ljava/lang/String;)Lo6/a;
    ...
    sget-object v3, Lo6/b;->a:Ljava/lang/String;
...
.method public static c(Landroid/content/Context;Landroid/net/Uri;)Landroid/graphics/Bitmap;
    ...
    sget-object v0, Lo6/b;->a:Ljava/lang/String;
    ...
    invoke-static {p0, p1}, Lo6/b;->g(Landroid/content/Context;Landroid/net/Uri;)[B
    ...
    move-result-object v6
    :try_end_0
    .catch Lg/c; {:try_start_0 .. :try_end_0} :catch_3

    :try_start_1
    invoke-virtual {v6}, Lh/k;->b()Ljava/lang/String;

    move-result-object v6

    invoke-static {v6}, Lo6/b;->b(Ljava/lang/String;)Lo6/a;
    ...
    .catch Lg/c; {:try_start_3 .. :try_end_3} :catch_3
    ...
    .catch Lg/c; {:try_start_5 .. :try_end_5} :catch_3
    ...
    .catch Lg/c; {:try_start_7 .. :try_end_7} :catch_3
    ...
    :try_end_8
    .catch Lg/c; {:try_start_8 .. :try_end_8} :catch_3
...
.method public static g(Landroid/content/Context;Landroid/net/Uri;)[B
    ...
    invoke-static {p0}, Lo6/b;->e(Ljava/io/InputStream;)S
    ...
    invoke-static {v2, v1}, Lo6/b;->i(I[B)Ljava/util/ArrayList;
...
.method public static h(Ljava/io/File;Lo6/c;[B[B)V
    .locals 16
    ...
    sget-object v2, Lo6/b;->a:Ljava/lang/String;
    ...
    invoke-static {v9}, Lo6/b;->e(Ljava/io/InputStream;)S
    ...
    invoke-static {v13, v6}, Lo6/b;->i(I[B)Ljava/util/ArrayList;
    ...
    invoke-static {v6, v7, v4, v1}, Lo6/b;->k(Ljava/util/ArrayList;I[BLo6/c;)V
    ...
    invoke-static {v6, v1}, Lo6/b;->j(Ljava/util/ArrayList;Lo6/c;)V
    ...
    invoke-static {v0}, Lo6/b;->f(S)[B

    move-result-object v0

    invoke-virtual {v1, v0}, Ljava/io/FileOutputStream;->write([B)V

    invoke-static {v1, v6}, Lo6/b;->l(Ljava/io/FileOutputStream;Ljava/util/ArrayList;)V
...
.method public static i(I[B)Ljava/util/ArrayList;
    ...
    iput v3, v2, Lo6/c;->a:I

    invoke-virtual {p1}, Ljava/nio/ByteBuffer;->getShort()S

    move-result v3

    iput v3, v2, Lo6/c;->b:I

    invoke-virtual {p1}, Ljava/nio/ByteBuffer;->getInt()I

    move-result v3

    iput v3, v2, Lo6/c;->c:I

    invoke-virtual {p1}, Ljava/nio/ByteBuffer;->getInt()I

    move-result v3

    iput v3, v2, Lo6/c;->d:I
...
.method public static j(Ljava/util/ArrayList;Lo6/c;)V
    .locals 6
    ...
    iget v2, v1, Lo6/c;->a:I

    const/16 v3, 0x111

    if-ne v2, v3, :cond_1

    iget v2, v1, Lo6/c;->d:I

    invoke-virtual {p1}, Lo6/c;->a()I
    ...
    iput v3, v1, Lo6/c;->d:I

    goto :goto_0

    :cond_1
    invoke-virtual {v1}, Lo6/c;->a()I
    ...
    invoke-static {p0, v0}, Landroidx/appcompat/app/b;->e(Ljava/util/ArrayList;I)Ljava/lang/Object;

    move-result-object v0

    check-cast v0, Lo6/c;

    invoke-virtual {v0}, Lo6/c;->a()I
    ...
    sget-object v5, Lo6/b;->a:Ljava/lang/String;
...
.method public static k(Ljava/util/ArrayList;I[BLo6/c;)V
    .locals 4
    ...
    invoke-static {p1, p0, v1, v0}, Landroidx/appcompat/widget/f;->c(Ljava/lang/String;ILjava/lang/String;I)Ljava/lang/String;
...
.method public static l(Ljava/io/FileOutputStream;Ljava/util/ArrayList;)V
    ...
    iget v1, v0, Lo6/c;->a:I

    int-to-short v1, v1

    invoke-static {v1}, Lo6/b;->f(S)[B

    move-result-object v1

    invoke-virtual {p0, v1}, Ljava/io/FileOutputStream;->write([B)V

    iget v1, v0, Lo6/c;->b:I
    ...
    iget v1, v0, Lo6/c;->c:I

    invoke-static {v1}, Lo6/b;->d(I)[B
