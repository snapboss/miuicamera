...
.method public static constructor <clinit>()V
    ...
    sput-object v0, Lz/l6;->q:Ljava/util/concurrent/locks/ReentrantLock;
...
.method public constructor <init>(Landroid/net/Uri;Landroid/graphics/Bitmap;IZ)V
    ...
    iput-boolean v0, p0, Lz/l6;->c:Z

    iput-boolean v0, p0, Lz/l6;->d:Z

    iput-boolean v0, p0, Lz/l6;->e:Z

    iput-boolean v0, p0, Lz/l6;->h:Z

    const/4 v1, -0x1

    iput v1, p0, Lz/l6;->i:I

    iput v1, p0, Lz/l6;->j:I

    const-wide/16 v1, -0x1

    iput-wide v1, p0, Lz/l6;->k:J

    iput-boolean v0, p0, Lz/l6;->l:Z

    const/4 v1, 0x0

    iput-object v1, p0, Lz/l6;->o:Ljava/lang/Boolean;

    const/4 v2, 0x1

    iput-boolean v2, p0, Lz/l6;->p:Z

    iput-object p1, p0, Lz/l6;->a:Landroid/net/Uri;
    ...
    invoke-virtual {v8, p1, v3}, Landroid/graphics/Matrix;->postTranslate(FF)Z
    ...
    invoke-virtual {v8, p1, p3}, Landroid/graphics/Matrix;->postTranslate(FF)Z
    ...
    :goto_1
    invoke-virtual {v8, p4, v5, p1, p3}, Landroid/graphics/Matrix;->postScale(FFFF)Z
    ...
    invoke-direct {p4, v0, v3}, Landroid/graphics/PaintFlagsDrawFilter;-><init>(II)V
    ...
    invoke-virtual {p3, p2, v8, p4}, Landroid/graphics/Canvas;->drawBitmap(Landroid/graphics/Bitmap;Landroid/graphics/Matrix;Landroid/graphics/Paint;)V
    ...
    :goto_2
    iput-object p2, p0, Lz/l6;->b:Landroid/graphics/Bitmap;
...
.method public static b(Landroid/database/Cursor;)Lz/l6$a;
    .locals 19
    ...
    invoke-static {v2, v3}, Lqj/f;->q(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    :try_start_1
    invoke-direct/range {v4 .. v16}, Lz/l6$a;-><init>(JIJLjava/lang/String;IIZZJ)V
    :try_end_1
    ...
    invoke-static {v0, v3}, Landroidx/appcompat/widget/d;->d(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
...
.method public static c(Landroid/net/Uri;Landroid/graphics/Bitmap;IZ)Lz/l6;
    .locals 1
    ...
    :cond_0
    new-instance v0, Lz/l6;

    invoke-direct {v0, p0, p1, p2, p3}, Lz/l6;-><init>(Landroid/net/Uri;Landroid/graphics/Bitmap;IZ)V

    return-object v0
.end method

.method public static d([BIILandroid/net/Uri;Z)Lz/l6;
    .locals 4
    ...
    :cond_0
    invoke-static {p0}, Lqd/a;->c([B)Lqd/b;

    move-result-object v0

    if-eqz v0, :cond_1

    invoke-virtual {v0}, Lqd/b;->s()Landroid/graphics/Bitmap;
    ...
    :cond_2
    invoke-static {p3, v0, p1, p4}, Lz/l6;->c(Landroid/net/Uri;Landroid/graphics/Bitmap;IZ)Lz/l6;
...
.method public static e(Landroid/content/Context;Landroid/net/Uri;)Lz/l6;
    .locals 24
    ...
    invoke-static {v1, v7}, Landroidx/appcompat/widget/d;->c(Ljava/lang/String;Landroid/net/Uri;)Ljava/lang/String;
    ...
    invoke-static {v0, v3, v4, v6, v2}, Lz/l6;->k(Landroid/content/Context;JILjava/lang/String;)Landroid/graphics/Bitmap;
    ...
    invoke-static {v1, v3, v4, v5, v13}, Landroid/provider/MediaStore$Images$Thumbnails;->getThumbnail(Landroid/content/ContentResolver;JILandroid/graphics/BitmapFactory$Options;)Landroid/graphics/Bitmap;

    move-result-object v1

    if-nez v1, :cond_b

    sget-boolean v13, Lgc/c;->j:Z
    ...
    invoke-static {v11, v8, v6, v2}, Lz/l6;->m(IIILjava/lang/String;)Landroid/graphics/Bitmap;
    ...
    invoke-static/range {v17 .. v23}, Lz/l6;->f(Landroid/media/MediaMetadataRetriever;Ljava/lang/String;Ljava/io/FileDescriptor;Landroid/app/Application;Landroid/net/Uri;II)Landroid/graphics/Bitmap;
    ...
    invoke-static {v7, v0, v1, v1}, Lz/l6;->c(Landroid/net/Uri;Landroid/graphics/Bitmap;IZ)Lz/l6;

    move-result-object v0

    if-eqz v0, :cond_f

    invoke-virtual {v0, v9, v10}, Lz/l6;->o(J)V
...
.method public static f(Landroid/media/MediaMetadataRetriever;Ljava/lang/String;Ljava/io/FileDescriptor;Landroid/app/Application;Landroid/net/Uri;II)Landroid/graphics/Bitmap;
    ...
    invoke-static/range {p1 .. p6}, Lz/l6;->g(Landroid/media/MediaMetadataRetriever;IIIILandroid/media/MediaMetadataRetriever$BitmapParams;)Landroid/graphics/Bitmap;
...
.method public static h(Landroid/content/ContentResolver;)Lz/l6$a;
    .locals 10
    ...
    invoke-static {v3, v4}, Landroidx/activity/m;->f(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v3, v5}, Landroidx/activity/m;->f(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v6}, Lz/l6;->b(Landroid/database/Cursor;)Lz/l6$a;
    ...
    invoke-static {p0}, Lz/l6;->b(Landroid/database/Cursor;)Lz/l6$a;
...
.method public static i(Landroid/content/Context;Landroid/content/ContentResolver;)Lz/l6;
    .locals 23
    ...
    sget-object v2, Lz/l6;->q:Ljava/util/concurrent/locks/ReentrantLock;
    ...
    invoke-static {v15}, Lqj/n;->b(Ljava/io/Closeable;)V

    invoke-static {v12}, Lqj/n;->b(Ljava/io/Closeable;)V

    invoke-static {v14}, Lqj/n;->b(Ljava/io/Closeable;)V
    ...
    invoke-static {v1, v6}, Lqj/n;->j(Landroid/content/ContentResolver;Landroid/net/Uri;)Z

    move-result v1

    if-eqz v1, :cond_7

    invoke-static {v0, v6}, Ll8/m;->c(Landroid/content/Context;Landroid/net/Uri;)Z
    ...
    invoke-static {v6, v0, v1, v1}, Lz/l6;->c(Landroid/net/Uri;Landroid/graphics/Bitmap;IZ)Lz/l6;

    move-result-object v0

    if-eqz v0, :cond_b

    iput-boolean v9, v0, Lz/l6;->e:Z

    iput v2, v0, Lz/l6;->i:I

    iput v8, v0, Lz/l6;->j:I

    const/4 v1, 0x1

    iput-boolean v1, v0, Lz/l6;->c:Z

    iput-boolean v7, v0, Lz/l6;->h:Z

    invoke-virtual {v0, v4, v5}, Lz/l6;->o(J)V

    sget v1, Lz/l6;->s:I

    iput v1, v0, Lz/l6;->m:I
    ...
    invoke-static/range {v16 .. v16}, Lqj/n;->b(Ljava/io/Closeable;)V
...
.method public static j(J)Lz/l6;
    .locals 18
    .annotation build Landroidx/annotation/Nullable;
    .end annotation
    ...
    invoke-virtual {v5}, Lp1/b;->y()Lxt/a;
    ...
    invoke-direct {v7, v5}, Lbu/e;-><init>(Lxt/a;)V
    ...
    iput-object v9, v7, Lbu/e;->f:Ljava/lang/Integer;

    sget-object v9, Lcom/android/camera/db/greendao/SaveTaskDao$Properties;->Id:Lxt/d;

    iget-object v10, v7, Lbu/e;->b:Ljava/lang/StringBuilder;
    ...
    iput-object v10, v7, Lbu/e;->b:Ljava/lang/StringBuilder;
    ...
    iget-object v11, v7, Lbu/e;->a:Lbu/f;

    invoke-virtual {v11, v9}, Lbu/f;->a(Lxt/d;)V
    ...
    iget-object v12, v9, Lxt/d;->e:Ljava/lang/String;
    ...
    iget-object v9, v9, Lxt/d;->b:Ljava/lang/Class;
    ...
    iget-object v9, v7, Lbu/e;->g:Ljava/lang/String;
    ...
    :cond_2
    iget-object v9, v7, Lbu/e;->b:Ljava/lang/StringBuilder;

    const-string v10, " DESC"

    invoke-virtual {v9, v10}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    invoke-virtual {v7}, Lbu/e;->a()Lbu/d;
    ...
    iget-object v10, v7, Lbu/a;->e:Ljava/lang/Thread;

    if-ne v9, v10, :cond_8

    iget-object v9, v7, Lbu/a;->a:Lxt/a;

    iget-object v9, v9, Lxt/a;->b:Lyt/b;

    iget-object v9, v9, Lyt/b;->a:Landroid/database/sqlite/SQLiteDatabase;

    iget-object v10, v7, Lbu/a;->c:Ljava/lang/String;

    iget-object v11, v7, Lbu/a;->d:[Ljava/lang/String;
    ...
    iget-object v7, v7, Lbu/a;->b:Lho/q2;

    iget-object v7, v7, Lho/q2;->a:Ljava/lang/Object;
    ...
    :try_start_0
    invoke-virtual {v7, v9}, Lxt/a;->h(Landroid/database/Cursor;)Ljava/util/ArrayList;
    ...
    iget-wide v11, v7, Ln1/b;->m:J

    cmp-long v0, v11, v0

    if-lez v0, :cond_7

    iget-object v0, v7, Ln1/b;->j:Ljava/lang/String;
    ...
    invoke-virtual/range {v11 .. v17}, Ln1/b;->a(Ljava/lang/String;IZZJ)Z
    ...
    :cond_4
    iget-object v0, v7, Ln1/b;->c:Ljava/lang/Long;
    ...
    invoke-static {v1, v0}, Ll8/y;->w(Landroid/content/Context;Landroid/net/Uri;)Z
    ...
    :cond_5
    iget-object v1, v7, Ln1/b;->j:Ljava/lang/String;

    invoke-static {v1, v5}, Landroid/media/ThumbnailUtils;->createImageThumbnail(Ljava/lang/String;I)Landroid/graphics/Bitmap;

    move-result-object v1

    iget v2, v7, Ln1/b;->g:I

    invoke-static {v0, v1, v2, v6}, Lz/l6;->c(Landroid/net/Uri;Landroid/graphics/Bitmap;IZ)Lz/l6;
    ...
    invoke-virtual {v0, v1, v2}, Lz/l6;->o(J)V
    ...
    invoke-direct {v0, v1}, Lxt/c;-><init>(Ljava/lang/String;)V
...
.method public static k(Landroid/content/Context;JILjava/lang/String;)Landroid/graphics/Bitmap;
    ...
    invoke-static/range {p0 .. p4}, Lz/l6;->l(Landroid/content/Context;JILjava/lang/String;)Landroid/graphics/Bitmap;
...
.method public static l(Landroid/content/Context;JILjava/lang/String;)Landroid/graphics/Bitmap;
    ...
    invoke-static {p0, p4, v8}, Ll8/y;->i(Landroid/content/Context;Ljava/lang/String;Z)Landroid/net/Uri;
...
.method public final o(J)V
    ...
    iput-wide p1, p0, Lz/l6;->k:J

    const-string v0, "setFileSize: "

    const-string v1, ", mUri: "

    invoke-static {v0, p1, p2, v1}, Lae/e;->g(Ljava/lang/String;JLjava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object p1

    iget-object p2, p0, Lz/l6;->a:Landroid/net/Uri;
...
.method public final p(J)V
    ...
    iput-object v0, p0, Lz/l6;->f:Ljava/lang/String;
    ...
    iput-object p1, p0, Lz/l6;->g:Ljava/lang/String;
...
.method public final q(Landroid/net/Uri;)V
    ...
    iget-object v0, p0, Lz/l6;->a:Landroid/net/Uri;
...
.method public final toString()Ljava/lang/String;
    ...
    iget-object v1, p0, Lz/l6;->a:Landroid/net/Uri;
    ...
    iget-object v1, p0, Lz/l6;->b:Landroid/graphics/Bitmap;
