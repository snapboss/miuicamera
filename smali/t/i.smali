...
.field public final y:Lt/i$a;

.field public final z:Lt/i$b;
...
.method public constructor <init>(Ll/j;Lt/e;)V
    ...
    iput-object v0, p0, Lt/i;->v:Ljava/lang/StringBuilder;

    new-instance v0, Landroid/graphics/RectF;

    invoke-direct {v0}, Landroid/graphics/RectF;-><init>()V

    iput-object v0, p0, Lt/i;->w:Landroid/graphics/RectF;

    new-instance v0, Landroid/graphics/Matrix;

    invoke-direct {v0}, Landroid/graphics/Matrix;-><init>()V

    iput-object v0, p0, Lt/i;->x:Landroid/graphics/Matrix;

    new-instance v0, Lt/i$a;

    invoke-direct {v0}, Lt/i$a;-><init>()V

    iput-object v0, p0, Lt/i;->y:Lt/i$a;

    new-instance v0, Lt/i$b;

    invoke-direct {v0}, Lt/i$b;-><init>()V

    iput-object v0, p0, Lt/i;->z:Lt/i$b;

    new-instance v0, Ljava/util/HashMap;

    invoke-direct {v0}, Ljava/util/HashMap;-><init>()V

    iput-object v0, p0, Lt/i;->A:Ljava/util/HashMap;

    new-instance v0, Landroidx/collection/LongSparseArray;

    invoke-direct {v0}, Landroidx/collection/LongSparseArray;-><init>()V

    iput-object v0, p0, Lt/i;->B:Landroidx/collection/LongSparseArray;

    iput-object p1, p0, Lt/i;->D:Ll/j;

    iget-object p1, p2, Lt/e;->b:Ll/d;

    iput-object p1, p0, Lt/i;->E:Ll/d;

    new-instance p1, Lo/n;

    iget-object v0, p2, Lt/e;->q:Lr/i;

    iget-object v0, v0, Lr/m;->b:Ljava/lang/Iterable;

    check-cast v0, Ljava/util/List;

    invoke-direct {p1, v0}, Lo/n;-><init>(Ljava/util/List;)V

    iput-object p1, p0, Lt/i;->C:Lo/n;

    invoke-virtual {p1, p0}, Lo/a;->a(Lo/a$a;)V

    invoke-virtual {p0, p1}, Lt/b;->b(Lo/a;)V

    iget-object p1, p2, Lt/e;->r:Lr/j;

    if-eqz p1, :cond_0

    iget-object p2, p1, Lr/j;->a:Lr/a;

    if-eqz p2, :cond_0

    invoke-virtual {p2}, Lr/a;->a()Lo/a;

    move-result-object p2

    iput-object p2, p0, Lt/i;->F:Lo/a;

    invoke-virtual {p2, p0}, Lo/a;->a(Lo/a$a;)V

    iget-object p2, p0, Lt/i;->F:Lo/a;
    ...
    iput-object p2, p0, Lt/i;->G:Lo/a;

    invoke-virtual {p2, p0}, Lo/a;->a(Lo/a$a;)V

    iget-object p2, p0, Lt/i;->G:Lo/a;
    ...
    iput-object p2, p0, Lt/i;->H:Lo/a;

    invoke-virtual {p2, p0}, Lo/a;->a(Lo/a$a;)V

    iget-object p2, p0, Lt/i;->H:Lo/a;
    ...
    iput-object p1, p0, Lt/i;->I:Lo/a;

    invoke-virtual {p1, p0}, Lo/a;->a(Lo/a$a;)V

    iget-object p1, p0, Lt/i;->I:Lo/a;
...
.method public final a(Landroid/graphics/RectF;Landroid/graphics/Matrix;Z)V
    ...
    iget-object p0, p0, Lt/i;->E:Ll/d;

    iget-object p2, p0, Ll/d;->j:Landroid/graphics/Rect;
    ...
    iget-object p0, p0, Ll/d;->j:Landroid/graphics/Rect;
...
.method public final d(Ly/c;Ljava/lang/Object;)V
    ...
    invoke-virtual {p2, p1}, Lo/a;->j(Ly/c;)V
    ...
    invoke-virtual {p0, p2}, Lt/b;->m(Lo/a;)V

    :cond_1
    iput-object v1, p0, Lt/i;->F:Lo/a;
    ...
    invoke-direct {p2, p1, v1}, Lo/p;-><init>(Ly/c;Ljava/lang/Object;)V

    iput-object p2, p0, Lt/i;->F:Lo/a;

    invoke-virtual {p2, p0}, Lo/a;->a(Lo/a$a;)V

    iget-object p1, p0, Lt/i;->F:Lo/a;
    ...
    :cond_7
    sget-object v0, Ll/n;->o:Ljava/lang/Float;
    ...
    :cond_b
    sget-object v0, Ll/n;->p:Ljava/lang/Float;

    if-ne p2, v0, :cond_f

    iget-object p2, p0, Lt/i;->I:Lo/a;
    ...
    :cond_f
    sget-object v0, Ll/n;->B:Ljava/lang/Float;

    if-ne p2, v0, :cond_12

    if-nez p1, :cond_11

    iget-object p1, p0, Lt/i;->J:Lo/p;

    if-eqz p1, :cond_10

    invoke-virtual {p0, p1}, Lt/b;->m(Lo/a;)V

    :cond_10
    iput-object v1, p0, Lt/i;->J:Lo/p;
...
.method public final j(Landroid/graphics/Canvas;Landroid/graphics/Matrix;I)V
    ...
    iget-object v2, v0, Lt/i;->D:Ll/j;

    iget-object v3, v2, Ll/j;->b:Ll/d;

    iget-object v3, v3, Ll/d;->g:Landroidx/collection/SparseArrayCompat;
    ...
    iget-object v6, v0, Lt/i;->E:Ll/d;

    iget-object v7, v6, Ll/d;->e:Ljava/util/Map;

    iget-object v8, v3, Lq/c;->b:Ljava/lang/String;
    ...
    :cond_2
    iget-object v8, v0, Lt/i;->F:Lo/a;

    iget-object v9, v0, Lt/i;->y:Lt/i$a;
    ...
    :goto_1
    iget-object v8, v0, Lt/i;->G:Lo/a;

    iget-object v10, v0, Lt/i;->z:Lt/i$b;
    ...
    :goto_2
    iget-object v8, v0, Lt/b;->t:Lo/o;

    iget-object v8, v8, Lo/o;->j:Lo/a;
    ...
    :cond_6
    invoke-static/range {p2 .. p2}, Lx/g;->d(Landroid/graphics/Matrix;)F

    move-result v8

    iget v11, v3, Lq/c;->j:F
    ...
    :goto_4
    iget-object v8, v2, Ll/j;->b:Ll/d;

    iget-object v8, v8, Ll/d;->g:Landroidx/collection/SparseArrayCompat;
    ...
    iget-boolean v11, v3, Lq/c;->k:Z

    iget v15, v3, Lq/c;->d:I
    ...
    iget-object v5, v3, Lq/c;->a:Ljava/lang/String;

    move-object/from16 v20, v10

    iget-object v10, v7, Lq/d;->b:Ljava/lang/String;

    iget-object v7, v7, Lq/d;->a:Ljava/lang/String;

    if-eqz v8, :cond_16

    iget-object v8, v0, Lt/i;->J:Lo/p;
    ...
    :cond_8
    invoke-virtual {v8}, Lo/p;->f()Ljava/lang/Object;
    ...
    invoke-static {v11, v7, v10}, Lq/e;->a(CLjava/lang/String;Ljava/lang/String;)I

    move-result v11

    move-object/from16 v24, v3

    iget-object v3, v6, Ll/d;->g:Landroidx/collection/SparseArrayCompat;
    ...
    invoke-static {v4, v7, v6}, Lq/e;->a(CLjava/lang/String;Ljava/lang/String;)I

    move-result v4

    move-object/from16 v10, v27

    iget-object v11, v10, Ll/d;->g:Landroidx/collection/SparseArrayCompat;
    ...
    :cond_d
    iget-object v11, v0, Lt/i;->A:Ljava/util/HashMap;
    ...
    :cond_e
    iget-object v14, v4, Lq/e;->a:Ljava/util/List;
    ...
    invoke-direct {v14, v2, v0, v5}, Ln/d;-><init>(Ll/j;Lt/b;Ls/m;)V
    ...
    invoke-virtual {v10}, Ln/d;->getPath()Landroid/graphics/Path;

    move-result-object v10

    iget-object v13, v0, Lt/i;->w:Landroid/graphics/RectF;

    const/4 v14, 0x0

    invoke-virtual {v10, v13, v14}, Landroid/graphics/Path;->computeBounds(Landroid/graphics/RectF;Z)V

    iget-object v13, v0, Lt/i;->x:Landroid/graphics/Matrix;
    ...
    invoke-static {v10, v11, v1}, Lt/i;->q(Landroid/graphics/Path;Landroid/graphics/Paint;Landroid/graphics/Canvas;)V

    move-object/from16 v13, v20

    invoke-static {v10, v13, v1}, Lt/i;->q(Landroid/graphics/Path;Landroid/graphics/Paint;Landroid/graphics/Canvas;)V
    ...
    iget-object v14, v0, Lt/i;->I:Lo/a;

    if-eqz v14, :cond_12

    invoke-virtual {v14}, Lo/a;->f()Ljava/lang/Object;
    ...
    invoke-direct {v9, v8}, Lp/a;-><init>(Landroid/graphics/drawable/Drawable$Callback;)V

    iput-object v9, v2, Ll/j;->l:Lp/a;
    ...
    :goto_11
    iget-object v2, v2, Ll/j;->l:Lp/a;

    :goto_12
    if-eqz v2, :cond_1f

    iget-object v8, v2, Lp/a;->a:Lq/j;

    iput-object v7, v8, Lq/j;->a:Ljava/lang/Object;

    iput-object v6, v8, Lq/j;->b:Ljava/lang/Object;

    iget-object v9, v2, Lp/a;->b:Ljava/util/HashMap;
    ...
    iget-object v10, v2, Lp/a;->c:Ljava/util/HashMap;
    ...
    iget-object v15, v2, Lp/a;->e:Ljava/lang/String;
    ...
    iget-object v2, v2, Lp/a;->d:Landroid/content/res/AssetManager;
    ...
    :cond_22
    invoke-virtual {v1}, Lo/p;->f()Ljava/lang/Object;
    ...
    iget-object v9, v0, Lt/i;->B:Landroidx/collection/LongSparseArray;
    ...
    :cond_29
    iget-object v15, v0, Lt/i;->v:Ljava/lang/StringBuilder;
    ...
    invoke-static {v9, v11, v8}, Lt/i;->p(Ljava/lang/String;Landroid/graphics/Paint;Landroid/graphics/Canvas;)V

    invoke-static {v9, v3, v8}, Lt/i;->p(Ljava/lang/String;Landroid/graphics/Paint;Landroid/graphics/Canvas;)V
    ...
    iget-object v15, v0, Lt/i;->I:Lo/a;
