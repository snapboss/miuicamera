...
.method public static c()Lvu/b;
    ...
    :cond_1
    new-instance v2, Lvu/b$a;

    invoke-direct {v2, v0}, Lvu/b$a;-><init>(Landroid/os/IHwBinder;)V
...
# virtual methods
.method public abstract a(Lcom/xiaomi/camera/mivi/b;)Z
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Landroid/os/RemoteException;
        }
...
.method public abstract d(ILvu/c;)I
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Landroid/os/RemoteException;
        }
