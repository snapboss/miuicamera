...
.method private buildSlidesAndNotes()V
    ...
    const-string v11, "A Notes SlideAtomSet at "

    invoke-static {v11, v8, v5}, Landroidx/appcompat/widget/c;->i(Ljava/lang/String;ILjava/lang/String;)Ljava/lang/StringBuilder;
    ...
    const-string v11, "A Slide SlideAtomSet at "
    ...
    const-string v5, "Notes not found for noteId="

    invoke-static {v5, v2, v4, v6}, Landroidx/appcompat/widget/f;->h(Ljava/lang/String;ILorg/apache/poi/util/POILogger;I)V
...
.method private getCoreRecordForRefID(I)Lorg/apache/poi/hslf/record/Record;
    ...
    const-string v0, "We tried to look up a reference to a core record, but there was no core ID for reference ID "

    const/4 v1, 0x7

    invoke-static {v0, p1, p0, v1}, Landroidx/appcompat/widget/f;->h(Ljava/lang/String;ILorg/apache/poi/util/POILogger;I)V
...
.method public addMovie(Ljava/lang/String;I)I
    ...
    const-string p1, "Unsupported Movie: "
...
.method public createSlide()Lorg/apache/poi/hslf/model/Slide;
    ...
    iget-object v8, v0, Lorg/apache/poi/hslf/usermodel/SlideShow;->_hslfSlideShow:Lorg/apache/poi/hslf/HSLFSlideShow;

    invoke-virtual {v8}, Lorg/apache/poi/hslf/HSLFSlideShow;->getRecords()[Lorg/apache/poi/hslf/record/Record;

    move-result-object v8

    iput-object v8, v0, Lorg/apache/poi/hslf/usermodel/SlideShow;->_records:[Lorg/apache/poi/hslf/record/Record;
    ...
    :goto_3
    iget-object v11, v0, Lorg/apache/poi/hslf/usermodel/SlideShow;->_records:[Lorg/apache/poi/hslf/record/Record;
    ...
    :try_start_0
    invoke-virtual {v11, v12}, Lorg/apache/poi/hslf/record/Record;->writeOut(Ljava/io/OutputStream;)V
    :try_end_0
    ...
    invoke-virtual {v11}, Lorg/apache/poi/hslf/record/Record;->getRecordType()J

    move-result-wide v13

    sget-object v11, Lorg/apache/poi/hslf/record/RecordTypes;->PersistPtrIncrementalBlock:Lorg/apache/poi/hslf/record/RecordTypes$Type;
    ...
    iget-object v5, v0, Lorg/apache/poi/hslf/usermodel/SlideShow;->_records:[Lorg/apache/poi/hslf/record/Record;
    ...
    sget-object v11, Lorg/apache/poi/hslf/record/RecordTypes;->UserEditAtom:Lorg/apache/poi/hslf/record/RecordTypes$Type;
    ...
    invoke-virtual {v10}, Lorg/apache/poi/hslf/record/UserEditAtom;->getMaxPersistWritten()I
    ...
    invoke-virtual {v10, v5}, Lorg/apache/poi/hslf/record/UserEditAtom;->setLastViewType(S)V

    invoke-virtual {v10, v2}, Lorg/apache/poi/hslf/record/UserEditAtom;->setMaxPersistWritten(I)V

    invoke-virtual {v6, v4}, Lorg/apache/poi/hslf/record/PositionDependentRecordContainer;->setLastOnDiskOffset(I)V

    invoke-virtual {v3}, Lorg/apache/poi/hslf/record/SlidePersistAtom;->getRefID()I

    move-result v2

    invoke-virtual {v9, v2, v4}, Lorg/apache/poi/hslf/record/PersistPtrHolder;->addSlideLookup(II)V

    iget-object v2, v0, Lorg/apache/poi/hslf/usermodel/SlideShow;->logger:Lorg/apache/poi/util/POILogger;

    const-string v3, "New slide ended up at "

    const/4 v5, 0x3

    invoke-static {v3, v4, v2, v5}, Landroidx/appcompat/widget/f;->h(Ljava/lang/String;ILorg/apache/poi/util/POILogger;I)V
...
.method public removeSlide(I)Lorg/apache/poi/hslf/model/Slide;
    ...
    const-string v1, "Slide index ("

    const-string v2, ") is out of range (0.."

    const-string v3, ")"

    invoke-static {v1, p1, v2, v0, v3}, Landroidx/appcompat/view/menu/a;->e(Ljava/lang/String;ILjava/lang/String;ILjava/lang/String;)Ljava/lang/String;
...
.method public reorderSlide(II)V
    ...
    invoke-static {p2, p0, v0}, Landroidx/appcompat/graphics/drawable/a;->e(Ljava/lang/StringBuilder;ILjava/lang/String;)Ljava/lang/String;
