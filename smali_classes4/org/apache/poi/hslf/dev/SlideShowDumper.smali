...
.method public walkEscherBasic(III)V
    ...
    invoke-static {v6, v7}, Landroidx/activity/m;->f(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v5, v9}, Lorg/apache/poi/util/LittleEndian;->getUInt([BI)J
    ...
    invoke-virtual {v0, v11}, Lorg/apache/poi/hslf/dev/SlideShowDumper;->makeHex(I)Ljava/lang/String;
    ...
    const-string v15, "That\'s an Escher Record: "
    ...
    iget-object v12, v0, Lorg/apache/poi/hslf/dev/SlideShowDumper;->_docstream:[B
    ...
    invoke-virtual {v0, v12}, Lorg/apache/poi/hslf/dev/SlideShowDumper;->makeHex(S)Ljava/lang/String;
    ...
    invoke-virtual {v9, v6}, Ljava/io/PrintStream;->print(Ljava/lang/String;)V
    ...
    invoke-virtual {v0, v4, v5, v11}, Lorg/apache/poi/hslf/dev/SlideShowDumper;->walkEscherBasic(III)V
...
.method public walkEscherDDF(III)V
    ...
    iget-object v7, v0, Lorg/apache/poi/hslf/dev/SlideShowDumper;->_docstream:[B

    invoke-static {v7, v2, v6, v4, v3}, Ljava/lang/System;->arraycopy(Ljava/lang/Object;ILjava/lang/Object;II)V
    ...
    invoke-virtual {v7, v6, v4}, Lorg/apache/poi/ddf/DefaultEscherRecordFactory;->createRecord([BI)Lorg/apache/poi/ddf/EscherRecord;

    move-result-object v8

    invoke-virtual {v8, v6, v4, v7}, Lorg/apache/poi/ddf/EscherRecord;->fillFields([BILorg/apache/poi/ddf/EscherRecordFactory;)I

    const/4 v4, 0x2

    invoke-static {v6, v4}, Lorg/apache/poi/util/LittleEndian;->getUShort([BI)I
    ...
    invoke-virtual {v8}, Lorg/apache/poi/ddf/EscherRecord;->getRecordSize()I
    ...
    invoke-virtual {v0, v14}, Lorg/apache/poi/hslf/dev/SlideShowDumper;->makeHex(I)Ljava/lang/String;

    move-result-object v14

    invoke-virtual {v13, v14}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    const-string v14, "), len is "
    ...
    const-string v6, ") doesn\'t match record length of "
    ...
    :cond_2
    instance-of v3, v8, Lorg/apache/poi/ddf/EscherContainerRecord;
    ...
    invoke-virtual {v0, v3, v6, v14}, Lorg/apache/poi/hslf/dev/SlideShowDumper;->walkEscherDDF(III)V
    ...
    invoke-virtual {v8, v6, v3, v7}, Lorg/apache/poi/ddf/EscherRecord;->fillFields([BILorg/apache/poi/ddf/EscherRecordFactory;)I

    instance-of v3, v8, Lorg/apache/poi/ddf/EscherTextboxRecord;
    ...
    invoke-virtual {v0, v4, v5, v14}, Lorg/apache/poi/hslf/dev/SlideShowDumper;->walkEscherDDF(III)V
