...
.method private createLVL([BILorg/apache/poi/hdf/model/hdftypes/LVL;)I
    ...
    invoke-static {p1, p0}, Lorg/apache/poi/hdf/extractor/Utils;->convertBytesToShort([BI)S
    ...
    iput-object v2, p3, Lorg/apache/poi/hdf/model/hdftypes/LVL;->_xst:[C

    :goto_0
    if-ge v1, v0, :cond_1

    iget-object v2, p3, Lorg/apache/poi/hdf/model/hdftypes/LVL;->_xst:[C
...
.method private initLFO([B)V
    ...
    invoke-static {v4, v7, v2, v5}, Landroidx/activity/o;->a(IIII)I
...
.method private initLST([B)V
    ...
    invoke-static {v1, v7, v8, v3}, Landroidx/activity/o;->a(IIII)I
