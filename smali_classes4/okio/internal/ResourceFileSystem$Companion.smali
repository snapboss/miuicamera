...
.method public final removeBase(Lokio/Path;Lokio/Path;)Lokio/Path;
    ...
    invoke-static {p1, p2}, Lvp/m;->i0(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {p1, p2, v0}, Lvp/i;->P(Ljava/lang/String;CC)Ljava/lang/String;
...
.method public final toClasspathRoots(Ljava/lang/ClassLoader;)Ljava/util/List;
    ...
    invoke-virtual {v4, v2}, Lokio/internal/ResourceFileSystem$Companion;->toFileRoot(Ljava/net/URL;)Lcp/g;
    ...
    invoke-virtual {v2, v0}, Lokio/internal/ResourceFileSystem$Companion;->toJarRoot(Ljava/net/URL;)Lcp/g;
    ...
    :cond_3
    invoke-static {p1, v1}, Ldp/q;->T(Ljava/lang/Iterable;Ljava/util/Collection;)Ljava/util/ArrayList;
...
.method public final toFileRoot(Ljava/net/URL;)Lcp/g;
    .locals 4
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct {v0, p0, p1}, Lcp/g;-><init>(Ljava/lang/Object;Ljava/lang/Object;)V

    return-object v0
.end method

.method public final toJarRoot(Ljava/net/URL;)Lcp/g;
    .locals 6
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-static {p1, v0, v3}, Lvp/m;->d0(Ljava/lang/CharSequence;Ljava/lang/String;I)I
    ...
    invoke-static {p1, v0, v1}, Lokio/internal/ZipKt;->openZip(Lokio/Path;Lokio/FileSystem;Lop/l;)Lokio/ZipFileSystem;
    ...
    invoke-direct {v0, p1, p0}, Lcp/g;-><init>(Ljava/lang/Object;Ljava/lang/Object;)V
