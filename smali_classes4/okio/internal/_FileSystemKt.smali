...
# direct methods
.method public static final collectRecursively(Lup/i;Lokio/FileSystem;Ldp/g;Lokio/Path;ZZLgp/d;)Ljava/lang/Object;
    .locals 17
    ...
    invoke-direct {v4, v3}, Lokio/internal/_FileSystemKt$collectRecursively$1;-><init>(Lgp/d;)V

    :goto_0
    iget-object v3, v4, Lokio/internal/_FileSystemKt$collectRecursively$1;->result:Ljava/lang/Object;

    sget-object v5, Lhp/a;->a:Lhp/a;
    ...
    invoke-static {v3}, Lcom/android/camera/effect/b;->N(Ljava/lang/Object;)V
    ...
    invoke-virtual {v0, v1, v4}, Lup/i;->a(Ljava/lang/Object;Lgp/d;)V
    ...
    invoke-virtual {v6, v13}, Ldp/g;->contains(Ljava/lang/Object;)Z
    ...
    :cond_9
    invoke-virtual {v6, v13}, Ldp/g;->addLast(Ljava/lang/Object;)V
    ...
    invoke-static/range {p0 .. p6}, Lokio/internal/_FileSystemKt;->collectRecursively(Lup/i;Lokio/FileSystem;Ldp/g;Lokio/Path;ZZLgp/d;)Ljava/lang/Object;
    ...
    :cond_c
    invoke-virtual {v11}, Ldp/g;->removeLast()Ljava/lang/Object;
    ...
    :goto_7
    invoke-virtual {v6}, Ldp/g;->removeLast()Ljava/lang/Object;
    ...
    invoke-virtual {v12, v1, v4}, Lup/i;->a(Ljava/lang/Object;Lgp/d;)V
...
.method public static final commonCopy(Lokio/FileSystem;Lokio/Path;Lokio/Path;)V
    ...
    :cond_3
    invoke-static {v0, p1}, Lnt/c;->f(Ljava/lang/Throwable;Ljava/lang/Throwable;)V
...
.method public static final commonCreateDirectories(Lokio/FileSystem;Lokio/Path;Z)V
    ...
    invoke-virtual {v0, v1}, Ldp/g;->addFirst(Ljava/lang/Object;)V
...
.method public static final commonDeleteRecursively(Lokio/FileSystem;Lokio/Path;Z)V
    ...
    invoke-direct {v0, p0, p1, v1}, Lokio/internal/_FileSystemKt$commonDeleteRecursively$sequence$1;-><init>(Lokio/FileSystem;Lokio/Path;Lgp/d;)V

    new-instance p1, Lup/h;

    invoke-direct {p1}, Lup/h;-><init>()V

    invoke-static {p1, p1, v0}, Lbb/b;->l(Ljava/lang/Object;Lgp/d;Lop/p;)Lgp/d;

    move-result-object v0

    iput-object v0, p1, Lup/h;->d:Lgp/d;

    :goto_0
    invoke-virtual {p1}, Lup/h;->hasNext()Z

    move-result v0

    if-eqz v0, :cond_1

    invoke-virtual {p1}, Lup/h;->next()Ljava/lang/Object;
...
.method public static final commonListRecursively(Lokio/FileSystem;Lokio/Path;Z)Lup/g;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct {v0, p1, p0, p2, v1}, Lokio/internal/_FileSystemKt$commonListRecursively$1;-><init>(Lokio/Path;Lokio/FileSystem;ZLgp/d;)V
