...
.method private static final buildIndex(Ljava/util/List;)Ljava/util/Map;
    ...
    invoke-direct {v4, v0, v3}, Lcp/g;-><init>(Ljava/lang/Object;Ljava/lang/Object;)V
    ...
    invoke-static {v1, v2}, Ldp/q;->V(Ljava/lang/Iterable;Ljava/util/Comparator;)Ljava/util/List;
...
.method private static final getHex(I)Ljava/lang/String;
    ...
    invoke-static {v0}, Lcom/android/camera/effect/b;->q(I)V
...
.method public static final openZip(Lokio/Path;Lokio/FileSystem;Lop/l;)Lokio/ZipFileSystem;
    .locals 18
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    sget-object v9, Lcp/m;->a:Lcp/m;
    :try_end_4
    .catchall {:try_start_4 .. :try_end_4} :catchall_0

    :try_start_5
    invoke-static {v5, v11}, Lho/n;->c(Ljava/io/Closeable;Ljava/lang/Throwable;)V
    :try_end_5
    ...
    :try_start_8
    invoke-static {v5, v1}, Lho/n;->c(Ljava/io/Closeable;Ljava/lang/Throwable;)V
    ...
    :try_start_9
    invoke-static {v3, v11}, Lho/n;->c(Ljava/io/Closeable;Ljava/lang/Throwable;)V
    :try_end_9
    ...
    invoke-interface {v2, v6}, Lop/l;->invoke(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-static {v4, v11}, Lho/n;->c(Ljava/io/Closeable;Ljava/lang/Throwable;)V
    ...
    invoke-static {v4, v1}, Lho/n;->c(Ljava/io/Closeable;Ljava/lang/Throwable;)V

    throw v2
.end method

.method public static synthetic openZip$default(Lokio/Path;Lokio/FileSystem;Lop/l;ILjava/lang/Object;)Lokio/ZipFileSystem;
    .locals 0
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    :cond_0
    invoke-static {p0, p1, p2}, Lokio/internal/ZipKt;->openZip(Lokio/Path;Lokio/FileSystem;Lop/l;)Lokio/ZipFileSystem;
...
.method public static final readEntry(Lokio/BufferedSource;)Lokio/internal/ZipEntry;
    ...
    iput-wide v2, v11, Lkotlin/jvm/internal/w;->a:J
    ...
    iput-wide v2, v14, Lkotlin/jvm/internal/w;->a:J
    ...
    iput-wide v1, v6, Lkotlin/jvm/internal/w;->a:J
    ...
    invoke-static {v2, v3}, Lvp/m;->U(Ljava/lang/CharSequence;C)Z

    move-result v0

    if-nez v0, :cond_5

    iget-wide v0, v14, Lkotlin/jvm/internal/w;->a:J
    ...
    iget-wide v1, v6, Lkotlin/jvm/internal/w;->a:J
    ...
    invoke-direct/range {v0 .. v7}, Lokio/internal/ZipKt$readEntry$1;-><init>(Lkotlin/jvm/internal/u;JLkotlin/jvm/internal/w;Lokio/BufferedSource;Lkotlin/jvm/internal/w;Lkotlin/jvm/internal/w;)V

    invoke-static {v8, v15, v13}, Lokio/internal/ZipKt;->readExtra(Lokio/BufferedSource;ILop/p;)V
    ...
    invoke-static {v9, v1, v4}, Lvp/i;->K(Ljava/lang/String;Ljava/lang/String;Z)Z
    ...
    iget-wide v11, v1, Lkotlin/jvm/internal/w;->a:J

    iget-wide v14, v10, Lkotlin/jvm/internal/w;->a:J
...
.method private static final readExtra(Lokio/BufferedSource;ILop/p;)V
    .locals 10
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-interface {p2, v8, v9}, Lop/p;->invoke(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
...
.method private static final readOrSkipLocalHeader(Lokio/BufferedSource;Lokio/FileMetadata;)Lokio/FileMetadata;
    ...
    invoke-direct {v2, v0, v1, v3, v4}, Lokio/internal/ZipKt$readOrSkipLocalHeader$1;-><init>(Lokio/BufferedSource;Lkotlin/jvm/internal/x;Lkotlin/jvm/internal/x;Lkotlin/jvm/internal/x;)V

    invoke-static {v0, v5, v2}, Lokio/internal/ZipKt;->readExtra(Lokio/BufferedSource;ILop/p;)V
