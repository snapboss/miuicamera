...
.method public declared-synchronized configure()V
    ...
    const-string v0, "configure: dest = "

    monitor-enter p0

    :try_start_0
    iget-boolean v1, p0, Lnet/majorkernelpanic/streaming/MediaStream;->mStreaming:Z
    ...
    iget v3, p0, Lnet/majorkernelpanic/streaming/MediaStream;->mRtpPort:I

    iget v4, p0, Lnet/majorkernelpanic/streaming/MediaStream;->mRtcpPort:I

    invoke-virtual {v1, v2, v3, v4}, Lnet/majorkernelpanic/streaming/rtp/AbstractPacketizer;->setDestination(Ljava/net/InetAddress;II)V
    ...
    iget-byte v3, p0, Lnet/majorkernelpanic/streaming/MediaStream;->mChannelIdentifier:B

    invoke-virtual {v1, v2, v3}, Lnet/majorkernelpanic/streaming/rtp/RtpSocket;->setOutputStream(Ljava/io/OutputStream;B)V
...
.method public declared-synchronized stop()V
    ...
    invoke-virtual {v2}, Lnet/majorkernelpanic/streaming/rtp/AbstractPacketizer;->stop()V
    :try_end_1
    ...
    iput-object v2, p0, Lnet/majorkernelpanic/streaming/MediaStream;->mMediaCodecHandlerThread:Landroid/os/HandlerThread;
