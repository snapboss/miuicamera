...
.method private parse(Ljava/lang/String;J)V
    ...
    invoke-direct {v4, v3, v13, v13}, Ljava/lang/String;-><init>([BII)V
    ...
    .line 8
    iget-object v13, v0, Lnet/majorkernelpanic/streaming/mp4/MP4Parser;->mFile:Ljava/io/RandomAccessFile;

    invoke-virtual {v13, v3, v11, v2}, Ljava/io/RandomAccessFile;->read([BII)I
    ...
    .line 13
    :cond_2
    invoke-static {v3, v11, v13}, Ljava/nio/ByteBuffer;->wrap([BII)Ljava/nio/ByteBuffer;
    ...
    const-wide/32 v14, 0x3f3f3f37

    cmp-long v2, v12, v14

    if-eqz v2, :cond_3

    const-string v2, "Atom -> name: "

    const-string v14, " position: "

    .line 15
    invoke-static {v2, v4, v14}, Landroidx/activity/result/d;->e(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/StringBuilder;
    ...
    invoke-direct {v0, v2, v12, v13}, Lnet/majorkernelpanic/streaming/mp4/MP4Parser;->parse(Ljava/lang/String;J)V
