...
.method private send(Ljava/nio/ByteBuffer;)V
    ...
    :cond_7
    :goto_3
    const-string p0, "NAL units are not preceded by 0x00000001"
...
.method public run()V
    ...
    const-string v3, "H264Packetizer"

    const-string v4, "H264 packetizer started !"
    ...
    invoke-virtual {v2, v4, v5}, Lnet/majorkernelpanic/streaming/rtp/RtpSocket;->setCacheSize(J)V
    ...
    iput-wide v4, p0, Lnet/majorkernelpanic/streaming/rtp/H264Packetizer;->oldtime:J
    ...
    iget-wide v6, p0, Lnet/majorkernelpanic/streaming/rtp/H264Packetizer;->oldtime:J

    sub-long/2addr v4, v6

    iget-object v2, p0, Lnet/majorkernelpanic/streaming/rtp/H264Packetizer;->stats:Lnet/majorkernelpanic/streaming/rtp/AbstractPacketizer$Statistics;

    invoke-virtual {v2, v4, v5}, Lnet/majorkernelpanic/streaming/rtp/AbstractPacketizer$Statistics;->push(J)V
    ...
    iput-wide v4, p0, Lnet/majorkernelpanic/streaming/rtp/H264Packetizer;->delay:J
    :try_end_0
