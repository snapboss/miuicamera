...
.method public static constructor <clinit>()V
    ...
    sput-object v0, Lac/c;->b:Ljava/nio/charset/Charset;
    ...
    sput-object v1, Lac/c;->d:[B

    new-array v1, v0, [B

    fill-array-data v1, :array_2

    sput-object v1, Lac/c;->e:[B

    new-array v1, v0, [B

    fill-array-data v1, :array_3

    sput-object v1, Lac/c;->f:[B

    new-instance v1, Ljava/util/concurrent/ConcurrentHashMap;

    invoke-direct {v1, v0}, Ljava/util/concurrent/ConcurrentHashMap;-><init>(I)V

    sput-object v1, Lac/c;->g:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    sput-object v0, Lac/c;->h:Ljava/text/DateFormat;
    ...
    sput-object v0, Lac/c;->i:Ljava/time/format/DateTimeFormatter;

    const-string v0, ""

    sput-object v0, Lac/c;->j:Ljava/lang/String;

    sput-object v0, Lac/c;->k:Ljava/lang/String;

    sput-object v0, Lac/c;->l:Ljava/lang/String;
...
.method public static A(Ljava/lang/String;ILandroid/location/Location;J[B)V
    .locals 9
    .param p5    # [B
    ...
    invoke-static {p0}, Lac/c;->u(Ljava/lang/String;)Z
    ...
    invoke-direct {v0, p0}, Lac/d;-><init>(Ljava/lang/String;)V
    :try_end_0
    ...
    :try_start_1
    invoke-static/range {v2 .. v7}, Lac/c;->x(Lac/d;ILandroid/location/Location;JI)V
    :try_end_1
    ...
    :try_start_4
    invoke-static {p4, v0, p5}, Lac/c;->l(Ljava/io/OutputStream;Lac/d;[B)Ljava/io/OutputStream;

    move-result-object p2

    invoke-static {p3, p2}, Lac/c;->d(Ljava/io/InputStream;Ljava/io/OutputStream;)J
    :try_end_4
    .catch Ljava/io/IOException; {:try_start_4 .. :try_end_4} :catch_0
    .catchall {:try_start_4 .. :try_end_4} :catchall_2

    :goto_0
    invoke-static {p3}, Lac/c;->b(Ljava/io/InputStream;)V

    invoke-static {p4}, Lac/c;->c(Ljava/io/OutputStream;)V
    ...
    :goto_4
    invoke-static {p2}, Lac/c;->b(Ljava/io/InputStream;)V
...
.method public static B([BLac/d;)[B
    .locals 4
    ...
    :try_start_0
    invoke-virtual {p1, v2, v0}, Lac/d;->b0(Ljava/io/InputStream;Ljava/io/OutputStream;)V
    ...
    :goto_0
    invoke-static {v0}, Lac/c;->c(Ljava/io/OutputStream;)V

    invoke-static {v2}, Lac/c;->b(Ljava/io/InputStream;)V
...
.method public static C([BLac/d;[B)[B
    .locals 0
    .param p2    # [B
        .annotation build Landroidx/annotation/Nullable;
        .end annotation
    ...
    invoke-virtual {p1, p2}, Lac/d;->f0([B)V

    invoke-static {p0, p1}, Lac/c;->B([BLac/d;)[B
...
.method public static final a()V
    ...
    sget-object v0, Lac/c;->g:Ljava/util/concurrent/ConcurrentHashMap;
...
.method public static f(Ljava/io/InputStream;I)Lac/d;
    .locals 1
    ...
    invoke-direct {v0, p0, p1}, Lac/d;-><init>(Ljava/io/InputStream;I)V
    :try_end_0
    .catch Ljava/io/IOException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public static g(Ljava/lang/String;)Lac/d;
    .locals 1
...
.method public static h([B)Lac/d;
    .locals 1
    .param p0    # [B
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
    ...
    invoke-static {v0, p0}, Lac/c;->f(Ljava/io/InputStream;I)Lac/d;

    move-result-object p0

    invoke-static {v0}, Lac/c;->b(Ljava/io/InputStream;)V
...
.method public static i(J)Ljava/lang/String;
    ...
    invoke-static {p0, p1, v0}, Lac/c;->j(JLjava/util/TimeZone;)Ljava/lang/String;
...
.method public static j(JLjava/util/TimeZone;)Ljava/lang/String;
    .locals 1

    sget-object v0, Lac/c;->h:Ljava/text/DateFormat;
...
.method public static l(Ljava/io/OutputStream;Lac/d;[B)Ljava/io/OutputStream;
    .locals 2
    .param p2    # [B
        .annotation build Landroidx/annotation/Nullable;
        .end annotation
    ...
    :cond_0
    invoke-virtual {p1, p0, p2}, Lac/d;->j(Ljava/io/OutputStream;[B)Ljava/io/OutputStream;
...
.method public static m(J)Ljava/lang/String;
    ...
    invoke-static {p0, p1, v0}, Lac/c;->n(JLjava/util/TimeZone;)Ljava/lang/String;
...
.method public static n(JLjava/util/TimeZone;)Ljava/lang/String;
    ...
    sget-object p1, Lac/c;->i:Ljava/time/format/DateTimeFormatter;
...
.method public static o(Ljava/io/BufferedInputStream;)I
    .locals 4
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
...
.method public static p([B)I
    ...
    invoke-static {v1}, Lac/c;->o(Ljava/io/BufferedInputStream;)I
...
.method public static q([B)I
    ...
    :cond_2
    invoke-static {p0, v2, v8, v0}, Lac/c;->w([BIIZ)I
    ...
    invoke-static {p0, v1, v4, v0}, Lac/c;->w([BIIZ)I
    ...
    invoke-static {p0, v1, v8, v0}, Lac/c;->w([BIIZ)I
    ...
    invoke-static {p0, v9, v4, v2}, Lac/c;->w([BIIZ)I
    ...
    invoke-static {p0, v4, v8, v2}, Lac/c;->w([BIIZ)I
    ...
    invoke-static {p0, v1, v8, v2}, Lac/c;->w([BIIZ)I
...
.method public static r(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    ...
    sput-object p0, Lac/c;->j:Ljava/lang/String;

    sput-object p1, Lac/c;->k:Ljava/lang/String;

    sput-object p2, Lac/c;->l:Ljava/lang/String;
...
.method public static s([B)Z
    ...
    invoke-direct {v1, p0}, Lac/a;-><init>([B)V
    :try_end_0
    ...
    invoke-virtual {v1, v2}, Lac/a;->a(Ljava/nio/ByteOrder;)V

    invoke-virtual {v1}, Lac/a;->readInt()I
    ...
    invoke-virtual {v1}, Lac/a;->readLong()J
...
.method public static v(Ljava/io/FileDescriptor;)Z
    .locals 3
...
.method public static x(Lac/d;ILandroid/location/Location;JI)V
    .locals 2
    .annotation system Ldalvik/annotation/Throws;
        value = {
    ...
    sget-object v0, Lac/c;->j:Ljava/lang/String;

    invoke-virtual {p0, p1, v0}, Lac/d;->d0(Ljava/lang/String;Ljava/lang/String;)V

    const-string p1, "Model"

    sget-object v0, Lac/c;->k:Ljava/lang/String;

    invoke-virtual {p0, p1, v0}, Lac/d;->d0(Ljava/lang/String;Ljava/lang/String;)V

    sget-object p1, Lac/c;->l:Ljava/lang/String;
    ...
    sget-object v0, Lac/c;->l:Ljava/lang/String;
    ...
    invoke-virtual {p0, p1, p5}, Lac/d;->d0(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {p3, p4}, Lac/c;->i(J)Ljava/lang/String;
    ...
    invoke-static {p3, p4}, Lac/c;->m(J)Ljava/lang/String;
    ...
    invoke-virtual {p0, p3, p1}, Lac/d;->d0(Ljava/lang/String;Ljava/lang/String;)V

    :cond_3
    invoke-virtual {p0, p2}, Lac/d;->e0(Landroid/location/Location;)V
...
.method public static y(Ljava/io/FileDescriptor;ILandroid/location/Location;JI[B)V
    .locals 10
    .param p6    # [B
        .annotation build Landroidx/annotation/Nullable;
        .end annotation
    ...
    :cond_0
    invoke-static {p0}, Lac/c;->v(Ljava/io/FileDescriptor;)Z
    ...
    invoke-direct {v0, v3}, Lac/d;-><init>(Ljava/io/InputStream;)V
    :try_end_1
    ...
    :try_start_3
    invoke-static/range {v4 .. v9}, Lac/c;->x(Lac/d;ILandroid/location/Location;JI)V
    :try_end_3
    ...
    :try_start_6
    invoke-static {v5, v8}, Lac/c;->d(Ljava/io/InputStream;Ljava/io/OutputStream;)J
    :try_end_6
    .catch Ljava/io/IOException; {:try_start_6 .. :try_end_6} :catch_3
    .catch Landroid/system/ErrnoException; {:try_start_6 .. :try_end_6} :catch_3
    .catchall {:try_start_6 .. :try_end_6} :catchall_3

    invoke-static {v5}, Lac/c;->b(Ljava/io/InputStream;)V

    invoke-static {v8}, Lac/c;->c(Ljava/io/OutputStream;)V
    ...
    :try_start_9
    invoke-static {v5, v0, v6}, Lac/c;->l(Ljava/io/OutputStream;Lac/d;[B)Ljava/io/OutputStream;
    ...
    :try_start_a
    invoke-static {v3, v8}, Lac/c;->d(Ljava/io/InputStream;Ljava/io/OutputStream;)J
    :try_end_a
...
.method public static z(Ljava/lang/String;ILandroid/location/Location;J)V
    .locals 6
    ...
    invoke-static/range {v0 .. v5}, Lac/c;->A(Ljava/lang/String;ILandroid/location/Location;J[B)V
