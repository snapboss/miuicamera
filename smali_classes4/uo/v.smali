...
.method public constructor <init>()V
    ...
    iput v0, p0, Luo/v;->d:I

    const/4 v0, 0x1

    new-array v0, v0, [I

    iput-object v0, p0, Luo/v;->s:[I
...
.method public final b(Ljo/h;)V
    ...
    iput p1, p0, Luo/v;->d:I

    if-eqz p1, :cond_4

    invoke-static {p1}, Landroid/opengl/GLES20;->glUseProgram(I)V

    iget p1, p0, Luo/v;->d:I
    ...
    iput p1, p0, Luo/v;->n:I

    iget-object p1, p0, Luo/v;->f:Ljava/nio/FloatBuffer;
    ...
    iput-object p1, p0, Luo/v;->f:Ljava/nio/FloatBuffer;

    :cond_0
    iget-object p1, p0, Luo/v;->g:Ljava/nio/FloatBuffer;
    ...
    iput-object p1, p0, Luo/v;->g:Ljava/nio/FloatBuffer;
    ...
    iget-object p1, p0, Luo/v;->e:Landroid/content/Context;
    ...
    :goto_0
    iput-object p1, p0, Luo/v;->e:Landroid/content/Context;

    iget-object v0, p0, Luo/v;->t:Ljava/lang/String;

    if-eqz v0, :cond_3

    iget-object p0, p0, Luo/v;->s:[I
    ...
    invoke-static {p1, v0}, Lt2/b;->e(Landroid/content/Context;Ljava/lang/String;)I
...
.method public final c(Lno/e;)V
    ...
    iput-object p1, p0, Luo/v;->h:Lno/h;
...
.method public final d()V
    ...
    iput-object v0, p0, Luo/v;->h:Lno/h;
...
.method public final e(Ljo/i;)I
    ...
    iget-object v2, v0, Luo/v;->h:Lno/h;
    ...
    iget-object v2, v2, Lno/h;->b:Ljava/lang/String;
    ...
    iput v2, v0, Luo/v;->u:I

    iget-object v2, v1, Ljo/i;->h:Llo/a;

    iput-object v2, v0, Luo/v;->v:Llo/a;
    ...
    iget v2, v0, Luo/v;->q:I

    invoke-static {v2}, Landroid/opengl/GLES20;->glEnableVertexAttribArray(I)V

    iget v2, v0, Luo/v;->r:I
    ...
    invoke-virtual {v2, v3, v6}, Loo/h;->c(FF)V
    ...
    invoke-virtual {v2, v3, v6}, Loo/h;->f(FF)V
    ...
    iget-object v11, v0, Luo/v;->f:Ljava/nio/FloatBuffer;

    const/4 v9, 0x0

    invoke-static/range {v6 .. v11}, Landroid/opengl/GLES20;->glVertexAttribPointer(IIIZILjava/nio/Buffer;)V

    iget v12, v0, Luo/v;->r:I
    ...
    iget-object v6, v0, Luo/v;->g:Ljava/nio/FloatBuffer;

    move-object/from16 v17, v6

    invoke-static/range {v12 .. v17}, Landroid/opengl/GLES20;->glVertexAttribPointer(IIIZILjava/nio/Buffer;)V

    iget v6, v0, Luo/v;->i:I
    ...
    iget v6, v0, Luo/v;->j:I

    iget-object v3, v3, Loo/h;->e:[F

    invoke-static {v6, v8, v5, v3, v5}, Landroid/opengl/GLES20;->glUniformMatrix4fv(IIZ[FI)V

    iget-object v3, v0, Luo/v;->h:Lno/h;

    iget-object v3, v3, Lno/h;->b:Ljava/lang/String;

    iget-object v6, v0, Luo/v;->s:[I

    if-eqz v3, :cond_2

    iget-object v7, v0, Luo/v;->t:Ljava/lang/String;
    ...
    iput-object v3, v0, Luo/v;->t:Ljava/lang/String;

    iget-object v4, v0, Luo/v;->e:Landroid/content/Context;

    invoke-static {v4, v3}, Lt2/b;->e(Landroid/content/Context;Ljava/lang/String;)I
    ...
    iget v2, v0, Luo/v;->p:I

    const/4 v3, 0x2

    invoke-static {v2, v3}, Landroid/opengl/GLES20;->glUniform1i(II)V

    iget v2, v0, Luo/v;->k:I

    iget-object v3, v0, Luo/v;->h:Lno/h;

    iget-boolean v3, v3, Lno/h;->c:Z

    if-eqz v3, :cond_3

    iget-object v3, v0, Luo/v;->v:Llo/a;

    sget-object v4, Llo/a;->b:Llo/a;
    ...
    iget v2, v0, Luo/v;->l:I

    iget-object v3, v0, Luo/v;->h:Lno/h;

    iget v3, v3, Lno/h;->e:I

    int-to-float v3, v3

    invoke-static {v2, v3}, Landroid/opengl/GLES20;->glUniform1f(IF)V

    iget v2, v0, Luo/v;->n:I

    iget-object v3, v0, Luo/v;->h:Lno/h;

    iget v3, v3, Lno/h;->d:I

    int-to-float v3, v3

    invoke-static {v2, v3}, Landroid/opengl/GLES20;->glUniform1f(IF)V

    iget v2, v0, Luo/v;->m:I

    iget v3, v0, Luo/v;->u:I
