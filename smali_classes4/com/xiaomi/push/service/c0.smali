...
.method public static a(ILandroid/app/Notification;Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static/range {p2 .. p3}, Lcom/xiaomi/push/service/h;->c(Landroid/content/Context;Ljava/lang/String;)Lcom/xiaomi/push/service/h;
    ...
    :cond_0
    invoke-virtual {v4}, Lcom/xiaomi/push/service/h;->o()Ljava/util/List;
    ...
    sget-object v11, Lho/w;->a:Ljava/util/HashMap;
    ...
    invoke-virtual {v14, v15, v6}, Landroid/os/Bundle;->getInt(Ljava/lang/String;I)I
    ...
    invoke-virtual {v4, v1, v9}, Lcom/xiaomi/push/service/h;->h(ILandroid/app/Notification;)V
    ...
    invoke-virtual {v4, v1, v0}, Lcom/xiaomi/push/service/h;->h(ILandroid/app/Notification;)V
    ...
    invoke-static/range {p2 .. p2}, Lho/d;->a(Landroid/content/Context;)Lho/d;

    move-result-object v4

    invoke-virtual {v4, v0}, Lho/d;->c(Ljava/lang/String;)V

    invoke-static/range {p2 .. p2}, Lho/d;->a(Landroid/content/Context;)Lho/d;

    move-result-object v0

    new-instance v4, Lcom/xiaomi/push/service/b0;

    move-object/from16 v5, p3

    invoke-direct {v4, v1, v2, v3, v5}, Lcom/xiaomi/push/service/b0;-><init>(ILandroid/content/Context;Ljava/lang/String;Ljava/lang/String;)V

    invoke-virtual {v0, v4, v14}, Lho/d;->e(Lho/d$b;I)Z
