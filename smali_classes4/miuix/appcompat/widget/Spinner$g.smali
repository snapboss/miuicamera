...
.field public final synthetic k0:Lmiuix/appcompat/widget/Spinner;
...
.method public constructor <init>(Lmiuix/appcompat/widget/Spinner;Landroid/content/Context;)V
    ...
    iput-object p1, p0, Lmiuix/appcompat/widget/Spinner$g;->k0:Lmiuix/appcompat/widget/Spinner;

    const/4 p1, 0x0

    invoke-direct {p0, p2, p1}, Lqs/e;-><init>(Landroid/content/Context;Landroid/view/View;)V
    ...
    iget-object p2, p0, Lqs/e;->d:Lns/a;

    sget v0, Lmq/a$f;->miuix_appcompat_drop_down_menu_padding_single_item:I
    ...
    sget v1, Lmq/a$f;->miuix_appcompat_drop_down_item_min_height:I
    ...
    iput p1, p2, Lns/a;->d:I

    const p1, 0x800053

    invoke-super {p0, p1}, Lqs/e;->c(I)V
...
.method public final i(Landroid/widget/ListAdapter;Landroid/content/Context;)[[I
    ...
    iget-object p2, p0, Lqs/e;->b:Landroid/view/View;
    ...
    iget-object p0, p0, Lqs/e;->b:Landroid/view/View;
...
.method public final j(Landroid/view/View;)Z
    ...
    invoke-super {p0, p1}, Lqs/e;->j(Landroid/view/View;)Z
...
.method public final setAdapter(Landroid/widget/ListAdapter;)V
    ...
    invoke-super {p0, p1}, Lqs/e;->setAdapter(Landroid/widget/ListAdapter;)V
...
.method public final show(II)V
    ...
    iget-object v4, p0, Lmiuix/appcompat/widget/Spinner$g;->k0:Lmiuix/appcompat/widget/Spinner;
    ...
    invoke-interface {v1}, Lmiuix/appcompat/app/r;->O4()Z
    ...
    sget v5, Lmq/a$h;->action_bar_overlay_layout:I
    ...
    invoke-virtual {p0, v1}, Lqs/e;->n(Landroid/view/View;)V
    ...
    invoke-virtual {v1}, Lns/a;->toString()Ljava/lang/String;
    ...
    invoke-virtual {p0, v4}, Lqs/e;->l(Landroid/view/View;)V

    :cond_4
    iget-object v5, v1, Lns/a;->q:Landroid/graphics/Rect;

    invoke-virtual {v5}, Landroid/graphics/Rect;->centerX()I

    move-result v5

    iget-object v6, v1, Lns/a;->p:Landroid/graphics/Rect;
    ...
    invoke-super {p0, v5}, Lqs/e;->c(I)V
    ...
    :goto_3
    iget-object v5, p0, Lqs/e;->e:Lcom/xiaomi/push/service/k0;

    invoke-virtual {v5, v1}, Lcom/xiaomi/push/service/k0;->z(Lns/a;)I

    move-result v6

    invoke-virtual {v5, v1}, Lcom/xiaomi/push/service/k0;->A(Lns/a;)I

    move-result v5

    iget v7, v1, Lns/a;->g:I

    invoke-virtual {p0, v7}, Landroid/widget/PopupWindow;->setWidth(I)V

    iget v1, v1, Lns/a;->h:I
    ...
    invoke-virtual {p0, v4, v3, v6, v5}, Lqs/e;->showAtLocation(Landroid/view/View;III)V
    ...
    :goto_4
    iget-object v1, p0, Lqs/e;->f:Landroid/widget/ListView;
