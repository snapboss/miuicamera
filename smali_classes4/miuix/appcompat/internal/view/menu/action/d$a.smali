...
.method public constructor <init>(Lmiuix/appcompat/internal/view/menu/action/d;Landroid/content/Context;Lmiuix/appcompat/internal/view/menu/d;Landroid/view/View;Lmiuix/appcompat/internal/app/widget/ActionBarOverlayLayout;)V
    ...
    sget p3, Lmq/a$c;->overflowMenuMaxHeight:I

    invoke-static {p3, p2}, Lwr/d;->i(ILandroid/content/Context;)Landroid/util/TypedValue;
...
.method public final e(Z)V
    ...
    iget-object p1, p0, Lmiuix/appcompat/internal/view/menu/b;->b:Lbr/g;

    new-instance v0, Lxq/b;

    invoke-direct {v0, p0}, Lxq/b;-><init>(Lmiuix/appcompat/internal/view/menu/b;)V

    iput-object v0, p1, Lqs/e;->u:Landroid/widget/PopupWindow$OnDismissListener;

    invoke-virtual {p1}, Lqs/e;->dismiss()V
