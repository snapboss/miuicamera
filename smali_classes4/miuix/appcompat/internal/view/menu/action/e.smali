...
.method public constructor <init>(Landroid/content/Context;I)V
    ...
    sget-object v1, Lmq/a$m;->OverflowMenuButton:[I
    ...
    sget v0, Lmq/a$m;->OverflowMenuButton_android_drawableTop:I

    invoke-virtual {p2, v0}, Landroid/content/res/TypedArray;->getDrawable(I)Landroid/graphics/drawable/Drawable;

    move-result-object v0

    sget v1, Lmq/a$m;->OverflowMenuButton_android_text:I

    invoke-virtual {p2, v1}, Landroid/content/res/TypedArray;->getText(I)Ljava/lang/CharSequence;

    move-result-object v1

    sget v3, Lmq/a$m;->OverflowMenuButton_android_contentDescription:I

    invoke-virtual {p2, v3}, Landroid/content/res/TypedArray;->getString(I)Ljava/lang/String;

    move-result-object v3

    sget v4, Lmq/a$m;->OverflowMenuButton_largeFontAdaptationEnabled:I
    ...
    invoke-direct {p2, p0}, Lyq/b;-><init>(Landroid/widget/LinearLayout;)V

    iput-object p2, p0, Lmiuix/appcompat/internal/view/menu/action/e;->a:Lyq/b;

    iget-object v4, p2, Lyq/b;->b:Landroid/widget/ImageView;
    ...
    :cond_1
    iget-object v0, p2, Lyq/b;->c:Landroid/widget/TextView;
    ...
    :goto_2
    invoke-virtual {p2, p1}, Lyq/b;->b(Z)V
...
.method public final onConfigurationChanged(Landroid/content/res/Configuration;)V
    ...
    iget-object p0, p0, Lmiuix/appcompat/internal/view/menu/action/e;->a:Lyq/b;

    invoke-virtual {p0, p1}, Lyq/b;->a(Landroid/content/res/Configuration;)V
...
.method public final setEnabled(Z)V
    ...
    iget-object v0, p0, Lyq/b;->b:Landroid/widget/ImageView;
