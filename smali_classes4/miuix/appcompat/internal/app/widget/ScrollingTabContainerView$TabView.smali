...
.field public b:Lmiuix/appcompat/internal/app/widget/n;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    invoke-direct {p1, p0}, Lmiuix/appcompat/internal/app/widget/m;-><init>(Lmiuix/appcompat/internal/app/widget/ScrollingTabContainerView$TabView;)V
...
.method public final a()V
    ...
    iget-object v2, p0, Lmiuix/appcompat/internal/app/widget/ScrollingTabContainerView$TabView;->b:Lmiuix/appcompat/internal/app/widget/n;

    iget-object v3, p0, Lmiuix/appcompat/internal/app/widget/ScrollingTabContainerView$TabView;->c:Landroid/widget/ImageView;

    invoke-virtual {v0, p0, v1, v2, v3}, Lmiuix/appcompat/internal/app/widget/ScrollingTabContainerView;->h(Landroid/view/ViewGroup;Landroid/view/View;Landroid/widget/TextView;Landroid/widget/ImageView;)Landroid/view/View;
    ...
    new-instance v2, Lmiuix/appcompat/internal/app/widget/n;

    iget-object v3, p0, Lmiuix/appcompat/internal/app/widget/ScrollingTabContainerView$TabView;->f:Lmiuix/appcompat/internal/app/widget/ScrollingTabContainerView;

    invoke-virtual {v3}, Lmiuix/appcompat/internal/app/widget/ScrollingTabContainerView;->getDefaultTabTextStyle()I

    move-result v3

    invoke-direct {v2, v1, v3}, Lmiuix/appcompat/internal/app/widget/n;-><init>(Landroid/content/Context;I)V
    ...
    iput-object v2, p0, Lmiuix/appcompat/internal/app/widget/ScrollingTabContainerView$TabView;->b:Lmiuix/appcompat/internal/app/widget/n;
    ...
    sget v2, Lmq/a$c;->actionBarTabBadgeIcon:I

    invoke-static {v2, v1}, Lwr/d;->f(ILandroid/content/Context;)Landroid/graphics/drawable/Drawable;
    ...
    iget-object v4, p0, Lmiuix/appcompat/internal/app/widget/ScrollingTabContainerView$TabView;->b:Lmiuix/appcompat/internal/app/widget/n;
    ...
    :cond_7
    iget-object v1, p0, Lmiuix/appcompat/internal/app/widget/ScrollingTabContainerView$TabView;->b:Lmiuix/appcompat/internal/app/widget/n;
    ...
    iget-object p0, p0, Lmiuix/appcompat/internal/app/widget/ScrollingTabContainerView$TabView;->b:Lmiuix/appcompat/internal/app/widget/n;

    invoke-virtual {v0, p0}, Lmiuix/appcompat/internal/app/widget/ScrollingTabContainerView;->j(Landroid/widget/TextView;)V
...
.method public final onConfigurationChanged(Landroid/content/res/Configuration;)V
    ...
    iget-object p1, p0, Lmiuix/appcompat/internal/app/widget/ScrollingTabContainerView$TabView;->b:Lmiuix/appcompat/internal/app/widget/n;

    if-eqz p1, :cond_0

    iget-object p1, p0, Lmiuix/appcompat/internal/app/widget/ScrollingTabContainerView$TabView;->f:Lmiuix/appcompat/internal/app/widget/ScrollingTabContainerView;
    ...
    invoke-static {p1, v0}, Lwr/d;->b(ILandroid/content/Context;)I

    move-result p1

    iget-object v0, p0, Lmiuix/appcompat/internal/app/widget/ScrollingTabContainerView$TabView;->b:Lmiuix/appcompat/internal/app/widget/n;
