...
.field public B0:Lmiuix/appcompat/app/s;
...
.field public i0:Lzq/ContextMenuBuilder;
...
.field public final k0:Lmiuix/appcompat/internal/app/widget/ActionBarOverlayLayout$c;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    iput-object v4, p0, Lmiuix/appcompat/internal/app/widget/ActionBarOverlayLayout;->e0:[I

    iput-object v1, p0, Lmiuix/appcompat/internal/app/widget/ActionBarOverlayLayout;->h0:Landroid/graphics/Rect;
    ...
    iput-object v1, p0, Lmiuix/appcompat/internal/app/widget/ActionBarOverlayLayout;->k0:Lmiuix/appcompat/internal/app/widget/ActionBarOverlayLayout$c;
    ...
    iput-boolean v0, p0, Lmiuix/appcompat/internal/app/widget/ActionBarOverlayLayout;->D0:Z

    iput-boolean v0, p0, Lmiuix/appcompat/internal/app/widget/ActionBarOverlayLayout;->E0:Z

    iput-boolean v2, p0, Lmiuix/appcompat/internal/app/widget/ActionBarOverlayLayout;->F0:Z

    new-array v1, v3, [I

    iput-object v1, p0, Lmiuix/appcompat/internal/app/widget/ActionBarOverlayLayout;->G0:[I
    ...
    invoke-direct {v1, p1, p2}, Loq/a;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;)V

    iput-object v1, p0, Lmiuix/appcompat/internal/app/widget/ActionBarOverlayLayout;->m0:Loq/a;

    invoke-static {}, Les/b;->a()I

    move-result v1

    iput v1, p0, Lmiuix/appcompat/internal/app/widget/ActionBarOverlayLayout;->z0:I
    ...
    sget v1, Lmq/a$m;->Window_isMiuixFloatingTheme:I
    ...
    invoke-static {p1}, Lpq/a;->h(Landroid/content/Context;)Z

    move-result v1

    iput-boolean v1, p0, Lmiuix/appcompat/internal/app/widget/ActionBarOverlayLayout;->o0:Z

    sget v1, Lmq/a$m;->Window_contentAutoFitSystemWindow:I
    ...
    sget v1, Lmq/a$m;->Window_contentHeaderBackground:I
    ...
    sget p2, Lmq/a$c;->bottomMenuMode:I

    invoke-static {p2, p1, v0}, Lwr/d;->h(ILandroid/content/Context;I)I

    move-result p2

    iput p2, p0, Lmiuix/appcompat/internal/app/widget/ActionBarOverlayLayout;->x0:I

    sget p2, Lmq/a$c;->squeezeContentByIme:I

    invoke-static {p1, p2, v0}, Lwr/d;->c(Landroid/content/Context;IZ)Z

    move-result p2

    iput-boolean p2, p0, Lmiuix/appcompat/internal/app/widget/ActionBarOverlayLayout;->D0:Z

    sget p2, Lmq/a$c;->layoutStable:I
...
# virtual methods
.method public final a(Ler/a;)V
    .locals 1

    iget-object v0, p0, Lmiuix/appcompat/internal/app/widget/ActionBarOverlayLayout;->C0:Ljava/util/concurrent/CopyOnWriteArrayList;
    ...
    iput-object v0, p0, Lmiuix/appcompat/internal/app/widget/ActionBarOverlayLayout;->C0:Ljava/util/concurrent/CopyOnWriteArrayList;
    ...
    iget p0, p0, Lmiuix/appcompat/internal/app/widget/ActionBarOverlayLayout;->q0:I

    invoke-interface {p1, p0}, Ler/a;->z1(I)Z
...
.method public final b(I)V
    ...
    iget-object v0, p0, Lmiuix/appcompat/internal/app/widget/ActionBarOverlayLayout;->h0:Landroid/graphics/Rect;
    ...
    iput-object v0, p0, Lmiuix/appcompat/internal/app/widget/ActionBarOverlayLayout;->h0:Landroid/graphics/Rect;
...
.method public final fitSystemWindows(Landroid/graphics/Rect;)Z
    ...
    iget-boolean v2, v0, Lmiuix/appcompat/internal/app/widget/ActionBarOverlayLayout;->E0:Z

    invoke-static {v0, v2}, Lmiuix/appcompat/internal/app/widget/ActionBarOverlayLayout;->e(Landroid/view/ViewGroup;Z)V
    ...
    iget-object v5, v0, Lmiuix/appcompat/internal/app/widget/ActionBarOverlayLayout;->d0:Landroid/graphics/Rect;

    invoke-virtual {v5, v1}, Landroid/graphics/Rect;->set(Landroid/graphics/Rect;)V

    iget-object v6, v0, Lmiuix/appcompat/internal/app/widget/ActionBarOverlayLayout;->c0:Landroid/graphics/Rect;

    invoke-virtual {v6, v1}, Landroid/graphics/Rect;->set(Landroid/graphics/Rect;)V

    iget-object v7, v0, Lmiuix/appcompat/internal/app/widget/ActionBarOverlayLayout;->w:Landroid/graphics/Rect;
    ...
    iget-boolean v8, v0, Lmiuix/appcompat/internal/app/widget/ActionBarOverlayLayout;->D0:Z
    ...
    invoke-virtual {v1, v10}, Landroidx/core/view/WindowInsetsCompat;->getInsetsIgnoringVisibility(I)Landroidx/core/graphics/Insets;
    ...
    invoke-virtual {v1, v10}, Landroidx/core/view/WindowInsetsCompat;->getInsets(I)Landroidx/core/graphics/Insets;
    ...
    invoke-virtual {v1, v11}, Landroidx/core/view/WindowInsetsCompat;->getInsets(I)Landroidx/core/graphics/Insets;
    ...
    iget v11, v11, Landroidx/core/graphics/Insets;->right:I
    ...
    invoke-virtual {v1, v13}, Landroidx/core/view/WindowInsetsCompat;->getInsetsIgnoringVisibility(I)Landroidx/core/graphics/Insets;
    ...
    :cond_8
    iget-boolean v1, v0, Lmiuix/appcompat/internal/app/widget/ActionBarOverlayLayout;->f0:Z

    iget-object v2, v0, Lmiuix/appcompat/internal/app/widget/ActionBarOverlayLayout;->s:Landroid/graphics/Rect;
    ...
    :cond_9
    iget v1, v0, Lmiuix/appcompat/internal/app/widget/ActionBarOverlayLayout;->g0:I
    ...
    invoke-static {v14, v13, v9}, Lwr/d;->h(ILandroid/content/Context;I)I
    ...
    invoke-direct/range {p0 .. p0}, Lmiuix/appcompat/internal/app/widget/ActionBarOverlayLayout;->getDisplayCoutInsets()Landroidx/core/graphics/Insets;
    ...
    :cond_13
    iget v13, v1, Landroidx/core/graphics/Insets;->left:I
    ...
    invoke-virtual/range {p0 .. p0}, Lmiuix/appcompat/internal/app/widget/ActionBarOverlayLayout;->m()V

    :cond_19
    iget-boolean v1, v0, Lmiuix/appcompat/internal/app/widget/ActionBarOverlayLayout;->n:Z
    ...
    :cond_1d
    iget-boolean v1, v0, Lmiuix/appcompat/internal/app/widget/ActionBarOverlayLayout;->o0:Z
    ...
    invoke-virtual {v1, v7}, Lmiuix/appcompat/internal/app/widget/ActionBarContainer;->setPendingInsets(Landroid/graphics/Rect;)V

    :cond_22
    iget-object v1, v0, Lmiuix/appcompat/internal/app/widget/ActionBarOverlayLayout;->i:Landroid/view/ActionMode;

    instance-of v3, v1, Lwq/f;

    if-eqz v3, :cond_23

    check-cast v1, Lwq/f;

    invoke-virtual {v1, v7}, Lwq/f;->f(Landroid/graphics/Rect;)V
    ...
    :goto_13
    invoke-static {v1, v6, v3, v9}, Lmiuix/appcompat/internal/app/widget/ActionBarOverlayLayout;->c(Landroid/view/View;Landroid/graphics/Rect;ZZ)Z
    ...
    :goto_14
    iget-object v3, v0, Lmiuix/appcompat/internal/app/widget/ActionBarOverlayLayout;->g:Lmiuix/appcompat/internal/app/widget/ActionBarContextView;

    if-eqz v3, :cond_26

    invoke-virtual {v3, v6}, Lmiuix/appcompat/internal/app/widget/ActionBarContextView;->setPendingInset(Landroid/graphics/Rect;)V

    :cond_26
    iget-object v3, v0, Lmiuix/appcompat/internal/app/widget/ActionBarOverlayLayout;->f:Lmiuix/appcompat/internal/app/widget/ActionBarContainer;

    if-eqz v3, :cond_29

    invoke-virtual {v3, v6}, Lmiuix/appcompat/internal/app/widget/ActionBarContainer;->setPendingInsets(Landroid/graphics/Rect;)V

    iget-object v3, v0, Lmiuix/appcompat/internal/app/widget/ActionBarOverlayLayout;->W:Landroid/graphics/Rect;
    ...
    iget-boolean v4, v0, Lmiuix/appcompat/internal/app/widget/ActionBarOverlayLayout;->o0:Z
    ...
    iget-object v4, v0, Lmiuix/appcompat/internal/app/widget/ActionBarOverlayLayout;->f:Lmiuix/appcompat/internal/app/widget/ActionBarContainer;

    invoke-static {v4, v3, v9, v11}, Lmiuix/appcompat/internal/app/widget/ActionBarOverlayLayout;->c(Landroid/view/View;Landroid/graphics/Rect;ZZ)Z
    ...
    invoke-static {v3, v6, v9, v9}, Lmiuix/appcompat/internal/app/widget/ActionBarOverlayLayout;->c(Landroid/view/View;Landroid/graphics/Rect;ZZ)Z
    ...
    invoke-virtual {v3, v6}, Lmiuix/appcompat/internal/app/widget/ActionBarView;->setPendingInset(Landroid/graphics/Rect;)V

    :cond_2a
    iget-object v3, v0, Lmiuix/appcompat/internal/app/widget/ActionBarOverlayLayout;->t:Landroid/graphics/Rect;
    ...
    :goto_17
    iget-boolean v0, v0, Lmiuix/appcompat/internal/app/widget/ActionBarOverlayLayout;->n:Z
...
.method public getExtraPaddingPolicy()Ler/b;
    .locals 0
    .annotation build Landroidx/annotation/Nullable;
    .end annotation

    iget-object p0, p0, Lmiuix/appcompat/internal/app/widget/ActionBarOverlayLayout;->p0:Ler/b;
...
.method public final i()V
    ...
    iget-object v1, p0, Lmiuix/appcompat/internal/app/widget/ActionBarOverlayLayout;->b0:Landroid/graphics/Rect;
    ...
    invoke-interface {v4, v1}, Lir/a;->m(Landroid/graphics/Rect;)V
    ...
    invoke-virtual {v0, v6, v5}, Lmiuix/appcompat/internal/app/widget/ActionBarImpl;->r(ILandroid/view/View;)V

    goto :goto_1

    :cond_5
    iget-object p0, p0, Lmiuix/appcompat/internal/app/widget/ActionBarOverlayLayout;->B0:Lmiuix/appcompat/app/s;
...
.method public final j(Z)V
    ...
    :goto_0
    iget-boolean v1, p0, Lmiuix/appcompat/internal/app/widget/ActionBarOverlayLayout;->f0:Z
    ...
    sget v0, Lmq/a$f;->miuix_appcompat_floating_window_top_offset:I
    ...
    iget-object v0, p0, Lmiuix/appcompat/internal/app/widget/ActionBarOverlayLayout;->m0:Loq/a;

    iget-boolean v1, v0, Loq/a;->b:Z
    ...
    iput v0, p1, Lmiuix/appcompat/internal/app/widget/SearchActionModeView;->o0:I
...
.method public final k(II)V
    ...
    iget-object v0, p0, Lmiuix/appcompat/internal/app/widget/ActionBarOverlayLayout;->e0:[I
    ...
    :cond_0
    iget p2, p0, Lmiuix/appcompat/internal/app/widget/ActionBarOverlayLayout;->w0:I

    invoke-static {p1, p2}, Ljava/lang/Math;->max(II)I

    move-result p1

    iget p2, p0, Lmiuix/appcompat/internal/app/widget/ActionBarOverlayLayout;->v0:I

    invoke-static {p1, p2}, Ljava/lang/Math;->max(II)I

    move-result p1

    iget-object p2, p0, Lmiuix/appcompat/internal/app/widget/ActionBarOverlayLayout;->a0:Landroid/graphics/Rect;
...
.method public final l()V
    ...
    iget v4, p0, Lmiuix/appcompat/internal/app/widget/ActionBarOverlayLayout;->z0:I
    ...
    invoke-static {v7}, Lgr/a;->e(Landroid/content/Context;)Landroid/graphics/Point;
    ...
    :cond_2
    :goto_1
    iget v1, p0, Lmiuix/appcompat/internal/app/widget/ActionBarOverlayLayout;->y0:I
...
.method public final m()V
    ...
    iget-object v0, p0, Lmiuix/appcompat/internal/app/widget/ActionBarOverlayLayout;->a0:Landroid/graphics/Rect;
    ...
    iget-object v4, v2, Lmiuix/appcompat/internal/app/widget/ActionBarImpl;->a:Lwq/a;
    ...
    iget v4, p0, Lmiuix/appcompat/internal/app/widget/ActionBarOverlayLayout;->g0:I
    ...
    iget v4, p0, Lmiuix/appcompat/internal/app/widget/ActionBarOverlayLayout;->v0:I

    invoke-static {v2, v4}, Ljava/lang/Math;->max(II)I

    move-result v2

    iget v4, p0, Lmiuix/appcompat/internal/app/widget/ActionBarOverlayLayout;->w0:I
...
.method public final n(Landroid/content/Context;Ler/b;II)V
    .locals 11
    ...
    iget-object v1, v2, Lgr/h;->c:Landroid/graphics/Point;
    ...
    iget-boolean v10, p0, Lmiuix/appcompat/internal/app/widget/ActionBarOverlayLayout;->f0:Z
    ...
    :cond_2
    iget p1, p0, Lmiuix/appcompat/internal/app/widget/ActionBarOverlayLayout;->q0:I

    if-eq v3, p1, :cond_3

    iput v3, p0, Lmiuix/appcompat/internal/app/widget/ActionBarOverlayLayout;->q0:I
...
.method public final onConfigurationChanged(Landroid/content/res/Configuration;)V
    ...
    invoke-virtual {v1, v0, p1}, Lmiuix/autodensity/d;->c(Landroid/content/Context;Landroid/content/res/Configuration;)Z

    invoke-static {v0}, Lmiuix/autodensity/AutoDensityConfig;->updateDensity(Landroid/content/Context;)V

    iget-object p1, p0, Lmiuix/appcompat/internal/app/widget/ActionBarOverlayLayout;->m0:Loq/a;

    invoke-virtual {p1}, Loq/a;->b()V

    new-instance p1, Lyk/e;

    const/4 v0, 0x7

    invoke-direct {p1, p0, v0}, Lyk/e;-><init>(Ljava/lang/Object;I)V

    invoke-virtual {p0, p1}, Landroid/view/View;->post(Ljava/lang/Runnable;)Z

    iget-object p1, p0, Lmiuix/appcompat/internal/app/widget/ActionBarOverlayLayout;->i0:Lzq/ContextMenuBuilder;

    if-eqz p1, :cond_7

    iget-object p1, p1, Lzq/ContextMenuBuilder;->y:Lzq/b;

    instance-of v0, p1, Lzq/b;
    ...
    :cond_0
    iget-object p1, p1, Lzq/b;->c:Lzq/e;
    ...
    iget-object p0, p0, Lzq/ContextMenuBuilder;->y:Lzq/b;

    instance-of p1, p0, Lzq/b;
    ...
    :cond_2
    iget-object p1, p0, Lzq/b;->c:Lzq/e;

    if-eqz p1, :cond_7

    iget-object v0, p0, Lzq/b;->d:Landroid/view/View;

    iget-object v3, p0, Lzq/b;->e:Landroid/view/ViewGroup;

    iget-object p0, p0, Lzq/b;->f:[F
    ...
    :cond_3
    iget-object v0, p1, Lzq/e;->D:Landroid/view/View;
    ...
    :cond_5
    iget-object v3, p1, Lzq/e;->E:Landroid/view/ViewGroup;
    ...
    :cond_6
    :goto_4
    invoke-virtual {p1, v0, v1, v2, p0}, Lzq/e;->l(Landroid/view/View;Landroid/view/ViewGroup;FF)V
...
.method public final onDetachedFromWindow()V
    ...
    iget-object p0, p0, Lmiuix/appcompat/internal/app/widget/ActionBarOverlayLayout;->C0:Ljava/util/concurrent/CopyOnWriteArrayList;
...
.method public final onFinishInflate()V
    ...
    iget-boolean v3, p0, Lmiuix/appcompat/internal/app/widget/ActionBarOverlayLayout;->o0:Z
    ...
    sget v3, Lmq/a$c;->windowActionBar:I

    invoke-static {v0, v3, v1}, Lwr/d;->c(Landroid/content/Context;IZ)Z
    ...
    iget v3, p0, Lmiuix/appcompat/internal/app/widget/ActionBarOverlayLayout;->y0:I
    ...
    sget v1, Lmq/a$f;->miuix_appcompat_floating_window_top_offset:I

    invoke-virtual {v0, v1}, Landroid/content/res/Resources;->getDimensionPixelSize(I)I

    move-result v0

    iput v0, p0, Lmiuix/appcompat/internal/app/widget/ActionBarOverlayLayout;->g0:I

    :cond_2
    iget-object v0, p0, Lmiuix/appcompat/internal/app/widget/ActionBarOverlayLayout;->b:Lmiuix/appcompat/internal/app/widget/ActionBarContainer;

    iget-boolean p0, p0, Lmiuix/appcompat/internal/app/widget/ActionBarOverlayLayout;->f0:Z
...
.method public onLayout(ZIIII)V
    ...
    :cond_0
    iget-object p1, p0, Lmiuix/appcompat/internal/app/widget/ActionBarOverlayLayout;->p0:Ler/b;

    if-eqz p1, :cond_4

    iget-boolean p1, p1, Ler/b;->a:Z
    ...
    iget-object p1, p0, Lmiuix/appcompat/internal/app/widget/ActionBarOverlayLayout;->C0:Ljava/util/concurrent/CopyOnWriteArrayList;

    if-eqz p1, :cond_1

    iput-boolean p2, p0, Lmiuix/appcompat/internal/app/widget/ActionBarOverlayLayout;->u0:Z

    move p1, p2

    :goto_0
    iget-object p3, p0, Lmiuix/appcompat/internal/app/widget/ActionBarOverlayLayout;->C0:Ljava/util/concurrent/CopyOnWriteArrayList;
    ...
    iget p4, p0, Lmiuix/appcompat/internal/app/widget/ActionBarOverlayLayout;->q0:I

    invoke-interface {p3, p4}, Ler/a;->N5(I)V
    ...
    invoke-virtual {p1}, Lmiuix/appcompat/internal/app/widget/ActionBarImpl;->C()V
...
.method public final onMeasure(II)V
    ...
    iget-object v0, v6, Lmiuix/appcompat/internal/app/widget/ActionBarOverlayLayout;->m0:Loq/a;
    ...
    iget-boolean v2, v0, Loq/a;->c:Z

    if-eqz v2, :cond_0

    iget-object v2, v0, Loq/a;->e:Landroid/util/TypedValue;
    ...
    iget-object v2, v0, Loq/a;->g:Landroid/util/TypedValue;
    ...
    iget-object v2, v0, Loq/a;->i:Landroid/util/TypedValue;
    ...
    iget-boolean v1, v0, Loq/a;->c:Z

    if-eqz v1, :cond_3

    iget-object v1, v0, Loq/a;->j:Landroid/util/TypedValue;
    ...
    invoke-virtual/range {v7 .. v13}, Loq/a;->a(IZLandroid/util/TypedValue;Landroid/util/TypedValue;Landroid/util/TypedValue;Landroid/util/TypedValue;)I
    ...
    iget-object v2, v0, Loq/a;->h:Landroid/util/TypedValue;
    ...
    iget-object v2, v0, Loq/a;->f:Landroid/util/TypedValue;
    ...
    iget-object v2, v0, Loq/a;->k:Landroid/util/TypedValue;
    ...
    iget-object v1, v0, Loq/a;->l:Landroid/util/TypedValue;
    ...
    invoke-virtual/range {v10 .. v16}, Loq/a;->a(IZLandroid/util/TypedValue;Landroid/util/TypedValue;Landroid/util/TypedValue;Landroid/util/TypedValue;)I
    ...
    :goto_b
    iget-object v3, v6, Lmiuix/appcompat/internal/app/widget/ActionBarOverlayLayout;->y:Landroid/graphics/Rect;

    iget-object v4, v6, Lmiuix/appcompat/internal/app/widget/ActionBarOverlayLayout;->w:Landroid/graphics/Rect;

    invoke-virtual {v3, v4}, Landroid/graphics/Rect;->set(Landroid/graphics/Rect;)V

    iget-object v5, v6, Lmiuix/appcompat/internal/app/widget/ActionBarOverlayLayout;->u:Landroid/graphics/Rect;

    iget-object v12, v6, Lmiuix/appcompat/internal/app/widget/ActionBarOverlayLayout;->s:Landroid/graphics/Rect;
    ...
    iget-boolean v0, v6, Lmiuix/appcompat/internal/app/widget/ActionBarOverlayLayout;->o0:Z
    ...
    invoke-static {v9, v5, v11, v11}, Lmiuix/appcompat/internal/app/widget/ActionBarOverlayLayout;->c(Landroid/view/View;Landroid/graphics/Rect;ZZ)Z

    const/4 v0, 0x0

    iput-object v0, v6, Lmiuix/appcompat/internal/app/widget/ActionBarOverlayLayout;->h0:Landroid/graphics/Rect;
    ...
    invoke-virtual {v9, v0, v5, v1, v5}, Landroid/view/View;->setPadding(IIII)V
    ...
    :cond_19
    :goto_f
    iget-object v0, v6, Lmiuix/appcompat/internal/app/widget/ActionBarOverlayLayout;->p0:Ler/b;

    if-eqz v0, :cond_1a

    iget-boolean v0, v0, Ler/b;->a:Z
    ...
    iget-object v4, v6, Lmiuix/appcompat/internal/app/widget/ActionBarOverlayLayout;->p0:Ler/b;

    invoke-virtual {v6, v3, v4, v0, v1}, Lmiuix/appcompat/internal/app/widget/ActionBarOverlayLayout;->n(Landroid/content/Context;Ler/b;II)V

    iget-boolean v1, v6, Lmiuix/appcompat/internal/app/widget/ActionBarOverlayLayout;->t0:Z
    ...
    iget v3, v6, Lmiuix/appcompat/internal/app/widget/ActionBarOverlayLayout;->q0:I
    ...
    iget-object v0, v6, Lmiuix/appcompat/internal/app/widget/ActionBarOverlayLayout;->W:Landroid/graphics/Rect;
    ...
    invoke-direct {v0, v6, v1}, Lsi/f;-><init>(Ljava/lang/Object;I)V
...
.method public final onNestedPreScroll(Landroid/view/View;II[II)V
    ...
    :cond_0
    iget-object p5, p0, Lmiuix/appcompat/internal/app/widget/ActionBarOverlayLayout;->G0:[I
    ...
    iget v7, v3, Lmiuix/appcompat/internal/app/widget/ActionBarContextView;->L0:I
    ...
    iput v6, v3, Lmiuix/appcompat/internal/app/widget/ActionBarContextView;->K0:I

    goto :goto_0

    :cond_2
    iput v1, v3, Lmiuix/appcompat/internal/app/widget/ActionBarContextView;->K0:I
    ...
    iget v6, v3, Lmiuix/appcompat/internal/app/widget/ActionBarContextView;->K0:I
    ...
    iget v7, v3, Lmiuix/appcompat/internal/app/widget/ActionBarView;->M1:I
    ...
    iput v6, v3, Lmiuix/appcompat/internal/app/widget/ActionBarView;->L1:I
    ...
    iget v6, v3, Lmiuix/appcompat/internal/app/widget/ActionBarView;->L1:I
    ...
    :cond_6
    :goto_2
    iget-boolean v3, v2, Lmiuix/appcompat/internal/app/widget/ActionBarContainer;->a0:Z
    ...
    iget-object v3, v2, Lmiuix/appcompat/internal/app/widget/ActionBarContainer;->g0:Lmiuix/appcompat/internal/app/widget/d;

    if-eqz v3, :cond_7

    iget v4, v2, Lmiuix/appcompat/internal/app/widget/ActionBarContainer;->e0:I

    check-cast v3, Ll2/w;

    invoke-virtual {v3, v1, v4}, Ll2/w;->a(II)V
    ...
    invoke-virtual {v2, p1}, Lmiuix/appcompat/internal/app/widget/ActionBarImpl;->t(Landroid/view/View;)Ljava/lang/Integer;
    ...
    invoke-virtual {p3, p1}, Lmiuix/appcompat/internal/app/widget/ActionBarImpl;->t(Landroid/view/View;)Ljava/lang/Integer;
    ...
    invoke-virtual {p3, v2, p1}, Lmiuix/appcompat/internal/app/widget/ActionBarImpl;->r(ILandroid/view/View;)V
    ...
    invoke-interface {p0}, Lmiuix/appcompat/app/s;->qh()V
...
.method public final onNestedScroll(Landroid/view/View;IIIII[I)V
    ...
    invoke-virtual {v5, v9}, Lmiuix/appcompat/internal/app/widget/ActionBarImpl;->t(Landroid/view/View;)Ljava/lang/Integer;
    ...
    invoke-virtual {v5, v11, v9}, Lmiuix/appcompat/internal/app/widget/ActionBarImpl;->r(ILandroid/view/View;)V
    ...
    :goto_2
    iget-object v5, v0, Lmiuix/appcompat/internal/app/widget/ActionBarOverlayLayout;->G0:[I
    ...
    :cond_6
    iget-object v11, v8, Lmiuix/appcompat/internal/app/widget/ActionBarContextView;->J0:Landroid/widget/FrameLayout;

    invoke-virtual {v11}, Landroid/view/View;->getMeasuredHeight()I

    move-result v11

    iget v12, v8, Lmiuix/appcompat/internal/app/widget/ActionBarContextView;->L0:I
    ...
    iget v14, v8, Lmiuix/appcompat/internal/app/widget/ActionBarContextView;->K0:I
    ...
    iput v11, v8, Lmiuix/appcompat/internal/app/widget/ActionBarContextView;->K0:I
    ...
    :goto_3
    iget v11, v8, Lmiuix/appcompat/internal/app/widget/ActionBarContextView;->K0:I
    ...
    :cond_9
    iget-object v11, v8, Lmiuix/appcompat/internal/app/widget/ActionBarView;->y0:Landroid/widget/FrameLayout;

    invoke-virtual {v11}, Landroid/view/View;->getMeasuredHeight()I

    move-result v11

    iget v12, v8, Lmiuix/appcompat/internal/app/widget/ActionBarView;->P1:I
    ...
    iget v12, v8, Lmiuix/appcompat/internal/app/widget/ActionBarView;->h0:I

    and-int/lit8 v12, v12, 0x10

    if-eqz v12, :cond_a

    iget-object v12, v8, Lmiuix/appcompat/internal/app/widget/ActionBarView;->K0:Landroid/view/View;
    ...
    iget v13, v8, Lmiuix/appcompat/internal/app/widget/ActionBarView;->O1:I
    ...
    iget v14, v8, Lmiuix/appcompat/internal/app/widget/ActionBarView;->L1:I
    ...
    iput v11, v8, Lmiuix/appcompat/internal/app/widget/ActionBarView;->L1:I
    ...
    :goto_4
    iget v11, v8, Lmiuix/appcompat/internal/app/widget/ActionBarView;->L1:I
    ...
    iget-boolean v7, v6, Lmiuix/appcompat/internal/app/widget/ActionBarContainer;->a0:Z
    ...
    iget-object v3, v6, Lmiuix/appcompat/internal/app/widget/ActionBarContainer;->g0:Lmiuix/appcompat/internal/app/widget/d;

    if-eqz v3, :cond_d

    iget v4, v6, Lmiuix/appcompat/internal/app/widget/ActionBarContainer;->e0:I

    check-cast v3, Ll2/w;

    invoke-virtual {v3, v4, v4}, Ll2/w;->a(II)V
    ...
    iget-boolean v3, v0, Lmiuix/appcompat/internal/app/widget/ActionBarOverlayLayout;->A0:Z

    if-nez v3, :cond_e

    iget-object v0, v0, Lmiuix/appcompat/internal/app/widget/ActionBarOverlayLayout;->B0:Lmiuix/appcompat/app/s;

    if-eqz v0, :cond_f

    invoke-interface {v0}, Lmiuix/appcompat/app/s;->qh()V
...
.method public final onNestedScrollAccepted(Landroid/view/View;Landroid/view/View;II)V
    ...
    iput-boolean p3, p0, Lmiuix/appcompat/internal/app/widget/ActionBarContextView;->Q0:Z

    goto :goto_0

    :cond_2
    iput-boolean p3, p0, Lmiuix/appcompat/internal/app/widget/ActionBarContextView;->R0:Z

    :goto_0
    iget-object p1, p0, Lmiuix/appcompat/internal/app/widget/ActionBarContextView;->S0:Landroid/widget/Scroller;
    ...
    iget-object p1, p0, Lmiuix/appcompat/internal/app/widget/ActionBarContextView;->T0:Lmiuix/appcompat/internal/app/widget/ActionBarContextView$d;
    ...
    iput-boolean p3, p0, Lmiuix/appcompat/internal/app/widget/ActionBarView;->S1:Z

    goto :goto_1

    :cond_6
    iput-boolean p3, p0, Lmiuix/appcompat/internal/app/widget/ActionBarView;->T1:Z
...
.method public final onStopNestedScroll(Landroid/view/View;I)V
    ...
    :cond_1
    iget-object p1, p0, Lmiuix/appcompat/internal/app/widget/ActionBarContextView;->J0:Landroid/widget/FrameLayout;
    ...
    iput-boolean p2, p0, Lmiuix/appcompat/internal/app/widget/ActionBarContextView;->Q0:Z

    iget-boolean v2, p0, Lmiuix/appcompat/internal/app/widget/ActionBarContextView;->R0:Z
    ...
    iput-boolean p2, p0, Lmiuix/appcompat/internal/app/widget/ActionBarContextView;->R0:Z
    ...
    iget v2, p0, Lmiuix/appcompat/internal/app/widget/ActionBarContextView;->K0:I
    ...
    :cond_5
    iget v0, p0, Lmiuix/appcompat/internal/app/widget/ActionBarContextView;->L0:I

    div-int/lit8 v2, p1, 0x2

    add-int/2addr v2, v0

    iget-object v3, p0, Lmiuix/appcompat/internal/app/widget/ActionBarContextView;->S0:Landroid/widget/Scroller;
    ...
    :goto_2
    iget-object p1, p0, Lmiuix/appcompat/internal/app/widget/ActionBarContextView;->B0:Landroid/os/Handler;

    iget-object p0, p0, Lmiuix/appcompat/internal/app/widget/ActionBarContextView;->C0:Lmiuix/appcompat/internal/app/widget/ActionBarContextView$a;
    ...
    iput-boolean p2, p0, Lmiuix/appcompat/internal/app/widget/ActionBarView;->S1:Z
    ...
    iput-boolean p2, p0, Lmiuix/appcompat/internal/app/widget/ActionBarView;->T1:Z
...
.method public setActionBar(Lmiuix/appcompat/app/ActionBar;)V
    ...
    iget-object v0, p1, Lmiuix/appcompat/internal/app/widget/ActionBarImpl;->E:Ler/b;

    if-eq v0, p0, :cond_1

    iput-object p0, p1, Lmiuix/appcompat/internal/app/widget/ActionBarImpl;->E:Ler/b;
    ...
    invoke-virtual {v0, p0}, Lmiuix/appcompat/internal/app/widget/ActionBarView;->setExtraPaddingPolicy(Ler/b;)V
    ...
    iget-object p1, p1, Lmiuix/appcompat/internal/app/widget/ActionBarImpl;->E:Ler/b;

    invoke-virtual {p0, p1}, Lmiuix/appcompat/internal/app/widget/SearchActionModeView;->setExtraPaddingPolicy(Ler/b;)V
...
.method public setContentInsetStateCallback(Lmiuix/appcompat/app/s;)V
    ...
    iput-object p1, p0, Lmiuix/appcompat/internal/app/widget/ActionBarOverlayLayout;->B0:Lmiuix/appcompat/app/s;
...
.method public setExtraHorizontalPaddingEnable(Z)V
    ...
    iget-object v0, p0, Lmiuix/appcompat/internal/app/widget/ActionBarOverlayLayout;->p0:Ler/b;

    if-eqz v0, :cond_0

    iput-boolean p1, v0, Ler/b;->a:Z
...
.method public setExtraPaddingPolicy(Ler/b;)V
    ...
    iput-object p1, p0, Lmiuix/appcompat/internal/app/widget/ActionBarOverlayLayout;->p0:Ler/b;

    iget-boolean v0, p0, Lmiuix/appcompat/internal/app/widget/ActionBarOverlayLayout;->r0:Z

    iput-boolean v0, p1, Ler/b;->a:Z
    ...
    invoke-virtual {p0, p1, v0, v1, v1}, Lmiuix/appcompat/internal/app/widget/ActionBarOverlayLayout;->n(Landroid/content/Context;Ler/b;II)V
    ...
    iget v1, p0, Lmiuix/appcompat/internal/app/widget/ActionBarOverlayLayout;->q0:I

    invoke-interface {v0, v1}, Ler/a;->z1(I)Z
    ...
    iget-object v1, p1, Lmiuix/appcompat/internal/app/widget/ActionBarImpl;->E:Ler/b;

    if-eq v1, v0, :cond_3

    iput-object v0, p1, Lmiuix/appcompat/internal/app/widget/ActionBarImpl;->E:Ler/b;
    ...
    invoke-virtual {v1, v0}, Lmiuix/appcompat/internal/app/widget/ActionBarView;->setExtraPaddingPolicy(Ler/b;)V
    ...
    invoke-virtual {v0, p1}, Lmiuix/appcompat/internal/app/widget/SearchActionModeView;->setExtraPaddingPolicy(Ler/b;)V
...
.method public final showContextMenuForChild(Landroid/view/View;)Z
    ...
    iget-object v1, p0, Lmiuix/appcompat/internal/app/widget/ActionBarOverlayLayout;->k0:Lmiuix/appcompat/internal/app/widget/ActionBarOverlayLayout$c;

    if-nez v0, :cond_0

    .line 25
    new-instance v0, Lzq/ContextMenuBuilder;

    invoke-virtual {p0}, Landroid/view/View;->getContext()Landroid/content/Context;

    move-result-object v2

    invoke-direct {v0, v2}, Lzq/ContextMenuBuilder;-><init>(Landroid/content/Context;)V

    iput-object v0, p0, Lmiuix/appcompat/internal/app/widget/ActionBarOverlayLayout;->i0:Lzq/ContextMenuBuilder;
    ...
    .line 35
    :goto_1
    iput-object v3, p0, Lmiuix/appcompat/internal/app/widget/ActionBarOverlayLayout;->j0:Lmiuix/appcompat/internal/view/menu/e;
...
.method public final showContextMenuForChild(Landroid/view/View;FF)Z
    ...
    invoke-direct {v2, v0}, Lzq/b;-><init>(Lzq/ContextMenuBuilder;)V

    iput-object v2, v0, Lzq/ContextMenuBuilder;->y:Lzq/b;
    ...
    .line 14
    invoke-direct {v6, v7, v0, v2, v5}, Lzq/e;-><init>(Landroid/content/Context;Lmiuix/appcompat/internal/view/menu/d;Lzq/b;Landroid/view/View;)V

    iput-object v6, v2, Lzq/b;->c:Lzq/e;

    .line 15
    iput-object p1, v2, Lzq/b;->d:Landroid/view/View;
    ...
    iput-object v5, v2, Lzq/b;->e:Landroid/view/ViewGroup;

    .line 17
    iget-object v6, v2, Lzq/b;->f:[F
    ...
    .line 19
    iget-object v6, v2, Lzq/b;->c:Lzq/e;

    iget-object v2, v2, Lzq/b;->d:Landroid/view/View;

    invoke-virtual {v6, v2, v5, p2, p3}, Lzq/e;->l(Landroid/view/View;Landroid/view/ViewGroup;FF)V

    .line 20
    iget-object v0, v0, Lzq/ContextMenuBuilder;->y:Lzq/b;
    ...
    .line 21
    iput-object v1, v0, Lzq/b;->b:Lmiuix/appcompat/internal/view/menu/h$a;
...
.method public final startActionMode(Landroid/view/ActionMode$Callback;)Landroid/view/ActionMode;
    ...
    iget-boolean v0, v0, Lmiuix/appcompat/internal/app/widget/ActionBarContextView;->P0:Z
