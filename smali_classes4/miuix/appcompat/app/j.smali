...
.field public final a0:Lmiuix/appcompat/app/e;

.field public final b0:Loq/g;
...
.field public l0:Lmiuix/appcompat/app/j$a;
    .annotation build Landroidx/annotation/Nullable;
    .end annotation
.end field

.field public m0:Landroid/view/Window;

.field public n0:Lmiuix/appcompat/app/j$c;

.field public final o0:Lmiuix/appcompat/app/j$b;
...
.method public constructor <init>(Lmiuix/appcompat/app/AppCompatActivity;Lmiuix/appcompat/app/AppCompatActivity$a;Lmiuix/appcompat/app/AppCompatActivity$b;)V
    ...
    iput-boolean p1, p0, Lmiuix/appcompat/app/j;->c0:Z

    iput-boolean p1, p0, Lmiuix/appcompat/app/j;->d0:Z

    iput-boolean p1, p0, Lmiuix/appcompat/app/j;->e0:Z

    const/4 v0, 0x0

    iput-object v0, p0, Lmiuix/appcompat/app/j;->h0:Landroid/view/ViewGroup;

    iput-boolean p1, p0, Lmiuix/appcompat/app/j;->j0:Z

    new-instance p1, Lmiuix/appcompat/app/j$b;

    invoke-direct {p1, p0}, Lmiuix/appcompat/app/j$b;-><init>(Lmiuix/appcompat/app/j;)V

    iput-object p1, p0, Lmiuix/appcompat/app/j;->o0:Lmiuix/appcompat/app/j$b;
    ...
    iput-object p1, p0, Lmiuix/appcompat/app/j;->i0:Ljava/lang/String;

    iput-object p2, p0, Lmiuix/appcompat/app/j;->a0:Lmiuix/appcompat/app/e;

    iput-object p3, p0, Lmiuix/appcompat/app/j;->b0:Loq/g;
...
.method public final invalidateOptionsMenu()V
    ...
    iget-object p0, p0, Lmiuix/appcompat/app/j;->o0:Lmiuix/appcompat/app/j$b;
...
.method public final o()V
    ...
    :cond_0
    iget-object v0, p0, Lmiuix/appcompat/app/j;->m0:Landroid/view/Window;
    ...
    iget-object v2, p0, Lmiuix/appcompat/app/j;->m0:Landroid/view/Window;
    ...
    iput-object v3, p0, Lmiuix/appcompat/app/j;->n0:Lmiuix/appcompat/app/j$c;

    invoke-virtual {v0, v3}, Landroid/view/Window;->setCallback(Landroid/view/Window$Callback;)V

    iput-object v0, p0, Lmiuix/appcompat/app/j;->m0:Landroid/view/Window;
    ...
    iput-object v3, p0, Lmiuix/appcompat/app/j;->Z:Landroid/view/LayoutInflater;

    sget-object v3, Lmq/a$m;->Window:[I

    invoke-virtual {v1, v3}, Landroid/app/Activity;->obtainStyledAttributes([I)Landroid/content/res/TypedArray;

    move-result-object v3

    sget v4, Lmq/a$m;->Window_responsiveEnabled:I

    iget-boolean v5, p0, Lmiuix/appcompat/app/j;->c0:Z
    ...
    invoke-direct {v4, p0, p0}, Lmiuix/appcompat/app/j$a;-><init>(Lmiuix/appcompat/app/j;Lzs/a;)V

    iput-object v4, p0, Lmiuix/appcompat/app/j;->l0:Lmiuix/appcompat/app/j$a;

    :cond_5
    sget v4, Lmq/a$m;->Window_windowLayoutMode:I
    ...
    :cond_6
    sget v4, Lmq/a$m;->Window_windowActionBar:I
    ...
    invoke-virtual {p0, v4}, Lmiuix/appcompat/app/c;->i(I)V

    :cond_7
    sget v4, Lmq/a$m;->Window_windowActionBarOverlay:I
    ...
    :cond_8
    sget v4, Lmq/a$m;->Window_isMiuixFloatingTheme:I

    invoke-virtual {v3, v4, v5}, Landroid/content/res/TypedArray;->getBoolean(IZ)Z

    move-result v4

    iput-boolean v4, p0, Lmiuix/appcompat/app/j;->d0:Z

    sget v4, Lmq/a$m;->Window_windowFloating:I

    invoke-virtual {v3, v4, v5}, Landroid/content/res/TypedArray;->getBoolean(IZ)Z

    move-result v4

    iput-boolean v4, p0, Lmiuix/appcompat/app/j;->e0:Z

    sget v4, Lmq/a$m;->Window_windowTranslucentStatus:I

    invoke-virtual {v3, v4, v5}, Landroid/content/res/TypedArray;->getInt(II)I

    move-result v4

    invoke-virtual {p0, v4}, Lmiuix/appcompat/app/c;->l(I)V
    ...
    iput v4, p0, Lmiuix/appcompat/app/j;->f0:I

    iget-boolean v4, p0, Lmiuix/appcompat/app/j;->d0:Z

    const/4 v6, 0x0

    if-eqz v4, :cond_b

    invoke-static {v1}, Lpq/b;->a(Lmiuix/appcompat/app/AppCompatActivity;)I
    ...
    invoke-direct {v4, v1}, Lpq/e;-><init>(Lmiuix/appcompat/app/AppCompatActivity;)V
    ...
    invoke-direct {v4, v1}, Lpq/c;-><init>(Lmiuix/appcompat/app/AppCompatActivity;)V

    goto :goto_2

    :cond_a
    new-instance v4, Lpq/d;

    invoke-direct {v4, v1}, Lpq/d;-><init>(Lmiuix/appcompat/app/AppCompatActivity;)V
    ...
    :goto_2
    iput-object v4, p0, Lmiuix/appcompat/app/j;->g0:Lpq/a;

    iput-object v6, p0, Lmiuix/appcompat/app/j;->h0:Landroid/view/ViewGroup;

    invoke-virtual {v2}, Landroid/view/Window;->getContext()Landroid/content/Context;

    move-result-object v4

    sget v7, Lmq/a$c;->windowActionBar:I

    invoke-static {v4, v7, v5}, Lwr/d;->c(Landroid/content/Context;IZ)Z

    move-result v8

    if-eqz v8, :cond_d

    sget v8, Lmq/a$c;->windowActionBarMovable:I

    invoke-static {v4, v8, v5}, Lwr/d;->c(Landroid/content/Context;IZ)Z

    move-result v8

    if-eqz v8, :cond_c

    sget v8, Lmq/a$j;->miuix_appcompat_screen_action_bar_movable:I
    ...
    :cond_d
    sget v8, Lmq/a$j;->miuix_appcompat_screen_simple:I

    :goto_3
    sget v9, Lmq/a$c;->startingWindowOverlay:I

    invoke-static {v9, v4}, Lwr/d;->b(ILandroid/content/Context;)I
    ...
    invoke-static {v4, v7, v0}, Lwr/d;->c(Landroid/content/Context;IZ)Z
    ...
    sget v7, Lmq/a$c;->windowTranslucentStatus:I

    invoke-static {v7, v4, v5}, Lwr/d;->h(ILandroid/content/Context;I)I

    move-result v4

    invoke-static {v2, v4}, Lhr/a;->a(Landroid/view/Window;I)Z
    ...
    iget-object v7, p0, Lmiuix/appcompat/app/j;->g0:Lpq/a;
    ...
    iput-boolean v7, p0, Lmiuix/appcompat/app/j;->e0:Z

    iget-object v8, p0, Lmiuix/appcompat/app/j;->g0:Lpq/a;

    invoke-virtual {v8, v7}, Lpq/a;->l(Z)V

    iget-object v7, p0, Lmiuix/appcompat/app/j;->g0:Lpq/a;

    iget-boolean v8, p0, Lmiuix/appcompat/app/j;->e0:Z

    invoke-virtual {v7, v4, v8}, Lpq/a;->j(Landroid/view/View;Z)Landroid/view/ViewGroup;

    move-result-object v4

    iput-object v4, p0, Lmiuix/appcompat/app/j;->h0:Landroid/view/ViewGroup;

    iget-boolean v7, p0, Lmiuix/appcompat/app/j;->e0:Z

    invoke-virtual {p0, v7}, Lmiuix/appcompat/app/j;->w(Z)V

    iget-object v7, p0, Lmiuix/appcompat/app/j;->g0:Lpq/a;

    invoke-virtual {v7}, Lpq/a;->n()Z
    ...
    sget v7, Lmq/a$h;->action_bar_overlay_layout:I
    ...
    iget-boolean v8, p0, Lmiuix/appcompat/app/c;->u:Z
    ...
    iget-object v8, p0, Lmiuix/appcompat/app/c;->t:Ler/b;

    invoke-virtual {v7, v8}, Lmiuix/appcompat/internal/app/widget/ActionBarOverlayLayout;->setExtraPaddingPolicy(Ler/b;)V
    ...
    iput-object v2, p0, Lmiuix/appcompat/app/j;->Y:Landroid/view/ViewGroup;

    :cond_13
    iget-object v2, p0, Lmiuix/appcompat/app/j;->g0:Lpq/a;

    if-eqz v2, :cond_14

    iget-object v4, p0, Lmiuix/appcompat/app/j;->h0:Landroid/view/ViewGroup;

    invoke-virtual {p0}, Lmiuix/appcompat/app/j;->v()Z

    move-result v6

    invoke-virtual {v2, v4, v6}, Lpq/a;->f(Landroid/view/ViewGroup;Z)V
    ...
    invoke-virtual {v2, v1}, Lmiuix/appcompat/internal/app/widget/ActionBarOverlayLayout;->a(Ler/a;)V
    ...
    iput-object v2, p0, Lmiuix/appcompat/app/j;->W:Lmiuix/appcompat/internal/app/widget/ActionBarContainer;
    ...
    sget v6, Lmq/a$d;->abc_split_action_bar_is_narrow:I

    invoke-virtual {v4, v6}, Landroid/content/res/Resources;->getBoolean(I)Z

    move-result v4

    iput-boolean v4, p0, Lmiuix/appcompat/app/j;->k0:Z

    goto :goto_5

    :cond_19
    sget v4, Lmq/a$m;->Window_windowSplitActionBar:I
    ...
    :goto_5
    iget-boolean v4, p0, Lmiuix/appcompat/app/j;->k0:Z

    if-eqz v4, :cond_1a

    iget-object v4, p0, Lmiuix/appcompat/app/j;->y:Lmiuix/appcompat/internal/app/widget/ActionBarOverlayLayout;

    invoke-virtual {p0, v0, v2, v4}, Lmiuix/appcompat/app/c;->c(ZZLmiuix/appcompat/internal/app/widget/ActionBarOverlayLayout;)V

    :cond_1a
    sget v0, Lmq/a$m;->Window_endActionMenuEnabled:I
    ...
    sget v0, Lmq/a$m;->Window_hyperActionMenuEnabled:I
...
.method public final p(Landroid/content/res/Configuration;)V
    ...
    iget-object v1, v0, Lmiuix/appcompat/app/AppCompatActivity;->a:Lgr/h;
    ...
    invoke-virtual {v0, v1}, Lmiuix/appcompat/internal/app/widget/ActionBarOverlayLayout;->setExtraPaddingPolicy(Ler/b;)V
    ...
    invoke-static {p0, p1}, Lmiuix/appcompat/app/AppCompatActivity;->bi(Lmiuix/appcompat/app/AppCompatActivity;Landroid/content/res/Configuration;)V
...
.method public final q(ILandroid/view/MenuItem;)Z
    ...
    invoke-static {v0, p1, p2}, Lmiuix/appcompat/app/AppCompatActivity;->hi(Lmiuix/appcompat/app/AppCompatActivity;ILandroid/view/MenuItem;)Z
...
.method public final r()V
    ...
    invoke-static {v0}, Lmiuix/appcompat/app/AppCompatActivity;->fi(Lmiuix/appcompat/app/AppCompatActivity;)V
...
.method public final s()V
    ...
    invoke-static {v0}, Lmiuix/appcompat/app/AppCompatActivity;->gi(Lmiuix/appcompat/app/AppCompatActivity;)V
...
.method public final u(Z)V
    ...
    iput-boolean p1, p0, Lmiuix/appcompat/app/c;->u:Z

    iget-object v0, p0, Lmiuix/appcompat/app/c;->t:Ler/b;
...
.method public final w(Z)V
    ...
    invoke-static {v0}, Landroidx/core/view/x;->a(Landroid/view/Window;)V

    goto :goto_4

    :cond_5
    invoke-static {v0}, Landroidx/core/app/n;->d(Landroid/view/Window;)V
