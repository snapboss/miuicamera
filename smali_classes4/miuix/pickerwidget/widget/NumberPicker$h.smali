...
.method public final a()V
    ...
    iget-boolean p0, v1, Lmiuix/pickerwidget/widget/NumberPicker;->w0:Z

    if-eqz p0, :cond_0

    iput-boolean v0, v1, Lmiuix/pickerwidget/widget/NumberPicker;->w0:Z

    iget p0, v1, Lmiuix/pickerwidget/widget/NumberPicker;->v0:I
    ...
    :cond_0
    iget-boolean p0, v1, Lmiuix/pickerwidget/widget/NumberPicker;->x0:Z

    if-eqz p0, :cond_1

    iput-boolean v0, v1, Lmiuix/pickerwidget/widget/NumberPicker;->x0:Z

    invoke-virtual {v1}, Landroid/view/View;->getRight()I

    move-result p0

    iget v2, v1, Lmiuix/pickerwidget/widget/NumberPicker;->u0:I
...
.method public final run()V
    ...
    :cond_1
    iget-boolean v0, v4, Lmiuix/pickerwidget/widget/NumberPicker;->x0:Z
    ...
    :cond_2
    iget-boolean p0, v4, Lmiuix/pickerwidget/widget/NumberPicker;->x0:Z

    xor-int/2addr p0, v3

    int-to-byte p0, p0

    iput-boolean p0, v4, Lmiuix/pickerwidget/widget/NumberPicker;->x0:Z

    invoke-virtual {v4}, Landroid/view/View;->getRight()I

    move-result p0

    iget v0, v4, Lmiuix/pickerwidget/widget/NumberPicker;->u0:I
    ...
    :cond_3
    iget-boolean v0, v4, Lmiuix/pickerwidget/widget/NumberPicker;->w0:Z
    ...
    :cond_4
    iget-boolean p0, v4, Lmiuix/pickerwidget/widget/NumberPicker;->w0:Z

    xor-int/2addr p0, v3

    int-to-byte p0, p0

    iput-boolean p0, v4, Lmiuix/pickerwidget/widget/NumberPicker;->w0:Z

    iget p0, v4, Lmiuix/pickerwidget/widget/NumberPicker;->v0:I
    ...
    :cond_6
    iput-boolean v3, v4, Lmiuix/pickerwidget/widget/NumberPicker;->x0:Z
    ...
    :cond_7
    iput-boolean v3, v4, Lmiuix/pickerwidget/widget/NumberPicker;->w0:Z
