...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    iget-object v3, p0, Lmiuix/miuixbasewidget/widget/FilterSortView$TabView;->a:Landroid/widget/TextView;

    const/4 v4, 0x2

    invoke-virtual {v3, v4}, Landroid/view/View;->setImportantForAccessibility(I)V

    iget-object v3, p0, Lmiuix/miuixbasewidget/widget/FilterSortView$TabView;->b:Landroid/widget/ImageView;

    invoke-virtual {v3, v4}, Landroid/view/View;->setImportantForAccessibility(I)V

    if-eqz p2, :cond_2

    sget v3, Las/e;->miuix_appcompat_filter_sort_tab_view:I

    if-ne v2, v3, :cond_2

    sget-object v2, Las/h;->FilterSortTabView:[I

    sget v3, Las/g;->Widget_FilterSortTabView_DayNight:I
    ...
    sget p2, Las/h;->FilterSortTabView_android_text:I

    invoke-virtual {p1, p2}, Landroid/content/res/TypedArray;->getString(I)Ljava/lang/String;

    move-result-object p2

    sget v2, Las/h;->FilterSortTabView_descending:I

    invoke-virtual {p1, v2, v1}, Landroid/content/res/TypedArray;->getBoolean(IZ)Z

    move-result v1

    sget v2, Las/h;->FilterSortTabView_indicatorVisibility:I
    ...
    sget v0, Las/h;->FilterSortTabView_arrowFilterSortTabView:I

    invoke-virtual {p1, v0}, Landroid/content/res/TypedArray;->getDrawable(I)Landroid/graphics/drawable/Drawable;

    move-result-object v0

    sget v2, Las/h;->FilterSortTabView_filterSortTabViewTextColor:I
    ...
    sget v3, Las/c;->miuix_appcompat_filter_sort_tab_view_bg_normal:I
    ...
    invoke-direct {p1, p0}, Lbs/a;-><init>(Lmiuix/miuixbasewidget/widget/FilterSortView$TabView;)V
...
.method public static synthetic b(Lmiuix/miuixbasewidget/widget/FilterSortView$TabView;)Lnt/a;
    .locals 0

    invoke-direct {p0}, Lmiuix/miuixbasewidget/widget/FilterSortView$TabView;->getHapticFeedbackCompat()Lnt/a;
...
.method private getHapticFeedbackCompat()Lnt/a;
    ...
    iget-object v0, p0, Lmiuix/miuixbasewidget/widget/FilterSortView$TabView;->h:Lnt/a;
    ...
    iput-object v0, p0, Lmiuix/miuixbasewidget/widget/FilterSortView$TabView;->h:Lnt/a;

    :cond_0
    iget-object p0, p0, Lmiuix/miuixbasewidget/widget/FilterSortView$TabView;->h:Lnt/a;
...
.method public getTabLayoutResource()I
    ...
    sget p0, Las/e;->miuix_appcompat_filter_sort_tab_view:I
