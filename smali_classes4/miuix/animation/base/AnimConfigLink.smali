...
.method public declared-synchronized addTo(Lmiuix/animation/base/AnimConfig;)V
    ...
    const-string v1, "AnimConfigLink addTo config listSize="
    ...
    iget-wide v6, p1, Lmiuix/animation/base/AnimConfig;->delay:J

    iget-wide v8, v0, Lmiuix/animation/base/AnimConfig;->delay:J

    invoke-static {v6, v7, v8, v9}, Ljava/lang/Math;->max(JJ)J

    move-result-wide v6

    iput-wide v6, p1, Lmiuix/animation/base/AnimConfig;->delay:J

    iget-object v3, v0, Lmiuix/animation/base/AnimConfig;->ease:Lmiuix/animation/utils/EaseManager$EaseStyle;

    iget-object v6, v0, Lmiuix/animation/base/AnimConfig;->listeners:Ljava/util/HashSet;
    ...
    iget-wide v8, v0, Lmiuix/animation/base/AnimConfig;->flags:J

    or-long/2addr v6, v8

    iput-wide v6, p1, Lmiuix/animation/base/AnimConfig;->flags:J

    iget-boolean v6, v0, Lmiuix/animation/base/AnimConfig;->startImmediately:Z

    if-nez v6, :cond_3

    iput-boolean v5, p1, Lmiuix/animation/base/AnimConfig;->startImmediately:Z

    :cond_3
    iget v6, p1, Lmiuix/animation/base/AnimConfig;->fromSpeed:F

    iget v7, v0, Lmiuix/animation/base/AnimConfig;->fromSpeed:F
    ...
    iget-wide v8, v0, Lmiuix/animation/base/AnimConfig;->minDuration:J
    ...
    iget v7, v0, Lmiuix/animation/base/AnimConfig;->tintMode:I
    ...
    invoke-virtual {v0}, Lmiuix/animation/base/AnimConfig;->getFocusPropertyCount()I
    ...
    :cond_4
    invoke-virtual {p1, v0}, Lmiuix/animation/base/AnimConfig;->addFocusPropertyForComplete(Lmiuix/animation/base/AnimConfig;)V

    invoke-virtual {p1, v0}, Lmiuix/animation/base/AnimConfig;->addSpecialConfigs(Lmiuix/animation/base/AnimConfig;)V
    ...
    const-string v0, "AnimConfigLink addTo config warning!! mConfigList.get(%s) is null!"
...
.method public declared-synchronized clear()V
    ...
    const-string v0, "AnimConfigLink clear trace:"
