...
.method private assignAnimTaskToStack(Ljava/util/List;II)V
    ...
    const-string v4, "+++ assignAnimTaskToStack-> minAnimCountStackInfo.min "
    ...
    :cond_6
    invoke-virtual {v2, v0}, Lmiuix/animation/utils/LinkNode;->addToTail(Lmiuix/animation/utils/LinkNode;)V
...
.method private static changeRunningPropertyOp(Lmiuix/animation/listener/UpdateInfo;Lmiuix/animation/internal/AnimOperationInfo;Lmiuix/animation/internal/AnimStats;Lmiuix/animation/internal/AnimStats;Lmiuix/animation/IAnimTarget;Lmiuix/animation/base/AnimConfig;)V
    ...
    invoke-static {v5, v4, v6}, Landroidx/appcompat/view/menu/b;->j(Ljava/lang/String;ZLjava/lang/String;)Ljava/lang/StringBuilder;
...
.method private doOperationForUpdateInfoList(Lmiuix/animation/internal/TransitionInfo;Lmiuix/animation/internal/AnimOperationInfo;Lmiuix/animation/internal/AnimStats;Ljava/util/List;)V
    ...
    const-string v13, "doSetTo "

    invoke-static {v13, v11}, Landroidx/appcompat/view/menu/a;->g(Ljava/lang/String;Z)Ljava/lang/String;
    ...
    invoke-static {v13, v5}, Lmiuix/animation/utils/LogUtils;->debug(Ljava/lang/String;[Ljava/lang/Object;)V
    ...
    invoke-static {v5, v11}, Lmiuix/animation/utils/LogUtils;->debug(Ljava/lang/String;[Ljava/lang/Object;)V
...
.method private updateTarget(Lmiuix/animation/IAnimTarget;Ljava/util/List;)Z
    ...
    iget v15, v11, Lmiuix/animation/internal/AnimStats;->endCount:I
    ...
    :goto_1
    iget v15, v11, Lmiuix/animation/internal/AnimStats;->focusCount:I

    if-lez v15, :cond_b

    iget v14, v11, Lmiuix/animation/internal/AnimStats;->focusEndCount:I
    ...
    iget v14, v9, Lmiuix/animation/internal/TransitionInfo;->id:I
    ...
    invoke-static {v12, v14}, Lmiuix/animation/utils/LogUtils;->debug(Ljava/lang/String;[Ljava/lang/Object;)V

    :cond_8
    move v12, v3

    :goto_2
    iget-object v14, v9, Lmiuix/animation/internal/TransitionInfo;->updateListForNotify:Ljava/util/List;
    ...
    invoke-virtual {v14, v9, v15}, Lmiuix/animation/internal/AnimManager;->notifyTransitionUpdate(Lmiuix/animation/internal/TransitionInfo;Ljava/util/List;)V

    iget-object v14, v1, Lmiuix/animation/IAnimTarget;->animManager:Lmiuix/animation/internal/AnimManager;

    invoke-virtual {v14, v9, v13, v12}, Lmiuix/animation/internal/AnimManager;->notifyTransitionEndOrCancel(Lmiuix/animation/internal/TransitionInfo;II)V
    ...
    iget-object v15, v9, Lmiuix/animation/internal/TransitionInfo;->key:Ljava/lang/Object;
    ...
    invoke-static {v14, v8}, Landroid/support/v4/media/a;->a(Ljava/lang/String;I)Ljava/lang/String;

    move-result-object v14

    aput-object v14, v13, v10

    const-string v10, "animStartAfterCancel="
    ...
    invoke-static {v0, v8}, Landroid/support/v4/media/a;->a(Ljava/lang/String;I)Ljava/lang/String;
...
.method public final update()V
    ...
    const-string v6, " hasRunningTarget:"

    invoke-static {v3, v2, v6, v4}, Landroidx/appcompat/widget/b;->e(Ljava/lang/String;ZLjava/lang/String;Z)Ljava/lang/String;
