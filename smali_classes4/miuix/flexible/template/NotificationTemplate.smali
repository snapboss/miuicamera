...
.method public static constructor <clinit>()V
    ...
    sput-object v10, Lmiuix/flexible/template/NotificationTemplate;->NORMAL_PARAMS:Landroid/util/SparseArray;

    sget v11, Lkr/a;->area_head:I
    ...
    invoke-static/range {v0 .. v9}, Landroidx/core/location/f;->h(IFFIIIIILandroid/util/SparseArray;I)V

    sget v9, Lkr/a;->view_auxiliary:I
    ...
    sget v9, Lkr/a;->area_title_comment:I

    invoke-static {v12, v13, v13, v15, v12}, Lmiuix/flexible/template/AbstractMarkTemplate;->generateLayoutParams(IFFII)Lmiuix/flexible/view/HyperCellLayout$a;

    move-result-object v0

    const/16 v1, 0x8

    invoke-virtual {v0, v1, v14, v14}, Lmiuix/flexible/view/HyperCellLayout$a;->a(III)V

    const/4 v2, 0x1

    iput v2, v0, Lmiuix/flexible/view/HyperCellLayout$a;->f:I

    invoke-virtual {v10, v9, v0}, Landroid/util/SparseArray;->put(ILjava/lang/Object;)V

    sget v8, Lkr/a;->view_auxiliary2:I

    const/4 v0, 0x4

    const/high16 v3, 0x3f800000    # 1.0f

    invoke-static {v12, v3, v13, v14, v0}, Lmiuix/flexible/template/AbstractMarkTemplate;->generateLayoutParams(IFFII)Lmiuix/flexible/view/HyperCellLayout$a;

    move-result-object v0

    invoke-virtual {v10, v8, v0}, Landroid/util/SparseArray;->put(ILjava/lang/Object;)V

    sget v7, Lkr/a;->area_comment:I

    const/4 v0, 0x5

    invoke-static {v12, v13, v13, v15, v0}, Lmiuix/flexible/template/AbstractMarkTemplate;->generateLayoutParams(IFFII)Lmiuix/flexible/view/HyperCellLayout$a;
    ...
    invoke-static {v2, v13, v13, v0, v1}, Lmiuix/flexible/template/AbstractMarkTemplate;->generateLayoutParams(IFFII)Lmiuix/flexible/view/HyperCellLayout$a;

    move-result-object v0

    invoke-virtual {v0, v15, v14, v14}, Lmiuix/flexible/view/HyperCellLayout$a;->a(III)V
    ...
    sput-object v10, Lmiuix/flexible/template/NotificationTemplate;->LARGE_PARAMS:Landroid/util/SparseArray;

    const/high16 v0, 0x3f800000    # 1.0f

    const/4 v8, 0x2

    invoke-static {v8, v13, v0, v14, v14}, Lmiuix/flexible/template/AbstractMarkTemplate;->generateLayoutParams(IFFII)Lmiuix/flexible/view/HyperCellLayout$a;
    ...
    invoke-static {v11, v13, v13, v0, v1}, Lmiuix/flexible/template/AbstractMarkTemplate;->generateLayoutParams(IFFII)Lmiuix/flexible/view/HyperCellLayout$a;

    move-result-object v0

    const/4 v9, 0x4

    invoke-virtual {v0, v14, v9, v14}, Lmiuix/flexible/view/HyperCellLayout$a;->a(III)V
    ...
    invoke-static {v11, v13, v13, v14, v9}, Lmiuix/flexible/template/AbstractMarkTemplate;->generateLayoutParams(IFFII)Lmiuix/flexible/view/HyperCellLayout$a;
    ...
    invoke-static {v11, v13, v13, v14, v0}, Lmiuix/flexible/template/AbstractMarkTemplate;->generateLayoutParams(IFFII)Lmiuix/flexible/view/HyperCellLayout$a;

    move-result-object v0

    invoke-virtual {v0, v14, v15, v14}, Lmiuix/flexible/view/HyperCellLayout$a;->a(III)V
...
.method public onAddAuxiliaryViews(Landroid/view/ViewGroup;)V
    ...
    sget v1, Lkr/a;->view_auxiliary:I
    ...
    sget v0, Lkr/a;->view_auxiliary2:I
