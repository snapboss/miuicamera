...
.method public static synthetic a(Lmiuix/flexible/template/AbstractMarkTemplate;Llr/d;Llr/d;)I
    .locals 0

    invoke-direct {p0, p1, p2}, Lmiuix/flexible/template/AbstractMarkTemplate;->lambda$measureViewList$0(Llr/d;Llr/d;)I
...
.method private synthetic lambda$measureViewList$0(Llr/d;Llr/d;)I
    .locals 0

    invoke-virtual {p0, p1}, Lmiuix/flexible/template/AbstractMarkTemplate;->getViewNodePriority(Llr/d;)I

    move-result p1

    invoke-virtual {p0, p2}, Lmiuix/flexible/template/AbstractMarkTemplate;->getViewNodePriority(Llr/d;)I
...
.method private layoutViewList(Llr/c;ZIII)V
    .locals 17
    ...
    iget v0, v9, Llr/d;->c:I

    add-int v0, p4, v0

    iget v1, v9, Llr/d;->d:I

    add-int v1, p5, v1

    new-instance v2, Ljava/util/ArrayList;

    iget-object v3, v9, Llr/c;->g:Ljava/util/ArrayList;
    ...
    iget-object v7, v6, Llr/d;->b:Landroid/view/View;
    ...
    check-cast v15, Llr/c;

    iget-object v0, v15, Llr/c;->g:Ljava/util/ArrayList;
    ...
    iget-object v0, v0, Llr/d;->b:Landroid/view/View;
    ...
    iget v0, v9, Llr/d;->d:I

    iget v1, v15, Llr/d;->d:I
    ...
    invoke-direct/range {v0 .. v5}, Lmiuix/flexible/template/AbstractMarkTemplate;->layoutViewList(Llr/c;ZIII)V

    iget v0, v9, Llr/c;->f:I

    if-ne v0, v14, :cond_7

    iget v0, v15, Llr/d;->c:I
    ...
    :cond_8
    iget-object v1, v0, Llr/d;->b:Landroid/view/View;
    ...
    iget v2, v9, Llr/d;->d:I

    iget v0, v0, Llr/d;->d:I
    ...
    iget v2, v9, Llr/d;->c:I

    iget v0, v0, Llr/d;->c:I
...
.method private measureChildView(Llr/d;IIII)V
    .locals 7

    iget-object v0, p1, Llr/d;->b:Landroid/view/View;
    ...
    iput p2, p1, Llr/d;->c:I

    iput p3, p1, Llr/d;->d:I

    :cond_8
    return-void
.end method

.method private measureViewList(Llr/c;Llr/c;IIII)V
    .locals 19
    ...
    iget-object v1, v9, Llr/c;->g:Ljava/util/ArrayList;
    ...
    invoke-direct/range {v0 .. v6}, Lmiuix/flexible/template/AbstractMarkTemplate;->measureViewList(Llr/c;Llr/c;IIII)V

    iget v0, v9, Llr/c;->f:I

    if-ne v0, v13, :cond_3

    iget v0, v12, Llr/d;->c:I
    ...
    iget-object v0, v4, Llr/d;->b:Landroid/view/View;
    ...
    invoke-direct/range {v0 .. v5}, Lmiuix/flexible/template/AbstractMarkTemplate;->measureChildView(Llr/d;IIII)V

    iget v0, v9, Llr/c;->f:I

    if-ne v0, v13, :cond_5

    iget v0, v6, Llr/d;->c:I
    ...
    :cond_b
    iget-object v0, v5, Llr/d;->b:Landroid/view/View;
    ...
    :cond_14
    iput v15, v9, Llr/d;->d:I

    iget-object v0, v9, Llr/c;->g:Ljava/util/ArrayList;
    ...
    invoke-virtual {v7, v2, v10}, Lmiuix/flexible/template/AbstractMarkTemplate;->hasMatchParentChild(Llr/c;I)Z

    move-result v0

    if-eqz v0, :cond_16

    iget v3, v2, Llr/d;->c:I

    iget v4, v9, Llr/d;->d:I
    ...
    iget v0, v2, Llr/d;->c:I

    iget v1, v9, Llr/d;->c:I

    if-ge v0, v1, :cond_15

    invoke-virtual {v7, v2, v13}, Lmiuix/flexible/template/AbstractMarkTemplate;->hasMatchParentChild(Llr/c;I)Z

    move-result v0

    if-eqz v0, :cond_15

    iget v3, v9, Llr/d;->c:I

    iget v4, v2, Llr/d;->d:I
    ...
    iget-object v0, v1, Llr/d;->b:Landroid/view/View;
    ...
    iget v2, v9, Llr/c;->f:I

    if-ne v2, v13, :cond_19

    iget v2, v1, Llr/d;->d:I
    ...
    iget v0, v1, Llr/d;->c:I

    iget v2, v9, Llr/d;->c:I

    if-ge v0, v2, :cond_15

    iget v3, v1, Llr/d;->d:I
...
.method public buildViewTree(Landroid/view/ViewGroup;)V
    ...
    invoke-direct {p1, p0}, Llr/a;-><init>(Llr/b$a;)V

    invoke-static {v1, p1}, Ljava/util/Arrays;->sort([Ljava/lang/Object;Ljava/util/Comparator;)V

    new-instance p1, Llr/c;

    invoke-direct {p1}, Llr/c;-><init>()V

    const/4 v0, 0x1

    iput v0, p1, Llr/d;->a:I

    const/high16 v3, 0x3f800000    # 1.0f

    iput v3, p1, Llr/d;->e:F

    iput v0, p1, Llr/c;->f:I

    invoke-static {v1, v2, p1, p0}, Llr/b;->a([Landroid/view/View;ILlr/c;Llr/b$a;)I

    iput-object p1, p0, Lmiuix/flexible/template/AbstractMarkTemplate;->mViewList:Llr/c;
...
.method public getViewNodePriority(Llr/d;)I
    .locals 2
    ...
    iget-object p1, p1, Llr/c;->g:Ljava/util/ArrayList;
...
.method public hasMatchParentChild(Llr/c;I)Z
    .locals 4
    ...
    invoke-virtual {p0, v0, p2}, Lmiuix/flexible/template/AbstractMarkTemplate;->hasMatchParentChild(Llr/c;I)Z
...
.method public init(Landroid/view/ViewGroup;Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    sget-object p1, Lkr/c;->HyperCellLayout:[I
    ...
    sget v2, Lkr/c;->HyperCellLayout_android_gravity:I
    ...
    :cond_0
    sget v2, Lkr/c;->HyperCellLayout_column_spacing:I
    ...
    :cond_1
    sget v2, Lkr/c;->HyperCellLayout_row_spacing:I
...
.method public onLayout(Landroid/view/ViewGroup;ZIIII)V
    ...
    iget-object p2, p0, Lmiuix/flexible/template/AbstractMarkTemplate;->mViewList:Llr/c;
    ...
    iget-object p5, p0, Lmiuix/flexible/template/AbstractMarkTemplate;->mViewList:Llr/c;

    iget p5, p5, Llr/d;->d:I
    ...
    iget-object p3, p0, Lmiuix/flexible/template/AbstractMarkTemplate;->mViewList:Llr/c;

    iget p3, p3, Llr/d;->d:I
    ...
    iget-object p1, p0, Lmiuix/flexible/template/AbstractMarkTemplate;->mViewList:Llr/c;

    iget p1, p1, Llr/d;->c:I
    ...
    :goto_2
    iget-object v2, p0, Lmiuix/flexible/template/AbstractMarkTemplate;->mViewList:Llr/c;

    move-object v1, p0

    invoke-direct/range {v1 .. v6}, Lmiuix/flexible/template/AbstractMarkTemplate;->layoutViewList(Llr/c;ZIII)V
...
.method public onMeasure(Landroid/view/ViewGroup;II)[I
    ...
    iget-object v4, p0, Lmiuix/flexible/template/AbstractMarkTemplate;->mViewList:Llr/c;
    ...
    invoke-direct/range {v2 .. v8}, Lmiuix/flexible/template/AbstractMarkTemplate;->measureViewList(Llr/c;Llr/c;IIII)V
    ...
    :cond_1
    iget-object p0, p0, Lmiuix/flexible/template/AbstractMarkTemplate;->mViewList:Llr/c;

    iget p0, p0, Llr/d;->d:I
