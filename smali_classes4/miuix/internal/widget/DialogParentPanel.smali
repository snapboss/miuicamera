...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    invoke-direct {v0, p1, p2}, Loq/a;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;)V

    iput-object v0, p0, Lmiuix/internal/widget/DialogParentPanel;->a:Loq/a;

    const/4 p0, 0x1

    iput-boolean p0, v0, Loq/a;->d:Z
...
.method public final onConfigurationChanged(Landroid/content/res/Configuration;)V
    ...
    iget-object p1, p0, Lmiuix/internal/widget/DialogParentPanel;->a:Loq/a;
...
.method public final onFinishInflate()V
    ...
    sget v0, Lmq/a$h;->contentPanel:I
...
.method public final onMeasure(II)V
    ...
    iget-object v7, p0, Lmiuix/internal/widget/DialogParentPanel;->a:Loq/a;

    iget-object v3, v7, Loq/a;->h:Landroid/util/TypedValue;

    iget-object v4, v7, Loq/a;->f:Landroid/util/TypedValue;

    iget-object v5, v7, Loq/a;->k:Landroid/util/TypedValue;

    iget-object v6, v7, Loq/a;->l:Landroid/util/TypedValue;

    move-object v0, v7

    move v1, p2

    invoke-virtual/range {v0 .. v6}, Loq/a;->a(IZLandroid/util/TypedValue;Landroid/util/TypedValue;Landroid/util/TypedValue;Landroid/util/TypedValue;)I
    ...
    iget-object v6, v7, Loq/a;->e:Landroid/util/TypedValue;

    iget-object v0, v7, Loq/a;->g:Landroid/util/TypedValue;

    iget-object v8, v7, Loq/a;->i:Landroid/util/TypedValue;

    iget-object v9, v7, Loq/a;->j:Landroid/util/TypedValue;
    ...
    invoke-virtual/range {v3 .. v9}, Loq/a;->a(IZLandroid/util/TypedValue;Landroid/util/TypedValue;Landroid/util/TypedValue;Landroid/util/TypedValue;)I
