...
# instance fields
.field public final n:Lis/a;

.field public final o:Lmiuix/pickerwidget/widget/DateTimePicker$b;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    .line 8
    sget v0, Lrs/p;->stretchablePickerPreferenceStyle:I
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    iput-object v0, p0, Lmiuix/preference/StretchablePickerPreference;->n:Lis/a;
    ...
    iput-object v0, p0, Lmiuix/preference/StretchablePickerPreference;->o:Lmiuix/pickerwidget/widget/DateTimePicker$b;

    .line 5
    sget-object v0, Lrs/x;->StretchablePickerPreference:[I
    ...
    .line 6
    sget p2, Lrs/x;->StretchablePickerPreference_show_lunar:I
...
.method public final j(JZ)V
    ...
    iget-object p3, p0, Lmiuix/preference/StretchablePickerPreference;->n:Lis/a;

    const/4 v1, 0x1

    invoke-virtual {p3, v1}, Lis/a;->x(I)I

    move-result v1

    const/4 v2, 0x5

    invoke-virtual {p3, v2}, Lis/a;->x(I)I

    move-result v2

    const/16 v3, 0x9

    invoke-virtual {p3, v3}, Lis/a;->x(I)I

    move-result p3

    iget-object v3, p0, Lmiuix/preference/StretchablePickerPreference;->o:Lmiuix/pickerwidget/widget/DateTimePicker$b;
    ...
    invoke-static {v0, v1, p1, p2}, Lis/c;->a(Landroid/content/Context;IJ)Ljava/lang/String;

    move-result-object p1

    const-string p2, " "

    invoke-static {p3, p2, p1}, Landroid/support/v4/media/session/d;->c(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;

    move-result-object p1

    iget-object p0, p0, Lmiuix/preference/StretchableWidgetPreference;->h:Landroid/widget/TextView;
    ...
    invoke-static {v0, p3, p1, p2}, Lis/c;->a(Landroid/content/Context;IJ)Ljava/lang/String;
...
.method public final onBindViewHolder(Landroidx/preference/PreferenceViewHolder;)V
    ...
    sget v2, Lrs/t;->datetime_picker:I
    ...
    new-instance v4, Lrs/a0;

    invoke-direct {v4, p0, v3, v2}, Lrs/a0;-><init>(Lmiuix/preference/StretchablePickerPreference;Lmiuix/slidingwidget/widget/SlidingButton;Lmiuix/pickerwidget/widget/DateTimePicker;)V
    ...
    new-instance p1, Lrs/c0;

    invoke-direct {p1, p0, v2}, Lrs/c0;-><init>(Lmiuix/preference/StretchablePickerPreference;Lmiuix/pickerwidget/widget/DateTimePicker;)V
    ...
    invoke-virtual {p0, v0, v1, p1}, Lmiuix/preference/StretchablePickerPreference;->j(JZ)V

    new-instance p1, Lrs/b0;

    invoke-direct {p1, p0}, Lrs/b0;-><init>(Lmiuix/preference/StretchablePickerPreference;)V
