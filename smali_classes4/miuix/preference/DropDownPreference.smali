...
.field public static final s:[Ljava/lang/CharSequence;


# instance fields
.field public e:Lsq/b;

.field public final f:Landroid/widget/ArrayAdapter;
...
.field public l:Landroidx/preference/PreferenceViewHolder;
...
.field public final q:Lmiuix/preference/DropDownPreference$a;
...
.method public static constructor <clinit>()V
    ...
    sput-object v0, Lmiuix/preference/DropDownPreference;->r:[Ljava/lang/Class;

    new-array v0, v2, [Ljava/lang/CharSequence;

    sput-object v0, Lmiuix/preference/DropDownPreference;->s:[Ljava/lang/CharSequence;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    .line 1
    sget v0, Lrs/p;->dropdownPreferenceStyle:I
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    .line 5
    iput v1, p0, Lmiuix/preference/DropDownPreference;->n:F

    const/4 v1, 0x1

    .line 6
    iput-boolean v1, p0, Lmiuix/preference/DropDownPreference;->o:Z
    ...
    iput-object v2, p0, Lmiuix/preference/DropDownPreference;->p:Landroid/os/Handler;
    ...
    iput-object v2, p0, Lmiuix/preference/DropDownPreference;->q:Lmiuix/preference/DropDownPreference$a;

    .line 9
    sget-object v2, Lrs/x;->DropDownPreference:[I
    ...
    .line 10
    sget v3, Lrs/x;->DropDownPreference_adapter:I
    ...
    .line 11
    sget v4, Lrs/x;->DropDownPreference_dimVisible:I
    ...
    .line 12
    sget v5, Lrs/x;->DropDownPreference_iconOnlyEnabled:I
    ...
    .line 17
    sget-object v2, Lmiuix/preference/DropDownPreference;->r:[Ljava/lang/Class;
    ...
    .line 23
    invoke-static {p2, v3}, Landroidx/appcompat/widget/d;->d(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    iput-object v1, p0, Lmiuix/preference/DropDownPreference;->f:Landroid/widget/ArrayAdapter;
    ...
    .line 36
    sget v2, Lmq/a$j;->miuix_appcompat_simple_spinner_layout_integrated:I

    invoke-direct {p1, p2, v2, v1, p3}, Lsq/b;-><init>(Landroid/content/Context;ILandroid/widget/ArrayAdapter;Lsq/b$b;)V

    .line 37
    iput-object p1, p0, Lmiuix/preference/DropDownPreference;->e:Lsq/b;

    .line 38
    iget-object p1, p0, Lmiuix/preference/DropDownPreference;->f:Landroid/widget/ArrayAdapter;
    ...
    .line 40
    iget-object p2, p1, Lnq/a;->a:[Ljava/lang/CharSequence;

    .line 41
    iput-object p2, p0, Lmiuix/preference/DropDownPreference;->j:[Ljava/lang/CharSequence;

    .line 42
    iget-object p1, p1, Lmiuix/preference/DropDownPreference$f;->g:[Ljava/lang/CharSequence;

    .line 43
    iput-object p1, p0, Lmiuix/preference/DropDownPreference;->k:[Ljava/lang/CharSequence;
    ...
    iput-object p3, p0, Lmiuix/preference/DropDownPreference;->j:[Ljava/lang/CharSequence;

    :goto_1
    if-ge v0, p2, :cond_2

    .line 46
    iget-object p3, p0, Lmiuix/preference/DropDownPreference;->j:[Ljava/lang/CharSequence;
    ...
    .line 47
    :cond_2
    iget-object p1, p0, Lmiuix/preference/DropDownPreference;->j:[Ljava/lang/CharSequence;

    iput-object p1, p0, Lmiuix/preference/DropDownPreference;->k:[Ljava/lang/CharSequence;

    .line 48
    :goto_2
    iput-boolean v4, p0, Lmiuix/preference/DropDownPreference;->o:Z
...
.method public final notifyChanged()V
    ...
    iget-object v0, p0, Lmiuix/preference/DropDownPreference;->e:Lsq/b;

    if-eqz v0, :cond_0

    iget-object v0, p0, Lmiuix/preference/DropDownPreference;->p:Landroid/os/Handler;
...
.method public final onAttached()V
    ...
    sget v1, Lrs/u;->miuix_preference_flexible_layout:I

    if-eq v0, v1, :cond_2

    sget v4, Lrs/u;->miuix_dropdown_preference_flexible_layout:I
    ...
    iget-boolean v0, p0, Lmiuix/preference/DropDownPreference;->m:Z

    if-eqz v0, :cond_3

    sget v1, Lrs/u;->miuix_dropdown_preference_flexible_layout:I
...
.method public final onBindViewHolder(Landroidx/preference/PreferenceViewHolder;)V
    ...
    iput-object p1, p0, Lmiuix/preference/DropDownPreference;->l:Landroidx/preference/PreferenceViewHolder;
    ...
    invoke-virtual {v0}, Lsq/b;->getCount()I
    ...
    iput-object v0, p0, Lmiuix/preference/DropDownPreference;->i:Lmiuix/appcompat/widget/Spinner;
    ...
    sget v4, Lrs/u;->miuix_appcompat_simple_spinner_flexible_layout_integrated:I
    ...
    iget-object v6, p0, Lmiuix/preference/DropDownPreference;->f:Landroid/widget/ArrayAdapter;

    invoke-direct {v0, v1, v4, v6, v5}, Lsq/b;-><init>(Landroid/content/Context;ILandroid/widget/ArrayAdapter;Lsq/b$b;)V

    iput-object v0, p0, Lmiuix/preference/DropDownPreference;->e:Lsq/b;
    ...
    iget-object v1, p0, Lmiuix/preference/DropDownPreference;->e:Lsq/b;
    ...
    iget-object v1, p0, Lmiuix/preference/DropDownPreference;->g:Ljava/lang/String;

    iget-object v4, p0, Lmiuix/preference/DropDownPreference;->k:[Ljava/lang/CharSequence;
    ...
    iget-boolean v0, p0, Lmiuix/preference/DropDownPreference;->o:Z
    ...
    :goto_4
    iget v0, p0, Lmiuix/preference/DropDownPreference;->n:F
    ...
    iget-object v1, p0, Lmiuix/preference/DropDownPreference;->i:Lmiuix/appcompat/widget/Spinner;
