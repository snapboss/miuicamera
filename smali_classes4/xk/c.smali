...
# direct methods
.method public constructor <init>(Landroidx/cardview/widget/CardView;ZLandroid/content/Context;)V
    .locals 2
    ...
    iput-object p1, p0, Lxk/c;->t:Landroid/view/View;

    iput-boolean p2, p0, Lxk/c;->q:Z

    iput-object p3, p0, Lxk/c;->d:Landroid/content/Context;
...
.method public final declared-synchronized a(FII)V
    ...
    iput v0, v1, Lxk/c;->r:F

    iput v2, v1, Lxk/c;->o:I

    iput v3, v1, Lxk/c;->p:I

    iget-object v2, v1, Lxk/c;->u:Landroid/util/Size;

    invoke-virtual {v2}, Landroid/util/Size;->getWidth()I

    move-result v2

    iget-object v3, v1, Lxk/c;->u:Landroid/util/Size;

    invoke-virtual {v3}, Landroid/util/Size;->getHeight()I

    move-result v3

    iget-object v6, v1, Lxk/c;->s:Landroid/util/Size;

    invoke-virtual {v6}, Landroid/util/Size;->getWidth()I

    move-result v6

    iget-object v7, v1, Lxk/c;->s:Landroid/util/Size;

    invoke-virtual {v7}, Landroid/util/Size;->getHeight()I

    move-result v7

    iget v9, v1, Lxk/c;->p:I
    ...
    :cond_4
    iput v11, v1, Lxk/c;->g:I

    iput v8, v1, Lxk/c;->k:I

    iput v10, v1, Lxk/c;->j:I
    ...
    iget-object v8, v1, Lxk/c;->d:Landroid/content/Context;

    invoke-virtual {v8}, Landroid/content/Context;->getResources()Landroid/content/res/Resources;

    move-result-object v8

    const v11, 0x7f0711f9
    ...
    :cond_8
    iput v2, v1, Lxk/c;->g:I

    sget-boolean v2, Lt1/d;->n:Z

    if-eqz v2, :cond_9

    iget-object v2, v1, Lxk/c;->d:Landroid/content/Context;
    ...
    iput v0, v1, Lxk/c;->k:I

    :goto_7
    iget v0, v1, Lxk/c;->f:I

    iget v2, v1, Lxk/c;->g:I

    add-int/2addr v0, v2

    div-int/lit8 v0, v0, 0x2

    iput v0, v1, Lxk/c;->h:I

    iget v0, v1, Lxk/c;->j:I

    iget v2, v1, Lxk/c;->k:I

    add-int/2addr v0, v2

    div-int/lit8 v0, v0, 0x2

    iput v0, v1, Lxk/c;->l:I
