...
# direct methods
.method public constructor <init>(Lcom/xiaomi/mimoji/mimojifu2/ui/fragment/FragmentFu2Edit;Lfm/g;Lfm/f;Lkotlin/jvm/internal/v;)V
    .locals 0

    iput-object p1, p0, Lin/c;->d:Lcom/xiaomi/mimoji/mimojifu2/ui/fragment/FragmentFu2Edit;

    iput-object p2, p0, Lin/c;->a:Lfm/g;

    iput-object p3, p0, Lin/c;->b:Lfm/f;

    iput-object p4, p0, Lin/c;->c:Lkotlin/jvm/internal/v;
...
.method public final convert(ILcom/xiaomi/mimoji/mimojifu2/ui/adapter/BaseViewHolder;Ljava/lang/Object;I)V
    ...
    iget-object p1, p0, Lin/c;->d:Lcom/xiaomi/mimoji/mimojifu2/ui/fragment/FragmentFu2Edit;

    iget-object v0, p1, Lcom/xiaomi/mimoji/mimojifu2/ui/fragment/FragmentFu2Edit;->i:Ljava/util/HashMap;

    iget-object v1, p3, Lfm/e;->g:Ljava/lang/String;
    ...
    iget-object v5, p0, Lin/c;->a:Lfm/g;

    iget-wide v6, v5, Lfm/g;->b:D
    ...
    iget-object v3, p3, Lfm/e;->b:Ljava/lang/String;
    ...
    :cond_0
    iget-object v2, p3, Lfm/e;->c:Ljava/lang/String;
    ...
    iput-boolean v2, v5, Lfm/g;->d:Z

    goto :goto_2

    :cond_2
    iget-boolean v1, v5, Lfm/g;->d:Z
    ...
    :goto_2
    sget-object v3, Lkm/b;->n:Ljava/util/HashMap;

    iget-object v4, p0, Lin/c;->b:Lfm/f;

    iget-object v5, v4, Lfm/f;->a:Ljava/lang/String;
    ...
    :cond_4
    iget-object v0, p1, Lcom/xiaomi/mimoji/mimojifu2/ui/fragment/FragmentFu2Edit;->a:Lfn/a;

    invoke-virtual {v0}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    iget-object v0, v0, Lfn/a;->i:Lhm/c;
    ...
    :cond_6
    :goto_3
    invoke-virtual {p1, p2, v0}, Lcom/xiaomi/mimoji/mimojifu2/ui/fragment/FragmentFu2Edit;->Od(Lcom/xiaomi/mimoji/mimojifu2/ui/adapter/BaseViewHolder;Lfm/b;)V
    ...
    iget-object p2, v4, Lfm/f;->d:Lfm/h;

    iget-object p2, p2, Lfm/h;->b:Lfm/e;
    ...
    iget-object p0, p0, Lin/c;->c:Lkotlin/jvm/internal/v;
...
.method public final onItemClickListener(Landroid/view/View;Ljava/lang/Object;I)V
    ...
    invoke-static {p1}, Lcom/xiaomi/mimoji/mimojifu2/ui/fragment/FragmentFu2Edit;->Zc(Lcom/xiaomi/mimoji/mimojifu2/ui/fragment/FragmentFu2Edit;)V

    iget-boolean v0, p2, Lfm/e;->f:Z

    if-eqz v0, :cond_11

    iget-object v0, p0, Lin/c;->c:Lkotlin/jvm/internal/v;
    ...
    iget-object v6, p1, Lcom/xiaomi/mimoji/mimojifu2/ui/fragment/FragmentFu2Edit;->a:Lfn/a;

    iget-object p0, p0, Lin/c;->b:Lfm/f;

    iget-object v8, p0, Lfm/f;->a:Ljava/lang/String;
    ...
    invoke-direct {p0, v8, p2}, Lfn/h;-><init>(Ljava/lang/String;Lfm/e;)V

    const-string p1, "KIT_EditorViewModel"

    invoke-static {p1, p0}, Lcom/faceunity/toolbox/utils/FULogger;->i(Ljava/lang/String;Lop/a;)V

    iget-object p0, v6, Lfn/a;->v:Ljava/util/HashMap;

    iget-object p3, p2, Lfm/e;->g:Ljava/lang/String;

    invoke-virtual {p0, v8, p3}, Ljava/util/HashMap;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    sget-object p0, Ldm/a;->g:Ldm/a$a;

    invoke-virtual {p0, v8}, Ldm/a$a;->contains(Ljava/lang/Object;)Z
    ...
    iget-object p0, v6, Lfn/a;->i:Lhm/c;

    invoke-static {p0}, Lkotlin/jvm/internal/j;->c(Ljava/lang/Object;)V

    iget-object p0, p0, Lhm/c;->b:Ljava/util/HashMap;
    ...
    sget-object p0, Lfm/b;->a:Lfm/b;

    :cond_4
    sget-object v2, Lfm/b;->b:Lfm/b;
    ...
    :cond_5
    iget-object p0, v6, Lfn/a;->c:Lkm/a;

    if-eqz p0, :cond_c

    iget-object p3, p0, Lkm/a;->a:Lkm/b;

    invoke-virtual {p3, v8}, Lkm/b;->l(Ljava/lang/String;)Lfm/f;
    ...
    iget-object v0, v0, Lfm/f;->c:Lfm/g;

    iget-object v0, v0, Lfm/g;->f:Ljava/util/ArrayList;
    ...
    invoke-virtual {p3, v3}, Lkm/b;->l(Ljava/lang/String;)Lfm/f;
    ...
    :cond_8
    iget-object v4, v4, Lfm/f;->d:Lfm/h;

    iget-object v4, v4, Lfm/h;->b:Lfm/e;
    ...
    :cond_9
    iget-object v4, p0, Lkm/a;->c:Ljava/lang/String;

    invoke-virtual {p3, v3, v4}, Lkm/b;->k(Ljava/lang/String;Ljava/lang/String;)Ljava/util/ArrayList;
    ...
    iget-object v5, v5, Lfm/e;->a:Ljava/util/ArrayList;
    ...
    :goto_2
    new-instance v9, Lfn/i;

    invoke-direct {v9, v6, v8, p2}, Lfn/i;-><init>(Lfn/a;Ljava/lang/String;Lfm/e;)V

    new-instance p0, Lfn/l;

    invoke-direct {p0, v8}, Lfn/l;-><init>(Ljava/lang/String;)V

    invoke-static {p1, p0}, Lcom/faceunity/toolbox/utils/FULogger;->i(Ljava/lang/String;Lop/a;)V

    iget-object p0, v6, Lfn/a;->k:Lcp/j;
    ...
    invoke-direct/range {v4 .. v9}, Lcom/google/android/exoplayer2/source/i;-><init>(ILjava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;)V
    ...
    iget-object p1, v6, Lfn/a;->n:Lcom/faceunity/core/avatar/model/Scene;

    if-eqz p1, :cond_f

    invoke-virtual {p0, p1, v8, p2}, Lkm/a;->c(Lcom/faceunity/core/avatar/model/Scene;Ljava/lang/String;Lfm/e;)V

    iget-object p0, v6, Lfn/a;->t:Lem/b;

    if-eqz p0, :cond_e

    invoke-virtual {p0, v8}, Lem/b;->b(Ljava/lang/String;)V

    :cond_e
    iget-object p0, v6, Lfn/a;->u:Lfm/d;

    if-eqz p0, :cond_11

    iget-object p0, p0, Lfm/d;->a:Ljava/lang/String;

    if-eqz p0, :cond_11

    invoke-static {p0, v8}, Lfn/a;->a(Ljava/lang/String;Ljava/lang/String;)V
