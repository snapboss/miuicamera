...
# instance fields
.field public final synthetic a:Lfm/f;
...
# direct methods
.method public constructor <init>(Lcom/xiaomi/mimoji/mimojifu2/ui/fragment/FragmentFu2Edit;Lfm/f;Lkotlin/jvm/internal/v;)V
    .locals 0

    iput-object p1, p0, Lin/e;->c:Lcom/xiaomi/mimoji/mimojifu2/ui/fragment/FragmentFu2Edit;

    iput-object p2, p0, Lin/e;->a:Lfm/f;

    iput-object p3, p0, Lin/e;->b:Lkotlin/jvm/internal/v;
...
.method public final convert(ILcom/xiaomi/mimoji/mimojifu2/ui/adapter/BaseViewHolder;Ljava/lang/Object;I)V
    ...
    iget v0, p3, Lfm/a;->d:I

    iget v1, p3, Lfm/a;->e:I

    iget v2, p3, Lfm/a;->c:I
    ...
    iget-object p1, p0, Lin/e;->a:Lfm/f;

    iget-object p1, p1, Lfm/f;->d:Lfm/h;

    iget-object p1, p1, Lfm/h;->a:Lfm/a;

    if-eqz p1, :cond_0

    iget v0, p3, Lfm/a;->e:I

    iget v1, p3, Lfm/a;->c:I

    iget v2, p3, Lfm/a;->d:I

    invoke-static {v1, v2, v0}, Landroid/graphics/Color;->rgb(III)I

    move-result v0

    iget v1, p1, Lfm/a;->e:I

    iget v2, p1, Lfm/a;->c:I

    iget p1, p1, Lfm/a;->d:I
    ...
    iget-object p0, p0, Lin/e;->b:Lkotlin/jvm/internal/v;
    ...
    iget-object p1, p3, Lfm/a;->b:Ljava/lang/String;
...
.method public final onItemClickListener(Landroid/view/View;Ljava/lang/Object;I)V
    ...
    iget-object v3, v0, Lin/e;->c:Lcom/xiaomi/mimoji/mimojifu2/ui/fragment/FragmentFu2Edit;

    invoke-static {v3}, Lcom/xiaomi/mimoji/mimojifu2/ui/fragment/FragmentFu2Edit;->Zc(Lcom/xiaomi/mimoji/mimojifu2/ui/fragment/FragmentFu2Edit;)V

    iget-object v4, v0, Lin/e;->b:Lkotlin/jvm/internal/v;
    ...
    iget-object v1, v3, Lcom/xiaomi/mimoji/mimojifu2/ui/fragment/FragmentFu2Edit;->a:Lfn/a;

    iget-object v0, v0, Lin/e;->a:Lfm/f;

    iget-object v0, v0, Lfm/f;->a:Ljava/lang/String;
    ...
    invoke-direct {v3, v0, v2}, Lfn/g;-><init>(Ljava/lang/String;Lfm/a;)V

    const-string v4, "KIT_EditorViewModel"

    invoke-static {v4, v3}, Lcom/faceunity/toolbox/utils/FULogger;->i(Ljava/lang/String;Lop/a;)V

    iget-object v3, v1, Lfn/a;->c:Lkm/a;

    if-eqz v3, :cond_d

    iget-object v6, v1, Lfn/a;->n:Lcom/faceunity/core/avatar/model/Scene;
    ...
    invoke-static {v6}, Lkm/a;->b(Lcom/faceunity/core/avatar/model/Scene;)Lcom/faceunity/core/avatar/model/Avatar;
    ...
    :cond_2
    iget-object v3, v3, Lkm/a;->a:Lkm/b;

    invoke-virtual {v3, v0}, Lkm/b;->l(Ljava/lang/String;)Lfm/f;
    ...
    iget-object v8, v0, Lfm/f;->c:Lfm/g;

    iget-object v8, v8, Lfm/g;->h:Ljava/util/ArrayList;
    ...
    invoke-virtual {v3, v9}, Lkm/b;->d(Ljava/lang/String;)Ljava/util/ArrayList;
    ...
    check-cast v11, Lfm/a;

    iget v12, v2, Lfm/a;->c:I

    iget v13, v11, Lfm/a;->c:I

    if-ne v12, v13, :cond_6

    iget v12, v2, Lfm/a;->d:I

    iget v13, v11, Lfm/a;->d:I

    if-ne v12, v13, :cond_6

    iget v12, v2, Lfm/a;->e:I

    iget v13, v11, Lfm/a;->e:I
    ...
    invoke-virtual {v3, v9}, Lkm/b;->l(Ljava/lang/String;)Lfm/f;

    move-result-object v9

    if-eqz v9, :cond_7

    iget-object v9, v9, Lfm/f;->d:Lfm/h;
    ...
    :cond_8
    iput-object v11, v9, Lfm/h;->a:Lfm/a;
    ...
    iget-object v6, v5, Lfm/a;->a:Ljava/lang/String;

    sget-object v8, Ldm/a;->a:Ljava/lang/String;

    const-string v8, "makeup_"

    invoke-static {v6, v8, v7}, Lvp/m;->T(Ljava/lang/CharSequence;Ljava/lang/CharSequence;Z)Z

    move-result v6

    iget v7, v5, Lfm/a;->e:I

    iget v8, v5, Lfm/a;->d:I

    iget v9, v5, Lfm/a;->c:I

    if-eqz v6, :cond_a

    iget-object v10, v4, Lcom/faceunity/core/avatar/model/Avatar;->color:Lcom/faceunity/core/avatar/avatar/Color;

    iget-object v11, v5, Lfm/a;->a:Ljava/lang/String;
    ...
    iget-object v10, v5, Lfm/a;->a:Ljava/lang/String;
    ...
    iget-object v7, v5, Lfm/a;->a:Ljava/lang/String;
    ...
    iput-object v2, v0, Lfm/h;->a:Lfm/a;

    :goto_6
    iget-object v0, v1, Lfn/a;->u:Lfm/d;
    ...
    invoke-static {v0, v1}, Lfn/a;->a(Ljava/lang/String;Ljava/lang/String;)V
