...
.method public constructor <init>(I)V
    ...
    iput-object v0, p0, Lsl/k;->c:Lbm/a;

    new-instance v1, Ljava/util/ArrayList;

    invoke-direct {v1}, Ljava/util/ArrayList;-><init>()V

    iput-object v1, p0, Lsl/k;->f:Ljava/util/ArrayList;
    ...
    iput-object v1, p0, Lsl/k;->g:Ljava/util/concurrent/atomic/AtomicBoolean;

    new-instance v1, Ljava/util/concurrent/atomic/AtomicBoolean;

    invoke-direct {v1, v2}, Ljava/util/concurrent/atomic/AtomicBoolean;-><init>(Z)V

    iput-object v1, p0, Lsl/k;->h:Ljava/util/concurrent/atomic/AtomicBoolean;

    const/4 v1, 0x1

    iput-boolean v1, p0, Lsl/k;->i:Z

    invoke-static {}, Lcom/faceunity/core/faceunity/FUAIKit;->getInstance()Lcom/faceunity/core/faceunity/FUAIKit;

    move-result-object v3

    iput-object v3, p0, Lsl/k;->l:Lcom/faceunity/core/faceunity/FUAIKit;

    const/4 v3, -0x1

    iput v3, p0, Lsl/k;->p:I

    iput-boolean v1, p0, Lsl/k;->q:Z

    iput v2, p0, Lsl/k;->v:I

    iput p1, p0, Lsl/k;->o:I
    ...
    iput-object v3, p0, Lsl/k;->u:Landroid/os/Handler;

    invoke-virtual {v0}, Lbm/a;->a()Lcom/faceunity/core/avatar/model/Scene;

    move-result-object v3

    iput-object v3, p0, Lsl/k;->b:Lcom/faceunity/core/avatar/model/Scene;
    ...
    iput-object v4, p0, Lsl/k;->a:Ldl/s;
    ...
    invoke-virtual {v0, p1}, Lbm/a;->b(I)Lcc/n;

    move-result-object p1

    iput-object p1, p0, Lsl/k;->e:Lcc/n;

    iget-object p1, p0, Lsl/k;->e:Lcc/n;

    iget-object p1, p1, Lcc/n;->b:Ljava/lang/Object;
    ...
    invoke-static {v4, v0, p1}, Ldq/g;->d(Ljava/lang/String;ILjava/lang/String;)V

    goto :goto_0

    :cond_1
    iget-object p1, p1, Lqm/a;->f:Ljava/util/HashMap;
    ...
    invoke-direct {v6}, Lqm/f;-><init>()V

    iget-object v7, p1, Lqm/f;->a:Lcom/faceunity/core/entity/FUAnimationBundleData;

    iput-object v7, v6, Lqm/f;->a:Lcom/faceunity/core/entity/FUAnimationBundleData;

    iget-object v7, p1, Lqm/f;->b:Lcom/faceunity/core/entity/FUBundleData;

    iput-object v7, v6, Lqm/f;->b:Lcom/faceunity/core/entity/FUBundleData;

    iget-object v7, p1, Lqm/f;->c:Lcom/faceunity/core/entity/FUBundleData;

    iput-object v7, v6, Lqm/f;->c:Lcom/faceunity/core/entity/FUBundleData;

    iget-object p1, p1, Lqm/f;->d:Lcom/faceunity/core/entity/FUBundleData;

    iput-object p1, v6, Lqm/f;->d:Lcom/faceunity/core/entity/FUBundleData;

    :goto_1
    iput-object v6, p0, Lsl/k;->d:Lqm/f;

    if-eqz v6, :cond_d

    iput-object v5, v6, Lqm/f;->a:Lcom/faceunity/core/entity/FUAnimationBundleData;

    iput-object v5, v6, Lqm/f;->c:Lcom/faceunity/core/entity/FUBundleData;

    iget-object p1, v6, Lqm/f;->d:Lcom/faceunity/core/entity/FUBundleData;
    ...
    :cond_3
    iget-object p1, v6, Lqm/f;->b:Lcom/faceunity/core/entity/FUBundleData;
    ...
    :cond_4
    iget-object p1, v6, Lqm/f;->a:Lcom/faceunity/core/entity/FUAnimationBundleData;
    ...
    iget-object v5, p0, Lsl/k;->e:Lcc/n;

    iget-object v5, v5, Lcc/n;->b:Ljava/lang/Object;

    check-cast v5, Lcom/faceunity/core/avatar/model/Avatar;

    invoke-static {v5}, Lsl/k;->n(Lcom/faceunity/core/avatar/model/Avatar;)Lcom/faceunity/core/avatar/model/Avatar;

    move-result-object v5

    iput-object v5, p1, Lcc/n;->b:Ljava/lang/Object;
    ...
    invoke-static {v5, v0, v4}, Ldq/g;->d(Ljava/lang/String;ILjava/lang/String;)V
    ...
    invoke-static {v0}, Len/a;->a(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v6}, Lcom/xiaomi/push/service/k0;->F(Ljava/lang/String;)Ljava/lang/String;
    ...
    :cond_c
    iput-object p1, p0, Lsl/k;->j:Ljava/util/HashMap;

    :cond_d
    return-void
.end method

.method public static a(Lsl/k;)V
    .locals 5

    iget-object v0, p0, Lsl/k;->d:Lqm/f;
    ...
    iget-object v0, v0, Lqm/f;->c:Lcom/faceunity/core/entity/FUBundleData;

    if-eqz v0, :cond_0

    iget-object v0, p0, Lsl/k;->b:Lcom/faceunity/core/avatar/model/Scene;
    ...
    iget-object v0, p0, Lsl/k;->e:Lcc/n;
    ...
    iget-object p0, p0, Lsl/k;->e:Lcc/n;
    ...
    iget-object p0, p0, Lsl/k;->b:Lcom/faceunity/core/avatar/model/Scene;
...
.method public final b(Z)V
    ...
    iput-boolean p1, p0, Lsl/k;->t:Z

    iget-object v0, p0, Lsl/k;->l:Lcom/faceunity/core/faceunity/FUAIKit;
...
.method public final c(I)V
    ...
    iget-object v0, p0, Lsl/k;->g:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    iget-object v0, p0, Lsl/k;->c:Lbm/a;

    invoke-virtual {v0, p1}, Lbm/a;->b(I)Lcc/n;

    move-result-object v0

    iput-object v0, p0, Lsl/k;->e:Lcc/n;
    ...
    iget-object v2, p0, Lsl/k;->e:Lcc/n;

    iget-object v4, p0, Lsl/k;->e:Lcc/n;

    iget-object v4, v4, Lcc/n;->b:Ljava/lang/Object;

    check-cast v4, Lcom/faceunity/core/avatar/model/Avatar;

    invoke-static {v4}, Lsl/k;->n(Lcom/faceunity/core/avatar/model/Avatar;)Lcom/faceunity/core/avatar/model/Avatar;

    move-result-object v4

    iput-object v4, v2, Lcc/n;->b:Ljava/lang/Object;
    ...
    iget-object v4, p0, Lsl/k;->j:Ljava/util/HashMap;
    ...
    :goto_0
    iget-object v2, p0, Lsl/k;->b:Lcom/faceunity/core/avatar/model/Scene;
    ...
    iget-object v0, p0, Lsl/k;->h:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    invoke-direct {v0, p0}, Lsl/c;-><init>(Lsl/k;)V

    invoke-virtual {p1, v0, v1}, Lcom/faceunity/core/faceunity/FUSceneKit;->executeGLAction(Lop/a;Z)V

    goto :goto_1

    :cond_4
    invoke-virtual {p0}, Lsl/k;->g()V

    goto :goto_1

    :cond_5
    iget-object p1, p0, Lsl/k;->b:Lcom/faceunity/core/avatar/model/Scene;
    ...
    iget-object v3, p0, Lsl/k;->e:Lcc/n;

    iget-object v3, v3, Lcc/n;->b:Ljava/lang/Object;

    check-cast v3, Lcom/faceunity/core/avatar/model/Avatar;

    new-instance v4, Lsl/h;

    invoke-direct {v4, p0, v0}, Lsl/h;-><init>(Lsl/k;Ljava/lang/String;)V
...
.method public final d(Lcom/xiaomi/mimoji/common/bean/AvatarItem;)V
    .locals 4
    ...
    invoke-virtual {v1, p1}, Lmm/b;->e(Lcom/xiaomi/mimoji/common/bean/AvatarItem;)Lcom/faceunity/core/avatar/model/Avatar;

    move-result-object v1

    invoke-static {v1}, Lsl/k;->n(Lcom/faceunity/core/avatar/model/Avatar;)Lcom/faceunity/core/avatar/model/Avatar;
    ...
    iput-object p1, v0, Lcc/n;->a:Ljava/lang/Object;
    ...
    :goto_0
    iget p1, p0, Lsl/k;->p:I

    const/16 v0, 0x9

    if-ne p1, v0, :cond_3

    invoke-virtual {p0, v1}, Lsl/k;->p(I)V
...
.method public final e()V
    ...
    invoke-direct {v1, p0}, Lsl/d;-><init>(Lsl/k;)V

    const/4 p0, 0x0

    invoke-virtual {v0, v1, p0}, Lcom/faceunity/core/faceunity/FUSceneKit;->executeGLAction(Lop/a;Z)V
...
.method public final g()V
    ...
    invoke-direct {v1, p0}, Lsl/e;-><init>(Lsl/k;)V
...
.method public final i()Lcom/faceunity/core/entity/FUCoordinate3DData;
    ...
    sget-object p0, Lpl/a;->b:Lcom/faceunity/core/entity/FUCoordinate3DData;

    invoke-static {p0}, Lpl/a;->a(Lcom/faceunity/core/entity/FUCoordinate3DData;)Lcom/faceunity/core/entity/FUCoordinate3DData;
    ...
    :cond_0
    sget-object p0, Lpl/a;->c:Lcom/faceunity/core/entity/FUCoordinate3DData;
    ...
    :cond_1
    sget-object p0, Lpl/a;->a:Lcom/faceunity/core/entity/FUCoordinate3DData;
...
.method public final j()V
    ...
    iget-object v0, p0, Lsl/k;->u:Landroid/os/Handler;
...
.method public final k()V
    ...
    invoke-static {v3}, Lsl/k;->n(Lcom/faceunity/core/avatar/model/Avatar;)Lcom/faceunity/core/avatar/model/Avatar;

    move-result-object v3

    iput-object v3, v0, Lcc/n;->b:Ljava/lang/Object;
    ...
    invoke-direct {v3, p0}, Lsl/j;-><init>(Lsl/k;)V
    ...
    invoke-direct {v4, p0}, Lsl/j;-><init>(Lsl/k;)V
...
.method public final l(Lcom/faceunity/core/entity/FUCoordinate3DData;)V
    ...
    iget v1, p0, Lsl/k;->o:I

    invoke-virtual {v0, v1}, Lbm/a;->b(I)Lcc/n;
    ...
    iget-object v0, p0, Lsl/k;->j:Ljava/util/HashMap;
    ...
    invoke-direct {v1, p0}, Lsl/i;-><init>(Lsl/k;)V
    ...
    new-instance v3, Lsl/i;

    invoke-direct {v3, p0}, Lsl/i;-><init>(Lsl/k;)V
...
.method public final m()V
    ...
    iget-object v1, p0, Lsl/k;->j:Ljava/util/HashMap;
    ...
    iput-object v2, v0, Lxl/c;->b:Lcom/faceunity/core/entity/FUAnimationBundleData;

    const/4 v3, 0x0

    iget-object v0, v0, Lxl/c;->a:Lcom/faceunity/core/avatar/model/Avatar;
    ...
    invoke-virtual {v0, v1}, Lxl/c;->a(Lcom/faceunity/core/entity/FUAnimationBundleData;)V

    iput-boolean v3, p0, Lsl/k;->m:Z
...
.method public final o(I)V
    ...
    :cond_1
    iget-object p1, p0, Lsl/k;->d:Lqm/f;
    ...
    iput-object v1, p1, Lqm/f;->c:Lcom/faceunity/core/entity/FUBundleData;
...
.method public final p(I)V
    ...
    :cond_0
    iput p1, p0, Lsl/k;->p:I

    if-ltz p1, :cond_2

    iget-object v0, p0, Lsl/k;->r:Lql/a;
    ...
    invoke-direct {v0, v1}, Lql/a;-><init>(Lcom/faceunity/core/entity/FUBundleData;)V

    iput-object v0, p0, Lsl/k;->r:Lql/a;
    ...
    :cond_2
    iget-object p1, p0, Lsl/k;->r:Lql/a;
    ...
    iput-object p1, p0, Lsl/k;->r:Lql/a;
