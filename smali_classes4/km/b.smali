...
.method public static constructor <clinit>()V
    ...
    sput-object v9, Lkm/b;->l:Ljava/util/HashMap;

    new-instance v10, Ljava/util/HashMap;

    invoke-direct {v10}, Ljava/util/HashMap;-><init>()V

    sput-object v10, Lkm/b;->m:Ljava/util/HashMap;

    new-instance v11, Ljava/util/HashMap;

    invoke-direct {v11}, Ljava/util/HashMap;-><init>()V

    sput-object v11, Lkm/b;->n:Ljava/util/HashMap;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lkm/b;->a:Lorg/json/JSONObject;

    new-instance v0, Lorg/json/JSONObject;

    invoke-direct {v0}, Lorg/json/JSONObject;-><init>()V

    iput-object v0, p0, Lkm/b;->b:Lorg/json/JSONObject;

    new-instance v0, Ljava/util/ArrayList;

    invoke-direct {v0}, Ljava/util/ArrayList;-><init>()V

    iput-object v0, p0, Lkm/b;->c:Ljava/util/ArrayList;

    new-instance v0, Ljava/util/HashMap;

    invoke-direct {v0}, Ljava/util/HashMap;-><init>()V

    iput-object v0, p0, Lkm/b;->d:Ljava/util/HashMap;

    new-instance v0, Ljava/util/HashMap;

    invoke-direct {v0}, Ljava/util/HashMap;-><init>()V

    iput-object v0, p0, Lkm/b;->e:Ljava/util/HashMap;

    new-instance v0, Ljava/util/HashMap;

    invoke-direct {v0}, Ljava/util/HashMap;-><init>()V

    iput-object v0, p0, Lkm/b;->f:Ljava/util/HashMap;

    new-instance v0, Ljava/util/HashMap;

    invoke-direct {v0}, Ljava/util/HashMap;-><init>()V

    iput-object v0, p0, Lkm/b;->g:Ljava/util/HashMap;

    new-instance v0, Ljava/util/HashMap;

    invoke-direct {v0}, Ljava/util/HashMap;-><init>()V

    iput-object v0, p0, Lkm/b;->h:Ljava/util/HashMap;

    new-instance v0, Ljava/util/HashMap;

    invoke-direct {v0}, Ljava/util/HashMap;-><init>()V

    iput-object v0, p0, Lkm/b;->i:Ljava/util/HashMap;

    new-instance v0, Ljava/util/HashMap;

    invoke-direct {v0}, Ljava/util/HashMap;-><init>()V

    iput-object v0, p0, Lkm/b;->j:Ljava/util/HashMap;

    new-instance v0, Lorg/json/JSONObject;

    invoke-direct {v0}, Lorg/json/JSONObject;-><init>()V

    iput-object v0, p0, Lkm/b;->k:Lorg/json/JSONObject;

    invoke-virtual {p0}, Lkm/b;->m()V
...
.method public static b(Ljava/lang/String;Lorg/json/JSONObject;)Lfm/f;
    .locals 10
    ...
    invoke-direct {v5, v2, v3, v4, p1}, Lfm/g;-><init>(Ljava/lang/String;DLorg/json/JSONObject;)V
    ...
    iget-object v4, v5, Lfm/g;->e:Ljava/util/ArrayList;
    ...
    iget-object v9, v5, Lfm/g;->f:Ljava/util/ArrayList;
    ...
    iget-object v9, v5, Lfm/g;->g:Ljava/util/ArrayList;
    ...
    iget-object v6, v5, Lfm/g;->h:Ljava/util/ArrayList;
    ...
    invoke-direct {p1, p0, v1, v5}, Lfm/f;-><init>(Ljava/lang/String;Ljava/lang/String;Lfm/g;)V
...
.method public final c(Ljava/lang/String;)Ljava/lang/String;
    ...
    iget-object p0, p0, Lkm/b;->k:Lorg/json/JSONObject;
...
.method public final d(Ljava/lang/String;)Ljava/util/ArrayList;
    ...
    iget-object p0, p0, Lkm/b;->i:Ljava/util/HashMap;
...
.method public final e()Ljava/util/ArrayList;
    ...
    iget-object v1, v1, Lkm/b;->k:Lorg/json/JSONObject;
...
.method public final k(Ljava/lang/String;Ljava/lang/String;)Ljava/util/ArrayList;
    ...
    iget-object p0, p0, Lkm/b;->h:Ljava/util/HashMap;
    ...
    iget-object v1, v0, Lfm/e;->d:Ljava/util/ArrayList;
...
.method public final l(Ljava/lang/String;)Lfm/f;
    .locals 1
    ...
    iget-object p0, p0, Lkm/b;->g:Ljava/util/HashMap;
...
.method public final m()V
    ...
    iget-object v4, v0, Lkm/b;->f:Ljava/util/HashMap;
    ...
    :cond_2
    iput-object v3, v0, Lkm/b;->a:Lorg/json/JSONObject;
    ...
    :cond_3
    iget-object v7, v0, Lkm/b;->c:Ljava/util/ArrayList;
    ...
    iget-object v13, v0, Lkm/b;->a:Lorg/json/JSONObject;
    ...
    :cond_4
    sget-object v14, Ldm/a;->a:Ljava/lang/String;
    ...
    new-instance v13, Lfm/c;

    invoke-static {v12, v10}, Lkotlin/jvm/internal/j;->e(Ljava/lang/Object;Ljava/lang/String;)V
    ...
    invoke-direct {v13, v12, v14, v15, v5}, Lfm/c;-><init>(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    ...
    iget-object v12, v0, Lkm/b;->d:Ljava/util/HashMap;
    ...
    iget-object v5, v0, Lkm/b;->a:Lorg/json/JSONObject;
    ...
    invoke-virtual/range {v19 .. v19}, Landroid/app/Application;->getResources()Landroid/content/res/Resources;

    move-result-object v14

    move-object/from16 v19, v2

    sget-object v2, Lkm/b;->l:Ljava/util/HashMap;
    ...
    invoke-direct {v14, v3, v2, v5}, Lfm/d;-><init>(Ljava/lang/String;Ljava/lang/String;Lorg/json/JSONObject;)V

    invoke-virtual {v13, v14}, Ljava/util/ArrayList;->add(Ljava/lang/Object;)Z

    iget-object v2, v0, Lkm/b;->e:Ljava/util/HashMap;
    ...
    iget-object v12, v0, Lkm/b;->g:Ljava/util/HashMap;
    ...
    iget-object v8, v0, Lkm/b;->a:Lorg/json/JSONObject;
    ...
    invoke-static {v2, v8}, Lkm/b;->b(Ljava/lang/String;Lorg/json/JSONObject;)Lfm/f;
    ...
    :cond_c
    invoke-static {v5, v8}, Lkm/b;->b(Ljava/lang/String;Lorg/json/JSONObject;)Lfm/f;
    ...
    sget-object v3, Ldm/a;->b:Ljava/lang/String;
    ...
    :cond_e
    iput-object v3, v0, Lkm/b;->b:Lorg/json/JSONObject;
    ...
    iget-object v8, v0, Lkm/b;->b:Lorg/json/JSONObject;

    iget-object v9, v7, Lfm/f;->a:Ljava/lang/String;
    ...
    :cond_f
    sget-object v11, Ldm/a;->a:Ljava/lang/String;
    ...
    sget-object v11, Lkm/b;->m:Ljava/util/HashMap;
    ...
    const-string v10, "getApplication().resourc\u2026rType[colorKey]!!, i + 1)"

    invoke-static {v12, v10}, Lkotlin/jvm/internal/j;->e(Ljava/lang/Object;Ljava/lang/String;)V

    new-instance v11, Lfm/a;
    ...
    invoke-direct/range {v10 .. v15}, Lfm/a;-><init>(Ljava/lang/String;Ljava/lang/String;III)V
    ...
    iget-object v2, v0, Lkm/b;->i:Ljava/util/HashMap;

    iget-object v7, v7, Lfm/f;->a:Ljava/lang/String;
    ...
    sget-object v3, Ldm/a;->c:Ljava/lang/String;
    ...
    iget-object v7, v5, Lfm/f;->a:Ljava/lang/String;
    ...
    :goto_11
    iget-object v11, v5, Lfm/f;->a:Ljava/lang/String;
    ...
    invoke-static {v15, v2}, Lkm/b;->a(Ljava/lang/String;Lorg/json/JSONObject;)Lcom/faceunity/core/entity/FUBundleData;
    ...
    invoke-static {v11, v12}, Lkm/b;->a(Ljava/lang/String;Lorg/json/JSONObject;)Lcom/faceunity/core/entity/FUBundleData;
    ...
    invoke-direct {v3, v13, v2, v11}, Lfm/e;-><init>(Ljava/util/ArrayList;Ljava/lang/String;Ljava/util/ArrayList;)V

    iget-object v2, v0, Lkm/b;->j:Ljava/util/HashMap;

    iget-object v11, v3, Lfm/e;->g:Ljava/lang/String;
    ...
    iget-object v2, v0, Lkm/b;->h:Ljava/util/HashMap;
    ...
    :cond_1e
    iput-object v1, v0, Lkm/b;->a:Lorg/json/JSONObject;
    ...
    :cond_1f
    iput-object v1, v0, Lkm/b;->k:Lorg/json/JSONObject;
