...
.method public static constructor <clinit>()V
    ...
    sput-object v2, Lnt/a;->g:Ljava/util/concurrent/ExecutorService;
    ...
    sput-boolean v8, Lnt/a;->b:Z

    :goto_0
    sget-boolean v2, Lnt/a;->b:Z
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v0, p0, Lnt/a;->a:Lmiui/util/HapticFeedbackUtil;
...
.method public final a(I)V
    ...
    iget-object p0, p0, Lnt/a;->a:Lmiui/util/HapticFeedbackUtil;
    ...
    invoke-static {v0}, Lgq/a;->a(Ljava/lang/String;)V
...
.method public final b()V
    ...
    iget-object v0, p0, Lnt/a;->a:Lmiui/util/HapticFeedbackUtil;
    ...
    invoke-direct {v0, p0, v1, v2}, Lq6/d;-><init>(Ljava/lang/Object;II)V

    sget-object p0, Lnt/a;->g:Ljava/util/concurrent/ExecutorService;
...
.method public final c(I)Z
    ...
    invoke-static {p1}, Lgq/a;->a(Ljava/lang/String;)V
    ...
    sget-boolean p1, Lnt/a;->d:Z

    if-eqz p1, :cond_0

    const/4 p1, 0x0

    invoke-virtual {p0, p1, v3, v2}, Lmiui/util/HapticFeedbackUtil;->performHapticFeedback(Landroid/os/VibrationAttributes;IZ)Z
    ...
    :cond_0
    invoke-virtual {p0, v3, v2}, Lmiui/util/HapticFeedbackUtil;->performHapticFeedback(IZ)Z
...
.method public final d(ID)Z
    ...
    const-string v7, "USAGE_PHYSICAL_EMULATION"

    iget-object v2, p0, Lnt/a;->a:Lmiui/util/HapticFeedbackUtil;

    if-eqz v2, :cond_1

    sget-boolean v4, Lnt/a;->c:Z
    ...
    invoke-virtual/range {v2 .. v7}, Lmiui/util/HapticFeedbackUtil;->performHapticFeedback(Landroid/os/VibrationAttributes;IDLjava/lang/String;)Z
    ...
    :cond_0
    invoke-virtual {v2, v4, p2, p3, v7}, Lmiui/util/HapticFeedbackUtil;->performHapticFeedback(IDLjava/lang/String;)Z
...
.method public final e(II)Z
    ...
    sget-boolean v0, Lnt/a;->e:Z

    if-eqz v0, :cond_0

    const/4 v0, 0x0

    invoke-virtual {p0, v0, p1, v2, p2}, Lmiui/util/HapticFeedbackUtil;->performHapticFeedback(Landroid/os/VibrationAttributes;IZI)Z
    ...
    :cond_0
    invoke-virtual {p0, v3, v2, p2}, Lmiui/util/HapticFeedbackUtil;->performHapticFeedback(IZI)Z
