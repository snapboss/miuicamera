...
.field public l:Loo/d;

.field public m:Loo/c;
...
.method public static constructor <clinit>()V
    ...
    sput-object v1, Loo/b;->y:[F

    new-array v1, v0, [F

    sput-object v1, Loo/b;->W:[F
    ...
    sput-object v1, Loo/b;->Z:[F

    new-array v0, v0, [F

    sput-object v0, Loo/b;->a0:[F
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v1, p0, Loo/b;->h:[I

    const/16 v1, 0x100

    new-array v1, v1, [I

    iput-object v1, p0, Loo/b;->i:[I

    iput v0, p0, Loo/b;->x:I

    iput-object p1, p0, Loo/b;->n:Landroid/content/Context;
...
.method public final onFrameAvailable(Landroid/graphics/SurfaceTexture;)V
    ...
    iput-object v5, v1, Loo/b;->r:Ljava/nio/FloatBuffer;
    ...
    iget-object v5, v1, Loo/b;->r:Ljava/nio/FloatBuffer;
    ...
    iput-object v0, v1, Loo/b;->q:Ljava/nio/FloatBuffer;
    ...
    iget-object v0, v1, Loo/b;->q:Ljava/nio/FloatBuffer;

    invoke-virtual {v0, v3}, Ljava/nio/FloatBuffer;->position(I)Ljava/nio/Buffer;

    const/4 v0, 0x2

    const-string v5, "ComputeRenderThread"

    invoke-static {v0, v5}, Lcom/xiaomi/gl/MIGL;->glGenTextures(ILjava/lang/String;)[I

    move-result-object v6

    iput-object v6, v1, Loo/b;->o:[I
    ...
    iget v13, v1, Loo/b;->j:I

    iget v14, v1, Loo/b;->k:I

    const v15, 0x8058

    invoke-static {v7, v4, v15, v13, v14}, Landroid/opengl/GLES30;->glTexStorage2D(IIIII)V
    ...
    iget v6, v1, Loo/b;->j:I

    invoke-static {v7, v4, v15, v6, v2}, Landroid/opengl/GLES30;->glTexStorage2D(IIIII)V

    iget v2, v1, Loo/b;->j:I
    ...
    iput-object v2, v1, Loo/b;->p:[I

    invoke-static {v0, v2, v3}, Landroid/opengl/GLES20;->glGenFramebuffers(I[II)V

    new-array v2, v0, [I

    invoke-static {v0, v2, v3}, Landroid/opengl/GLES20;->glGenRenderbuffers(I[II)V

    const v0, 0x84c1

    invoke-static {v0}, Landroid/opengl/GLES20;->glActiveTexture(I)V

    iget-object v0, v1, Loo/b;->o:[I
    ...
    iget v0, v1, Loo/b;->j:I

    iget v8, v1, Loo/b;->k:I

    const v9, 0x81a5

    invoke-static {v6, v9, v0, v8}, Landroid/opengl/GLES20;->glRenderbufferStorage(IIII)V

    iget-object v0, v1, Loo/b;->p:[I
    ...
    invoke-static {v8, v9, v7, v0, v3}, Landroid/opengl/GLES20;->glFramebufferTexture2D(IIIII)V

    const v0, 0x8d00

    aget v2, v2, v3

    invoke-static {v8, v0, v6, v2}, Landroid/opengl/GLES20;->glFramebufferRenderbuffer(IIII)V
    ...
    iget-object v10, v1, Loo/b;->n:Landroid/content/Context;
    ...
    invoke-static {v0, v12}, Landroidx/appcompat/graphics/drawable/a;->c(Ljava/io/IOException;Ljava/lang/StringBuilder;)Ljava/lang/String;

    move-result-object v0

    new-array v12, v3, [Ljava/lang/Object;

    invoke-static {v5, v0, v12}, Lcom/android/camera/log/Log;->d(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    ...
    invoke-static {v9, v13, v12, v3}, Landroid/opengl/GLES20;->glGetShaderiv(II[II)V
    ...
    invoke-static {v5, v0, v14}, Lcom/android/camera/log/Log;->e(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    ...
    invoke-static {v0, v11}, Landroidx/appcompat/graphics/drawable/a;->c(Ljava/io/IOException;Ljava/lang/StringBuilder;)Ljava/lang/String;
    ...
    invoke-static {v14, v13, v12, v3}, Landroid/opengl/GLES20;->glGetShaderiv(II[II)V
    ...
    invoke-static {v0, v6}, Landroidx/appcompat/graphics/drawable/a;->c(Ljava/io/IOException;Ljava/lang/StringBuilder;)Ljava/lang/String;
    ...
    invoke-static {v7, v13, v8, v3}, Landroid/opengl/GLES20;->glGetShaderiv(II[II)V
    ...
    iput v0, v1, Loo/b;->t:I

    iget v0, v1, Loo/b;->k:I
    ...
    iput v0, v1, Loo/b;->w:F

    iput-boolean v4, v1, Loo/b;->u:Z
    ...
    iget-object v7, v1, Loo/b;->c:[I

    const/16 v8, 0x10

    if-nez v0, :cond_a

    iget v0, v1, Loo/b;->e:I
    ...
    iget v0, v1, Loo/b;->f:I

    invoke-static {v0, v4}, Landroid/opengl/GLES20;->glUniform1i(II)V

    iget v0, v1, Loo/b;->g:I

    iget v6, v1, Loo/b;->j:I

    iget v7, v1, Loo/b;->k:I

    invoke-static {v0, v6, v7}, Landroid/opengl/GLES20;->glUniform2i(III)V

    iget-object v0, v1, Loo/b;->h:[I
    ...
    invoke-static {v5, v7, v6}, Landroid/opengl/GLES30;->glBindBufferBase(III)V
    ...
    invoke-static {v6, v9, v4}, Landroid/opengl/GLES31;->glDispatchCompute(III)V
    ...
    invoke-static {v5, v3, v0, v4}, Landroid/opengl/GLES30;->glMapBufferRange(IIII)Ljava/nio/Buffer;

    move-result-object v0

    check-cast v0, Ljava/nio/ByteBuffer;

    iget-object v2, v1, Loo/b;->i:[I
    ...
    :cond_7
    iget-object v0, v1, Loo/b;->d:Loo/b$a;

    if-eqz v0, :cond_8

    check-cast v0, Luo/e$b;

    iget-object v0, v0, Luo/e$b;->a:Luo/e$a;

    if-eqz v0, :cond_8

    sget-object v0, Lcom/xiaomi/camera/rx/CameraSchedulers;->sMainThreadScheduler:Lio/reactivex/Scheduler;

    new-instance v4, Lcom/android/camera/module/video/g;

    invoke-direct {v4, v2}, Lcom/android/camera/module/video/g;-><init>([I)V

    invoke-static {v0, v4}, Lnt/c;->z(Lio/reactivex/Scheduler;Ljava/lang/Runnable;)Lio/reactivex/disposables/Disposable;

    :cond_8
    iget-object v0, v1, Loo/b;->a:Loo/b$b;
    ...
    invoke-static {v5, v7, v3}, Landroid/opengl/GLES30;->glBindBufferBase(III)V
    ...
    iget-object v15, v1, Loo/b;->r:Ljava/nio/FloatBuffer;
    ...
    iget-object v11, v1, Loo/b;->q:Ljava/nio/FloatBuffer;
    ...
    iget v9, v1, Loo/b;->j:I

    iget v10, v1, Loo/b;->k:I

    invoke-static {v3, v3, v9, v10}, Landroid/opengl/GLES20;->glViewport(IIII)V
    ...
    invoke-static {v15, v3, v9, v9, v9}, Landroid/opengl/Matrix;->translateM([FIFFF)V
    ...
    invoke-static {v15, v3, v9, v10, v11}, Landroid/opengl/Matrix;->scaleM([FIFFF)V
    ...
    invoke-static {v6, v4, v3, v15, v3}, Landroid/opengl/GLES20;->glUniformMatrix4fv(IIZ[FI)V
    ...
    invoke-static {v6, v4, v3, v0, v3}, Landroid/opengl/GLES20;->glUniformMatrix4fv(IIZ[FI)V

    iget v0, v1, Loo/b;->s:I
    ...
    invoke-static/range {v19 .. v25}, Landroid/opengl/GLES31;->glBindImageTexture(IIIZIII)V

    iget-object v0, v1, Loo/b;->p:[I

    aget v0, v0, v3

    invoke-static {v5, v6, v0}, Landroid/opengl/GLES30;->glBindBufferBase(III)V
    ...
    invoke-static {v0, v5, v4}, Landroid/opengl/GLES31;->glDispatchCompute(III)V
    ...
    iget-object v2, v1, Loo/b;->o:[I

    aget v10, v2, v4

    iget-object v7, v1, Loo/b;->m:Loo/c;

    iget v8, v1, Loo/b;->s:I

    iget v11, v1, Loo/b;->w:F

    iget-object v9, v1, Loo/b;->n:Landroid/content/Context;
    ...
    check-cast v6, Lcom/android/camera/module/video/h;

    iget v0, v6, Lcom/android/camera/module/video/h;->c:I
    ...
    invoke-direct/range {v5 .. v11}, Lcom/android/camera/module/video/f;-><init>(Lcom/android/camera/module/video/h;Loo/c;ILandroid/content/Context;IF)V
...
.method public final onLooperPrepared()V
    ...
    invoke-direct {v1, v2, v3}, Loo/c;-><init>(Landroid/opengl/EGLContext;[I)V

    iput-object v1, p0, Loo/b;->m:Loo/c;
    ...
    iget-object v2, p0, Loo/b;->m:Loo/c;

    invoke-direct {v1, v2}, Loo/d;-><init>(Loo/c;)V

    iput-object v1, p0, Loo/b;->l:Loo/d;
    ...
    :goto_0
    iget-object v1, p0, Loo/b;->b:Landroid/graphics/SurfaceTexture;
    ...
    invoke-static {v1, v3}, Loo/i;->f(I[I)V
    ...
    iput-object v1, p0, Loo/b;->b:Landroid/graphics/SurfaceTexture;
    ...
    iput v5, p0, Loo/b;->e:I

    if-eqz v5, :cond_2

    invoke-static {v5}, Landroid/opengl/GLES20;->glUseProgram(I)V

    iget v1, p0, Loo/b;->e:I
    ...
    invoke-direct {v0, p0}, Loo/b$b;-><init>(Loo/b;)V
