...
.field private transient reflected:Ltp/b;
...
.method public varargs call([Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-virtual {p0}, Lkotlin/jvm/internal/c;->getReflected()Ltp/b;

    move-result-object p0

    invoke-interface {p0, p1}, Ltp/b;->call([Ljava/lang/Object;)Ljava/lang/Object;
...
.method public callBy(Ljava/util/Map;)Ljava/lang/Object;
    ...
    invoke-interface {p0, p1}, Ltp/b;->callBy(Ljava/util/Map;)Ljava/lang/Object;
...
.method public compute()Ltp/b;
    .locals 1

    iget-object v0, p0, Lkotlin/jvm/internal/c;->reflected:Ltp/b;

    if-nez v0, :cond_0

    invoke-virtual {p0}, Lkotlin/jvm/internal/c;->computeReflected()Ltp/b;

    move-result-object v0

    iput-object v0, p0, Lkotlin/jvm/internal/c;->reflected:Ltp/b;

    :cond_0
    return-object v0
.end method

.method public abstract computeReflected()Ltp/b;
.end method
...
.method public getAnnotations()Ljava/util/List;
    ...
    invoke-interface {p0}, Ltp/a;->getAnnotations()Ljava/util/List;
...
.method public getOwner()Ltp/d;
    ...
    sget-object p0, Lkotlin/jvm/internal/y;->a:Lkotlin/jvm/internal/z;

    invoke-virtual {p0}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    new-instance p0, Lkotlin/jvm/internal/o;

    invoke-direct {p0, v0}, Lkotlin/jvm/internal/o;-><init>(Ljava/lang/Class;)V
...
.method public getParameters()Ljava/util/List;
    ...
    invoke-interface {p0}, Ltp/b;->getParameters()Ljava/util/List;
...
.method public getReflected()Ltp/b;
    .locals 1

    invoke-virtual {p0}, Lkotlin/jvm/internal/c;->compute()Ltp/b;
...
.method public getReturnType()Ltp/j;
    .locals 0
    ...
    invoke-interface {p0}, Ltp/b;->getReturnType()Ltp/j;
...
.method public getTypeParameters()Ljava/util/List;
    ...
    invoke-interface {p0}, Ltp/b;->getTypeParameters()Ljava/util/List;
...
.method public getVisibility()Ltp/k;
    .locals 0
    ...
    invoke-interface {p0}, Ltp/b;->getVisibility()Ltp/k;
...
.method public isAbstract()Z
    ...
    invoke-interface {p0}, Ltp/b;->isAbstract()Z
...
.method public isFinal()Z
    ...
    invoke-interface {p0}, Ltp/b;->isFinal()Z
...
.method public isOpen()Z
    ...
    invoke-interface {p0}, Ltp/b;->isOpen()Z
...
.method public isSuspend()Z
    ...
    invoke-interface {p0}, Ltp/b;->isSuspend()Z
