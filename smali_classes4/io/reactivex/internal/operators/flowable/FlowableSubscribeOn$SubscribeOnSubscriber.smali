...
# direct methods
.method public constructor <init>(Llu/c;Lio/reactivex/Scheduler$Worker;Llu/b;Z)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput-object p1, p0, Lio/reactivex/internal/operators/flowable/FlowableSubscribeOn$SubscribeOnSubscriber;->downstream:Llu/c;
    ...
    iput-object p3, p0, Lio/reactivex/internal/operators/flowable/FlowableSubscribeOn$SubscribeOnSubscriber;->source:Llu/b;
...
.method public onComplete()V
    ...
    iget-object v0, p0, Lio/reactivex/internal/operators/flowable/FlowableSubscribeOn$SubscribeOnSubscriber;->downstream:Llu/c;
...
.method public onNext(Ljava/lang/Object;)V
    ...
    iget-object p0, p0, Lio/reactivex/internal/operators/flowable/FlowableSubscribeOn$SubscribeOnSubscriber;->downstream:Llu/c;
...
.method public onSubscribe(Llu/d;)V
    ...
    invoke-static {v0, p1}, Lio/reactivex/internal/subscriptions/SubscriptionHelper;->setOnce(Ljava/util/concurrent/atomic/AtomicReference;Llu/d;)Z
    ...
    invoke-virtual {p0, v3, v4, p1}, Lio/reactivex/internal/operators/flowable/FlowableSubscribeOn$SubscribeOnSubscriber;->requestUpstream(JLlu/d;)V
...
.method public request(J)V
    ...
    invoke-virtual {p0, p1, p2, v0}, Lio/reactivex/internal/operators/flowable/FlowableSubscribeOn$SubscribeOnSubscriber;->requestUpstream(JLlu/d;)V
    ...
    invoke-virtual {p0, v2, v3, p1}, Lio/reactivex/internal/operators/flowable/FlowableSubscribeOn$SubscribeOnSubscriber;->requestUpstream(JLlu/d;)V
...
.method public requestUpstream(JLlu/d;)V
    .locals 2
    ...
    invoke-direct {v0, p3, p1, p2}, Lio/reactivex/internal/operators/flowable/FlowableSubscribeOn$SubscribeOnSubscriber$Request;-><init>(Llu/d;J)V
    ...
    :cond_1
    :goto_0
    invoke-interface {p3, p1, p2}, Llu/d;->request(J)V
...
.method public run()V
    ...
    iget-object v0, p0, Lio/reactivex/internal/operators/flowable/FlowableSubscribeOn$SubscribeOnSubscriber;->source:Llu/b;

    const/4 v1, 0x0

    iput-object v1, p0, Lio/reactivex/internal/operators/flowable/FlowableSubscribeOn$SubscribeOnSubscriber;->source:Llu/b;

    invoke-interface {v0, p0}, Llu/b;->subscribe(Llu/c;)V
