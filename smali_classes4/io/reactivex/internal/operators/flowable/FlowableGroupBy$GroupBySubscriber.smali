...
.method public constructor <init>(Llu/c;Lio/reactivex/functions/Function;Lio/reactivex/functions/Function;IZLjava/util/Map;Ljava/util/Queue;)V
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput-object p1, p0, Lio/reactivex/internal/operators/flowable/FlowableGroupBy$GroupBySubscriber;->downstream:Llu/c;
...
.method private completeEvictions()V
    ...
    iget-object p0, p0, Lio/reactivex/internal/operators/flowable/FlowableGroupBy$GroupBySubscriber;->groupCount:Ljava/util/concurrent/atomic/AtomicInteger;
...
.method public cancel()V
    ...
    .line 4
    iget-object p0, p0, Lio/reactivex/internal/operators/flowable/FlowableGroupBy$GroupBySubscriber;->upstream:Llu/d;
...
.method public cancel(Ljava/lang/Object;)V
    ...
    .line 8
    iget-object p1, p0, Lio/reactivex/internal/operators/flowable/FlowableGroupBy$GroupBySubscriber;->upstream:Llu/d;

    invoke-interface {p1}, Llu/d;->cancel()V
...
.method public checkTerminated(ZZLlu/c;Lio/reactivex/internal/queue/SpscLinkedArrayQueue;)Z
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(ZZ",
    ...
    invoke-interface {p3, p0}, Llu/c;->onError(Ljava/lang/Throwable;)V
...
.method public drainFused()V
    ...
    iget-object v1, p0, Lio/reactivex/internal/operators/flowable/FlowableGroupBy$GroupBySubscriber;->downstream:Llu/c;
    ...
    invoke-interface {v1, v4}, Llu/c;->onError(Ljava/lang/Throwable;)V
    ...
    invoke-interface {v1, v4}, Llu/c;->onNext(Ljava/lang/Object;)V
    ...
    invoke-interface {v1, p0}, Llu/c;->onError(Ljava/lang/Throwable;)V

    goto :goto_0

    :cond_3
    invoke-interface {v1}, Llu/c;->onComplete()V
...
.method public drainNormal()V
    ...
    :goto_1
    invoke-virtual {p0, v11, v13, v1, v0}, Lio/reactivex/internal/operators/flowable/FlowableGroupBy$GroupBySubscriber;->checkTerminated(ZZLlu/c;Lio/reactivex/internal/queue/SpscLinkedArrayQueue;)Z
    ...
    :cond_3
    invoke-interface {v1, v12}, Llu/c;->onNext(Ljava/lang/Object;)V
    ...
    invoke-virtual {p0, v10, v11, v1, v0}, Lio/reactivex/internal/operators/flowable/FlowableGroupBy$GroupBySubscriber;->checkTerminated(ZZLlu/c;Lio/reactivex/internal/queue/SpscLinkedArrayQueue;)Z
    ...
    :cond_6
    iget-object v4, p0, Lio/reactivex/internal/operators/flowable/FlowableGroupBy$GroupBySubscriber;->upstream:Llu/d;

    invoke-interface {v4, v8, v9}, Llu/d;->request(J)V
...
.method public onNext(Ljava/lang/Object;)V
    ...
    iget-object v0, p0, Lio/reactivex/internal/operators/flowable/FlowableGroupBy$GroupBySubscriber;->upstream:Llu/d;
...
.method public onSubscribe(Llu/d;)V
    ...
    iput-object p1, p0, Lio/reactivex/internal/operators/flowable/FlowableGroupBy$GroupBySubscriber;->upstream:Llu/d;

    iget-object v0, p0, Lio/reactivex/internal/operators/flowable/FlowableGroupBy$GroupBySubscriber;->downstream:Llu/c;
