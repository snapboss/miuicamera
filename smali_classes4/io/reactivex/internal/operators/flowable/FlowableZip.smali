...
# direct methods
.method public constructor <init>([Llu/b;Ljava/lang/Iterable;Lio/reactivex/functions/Function;IZ)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "([",
    ...
    iput-object p1, p0, Lio/reactivex/internal/operators/flowable/FlowableZip;->sources:[Llu/b;
...
.method public subscribeActual(Llu/c;)V
    ...
    iget-object v0, p0, Lio/reactivex/internal/operators/flowable/FlowableZip;->sources:[Llu/b;
    ...
    invoke-direct/range {v1 .. v6}, Lio/reactivex/internal/operators/flowable/FlowableZip$ZipCoordinator;-><init>(Llu/c;Lio/reactivex/functions/Function;IIZ)V

    invoke-interface {p1, v8}, Llu/c;->onSubscribe(Llu/d;)V

    invoke-virtual {v8, v0, v7}, Lio/reactivex/internal/operators/flowable/FlowableZip$ZipCoordinator;->subscribe([Llu/b;I)V
