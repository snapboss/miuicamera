...
# direct methods
.method public constructor <init>(Llu/c;JLjava/util/concurrent/TimeUnit;Lio/reactivex/Scheduler;IJZ)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct {p0, p1, v0}, Lio/reactivex/internal/subscribers/QueueDrainSubscriber;-><init>(Llu/c;Lio/reactivex/internal/fuseable/SimplePlainQueue;)V
...
.method public drainLoop()V
    ...
    iget-object v2, v0, Lio/reactivex/internal/subscribers/QueueDrainSubscriber;->downstream:Llu/c;
    ...
    iget-object v2, v0, Lio/reactivex/internal/operators/flowable/FlowableWindowTimed$WindowExactBoundedSubscriber;->upstream:Llu/d;
    ...
    invoke-interface {v2, v3}, Llu/c;->onNext(Ljava/lang/Object;)V
    ...
    iget-object v1, v0, Lio/reactivex/internal/operators/flowable/FlowableWindowTimed$WindowExactBoundedSubscriber;->upstream:Llu/d;

    invoke-interface {v1}, Llu/d;->cancel()V
    ...
    invoke-interface {v2, v1}, Llu/c;->onError(Ljava/lang/Throwable;)V
    ...
    iget-object v6, v0, Lio/reactivex/internal/subscribers/QueueDrainSubscriber;->downstream:Llu/c;

    invoke-interface {v6, v5}, Llu/c;->onNext(Ljava/lang/Object;)V
    ...
    iget-object v1, v0, Lio/reactivex/internal/subscribers/QueueDrainSubscriber;->downstream:Llu/c;
    ...
    invoke-interface {v1, v2}, Llu/c;->onError(Ljava/lang/Throwable;)V
...
.method public onComplete()V
    ...
    :cond_0
    iget-object p0, p0, Lio/reactivex/internal/subscribers/QueueDrainSubscriber;->downstream:Llu/c;
...
.method public onNext(Ljava/lang/Object;)V
    ...
    iget-object v0, p0, Lio/reactivex/internal/subscribers/QueueDrainSubscriber;->downstream:Llu/c;

    invoke-interface {v0, p1}, Llu/c;->onNext(Ljava/lang/Object;)V
    ...
    iget-object p1, p0, Lio/reactivex/internal/operators/flowable/FlowableWindowTimed$WindowExactBoundedSubscriber;->upstream:Llu/d;

    invoke-interface {p1}, Llu/d;->cancel()V

    iget-object p1, p0, Lio/reactivex/internal/subscribers/QueueDrainSubscriber;->downstream:Llu/c;
    ...
    invoke-interface {p1, v0}, Llu/c;->onError(Ljava/lang/Throwable;)V
...
.method public onSubscribe(Llu/d;)V
    ...
    iget-object v0, p0, Lio/reactivex/internal/operators/flowable/FlowableWindowTimed$WindowExactBoundedSubscriber;->upstream:Llu/d;
    ...
    iput-object p1, p0, Lio/reactivex/internal/operators/flowable/FlowableWindowTimed$WindowExactBoundedSubscriber;->upstream:Llu/d;
    ...
    invoke-interface {v0, v1}, Llu/c;->onNext(Ljava/lang/Object;)V
    ...
    invoke-interface {v0, p0}, Llu/c;->onError(Ljava/lang/Throwable;)V
