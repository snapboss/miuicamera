...
# direct methods
.method public constructor <init>(Llu/c;ILio/reactivex/internal/queue/SpscArrayQueue;Lio/reactivex/Scheduler$Worker;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput-object p1, p0, Lio/reactivex/internal/operators/parallel/ParallelRunOn$RunOnSubscriber;->downstream:Llu/c;
...
.method public onSubscribe(Llu/d;)V
    ...
    iget-object v0, p0, Lio/reactivex/internal/operators/parallel/ParallelRunOn$BaseRunOnSubscriber;->upstream:Llu/d;
    ...
    iput-object p1, p0, Lio/reactivex/internal/operators/parallel/ParallelRunOn$BaseRunOnSubscriber;->upstream:Llu/d;

    iget-object v0, p0, Lio/reactivex/internal/operators/parallel/ParallelRunOn$RunOnSubscriber;->downstream:Llu/c;
...
.method public run()V
    ...
    iget-object v3, v0, Lio/reactivex/internal/operators/parallel/ParallelRunOn$RunOnSubscriber;->downstream:Llu/c;
    ...
    invoke-interface {v3, v15}, Llu/c;->onError(Ljava/lang/Throwable;)V
    ...
    :cond_6
    invoke-interface {v3, v15}, Llu/c;->onNext(Ljava/lang/Object;)V
    ...
    iget-object v13, v0, Lio/reactivex/internal/operators/parallel/ParallelRunOn$BaseRunOnSubscriber;->upstream:Llu/d;

    int-to-long v14, v1

    invoke-interface {v13, v14, v15}, Llu/d;->request(J)V
    ...
    invoke-interface {v3, v13}, Llu/c;->onError(Ljava/lang/Throwable;)V
