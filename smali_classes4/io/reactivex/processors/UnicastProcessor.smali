...
# virtual methods
.method public checkTerminated(ZZZLlu/c;Lio/reactivex/internal/queue/SpscLinkedArrayQueue;)Z
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(ZZZ",
    ...
    invoke-interface {p4, p0}, Llu/c;->onError(Ljava/lang/Throwable;)V
    ...
    invoke-interface {p4, p1}, Llu/c;->onError(Ljava/lang/Throwable;)V

    goto :goto_0

    :cond_2
    invoke-interface {p4}, Llu/c;->onComplete()V
...
.method public drain()V
    ...
    invoke-virtual {p0, v0}, Lio/reactivex/processors/UnicastProcessor;->drainFused(Llu/c;)V

    goto :goto_1

    :cond_1
    invoke-virtual {p0, v0}, Lio/reactivex/processors/UnicastProcessor;->drainRegular(Llu/c;)V
...
.method public drainFused(Llu/c;)V
    .locals 6
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    :cond_2
    invoke-interface {p1, v4}, Llu/c;->onNext(Ljava/lang/Object;)V
...
.method public drainRegular(Llu/c;)V
    .locals 17
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-virtual/range {v0 .. v5}, Lio/reactivex/processors/UnicastProcessor;->checkTerminated(ZZZLlu/c;Lio/reactivex/internal/queue/SpscLinkedArrayQueue;)Z
    ...
    invoke-interface {v5, v8}, Llu/c;->onNext(Ljava/lang/Object;)V
