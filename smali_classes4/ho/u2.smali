...
.method public constructor <init>(Landroid/content/Context;ILjava/lang/String;)V
    ...
    invoke-direct {p0, p1}, Lho/s2;-><init>(Landroid/content/Context;)V

    new-instance p1, Ljava/util/ArrayList;

    invoke-direct {p1}, Ljava/util/ArrayList;-><init>()V

    iput-object p1, p0, Lho/u2;->k:Ljava/util/ArrayList;

    iput-object p3, p0, Lho/u2;->i:Ljava/lang/String;

    iput p2, p0, Lho/u2;->h:I

    iget-object p1, p0, Lho/s2;->a:Landroid/content/Context;

    invoke-virtual {p1}, Landroid/content/Context;->getResources()Landroid/content/res/Resources;

    move-result-object p2

    invoke-virtual {p0}, Lho/u2;->m()Ljava/lang/String;
    ...
    invoke-static {p1, p3}, Lcom/xiaomi/push/service/h;->c(Landroid/content/Context;Ljava/lang/String;)Lcom/xiaomi/push/service/h;

    move-result-object p3

    invoke-virtual {p3}, Lcom/xiaomi/push/service/h;->o()Ljava/util/List;
    ...
    :cond_6
    invoke-virtual {p0}, Lho/u2;->i()Ljava/lang/String;
    ...
    invoke-static {p2, p3, v1, v0}, Lho/s2;->a(Landroid/content/res/Resources;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)I
    ...
    iput-object p3, p0, Lho/u2;->b:Landroid/widget/RemoteViews;

    invoke-virtual {p0}, Lho/u2;->k()Z

    move-result p1

    iput-boolean p1, p0, Lho/u2;->c:Z
...
.method public final addAction(ILjava/lang/CharSequence;Landroid/app/PendingIntent;)Landroid/app/Notification$Builder;
    ...
    .line 2
    iget-object p1, p0, Lho/u2;->k:Ljava/util/ArrayList;
...
.method public final addAction(Landroid/app/Notification$Action;)Landroid/app/Notification$Builder;
    ...
    .line 3
    iget-object v0, p0, Lho/u2;->k:Ljava/util/ArrayList;
...
.method public b()V
    ...
    iget-object v1, p0, Lho/u2;->i:Ljava/lang/String;
    ...
    iget-object v1, p0, Lho/s2;->a:Landroid/content/Context;
    ...
    invoke-static {v4, v7, v6, v5}, Lho/s2;->a(Landroid/content/res/Resources;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)I
    ...
    iget-object v4, p0, Lho/u2;->k:Ljava/util/ArrayList;
    ...
    :cond_2
    iget-object v4, p0, Lho/u2;->g:Ljava/util/Map;
    ...
    iget-object v2, p0, Lho/u2;->e:Ljava/lang/CharSequence;

    invoke-virtual {v0, v1, v2}, Landroid/os/Bundle;->putCharSequence(Ljava/lang/String;Ljava/lang/CharSequence;)V

    const-string v1, "mipush.customContent"

    iget-object v2, p0, Lho/u2;->f:Ljava/lang/CharSequence;
    ...
    :cond_7
    :goto_5
    iget-object v1, p0, Lho/u2;->e:Ljava/lang/CharSequence;
    ...
    iget-object v1, p0, Lho/u2;->f:Ljava/lang/CharSequence;
    ...
    :goto_6
    invoke-virtual {p0, v0}, Lho/s2;->c(Landroid/os/Bundle;)V
...
.method public h(Landroid/graphics/Bitmap;)Lho/u2;
    .locals 0

    iput-object p1, p0, Lho/u2;->d:Landroid/graphics/Bitmap;
...
.method public final j(I)V
    ...
    iget-object v0, p0, Lho/s2;->a:Landroid/content/Context;

    iget-object v1, p0, Lho/u2;->i:Ljava/lang/String;

    invoke-static {v0, v1}, Lho/v4;->e(Landroid/content/Context;Ljava/lang/String;)Landroid/content/pm/ApplicationInfo;
    ...
    :goto_1
    invoke-static {v3}, Lcom/xiaomi/push/service/i1;->g(Landroid/graphics/drawable/Drawable;)Landroid/graphics/Bitmap;

    move-result-object v2

    if-eqz v2, :cond_2

    iget-object p0, p0, Lho/u2;->b:Landroid/widget/RemoteViews;
    ...
    :cond_2
    invoke-static {v0, v1}, Lho/v4;->g(Landroid/content/Context;Ljava/lang/String;)I
...
.method public final n()V
    ...
    iget-object v0, p0, Lho/u2;->e:Ljava/lang/CharSequence;
    ...
    iget-object v0, p0, Lho/u2;->f:Ljava/lang/CharSequence;
    ...
    iget-object v0, p0, Lho/u2;->d:Landroid/graphics/Bitmap;
...
.method public final setContentText(Ljava/lang/CharSequence;)Landroid/app/Notification$Builder;
    ...
    iput-object p1, p0, Lho/u2;->f:Ljava/lang/CharSequence;
...
.method public final setContentTitle(Ljava/lang/CharSequence;)Landroid/app/Notification$Builder;
    ...
    iput-object p1, p0, Lho/u2;->e:Ljava/lang/CharSequence;
...
.method public synthetic setLargeIcon(Landroid/graphics/Bitmap;)Landroid/app/Notification$Builder;
    ...
    invoke-virtual {p0, p1}, Lho/u2;->h(Landroid/graphics/Bitmap;)Lho/u2;
