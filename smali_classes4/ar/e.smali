...
.method public constructor <init>(Landroid/content/Context;Z)V
    ...
    invoke-direct {p0}, Lar/d;-><init>()V

    new-instance v0, Ljava/util/ArrayList;

    invoke-direct {v0}, Ljava/util/ArrayList;-><init>()V

    iput-object v0, p0, Lar/e;->d:Ljava/util/ArrayList;

    new-instance v1, Ljava/util/HashMap;

    invoke-direct {v1}, Ljava/util/HashMap;-><init>()V

    iput-object v1, p0, Lar/e;->e:Ljava/util/HashMap;

    new-instance v1, Ljava/util/HashMap;

    invoke-direct {v1}, Ljava/util/HashMap;-><init>()V

    iput-object v1, p0, Lar/e;->f:Ljava/util/HashMap;

    new-instance v1, Ljava/util/HashMap;

    invoke-direct {v1}, Ljava/util/HashMap;-><init>()V

    iput-object v1, p0, Lar/e;->g:Ljava/util/HashMap;

    new-instance v1, Ljava/util/HashMap;

    invoke-direct {v1}, Ljava/util/HashMap;-><init>()V

    iput-object v1, p0, Lar/e;->h:Ljava/util/HashMap;
    ...
    iput-object v0, p0, Lar/d;->a:Ljava/util/List;

    iput-boolean p2, p0, Lar/e;->i:Z
...
# virtual methods
.method public final a(I)Lar/g;
    .locals 0

    iget-object p0, p0, Lar/e;->d:Ljava/util/ArrayList;
...
.method public final c(ILjava/util/List;Z)V
    ...
    :goto_0
    iget-object v6, v0, Lar/e;->h:Ljava/util/HashMap;
    ...
    check-cast v11, Lar/g;

    instance-of v12, v11, Lar/h;

    if-eqz v12, :cond_5

    iget-object v12, v11, Lar/g;->a:Lmiuix/appcompat/internal/view/menu/f;
    ...
    :goto_5
    iget-object v14, v0, Lar/e;->g:Ljava/util/HashMap;
...
.method public final bridge synthetic getItem(I)Ljava/lang/Object;
    ...
    invoke-virtual {p0, p1}, Lar/e;->b(I)Lmiuix/appcompat/internal/view/menu/f;
