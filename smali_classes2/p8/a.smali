...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v0, p0, Lp8/a;->i:Landroid/os/ParcelFileDescriptor;

    new-instance v0, Ljava/util/ArrayList;

    invoke-direct {v0}, Ljava/util/ArrayList;-><init>()V

    iput-object v0, p0, Lp8/a;->j:Ljava/util/ArrayList;

    new-instance v0, Ljava/util/LinkedList;

    invoke-direct {v0}, Ljava/util/LinkedList;-><init>()V

    iput-object v0, p0, Lp8/a;->k:Ljava/util/LinkedList;

    iput-object p1, p0, Lp8/a;->c:Landroid/content/Context;
...
.method public final a()V
    ...
    iget-object v0, p0, Lp8/a;->g:Ljava/lang/String;
    ...
    iget-object v1, p0, Lp8/a;->g:Ljava/lang/String;
    ...
    :cond_0
    iget-object v0, p0, Lp8/a;->b:Landroid/os/ParcelFileDescriptor;

    invoke-static {v0}, Lgr/b;->a(Landroid/os/ParcelFileDescriptor;)V

    const/4 v0, 0x0

    iput-object v0, p0, Lp8/a;->b:Landroid/os/ParcelFileDescriptor;

    iget-object v1, p0, Lp8/a;->a:Landroid/net/Uri;

    if-eqz v1, :cond_5

    iget-object v1, p0, Lp8/a;->c:Landroid/content/Context;

    invoke-virtual {v1}, Landroid/content/Context;->getContentResolver()Landroid/content/ContentResolver;

    move-result-object v2

    iget-object v3, p0, Lp8/a;->a:Landroid/net/Uri;
    ...
    iget-object v2, p0, Lp8/a;->a:Landroid/net/Uri;
    ...
    :cond_5
    :goto_3
    iput-object v0, p0, Lp8/a;->a:Landroid/net/Uri;

    iget-object p0, p0, Lp8/a;->d:Landroid/content/ContentValues;
...
.method public final b()V
    ...
    iget-object v0, p0, Lp8/a;->i:Landroid/os/ParcelFileDescriptor;
...
.method public final c()Ljava/io/FileDescriptor;
    ...
    invoke-virtual {p0}, Lp8/a;->e()Landroid/os/ParcelFileDescriptor;
...
.method public final d()Ljava/lang/String;
    ...
    iget-object v0, p0, Lp8/a;->a:Landroid/net/Uri;

    if-eqz v0, :cond_0

    iget-object v0, p0, Lp8/a;->c:Landroid/content/Context;

    invoke-virtual {v0}, Landroid/content/Context;->getContentResolver()Landroid/content/ContentResolver;

    move-result-object v0

    iget-object p0, p0, Lp8/a;->a:Landroid/net/Uri;

    invoke-static {v0, p0}, Lp8/a;->i(Landroid/content/ContentResolver;Landroid/net/Uri;)Ljava/lang/String;
...
.method public final e()Landroid/os/ParcelFileDescriptor;
    ...
    invoke-static {p0, v0}, Lq8/b;->b(Landroid/net/Uri;Ljava/lang/String;)Landroid/os/ParcelFileDescriptor;
...
.method public final g(Landroid/content/Intent;Z)V
    ...
    iput-object p1, p0, Lp8/a;->e:Landroid/net/Uri;
    ...
    iget-object v2, p0, Lp8/a;->e:Landroid/net/Uri;
    ...
    iput-object v1, p0, Lp8/a;->f:Landroid/os/ParcelFileDescriptor;

    new-instance v1, Ljava/lang/StringBuilder;

    invoke-direct {v1, v0}, Ljava/lang/StringBuilder;-><init>(Ljava/lang/String;)V

    iget-object p0, p0, Lp8/a;->e:Landroid/net/Uri;
...
.method public final h()Landroid/net/Uri;
    ...
    iget-object v5, p0, Lp8/a;->d:Landroid/content/ContentValues;
    ...
    iget-object v6, p0, Lp8/a;->d:Landroid/content/ContentValues;
    ...
    invoke-static {v6}, Ll8/y;->C(Ljava/lang/String;)Z
    ...
    :cond_6
    invoke-static {v0, v6, v9}, Ll8/y;->i(Landroid/content/Context;Ljava/lang/String;Z)Landroid/net/Uri;
...
.method public final k(Lzi/n;Z)V
    .locals 11
    .annotation build Landroidx/annotation/WorkerThread;
    .end annotation
    ...
    const-string/jumbo p2, "setMediaRecorderOutput recorder is Null"

    invoke-direct {p1, p2}, Ljava/lang/StringBuilder;-><init>(Ljava/lang/String;)V

    iget-object p0, p0, Lp8/a;->g:Ljava/lang/String;
    ...
    iget-object v3, p0, Lp8/a;->c:Landroid/content/Context;
    ...
    iget-object v4, p0, Lp8/a;->f:Landroid/os/ParcelFileDescriptor;
    ...
    :cond_2
    iget-object v2, p0, Lp8/a;->d:Landroid/content/ContentValues;
    ...
    iput-object p2, p0, Lp8/a;->g:Ljava/lang/String;
    ...
    iget-object v2, p0, Lp8/a;->g:Ljava/lang/String;
    ...
    invoke-interface {p1, p0}, Lzi/n;->q(Ljava/lang/String;)V

    return-void

    :cond_3
    iget-object p2, p0, Lp8/a;->f:Landroid/os/ParcelFileDescriptor;
    ...
    invoke-interface {p1, p0}, Lzi/n;->m(Ljava/io/FileDescriptor;)V

    return-void

    :cond_5
    iget-object p2, p0, Lp8/a;->d:Landroid/content/ContentValues;
    ...
    invoke-static {p2}, Ll8/y;->C(Ljava/lang/String;)Z
    ...
    iget-object v7, p0, Lp8/a;->d:Landroid/content/ContentValues;
    ...
    iget-object v4, p0, Lp8/a;->d:Landroid/content/ContentValues;
    ...
    :cond_6
    invoke-static {v3, p2, v2}, Ll8/y;->i(Landroid/content/Context;Ljava/lang/String;Z)Landroid/net/Uri;
    ...
    iput-object v2, p0, Lp8/a;->a:Landroid/net/Uri;

    const-string/jumbo v2, "setMediaRecorderOutput after insert "
    ...
    iput-object v2, p0, Lp8/a;->b:Landroid/os/ParcelFileDescriptor;
    ...
    :catch_0
    const-string/jumbo p0, "setMediaRecorderOutput: Failed to open file descriptor for "
    ...
    :cond_7
    const-string/jumbo v2, "setMediaRecorderOutput: "

    invoke-static {v2, p2}, Landroidx/appcompat/widget/d;->d(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
