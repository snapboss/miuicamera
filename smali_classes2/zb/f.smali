...
.method public constructor <init>(Lzb/f;Llb/c;Lvb/g;Llb/m;Ljava/lang/Boolean;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public final h(Ldb/e;Llb/a0;Ljava/lang/Object;)V
    ...
    :cond_1
    invoke-virtual {p0, p3, p1, p2}, Lzb/f;->v(Ljava/util/List;Ldb/e;Llb/a0;)V
...
.method public final q(Lvb/g;)Lyb/h;
    ...
    invoke-direct/range {v0 .. v5}, Lzb/f;-><init>(Lzb/f;Llb/c;Lvb/g;Llb/m;Ljava/lang/Boolean;)V
...
.method public final v(Ljava/util/List;Ldb/e;Llb/a0;)V
    .locals 9
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-virtual {v3, p2, p3, v4}, Llb/m;->h(Ldb/e;Llb/a0;Ljava/lang/Object;)V

    goto :goto_1

    :cond_2
    invoke-virtual {v3, v4, p2, p3, v2}, Llb/m;->i(Ljava/lang/Object;Ldb/e;Llb/a0;Lvb/g;)V
    :try_end_0
    ...
    :goto_2
    invoke-static {p3, p0, p1, v1}, Lac/r0;->o(Llb/a0;Ljava/lang/Exception;Ljava/lang/Object;I)V
    ...
    :cond_4
    iget-object v3, p0, Lac/b;->c:Llb/h;
    ...
    invoke-virtual {v3}, Llb/h;->u()Z

    move-result v8

    if-eqz v8, :cond_7

    invoke-virtual {p3, v3, v7}, Llb/d;->e(Llb/h;Ljava/lang/Class;)Llb/h;
    ...
    :cond_b
    :try_start_2
    iget-object v4, p0, Lac/b;->i:Lzb/l;
    ...
    invoke-virtual {v4, v6}, Lzb/l;->c(Ljava/lang/Class;)Llb/m;
    ...
    invoke-virtual {p3, v3, v6}, Llb/d;->e(Llb/h;Ljava/lang/Class;)Llb/h;

    move-result-object v6

    invoke-virtual {p0, v4, v6, p3}, Lac/b;->s(Lzb/l;Llb/h;Llb/a0;)Llb/m;
    ...
    :cond_d
    invoke-virtual {p0, v4, v6, p3}, Lac/b;->r(Lzb/l;Ljava/lang/Class;Llb/a0;)Llb/m;
    ...
    :cond_e
    invoke-virtual {v7, p2, p3, v5}, Llb/m;->h(Ldb/e;Llb/a0;Ljava/lang/Object;)V
    :try_end_2
