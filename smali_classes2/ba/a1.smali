...
# direct methods
.method public constructor <init>(Lba/o0;IZ)V
    .locals 1
    ...
    iput-boolean v0, p0, Lba/a1;->y:Z

    iput p1, p0, Lba/a1;->B:I

    iput-boolean p1, p0, Lba/a1;->C:Z

    iput p2, p0, Lba/a1;->z:I

    iput-boolean p3, p0, Lba/a1;->x:Z
...
.method public final j(Landroid/media/Image;I)V
    ...
    :cond_0
    iget-object v0, p0, Lba/a1;->w:Landroid/hardware/camera2/TotalCaptureResult;

    invoke-interface {p2, p1, v0}, Lba/a$k;->onPictureTakenImageConsumed(Landroid/media/Image;Landroid/hardware/camera2/TotalCaptureResult;)Z
    ...
    :cond_1
    iget p2, p0, Lba/a1;->B:I

    const/4 v0, 0x1

    add-int/2addr p2, v0

    iput p2, p0, Lba/a1;->B:I
    ...
    iget-object p1, p0, Lba/a1;->w:Landroid/hardware/camera2/TotalCaptureResult;

    iget-object v1, p0, Lba/y0;->g:Lba/a$k;
    ...
    invoke-interface {v1, p2, p1}, Lba/a$k;->onPictureTaken([BLandroid/hardware/camera2/CaptureResult;)V
    ...
    :goto_0
    iget-boolean p1, p0, Lba/a1;->C:Z

    if-eqz p1, :cond_3

    iget p1, p0, Lba/a1;->B:I

    iget p2, p0, Lba/a1;->A:I

    if-ne p1, p2, :cond_3

    iget p1, p0, Lba/a1;->v:I

    invoke-virtual {p0, p1, v0}, Lba/a1;->p(IZ)V
...
.method public final m()V
    ...
    invoke-virtual {v2}, Lgc/b;->k1()Z

    move-result v3

    iget v4, p0, Lba/a1;->z:I

    if-eqz v3, :cond_0

    if-lez v4, :cond_0

    iget v3, p0, Lba/a1;->A:I
    ...
    :try_start_0
    new-instance v3, Lba/z0;

    invoke-direct {v3, p0}, Lba/z0;-><init>(Lba/a1;)V

    invoke-virtual {p0}, Lba/a1;->o()Landroid/hardware/camera2/CaptureRequest$Builder;
    ...
    iget-object v8, p0, Lba/y0;->c:Landroid/os/Handler;
    ...
    iget v11, p0, Lba/a1;->A:I

    add-int/2addr v11, v2

    iput v11, p0, Lba/a1;->A:I

    iput v10, p0, Lba/a1;->u:I

    if-ne v11, v4, :cond_3

    iput v10, p0, Lba/a1;->v:I
...
.method public final o()Landroid/hardware/camera2/CaptureRequest$Builder;
    ...
    invoke-static {v2, v6}, Lcom/android/camera2/compat/MiCameraCompat;->applyCShotFeatureCapture(Landroid/hardware/camera2/CaptureRequest$Builder;Z)V

    invoke-static {v2, v6}, Lcom/android/camera2/compat/MiCameraCompat;->applyNotificationTrigger(Landroid/hardware/camera2/CaptureRequest$Builder;Z)V
    ...
    invoke-virtual {v2, v5, v7}, Landroid/hardware/camera2/CaptureRequest$Builder;->set(Landroid/hardware/camera2/CaptureRequest$Key;Ljava/lang/Object;)V
    ...
    invoke-static {v2, v6}, Lcom/android/camera2/compat/MiCameraCompat;->applyPanoramaP2SEnabled(Landroid/hardware/camera2/CaptureRequest$Builder;Z)V

    goto :goto_0

    :cond_2
    sget-boolean v7, Lgc/c;->k:Z
    ...
    invoke-virtual {v2, v7, v5}, Landroid/hardware/camera2/CaptureRequest$Builder;->set(Landroid/hardware/camera2/CaptureRequest$Key;Ljava/lang/Object;)V
    ...
    iget-object v5, v5, Lba/w1;->a:Landroid/media/ImageReader;
    ...
    invoke-virtual {v0, v2, p0}, Lba/a;->c(Landroid/hardware/camera2/CaptureRequest$Builder;I)V
    ...
    invoke-static {v2, v4}, Lcom/android/camera2/compat/MiCameraCompat;->applyZsl(Landroid/hardware/camera2/CaptureRequest$Builder;Z)V
    ...
    invoke-static {p0}, Lba/d;->N1(Lba/c;)Z

    move-result p0

    if-eqz p0, :cond_6

    invoke-static {v2, v6}, Lcom/android/camera2/compat/MiCameraCompat;->applyBurstHint(Landroid/hardware/camera2/CaptureRequest$Builder;I)V
    ...
    invoke-static {p0}, Lba/d;->f3(Lba/c;)Z
    ...
    invoke-virtual {p0}, Lꢯꢣꢡ꣢ꢡꢥ꣢ꢨꢩꢺꢥꢯꢩ꣢ꢯꢣꢡꢡꢣꢢ꣢ꢏꢣꢡꢡꢣꢢ;->G()I

    move-result p0

    invoke-static {v2, p0}, Lcom/android/camera2/compat/MiCameraCompat;->applySprdCaptureMode(Landroid/hardware/camera2/CaptureRequest$Builder;I)V
...
.method public final p(IZ)V
    ...
    invoke-virtual {v0, v2}, Lba/a;->d(Z)V
    ...
    invoke-interface {p1, p2, v3, v4, v2}, Lba/a$k;->onPictureTakenFinished(ZJI)V
    ...
    :goto_0
    invoke-virtual {v0, p0, p2}, Lba/a;->w0(Lba/y0;Z)V
