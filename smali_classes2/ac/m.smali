...
# direct methods
.method public constructor <init>(Lcc/l;Ljava/lang/Boolean;)V
    .locals 2

    iget-object v0, p1, Lcc/l;->a:Ljava/lang/Class;

    const/4 v1, 0x0

    invoke-direct {p0, v0, v1}, Lac/q0;-><init>(Ljava/lang/Class;I)V

    iput-object p1, p0, Lac/m;->c:Lcc/l;

    iput-object p2, p0, Lac/m;->d:Ljava/lang/Boolean;

    return-void
.end method

.method public static q(Ljava/lang/Class;Lcb/k$d;ZLjava/lang/Boolean;)Ljava/lang/Boolean;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    sget-object v0, Lcb/k$c;->c:Lcb/k$c;
    ...
    :cond_2
    sget-object p3, Lcb/k$c;->i:Lcb/k$c;

    if-eq p1, p3, :cond_7

    sget-object p3, Lcb/k$c;->b:Lcb/k$c;
    ...
    sget-object p3, Lcb/k$c;->d:Lcb/k$c;
...
.method public final c(Llb/a0;Llb/c;)Llb/m;
    ...
    iget-object v1, p0, Lac/m;->d:Ljava/lang/Boolean;

    invoke-static {v0, p1, p2, v1}, Lac/m;->q(Ljava/lang/Class;Lcb/k$d;ZLjava/lang/Boolean;)Ljava/lang/Boolean;
    ...
    iget-object p0, p0, Lac/m;->c:Lcc/l;

    invoke-direct {p2, p0, p1}, Lac/m;-><init>(Lcc/l;Ljava/lang/Boolean;)V
...
.method public final h(Ldb/e;Llb/a0;Ljava/lang/Object;)V
    ...
    iget-object v0, p0, Lac/m;->d:Ljava/lang/Boolean;
