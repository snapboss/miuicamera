...
.method public constructor <init>(Lqa/g;ILv2/f;Landroid/content/Context;)V
    .locals 0
    ...
    iput-object p3, p0, Lcom/android/camera2/compat/theme/custom/cv/filter/CvStyleFilterRender;->mFilter:Lv2/f;
...
.method private updateVertexData(Landroid/graphics/Rect;)V
    ...
    iget-object v3, p0, Lcom/android/camera/effect/renders/s;->mVertexBuffer:Ljava/nio/FloatBuffer;
    ...
    iget-object v4, p0, Lcom/android/camera/effect/renders/s;->mTexCoorBuffer:Ljava/nio/FloatBuffer;
...
.method public destroy()V
    ...
    const-string/jumbo v1, "releaseFilter hash: "
...
.method public draw(Lp2/b;)Z
    ...
    :cond_0
    iget-object v0, p0, Lcom/android/camera2/compat/theme/custom/cv/filter/CvStyleFilterRender;->mFilter:Lv2/f;
    ...
    sget-object v1, Ltf/b;->a:Landroid/content/Context;
    ...
    invoke-virtual {p0, v0, p1, v1}, Lcom/android/camera2/compat/theme/custom/cv/filter/CvStyleFilterRender;->drawTexture(Lqa/b;Landroid/graphics/Rect;Landroid/content/Context;)V
...
.method public drawTexture(ILandroid/graphics/Rect;Landroid/content/Context;)V
    ...
    .line 13
    invoke-virtual {p0, v0}, Lcom/android/camera/effect/renders/s;->setBlendEnabled(Z)V
    ...
    .line 16
    iget-object p2, p0, Lcom/android/camera/effect/renders/s;->mVertexBuffer:Ljava/nio/FloatBuffer;
    ...
    .line 17
    iget-object p0, p0, Lcom/android/camera2/compat/theme/custom/cv/filter/CvStyleFilterRender;->mFilter:Lv2/f;

    invoke-virtual {p0, p1, p2, v0, p3}, Lv2/f;->b(ILjava/nio/FloatBuffer;Ljava/nio/FloatBuffer;Landroid/content/Context;)V

    :cond_1
    return-void
.end method

.method public drawTexture(Lqa/b;Landroid/graphics/Rect;Landroid/content/Context;)V
    .locals 1
    ...
    iget-object p2, p0, Lcom/android/camera/effect/renders/s;->mTexCoorBuffer:Ljava/nio/FloatBuffer;

    if-eqz p2, :cond_3

    .line 9
    iget-object p2, p0, Lcom/android/camera2/compat/theme/custom/cv/filter/CvStyleFilterRender;->mFilter:Lv2/f;
    ...
    invoke-virtual {p2, p1, v0, p0, p3}, Lv2/f;->b(ILjava/nio/FloatBuffer;Ljava/nio/FloatBuffer;Landroid/content/Context;)V
...
.method public initFilter(Landroid/content/Context;)V
    ...
    iget-boolean v1, v0, Lv2/f;->h:Z

    if-nez v1, :cond_0

    invoke-virtual {v0, p1}, Lv2/f;->a(Landroid/content/Context;)V
