...
.method public final handleMessage(Landroid/os/Message;)V
    ...
    iget-object v1, v1, Lcom/android/camera/ui/FocusView;->k0:Lcom/android/camera/ui/v;
    ...
    iget-object v1, v0, Lcom/android/camera/ui/FocusView;->k0:Lcom/android/camera/ui/v;
    ...
    invoke-direct {v1, v0, v2}, Ld4/d;-><init>(Ljava/lang/Object;I)V
    ...
    invoke-virtual {p1}, Lcom/android/camera/ui/FocusView;->n()Z
    ...
    invoke-virtual {p1, p0, v3}, Lx8/q;->o(Landroid/graphics/drawable/Drawable;Z)V

    iget-object p1, p0, Lx8/i;->g:Lx8/v;

    invoke-virtual {p1, p0, v3}, Lx8/v;->o(Landroid/graphics/drawable/Drawable;Z)V
    ...
    iget-wide v4, p1, Lcom/android/camera/ui/FocusView;->q0:J
    ...
    iput v0, p1, Lcom/android/camera/ui/FocusView;->h0:F
    ...
    iput-wide p0, v0, Lcom/android/camera/ui/FocusView;->p0:J

    iget-object p0, v0, Lcom/android/camera/ui/FocusView;->r0:Lcom/android/camera/ui/p;

    if-eqz p0, :cond_7

    invoke-interface {p0}, Lcom/android/camera/ui/p;->isShowAeAfLockIndicator()Z

    move-result p0

    iget-object p1, v0, Lcom/android/camera/ui/FocusView;->w0:Lx8/z;
    ...
    invoke-interface {p0}, Lcom/android/camera/ui/p;->isShowCaptureButton()Z
    ...
    invoke-interface {p0}, Lcom/android/camera/ui/p;->isSupportTapShoot()Z
    ...
    :pswitch_5
    iget-boolean p1, v0, Lcom/android/camera/ui/FocusView;->q:Z

    if-eqz p1, :cond_5

    iget-object p1, p0, Lcom/android/camera/ui/FocusView$a;->a:Lcom/android/camera/ui/FocusView;

    iget-boolean v0, p1, Lcom/android/camera/ui/FocusView;->i0:Z
    ...
    invoke-virtual {v0}, Lcom/android/camera/ui/FocusView;->u()V
