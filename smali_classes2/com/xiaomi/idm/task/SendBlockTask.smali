...
.field private final dispatcher:Lop/r;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Lop/r<",
...
.field private final taskMap:Lst/c;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Lst/c<",
            "Ljava/lang/String;",
...
.method public constructor <init>([BLcom/xiaomi/idm/internal/Connection;Lop/r;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "([B",
    ...
    iput-object p3, p0, Lcom/xiaomi/idm/task/SendBlockTask;->dispatcher:Lop/r;
    ...
    iput-wide p2, p1, Lst/c$e;->d:J

    const-string/jumbo p2, "timeUnit"

    invoke-static {v0, p2}, Lbq/l;->n(Ljava/lang/Object;Ljava/lang/String;)V
    ...
    iput-object p2, p0, Lcom/xiaomi/idm/task/SendBlockTask;->taskMap:Lst/c;
...
.method private final recordTimeConsumed()V
    ...
    const-string/jumbo v1, "recordTimeConsumed: blockId="
...
.method public setDone([B)Lcom/xiaomi/idm/task/CallFuture;
    ...
    const-string/jumbo v1, "sendBlock success:\tblockId="
    ...
    const-string/jumbo p1, "super.setDone(response)"
...
.method public final setDoneSubTask(Ljava/lang/String;)V
    ...
    iget-object v0, p0, Lcom/xiaomi/idm/task/SendBlockTask;->taskMap:Lst/c;

    invoke-virtual {v0, p1}, Lst/c;->remove(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    :cond_0
    const-string/jumbo v0, "setDone: could not find the task="
...
.method public setFailed(Ljava/lang/Throwable;)Lcom/xiaomi/idm/task/CallFuture;
    ...
    const-string/jumbo v1, "sendBlock failed:\tblockId="
    ...
    const-string/jumbo p1, "super.setFailed(e)"
...
.method public final setFailedSubTask(Ljava/lang/String;Lcom/xiaomi/idm/exception/IDMException;)V
    ...
    :cond_0
    const-string/jumbo p2, "setFailed: could not find the task="

    const-string v0, " in block="

    invoke-static {p2, p1, v0}, Landroidx/activity/result/d;->e(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/StringBuilder;
...
.method public final start()V
    ...
    const-string/jumbo v1, "run: \tblockId="
...
.method public final declared-synchronized tryArrangeNextTask()V
    ...
    invoke-virtual {v0}, Lst/c;->size()I
    ...
    invoke-static {v1, v3, v2}, Ldp/i;->v([BII)[B
    ...
    iget-object v4, p0, Lcom/xiaomi/idm/task/SendBlockTask;->taskMap:Lst/c;

    const-string/jumbo v5, "taskMap"
    ...
    iget-object v0, p0, Lcom/xiaomi/idm/task/SendBlockTask;->dispatcher:Lop/r;
    ...
    invoke-interface {v0, p0, v1, v3, v2}, Lop/r;->invoke(Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
