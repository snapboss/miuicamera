...
.method public constructor <init>(Ljava/lang/ref/WeakReference;)V
    ...
    iput-object p1, p0, Lg8/f;->a:Ljava/lang/ref/WeakReference;
...
.method public final a(Ljava/lang/Object;)V
    ...
    invoke-virtual {v3}, Lpa/i$a;->toString()Ljava/lang/String;
    ...
    :cond_0
    sget-object v6, Lg8/c;->a:Ljava/util/ArrayList;
    ...
    iget v9, v8, Lg8/d;->a:I

    if-ne v9, v4, :cond_1

    int-to-float v4, v5

    iget v6, v8, Lg8/d;->b:F
    ...
    :cond_4
    new-array v4, v7, [Lpa/i$a;

    aput-object v3, v4, v1

    iget-object v3, p0, Lg8/f;->a:Ljava/lang/ref/WeakReference;
    ...
    instance-of v6, v3, Lcom/android/camera/module/LongExposureModule;
    ...
    invoke-virtual {v6, v4}, Lcom/android/camera/module/Camera2Module;->setAsdScenes([Lpa/i$a;)V

    new-array v4, v7, [I

    aput v8, v4, v1

    invoke-virtual {v6, v4}, Lcom/android/camera/module/BaseModule;->updatePreferenceInWorkThread([I)V
    ...
    invoke-virtual {v6, v4}, Lcom/android/camera/module/AmbilightModule;->setAsdScenes([Lpa/i$a;)V
    ...
    iget-object v4, v3, Lcom/android/camera/module/VideoBase;->mUserRecordSetting:Lcom/android/camera/module/video/b0;

    invoke-virtual {v3}, Lcom/android/camera/module/BaseModule;->getActualCameraId()I

    move-result v6

    invoke-virtual {v4, v6}, Lcom/android/camera/module/video/b0;->h(I)Z
