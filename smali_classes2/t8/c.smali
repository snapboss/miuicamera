...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v0, p0, Lt8/c;->m:Landroid/graphics/Rect;
    ...
    iput p1, p0, Lt8/c;->k:I

    new-instance p1, Landroid/graphics/Paint;

    invoke-direct {p1}, Landroid/graphics/Paint;-><init>()V

    iput-object p1, p0, Lt8/c;->f:Landroid/graphics/Paint;
    ...
    iput-object p1, p0, Lt8/c;->g:Landroid/graphics/Paint;
    ...
    iput-object v2, p0, Lt8/c;->h:Landroid/graphics/Paint;
...
.method public final b(Landroid/graphics/Canvas;Landroid/graphics/Rect;Landroid/graphics/Paint;F)V
    ...
    iget v1, v0, Lt8/c;->c:I

    int-to-float v2, v1

    iget v3, v0, Lt8/c;->d:I
    ...
    iget v8, v0, Lt8/c;->a:I

    const/high16 v9, 0x3f800000    # 1.0f

    iget v10, v0, Lt8/c;->e:I
    ...
    :goto_4
    iget-object v3, v0, Lt8/c;->m:Landroid/graphics/Rect;

    move-object/from16 v5, p2

    invoke-virtual {v3, v5}, Landroid/graphics/Rect;->set(Landroid/graphics/Rect;)V

    iget v5, v0, Lt8/c;->n:I

    invoke-virtual {v3, v5, v5}, Landroid/graphics/Rect;->inset(II)V

    iget-object v13, v0, Lt8/c;->f:Landroid/graphics/Paint;

    invoke-virtual {v13, v4}, Landroid/graphics/Paint;->setStrokeWidth(F)V

    iget-object v9, v0, Lt8/c;->m:Landroid/graphics/Rect;

    move-object v8, p1

    move v12, v7

    invoke-static/range {v8 .. v13}, Lt8/c;->a(Landroid/graphics/Canvas;Landroid/graphics/Rect;FFFLandroid/graphics/Paint;)V
...
.method public final draw(Landroid/graphics/Canvas;)V
    ...
    iget-object v0, p0, Lt8/c;->l:Landroid/graphics/Rect;

    iget-object v1, p0, Lt8/c;->h:Landroid/graphics/Paint;

    iget v2, p0, Lt8/c;->k:I

    int-to-float v2, v2

    invoke-virtual {p0, p1, v0, v1, v2}, Lt8/c;->b(Landroid/graphics/Canvas;Landroid/graphics/Rect;Landroid/graphics/Paint;F)V
    ...
    iget-object v1, p0, Lt8/c;->g:Landroid/graphics/Paint;

    iget v2, p0, Lt8/c;->j:I
