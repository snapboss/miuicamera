...
.method public constructor <init>(Lng/t;)V
    ...
    iput-object p1, p0, Lng/t$a;->a:Lng/t;
...
.method public final onSessionCallback(ILjava/lang/String;Ljava/lang/Object;)V
    ...
    iget-object p0, p0, Lng/t$a;->a:Lng/t;
    ...
    sget p3, Lcom/android/camera/b$b;->g:I
    ...
    iget-object v0, p3, Lng/t;->j:Ljava/lang/Object;

    monitor-enter v0

    :try_start_0
    iget-object v3, p3, Lng/t;->b:Lng/n;

    if-eqz v3, :cond_2

    invoke-virtual {v3, p1, p2}, Lng/n;->q(J)Z
    ...
    :cond_2
    iget-object p3, p3, Lng/t;->c:Ljava/util/HashMap;
    ...
    invoke-virtual {v4, p1, p2}, Lng/n;->q(J)Z
    ...
    invoke-interface {p0, p1, p3}, Lng/l;->a(ILjava/lang/Object;)V
    ...
    iget-object p1, p0, Lng/t$a;->a:Lng/t;
    ...
    sget p1, Lcom/android/camera/b$b;->g:I
    ...
    iget-object p3, p1, Lng/t;->j:Ljava/lang/Object;

    monitor-enter p3

    :try_start_2
    iget-object v0, p1, Lng/t;->b:Lng/n;

    iget-object v1, p1, Lng/t;->c:Ljava/util/HashMap;
    ...
    invoke-virtual {v3}, Lng/n;->p()Ljava/util/ArrayList;
    ...
    invoke-virtual {v0}, Lng/n;->p()Ljava/util/ArrayList;
    ...
    :cond_9
    iget-object v0, p1, Lng/t;->c:Ljava/util/HashMap;
    ...
    iget-object p3, p1, Lng/t;->g:Landroid/os/Handler;

    new-instance v0, Ld/a;

    const/16 v1, 0xb

    invoke-direct {v0, v1, p1, p2}, Ld/a;-><init>(ILjava/lang/Object;Ljava/lang/Object;)V
    ...
    iget-object p0, p0, Lng/t;->C:Lng/t$e;
    ...
    const-string/jumbo p0, "unexpected meta type: "
    ...
    invoke-virtual {p0, p1, p2}, Lng/t$e;->a(J)Lng/q;

    move-result-object p0

    if-nez p0, :cond_d

    const-string/jumbo p0, "processAlgorithmMeta: no parallelTaskData with timestamp "
    ...
    const-string/jumbo p0, "processAlgorithmMeta: null ParallelTaskDataParameter with timestamp "
    ...
    :cond_e
    iget-object p1, p0, Lng/r;->G:Lyf/f;
    ...
    const-string/jumbo p3, "processAlgorithmMeta: "
    ...
    iput-object p2, p1, Lyf/f;->A:Ljava/lang/String;
    ...
    invoke-virtual {p0, v5, v6}, Lng/t$e;->a(J)Lng/q;
    ...
    iget-object v8, p0, Lng/t;->r:Ljava/util/Map;
    ...
    iput-object v8, p0, Lng/t;->r:Ljava/util/Map;
    ...
    iget-object v1, p0, Lng/t;->s:Ljava/util/Map;
    ...
    iget-object v2, p0, Lng/t;->r:Ljava/util/Map;
    ...
    iget v3, p3, Lng/q;->R:I

    iget v4, p3, Lng/q;->S:I

    iget-object v8, p3, Lng/q;->T:Landroid/graphics/Rect;

    iget p3, p3, Lng/q;->U:F

    invoke-static {v2, v3, v4, v8, p3}, Lng/t;->c(Landroid/graphics/Rect;IILandroid/graphics/Rect;F)V
    ...
    :try_start_5
    iget-object p3, p0, Lng/t;->D:Lng/t$f;
    ...
    invoke-virtual {p3, p2, p1}, Lng/t$f;->onError(Ljava/lang/String;Ljava/lang/String;)V
    :try_end_5
    .catchall {:try_start_5 .. :try_end_5} :catchall_2

    :goto_a
    iget-object p1, p0, Lng/t;->s:Ljava/util/Map;
    ...
    iget-object p0, p0, Lng/t;->r:Ljava/util/Map;
    ...
    :goto_b
    iget-object p2, p0, Lng/t;->s:Ljava/util/Map;
    ...
    :cond_18
    const-string/jumbo p0, "reprocessData not ready, should wait"
