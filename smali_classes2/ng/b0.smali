...
.method public final C(Lyf/h;)V
    ...
    const-string/jumbo v4, "processImage: dataBeans size = "
    ...
    iget-boolean v1, v1, Lyf/b$a;->i:Z
    ...
    iget-object v5, v4, Lyf/b$a;->d:Landroid/media/Image;

    invoke-static {v5}, Lng/n;->m(Landroid/media/Image;)Z
    ...
    const-string/jumbo v6, "processImage: invalid image: "
    ...
    :cond_2
    iget-object v6, v4, Lyf/b$a;->c:Lcom/xiaomi/protocol/ICustomCaptureResult;

    if-nez v1, :cond_3

    iget v7, p1, Lyf/h;->d:I

    invoke-virtual {p0, v6, v5, v3, v7}, Lng/b0;->K(Lcom/xiaomi/protocol/ICustomCaptureResult;Landroid/media/Image;II)V
    ...
    iget-object v8, v4, Lyf/b$a;->c:Lcom/xiaomi/protocol/ICustomCaptureResult;

    invoke-virtual {v8}, Lcom/xiaomi/protocol/ICustomCaptureResult;->getRequest()Landroid/hardware/camera2/CaptureRequest;

    move-result-object v8

    sget-object v9, Loa/x;->u:Loa/w;

    const v10, 0xbabe

    invoke-static {v8, v9, v10}, Loa/b0;->k(Landroid/hardware/camera2/CaptureRequest;Loa/w;I)Ljava/lang/Object;
    ...
    const-string/jumbo v10, "processImage: ev = "
    ...
    :goto_2
    iget v8, p1, Lyf/h;->d:I

    invoke-virtual {p0, v6, v5, v7, v8}, Lng/b0;->K(Lcom/xiaomi/protocol/ICustomCaptureResult;Landroid/media/Image;II)V

    :goto_3
    iget-object v4, v4, Lyf/b$a;->e:Landroid/media/Image;

    iget-object v5, p0, Lng/n;->j:Lng/n$a;

    invoke-static {v4, v5}, Lng/b;->E(Landroid/media/Image;Lng/n$a;)V
...
.method public final K(Lcom/xiaomi/protocol/ICustomCaptureResult;Landroid/media/Image;II)V
    ...
    const-string/jumbo v2, "processCaptureResult: cameraMetadataNative = "
    ...
    const-string/jumbo v2, "processCaptureResult: image = "
    ...
    const-string/jumbo v4, "processCaptureResult: timestamp = "

    invoke-static {v0, v1, v2, v4}, Landroidx/appcompat/view/menu/b;->i(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;Ljava/lang/String;)Ljava/lang/StringBuilder;
    ...
    :cond_0
    new-instance p1, Lng/b0$a;

    invoke-direct {p1, p0}, Lng/b0$a;-><init>(Lng/b0;)V
    ...
    :cond_2
    new-instance p1, Lng/b0$b;

    invoke-direct {p1}, Lng/b0$b;-><init>()V
...
.method public final b(Lcom/xiaomi/engine/BufferFormat;)Ljava/util/ArrayList;
    ...
    iget-object v1, p0, Lng/b;->w:Landroid/media/ImageReader;

    new-instance v2, Lng/y;

    invoke-direct {v2, p0}, Lng/y;-><init>(Lng/b0;)V
    ...
    new-instance v2, Lng/z;

    invoke-direct {v2, p0}, Lng/z;-><init>(Lng/b0;)V
    ...
    invoke-direct {v1, p0}, Lng/a0;-><init>(Lng/b0;)V
...
.method public final l()Z
    ...
    iget-object v3, p0, Lng/n;->b:Ljava/util/concurrent/atomic/AtomicInteger;

    const/4 v4, 0x0

    iget-boolean v5, p0, Lng/n;->m:Z
    ...
    invoke-virtual {v5, p0}, Lng/t$e;->b(Lng/n;)Z
