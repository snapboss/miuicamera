...
# direct methods
.method public constructor <init>(Lng/t$e;Lcom/xiaomi/engine/BufferFormat;)V
    .locals 2

    invoke-direct {p0, p1, p2}, Lng/n;-><init>(Lng/t$e;Lcom/xiaomi/engine/BufferFormat;)V
    ...
    iput-object p1, p0, Lng/b;->r:Ljava/util/concurrent/atomic/AtomicInteger;

    new-instance p1, Ljava/lang/Object;

    invoke-direct {p1}, Ljava/lang/Object;-><init>()V

    iput-object p1, p0, Lng/b;->A:Ljava/lang/Object;

    new-instance p1, Landroid/util/LongSparseArray;

    invoke-direct {p1}, Landroid/util/LongSparseArray;-><init>()V

    iput-object p1, p0, Lng/b;->B:Landroid/util/LongSparseArray;
    ...
    iget-object v1, p0, Lng/n;->l:Ljava/lang/String;
    ...
    iput-object p1, p0, Lng/b;->s:Landroid/os/HandlerThread;
    ...
    iget-object p0, p0, Lng/n;->l:Ljava/lang/String;
...
.method public static E(Landroid/media/Image;Lng/n$a;)V
    .locals 0
    ...
    check-cast p1, Lng/t$e;

    invoke-virtual {p1, p0}, Lng/t$e;->e(Landroid/media/Image;)V
...
.method public final A(JZ)V
    ...
    iget-object v0, p0, Lng/b;->A:Ljava/lang/Object;
    ...
    :try_start_0
    iget-object p0, p0, Lng/b;->v:Lyf/j;

    if-eqz p0, :cond_0

    iget-object p0, p0, Lyf/j;->a:Lcom/xiaomi/engine/TaskSession;
    ...
    :cond_1
    iget-object p0, p0, Lng/b;->u:Lcom/xiaomi/engine/TaskSession;
...
.method public final B(J)V
    ...
    iget-object v2, p0, Lng/b;->r:Ljava/util/concurrent/atomic/AtomicInteger;

    invoke-virtual {v2}, Ljava/util/concurrent/atomic/AtomicInteger;->getAndDecrement()I

    invoke-virtual {p0}, Lng/b;->G()V

    iget-object v2, p0, Lng/n;->n:Ljava/lang/Object;
    ...
    iget-object v1, p0, Lng/b;->B:Landroid/util/LongSparseArray;

    invoke-virtual {v1, p1, p2}, Landroid/util/LongSparseArray;->remove(J)V

    iget-object p1, p0, Lng/n;->o:Ljava/util/LinkedList;
...
.method public abstract C(Lyf/h;)V
.end method
...
.method public final D(Lyf/b$a;)V
    ...
    const-string/jumbo v1, "releaseCaptureDataBean: "
    ...
    iget-object v0, p1, Lyf/b$a;->d:Landroid/media/Image;

    iget-object v1, p0, Lng/n;->j:Lng/n$a;

    invoke-static {v0, v1}, Lng/b;->E(Landroid/media/Image;Lng/n$a;)V

    iget-object v0, p1, Lyf/b$a;->e:Landroid/media/Image;

    iget-object v1, p0, Lng/n;->j:Lng/n$a;

    invoke-static {v0, v1}, Lng/b;->E(Landroid/media/Image;Lng/n$a;)V

    iget-object p1, p1, Lyf/b$a;->g:Landroid/media/Image;

    iget-object p0, p0, Lng/n;->j:Lng/n$a;

    invoke-static {p1, p0}, Lng/b;->E(Landroid/media/Image;Lng/n$a;)V
...
.method public final F(Lyf/i;)V
    ...
    iget-object p1, p1, Lyf/i;->c:Ljava/util/ArrayList;
    ...
    iget-object v0, v0, Lyf/h;->a:Ljava/util/List;
    ...
    invoke-virtual {p0, v1}, Lng/b;->D(Lyf/b$a;)V
...
.method public final G()V
    ...
    iget-object v0, p0, Lng/n;->g:Ljava/lang/Object;

    monitor-enter v0

    :try_start_0
    iget-object v1, p0, Lng/n;->i:Lng/n$b;

    if-eqz v1, :cond_1

    invoke-virtual {p0}, Lng/n;->n()Z
    ...
    iget-object p0, p0, Lng/n;->i:Lng/n$b;
    ...
    const-string/jumbo v1, "sendCheckTimeoutTaskMessage: worker thread is dead"
...
.method public final H()V
    ...
    const-string/jumbo v1, "sendProcessImageMessage"
    ...
    const-string/jumbo v4, "sendProcessImageMessage: failed. %s has died!"

    new-array v3, v3, [Ljava/lang/Object;

    iget-object p0, p0, Lng/n;->h:Landroid/os/HandlerThread;
...
.method public final I(Lcom/xiaomi/engine/TaskSession;)V
    ...
    const-string/jumbo v0, "setTaskSession: "

    iget-object v1, p0, Lng/b;->A:Ljava/lang/Object;
    ...
    iput-object p1, p0, Lng/b;->u:Lcom/xiaomi/engine/TaskSession;

    monitor-exit v1
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_1

    iget-object p1, p0, Lng/n;->h:Landroid/os/HandlerThread;
    ...
    iget-object p1, p0, Lng/n;->n:Ljava/lang/Object;

    monitor-enter p1

    :try_start_1
    iget-object v0, p0, Lng/n;->o:Ljava/util/LinkedList;
    ...
    const-string/jumbo p1, "setTaskSession: worker thread has died"
...
.method public final J()V
    ...
    const-string/jumbo v3, "startWork: E"

    invoke-static {v2, v3, v1}, Lcom/android/camera/log/Log;->i(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V

    iget-object v1, p0, Lng/n;->h:Landroid/os/HandlerThread;
    ...
    iget-object v1, p0, Lng/n;->g:Ljava/lang/Object;

    monitor-enter v1

    :try_start_0
    new-instance v3, Lng/n$b;

    iget-object v4, p0, Lng/n;->h:Landroid/os/HandlerThread;

    invoke-virtual {v4}, Landroid/os/HandlerThread;->getLooper()Landroid/os/Looper;

    move-result-object v4

    invoke-direct {v3, v4, p0}, Lng/n$b;-><init>(Landroid/os/Looper;Lng/b;)V

    iput-object v3, p0, Lng/n;->i:Lng/n$b;
    ...
    iget-object v3, p0, Lng/n;->p:Ljava/lang/Object;
    ...
    :try_start_1
    iput v1, p0, Lng/n;->q:I

    monitor-exit v3
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0

    iget-object v3, p0, Lng/b;->s:Landroid/os/HandlerThread;
    ...
    iput-object v4, p0, Lng/b;->t:Landroid/os/Handler;
    ...
    const-string/jumbo p0, "startWork: X. %s started"
...
.method public final a(J)V
    ...
    iget-object v1, p0, Lng/n;->n:Ljava/lang/Object;

    monitor-enter v1

    :try_start_0
    iget-object v2, p0, Lng/b;->B:Landroid/util/LongSparseArray;
    ...
    iget-object v6, p0, Lng/b;->B:Landroid/util/LongSparseArray;
    ...
    iget-wide v7, v6, Lyf/i;->b:J

    sub-long v7, p1, v7

    sget-boolean v9, Lva/c;->h:Z
    ...
    iget-object v5, p0, Lng/b;->B:Landroid/util/LongSparseArray;

    invoke-virtual {v5, v2}, Landroid/util/LongSparseArray;->removeAt(I)V

    const-string v5, "BaseImageProcessor"

    const-string/jumbo v7, "task %d is timeout. cost: %dms"

    const/4 v8, 0x2

    new-array v8, v8, [Ljava/lang/Object;

    iget-wide v9, v6, Lyf/i;->a:J
    ...
    invoke-virtual {p0, p2, v0}, Lng/b;->z(Lyf/i;Ljava/lang/String;)V
...
.method public final c(Lcom/xiaomi/engine/BufferFormat;)Ljava/util/ArrayList;
    ...
    iget-object p1, p0, Lng/b;->z:Landroid/media/ImageReader;

    new-instance v1, Lng/a;

    invoke-direct {v1, p0}, Lng/a;-><init>(Lng/b;)V

    iget-object v2, p0, Lng/b;->t:Landroid/os/Handler;
    ...
    iget-object p0, p0, Lng/b;->z:Landroid/media/ImageReader;
...
.method public final e(Lyf/h;)I
    ...
    iget-object v0, p0, Lng/n;->n:Ljava/lang/Object;

    monitor-enter v0

    :try_start_0
    iget-object v1, p0, Lng/n;->o:Ljava/util/LinkedList;
    ...
    iput-boolean v2, p0, Lng/n;->f:Z

    iget-object v3, p0, Lng/b;->A:Ljava/lang/Object;

    monitor-enter v3

    :try_start_1
    iget-object v0, p0, Lng/b;->u:Lcom/xiaomi/engine/TaskSession;
    ...
    :cond_1
    iget-boolean v0, p1, Lyf/h;->e:Z

    if-eqz v0, :cond_2

    iget-boolean p1, p1, Lyf/h;->b:Z
...
.method public final f(J)V
    ...
    invoke-virtual {p0, p1, p2, v1}, Lng/b;->A(JZ)V

    const/4 v0, 0x1

    invoke-virtual {p0, p1, p2, v0}, Lng/b;->A(JZ)V
...
.method public final j()Lyf/j;
    ...
    iget-object v0, p0, Lng/b;->v:Lyf/j;
...
.method public final k()Z
    ...
    iget-object v0, p0, Lng/b;->r:Ljava/util/concurrent/atomic/AtomicInteger;

    invoke-virtual {v0}, Ljava/util/concurrent/atomic/AtomicInteger;->get()I

    move-result v0

    iget p0, p0, Lng/n;->a:I
...
.method public final o(I)Z
    ...
    const-string/jumbo v2, "slow down. processingTaskNum = %d, pendingTaskNum = %d, inFlightTaskNum = %d"
...
.method public final p()Ljava/util/ArrayList;
    ...
    :try_start_0
    iput-object v1, p0, Lng/b;->u:Lcom/xiaomi/engine/TaskSession;

    iput-object v1, p0, Lng/b;->v:Lyf/j;
    ...
    :try_start_1
    iget-object v3, p0, Lng/b;->B:Landroid/util/LongSparseArray;
    ...
    iget-object v4, p0, Lng/b;->B:Landroid/util/LongSparseArray;
    ...
    invoke-virtual {p0, v4}, Lng/b;->F(Lyf/i;)V

    iget-object v5, p0, Lng/b;->r:Ljava/util/concurrent/atomic/AtomicInteger;
    ...
    :cond_0
    iget-object v3, p0, Lng/n;->o:Ljava/util/LinkedList;
    ...
    iget-boolean v5, v4, Lyf/h;->b:Z

    if-eqz v5, :cond_1

    iget-wide v5, v4, Lyf/h;->c:J
    ...
    :cond_1
    iget-object v5, v4, Lyf/h;->a:Ljava/util/List;
    ...
    invoke-virtual {p0, v6}, Lng/b;->D(Lyf/b$a;)V
...
.method public final q(J)Z
    ...
    iget-object p2, p0, Lng/b;->B:Landroid/util/LongSparseArray;
    ...
    invoke-virtual {p0, p2, p1}, Lng/b;->z(Lyf/i;Ljava/lang/String;)V
...
.method public final r(J)V
    ...
    :cond_0
    iget-object p1, p0, Lng/n;->i:Lng/n$b;
...
.method public final s()V
    ...
    :try_start_0
    iget-object v1, p0, Lng/b;->u:Lcom/xiaomi/engine/TaskSession;
    ...
    const-string/jumbo v1, "processImage: task session has died"
    ...
    const-string/jumbo v4, "processImage: timestamp = "

    invoke-direct {v3, v4}, Ljava/lang/StringBuilder;-><init>(Ljava/lang/String;)V

    iget-wide v4, v0, Lyf/h;->c:J
    ...
    const-string v5, "mockProcessImage: skip image processor"

    invoke-static {v4, v5, v1}, Lcom/android/camera/log/Log;->d(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V

    iget-object v1, v0, Lyf/h;->a:Ljava/util/List;
    ...
    invoke-virtual {p0, v4}, Lng/b;->D(Lyf/b$a;)V
    ...
    :cond_3
    iget-object v1, v0, Lyf/b$a;->d:Landroid/media/Image;
    ...
    invoke-static {v5, v1}, Lng/n;->t(Lcom/xiaomi/camera/imagecodec/ImagePool;Landroid/media/Image;)Landroid/media/Image;

    move-result-object v1

    invoke-virtual {p0, v0}, Lng/b;->D(Lyf/b$a;)V
    ...
    invoke-direct {v0, v1, v2, v5, v6}, Lyf/c;-><init>(Landroid/media/Image;IZLu2/i;)V

    invoke-virtual {p0, v0}, Lng/n;->d(Lyf/c;)V

    invoke-virtual {p0, v3, v4}, Lng/b;->B(J)V
    ...
    const-string v5, "onPreProcessImage: E"

    new-array v6, v2, [Ljava/lang/Object;

    invoke-static {v4, v5, v6}, Lcom/android/camera/log/Log;->d(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V

    iget-object v4, p0, Lng/n;->n:Ljava/lang/Object;

    monitor-enter v4

    :try_start_2
    iget-wide v5, v0, Lyf/h;->c:J

    iget-boolean v7, v0, Lyf/h;->b:Z
    ...
    const-string v7, "onPreProcessImage: timestamp=%d, startTime=%d"
    ...
    invoke-direct {v1, v5, v6, v9, v10}, Lyf/i;-><init>(JJ)V

    iget-object v3, v1, Lyf/i;->c:Ljava/util/ArrayList;
    ...
    :cond_5
    iget-object v7, p0, Lng/b;->B:Landroid/util/LongSparseArray;
    ...
    iget-object v1, v7, Lyf/i;->c:Ljava/util/ArrayList;
    ...
    iget-object v5, v7, Lyf/i;->c:Ljava/util/ArrayList;
    ...
    invoke-static {v1, v9, v8}, Lcom/android/camera/log/Log;->i(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    ...
    invoke-virtual {p0, v0}, Lng/b;->C(Lyf/h;)V
...
.method public final u(Lyf/j;)V
    ...
    const-string/jumbo v0, "setTaskSession2: "
    ...
    iput-object p1, p0, Lng/b;->v:Lyf/j;
    ...
    const-string/jumbo p1, "setTaskSession2: worker thread has died"
...
.method public final v()V
    ...
    const-string/jumbo v2, "stopWork: E. processor: "
    ...
    invoke-super {p0}, Lng/n;->v()V

    iget-object v0, p0, Lng/b;->s:Landroid/os/HandlerThread;

    invoke-virtual {v0}, Landroid/os/HandlerThread;->quitSafely()Z

    iget-object v0, p0, Lng/b;->t:Landroid/os/Handler;
    ...
    iput-object v1, p0, Lng/b;->t:Landroid/os/Handler;

    :cond_0
    iget-object v0, p0, Lng/n;->k:Lng/k;

    if-eqz v0, :cond_1

    iput-object v1, p0, Lng/n;->k:Lng/k;
    ...
    :try_start_0
    iget-object v3, p0, Lng/b;->u:Lcom/xiaomi/engine/TaskSession;
    ...
    iget-object v0, v0, Lyf/j;->a:Lcom/xiaomi/engine/TaskSession;
    ...
    iput-object v1, p0, Lng/n;->j:Lng/n$a;

    iget-object v0, p0, Lng/b;->w:Landroid/media/ImageReader;

    if-eqz v0, :cond_5

    invoke-virtual {v0}, Landroid/media/ImageReader;->close()V

    iput-object v1, p0, Lng/b;->w:Landroid/media/ImageReader;

    :cond_5
    iget-object v0, p0, Lng/b;->x:Landroid/media/ImageReader;

    if-eqz v0, :cond_6

    invoke-virtual {v0}, Landroid/media/ImageReader;->close()V

    iput-object v1, p0, Lng/b;->x:Landroid/media/ImageReader;

    :cond_6
    iget-object v0, p0, Lng/b;->y:Landroid/media/ImageReader;

    if-eqz v0, :cond_7

    invoke-virtual {v0}, Landroid/media/ImageReader;->close()V

    iput-object v1, p0, Lng/b;->y:Landroid/media/ImageReader;

    :cond_7
    iget-object v0, p0, Lng/b;->z:Landroid/media/ImageReader;

    if-eqz v0, :cond_8

    invoke-virtual {v0}, Landroid/media/ImageReader;->close()V

    iput-object v1, p0, Lng/b;->z:Landroid/media/ImageReader;

    :cond_8
    const-string p0, "BaseImageProcessor"

    const-string/jumbo v0, "stopWork: X"
...
.method public final x()Z
    ...
    const-string/jumbo v3, "tryToReuse: failed! processor: "
    ...
    :try_start_0
    iget-object v2, p0, Lng/b;->u:Lcom/xiaomi/engine/TaskSession;
    ...
    const-string/jumbo v5, "tryToReuse: failed. TaskSession is null! processor: %s"
    ...
    const-string/jumbo v2, "tryToReuse: state = %d, processor: %s"

    const/4 v4, 0x2

    new-array v4, v4, [Ljava/lang/Object;

    invoke-virtual {p0}, Lng/n;->h()I
    ...
    iget-object v1, p0, Lng/n;->p:Ljava/lang/Object;

    monitor-enter v1

    :try_start_1
    iput v3, p0, Lng/n;->q:I
...
.method public final z(Lyf/i;Ljava/lang/String;)V
    .locals 7
    .param p1    # Lyf/i;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
    ...
    invoke-virtual {p0, p1}, Lng/b;->F(Lyf/i;)V

    iget-object v0, p0, Lng/b;->r:Ljava/util/concurrent/atomic/AtomicInteger;

    invoke-virtual {v0}, Ljava/util/concurrent/atomic/AtomicInteger;->getAndDecrement()I

    iget-object v0, p0, Lng/n;->j:Lng/n$a;

    if-eqz v0, :cond_0

    check-cast v0, Lng/t$e;

    iget-wide v4, p1, Lyf/i;->a:J

    invoke-virtual {v0, v4, v5}, Lng/t$e;->a(J)Lng/q;
    ...
    const-string v6, "onImageProcessFailed: timestamp=%d, reason=%s"
    ...
    invoke-virtual {p0, v4, v5}, Lng/t;->v(J)Lng/q;
    ...
    invoke-virtual {p0, v0, p1, p2}, Lp1/b;->H(ILjava/lang/String;Ljava/lang/String;)V
