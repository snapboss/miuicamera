...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lng/p;->c:Landroid/util/LongSparseArray;

    new-instance v0, Ljava/util/concurrent/ConcurrentHashMap;

    invoke-direct {v0, v1}, Ljava/util/concurrent/ConcurrentHashMap;-><init>(I)V

    iput-object v0, p0, Lng/p;->d:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    iput-object v0, p0, Lng/p;->a:Landroid/os/HandlerThread;
    ...
    iput-object v1, p0, Lng/p;->a:Landroid/os/HandlerThread;
    ...
    invoke-direct {v1, p0, v0}, Lng/p$a;-><init>(Lng/p;Landroid/os/Looper;)V

    iput-object v1, p0, Lng/p;->b:Lng/p$a;

    return-void
.end method

.method public static a(Lng/p;)V
    .locals 9
    ...
    iget-object v3, p0, Lng/p;->d:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    iget-object p0, p0, Lng/p;->c:Landroid/util/LongSparseArray;
    ...
    invoke-virtual {v2}, Lyf/b;->toString()Ljava/lang/String;

    move-result-object v2

    aput-object v2, v7, v6

    const-string/jumbo v2, "printDataForDebug: mCaptureDataArray key: %d values: %s"
...
.method public static b(Lng/p;J)J
    .locals 7
...
# virtual methods
.method public final c(JLyf/b;Z)Ljava/util/ArrayList;
    .locals 17
    .param p3    # Lyf/b;
    ...
    iget-object v2, v2, Lyf/b;->u:Ljava/lang/String;
    ...
    :goto_1
    iget-object v10, v5, Lng/p;->c:Landroid/util/LongSparseArray;
    ...
    check-cast v10, Lyf/b$a;

    iget-wide v11, v10, Lyf/b$a;->o:J
    ...
    iget-object v11, v10, Lyf/b$a;->p:Ljava/lang/String;
    ...
    iget-wide v11, v10, Lyf/b$a;->q:J

    sub-long v11, v7, v11

    sget-boolean v13, Lva/c;->h:Z
    ...
    check-cast v1, Lyf/b$a;

    iget-wide v1, v1, Lyf/b$a;->o:J
    ...
    invoke-static {v3, v0}, Landroidx/appcompat/widget/b;->g(Ljava/util/ArrayList;Ljava/lang/StringBuilder;)Ljava/lang/String;
...
.method public final d(Lyf/b$a;)V
    .locals 14

    invoke-virtual {p1}, Lyf/b$a;->c()Z
    ...
    iget-object v0, p0, Lng/p;->c:Landroid/util/LongSparseArray;

    iget-wide v4, p1, Lyf/b$a;->o:J

    invoke-virtual {v0, v4, v5}, Landroid/util/LongSparseArray;->remove(J)V

    iget-object v0, p1, Lyf/b$a;->c:Lcom/xiaomi/protocol/ICustomCaptureResult;

    invoke-virtual {v0}, Lcom/xiaomi/protocol/ICustomCaptureResult;->getSequenceId()I

    move-result v0

    iget-object v2, p1, Lyf/b$a;->p:Ljava/lang/String;

    iget-object v4, p1, Lyf/b$a;->c:Lcom/xiaomi/protocol/ICustomCaptureResult;

    invoke-virtual {v4}, Lcom/xiaomi/protocol/ICustomCaptureResult;->getTimeStamp()J

    move-result-wide v4

    iget-wide v7, p1, Lyf/b$a;->n:J

    iget-object v9, p0, Lng/p;->d:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    new-instance v11, Lc1/v1;

    invoke-direct {v11, v2, v3}, Lc1/v1;-><init>(Ljava/lang/String;I)V

    invoke-interface {v9, v11}, Ljava/util/stream/Stream;->filter(Ljava/util/function/Predicate;)Ljava/util/stream/Stream;

    move-result-object v2

    new-instance v9, Lcom/android/camera2/compat/theme/custom/mm/adapter/c;

    const/4 v11, 0x6

    invoke-direct {v9, v11}, Lcom/android/camera2/compat/theme/custom/mm/adapter/c;-><init>(I)V
    ...
    iget-wide v7, v9, Lyf/b;->d:J

    iput-wide v7, p1, Lyf/b$a;->n:J

    const-string v2, "ParallelDataZipper"

    const-string/jumbo v11, "update data bean\'s first timestamp to "

    invoke-static {v11, v7, v8}, Landroidx/appcompat/widget/c;->g(Ljava/lang/String;J)Ljava/lang/String;
    ...
    iget-object v0, v9, Lyf/b;->f:Ljava/util/ArrayList;

    iget v1, v9, Lyf/b;->a:I

    if-ne v1, v3, :cond_1

    iget-wide v1, p1, Lyf/b$a;->o:J

    iget-wide v4, p1, Lyf/b$a;->n:J
    ...
    :goto_0
    iget p1, v9, Lyf/b;->h:I

    add-int/2addr p1, v3

    iput p1, v9, Lyf/b;->h:I
    ...
    iget-object p1, v9, Lyf/b;->v:Lyf/a;

    if-eqz p1, :cond_3

    invoke-virtual {v9}, Lyf/b;->b()Z
    ...
    const-string/jumbo v0, "tryToCallback: checkStatus"

    new-array v1, v6, [Ljava/lang/Object;

    invoke-static {p1, v0, v1}, Lcom/android/camera/log/Log;->w(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V

    iget-object p1, v9, Lyf/b;->q:Lng/p$e;

    check-cast p1, Lng/t$b;

    invoke-virtual {p1}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    iget v0, v9, Lyf/b;->a:I

    invoke-static {v0}, Lvf/c;->c(I)Z
    ...
    iget-object p1, p1, Lng/t$b;->a:Lng/t;

    iget-object p1, p1, Lng/t;->C:Lng/t$e;

    invoke-virtual {p1, v3, v1, v2}, Lng/t$e;->c(IJ)V

    :cond_2
    iget-object p1, v9, Lyf/b;->v:Lyf/a;

    new-instance v0, Lng/p$g;

    invoke-direct {v0, p0, v9}, Lng/p$g;-><init>(Lng/p;Lyf/b;)V

    new-instance v1, Lng/p$d;

    invoke-direct {v1, p0, v9}, Lng/p$d;-><init>(Lng/p;Lyf/b;)V

    iget-object p0, p0, Lng/p;->b:Lng/p$a;
    ...
    invoke-virtual {p1, v0, v1, p0}, Lyf/a;->a(Ljava/lang/Runnable;Ljava/lang/Runnable;Lio/reactivex/Scheduler;)V
    :try_end_0
    ...
    :cond_3
    iget-wide v0, v9, Lyf/b;->d:J

    iget-boolean p1, v9, Lyf/b;->s:Z
    ...
    iget-object v2, p1, Lng/t$b;->a:Lng/t;

    iget-object v2, v2, Lng/t;->A:Lng/t$c;

    const-string v3, "onPartialDataAvailable"

    invoke-virtual {v2, v9, v3}, Lng/t$c;->c(Lyf/b;Ljava/lang/String;)V
    ...
    invoke-virtual {v2, v0, v1}, Lng/t;->s(J)Lng/q;

    move-result-object v2

    if-eqz v2, :cond_4

    iput-boolean v6, v2, Lng/q;->x:Z
    ...
    invoke-virtual {v2, v6, v0, v1}, Lng/t$e;->c(IJ)V

    iget-object p1, p1, Lng/t$b;->a:Lng/t;

    invoke-virtual {p1}, Lng/t;->w()V
    ...
    iget-object p1, v9, Lyf/b;->w:Lyf/b$b;

    invoke-virtual {p0, p1}, Lng/p;->j(Lyf/b$b;)V
    ...
    invoke-virtual {p0, v9}, Lng/p;->l(Lyf/b;)V
...
.method public final declared-synchronized e(Landroid/media/Image;IIZ)V
    ...
    invoke-direct/range {v1 .. v6}, Lng/p$c;-><init>(Lng/p;Landroid/media/Image;IIZ)V
...
.method public final declared-synchronized f(Lcom/xiaomi/protocol/ICustomCaptureResult;Z)V
    ...
    new-instance v1, Lng/p$b;

    invoke-direct {v1, p0, p1, p2}, Lng/p$b;-><init>(Lng/p;Lcom/xiaomi/protocol/ICustomCaptureResult;Z)V
...
.method public final declared-synchronized h(Lyf/b;)V
    .locals 3
    .param p1    # Lyf/b;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
    ...
    :try_start_0
    iget-object v1, p0, Lng/p;->a:Landroid/os/HandlerThread;
    ...
    iget-object v1, p0, Lng/p;->b:Lng/p$a;
...
.method public final i(Lng/v;)V
    ...
    iget-object v8, p0, Lng/p;->d:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    invoke-virtual {p0, v1, v2, v0, v6}, Lng/p;->c(JLyf/b;Z)Ljava/util/ArrayList;

    move-result-object v4

    iget-boolean v3, p1, Lng/v;->c:Z

    if-eqz v0, :cond_4

    iget-object v5, v0, Lyf/b;->q:Lng/p$e;

    iget-object v9, v0, Lyf/b;->r:Lng/n;

    iget-object v10, v0, Lyf/b;->f:Ljava/util/ArrayList;

    if-eqz v3, :cond_1

    iget-boolean v11, v0, Lyf/b;->s:Z

    if-eqz v11, :cond_0

    iget v10, v0, Lyf/b;->t:I
    ...
    iget-object v11, v11, Lyf/h;->a:Ljava/util/List;
    ...
    iget-object v0, v0, Lyf/b;->w:Lyf/b$b;

    invoke-virtual {p0, v0}, Lng/p;->j(Lyf/b$b;)V
    ...
    iget-object v5, p1, Lng/v;->a:Lng/p$e;
    ...
    invoke-virtual/range {v0 .. v5}, Lng/t$b;->b(JILjava/util/ArrayList;Lng/n;)V
    ...
    invoke-virtual {v5, v1, v2, v4}, Lng/t$b;->a(JLjava/util/ArrayList;)V
...
.method public final j(Lyf/b$b;)V
    .locals 1
...
.method public final k(Lyf/b;)V
    ...
    iget-wide v2, p1, Lyf/b;->d:J

    iget-object v0, p0, Lng/p;->d:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    iget-object v3, p1, Lyf/b;->w:Lyf/b$b;

    invoke-virtual {v0, v2, v3}, Landroid/os/Handler;->obtainMessage(ILjava/lang/Object;)Landroid/os/Message;

    move-result-object v2

    sget-boolean v3, Lva/c;->h:Z
    ...
    :goto_1
    iget-object v4, p0, Lng/p;->c:Landroid/util/LongSparseArray;

    invoke-virtual {v4}, Landroid/util/LongSparseArray;->size()I

    move-result v5

    iget-wide v6, p1, Lyf/b;->d:J
    ...
    check-cast v4, Lyf/b$a;

    iget-boolean v5, v4, Lyf/b$a;->m:Z

    if-nez v5, :cond_3

    iget-wide v8, v4, Lyf/b$a;->n:J

    cmp-long v5, v8, v6

    if-eqz v5, :cond_2

    iget-object v5, v4, Lyf/b$a;->p:Ljava/lang/String;

    iget-object v6, p1, Lyf/b;->u:Ljava/lang/String;
    ...
    check-cast v3, Lyf/b$a;

    iget-wide v4, v3, Lyf/b$a;->o:J
    ...
    :cond_7
    iget-wide v4, v3, Lyf/b$a;->n:J

    :goto_3
    iput-wide v6, v3, Lyf/b$a;->n:J

    iget v8, p1, Lyf/b;->b:I

    iput v8, v3, Lyf/b$a;->b:I

    iget-boolean v8, p1, Lyf/b;->l:Z

    iput-boolean v8, v3, Lyf/b$a;->f:Z

    iget-object v8, p1, Lyf/b;->o:Lyf/d;

    iput-object v8, v3, Lyf/b$a;->h:Lyf/d;

    iget-boolean v8, v3, Lyf/b$a;->m:Z

    const/4 v9, 0x1

    if-nez v8, :cond_8

    iput-boolean v9, v3, Lyf/b$a;->m:Z

    :cond_8
    iget-boolean v8, p1, Lyf/b;->m:Z

    iput-boolean v8, v3, Lyf/b$a;->i:Z
    ...
    const-string/jumbo v4, "updateCaptureDataBean: update CaptureDataBean[%d] with captureData[%d]"
    ...
    invoke-virtual {v3}, Lyf/b$a;->b()V

    invoke-virtual {p0, v3}, Lng/p;->d(Lyf/b$a;)V
...
.method public final l(Lyf/b;)V
    ...
    iget-wide v3, v2, Lyf/b;->d:J

    const-string/jumbo v0, "tryToConfirm: "

    invoke-static {v0, v3, v4}, Landroidx/appcompat/widget/c;->g(Ljava/lang/String;J)Ljava/lang/String;
    ...
    iget-object v6, v2, Lyf/b;->q:Lng/p$e;
    ...
    :try_start_0
    iget-object v0, v2, Lyf/b;->f:Ljava/util/ArrayList;
    ...
    check-cast v9, Lyf/b$a;

    iget-object v9, v9, Lyf/b$a;->d:Landroid/media/Image;
    ...
    invoke-virtual {v7, v9}, Ll7/j;->d(Ljava/lang/String;)J

    iget-boolean v7, v2, Lyf/b;->e:Z

    if-nez v7, :cond_2e

    if-eqz v0, :cond_2e

    check-cast v6, Lng/t$b;
    ...
    invoke-static {v9, v10, v11, v12}, Landroidx/appcompat/view/menu/b;->i(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v10

    iget-object v7, v7, Lyf/b$a;->c:Lcom/xiaomi/protocol/ICustomCaptureResult;
    ...
    :goto_4
    iget-object v11, v6, Lng/t$b;->a:Lng/t;

    iget-wide v12, v2, Lyf/b;->d:J

    invoke-virtual {v11, v12, v13}, Lng/t;->s(J)Lng/q;

    move-result-object v11

    if-eqz v11, :cond_6

    iget-object v12, v2, Lyf/b;->r:Lng/n;

    if-eqz v12, :cond_5

    iput-boolean v8, v12, Lng/n;->f:Z

    :cond_5
    iput-boolean v5, v11, Lng/q;->x:Z

    if-eqz v7, :cond_6

    iput v8, v11, Lng/q;->Q:I

    iput-object v12, v11, Lng/q;->P:Ljava/lang/Object;
    ...
    iget-object v13, v2, Lyf/b;->f:Ljava/util/ArrayList;

    invoke-virtual {v13, v5}, Ljava/util/ArrayList;->get(I)Ljava/lang/Object;

    move-result-object v13

    check-cast v13, Lyf/b$a;

    iget-object v13, v13, Lyf/b$a;->d:Landroid/media/Image;
    ...
    :cond_9
    iget-object v13, v12, Lng/n;->b:Ljava/util/concurrent/atomic/AtomicInteger;

    invoke-virtual {v13}, Ljava/util/concurrent/atomic/AtomicInteger;->getAndIncrement()I

    iget-boolean v13, v12, Lng/n;->m:Z

    if-eqz v13, :cond_a

    iget-object v13, v12, Lng/n;->c:Ljava/util/concurrent/atomic/AtomicInteger;

    invoke-virtual {v13}, Ljava/util/concurrent/atomic/AtomicInteger;->getAndIncrement()I

    iget-object v12, v12, Lng/n;->d:Ljava/util/concurrent/atomic/AtomicInteger;
    ...
    iget-object v12, v2, Lyf/b;->v:Lyf/a;

    if-nez v12, :cond_b

    iget-object v12, v6, Lng/t$b;->a:Lng/t;

    iget-object v12, v12, Lng/t;->C:Lng/t$e;

    iget-wide v13, v2, Lyf/b;->d:J

    invoke-virtual {v12, v5, v13, v14}, Lng/t$e;->c(IJ)V
    ...
    iget-boolean v10, v11, Lng/q;->J:Z

    if-eqz v10, :cond_1d

    iget-object v8, v2, Lyf/b;->f:Ljava/util/ArrayList;
    ...
    iget-object v13, v13, Lyf/b$a;->c:Lcom/xiaomi/protocol/ICustomCaptureResult;
    ...
    check-cast v15, Lyf/b$a;

    move-object/from16 v16, v8

    iget-object v8, v15, Lyf/b$a;->g:Landroid/media/Image;

    move-wide/from16 v17, v3

    iget-boolean v3, v15, Lyf/b$a;->l:Z
    ...
    iput-object v8, v11, Lng/q;->K:Landroid/media/Image;
    ...
    invoke-static {v4, v8, v15, v15}, Lvf/e;->l(Lcom/xiaomi/camera/imagecodec/ImagePool;Landroid/media/Image;IZ)Landroid/media/Image;

    move-result-object v4

    iput-object v4, v11, Lng/q;->K:Landroid/media/Image;
    ...
    :cond_16
    :goto_c
    iget-object v4, v15, Lyf/b$a;->c:Lcom/xiaomi/protocol/ICustomCaptureResult;
    ...
    invoke-static {v4, v8, v10, v10}, Lvf/e;->l(Lcom/xiaomi/camera/imagecodec/ImagePool;Landroid/media/Image;IZ)Landroid/media/Image;
    ...
    iget-object v4, v12, Lng/t;->A:Lng/t$c;

    invoke-virtual {v4, v8}, Lng/t$c;->b(Landroid/media/Image;)V
    ...
    iget-object v3, v6, Lng/t$b;->a:Lng/t;

    iget-boolean v3, v3, Lng/t;->p:Z
    ...
    iget-object v0, v6, Lng/t$b;->a:Lng/t;
    ...
    check-cast v5, Lyf/b$a;

    iget-object v5, v5, Lyf/b$a;->d:Landroid/media/Image;
    ...
    invoke-static {v5, v10, v3}, Landroidx/activity/m;->h(Ljava/lang/StringBuilder;Ljava/lang/String;I)Ljava/lang/String;

    move-result-object v3

    invoke-virtual {v0, v7, v8}, Lng/t;->s(J)Lng/q;
    ...
    check-cast v12, Lyf/b$a;

    iget-object v13, v12, Lyf/b$a;->d:Landroid/media/Image;

    invoke-virtual {v10, v13}, Ljava/util/ArrayList;->add(Ljava/lang/Object;)Z

    iget-object v12, v12, Lyf/b$a;->g:Landroid/media/Image;
    ...
    iget-boolean v13, v12, Lyf/b$a;->a:Z

    if-eqz v13, :cond_21

    iget-object v4, v12, Lyf/b$a;->c:Lcom/xiaomi/protocol/ICustomCaptureResult;

    iput-object v4, v5, Lng/q;->g:Lcom/xiaomi/protocol/ICustomCaptureResult;
    ...
    iget-object v4, v5, Lng/q;->q:Lng/r;

    new-instance v7, Lcom/xiaomi/camera/imagecodec/ReprocessData;

    iget-boolean v8, v4, Lng/r;->B:Z

    iget-object v12, v4, Lng/r;->C:Landroid/util/Size;
    ...
    iget-object v8, v4, Lng/r;->i:Landroid/util/Size;

    invoke-virtual {v8}, Landroid/util/Size;->getWidth()I

    move-result v8

    iget-object v4, v4, Lng/r;->i:Landroid/util/Size;
    ...
    const-string/jumbo v5, "processRaw: "
    ...
    invoke-virtual {v13, v0, v3}, Lng/t$f;->onError(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {v1, v7, v8}, Landroidx/appcompat/widget/c;->g(Ljava/lang/String;J)Ljava/lang/String;
    ...
    iget-object v0, v2, Lyf/b;->r:Lng/n;

    iput-object v0, v11, Lng/q;->P:Ljava/lang/Object;

    :cond_28
    iget-object v0, v6, Lng/t$b;->a:Lng/t;

    iget-object v0, v0, Lng/t;->A:Lng/t$c;

    invoke-virtual {v0, v2}, Lng/t$c;->a(Lyf/b;)V
    ...
    iget-object v3, v0, Lng/t;->A:Lng/t$c;

    iput-object v3, v2, Lyf/b;->p:Lng/d;

    if-eqz v11, :cond_2a

    iget-object v3, v11, Lng/q;->q:Lng/r;

    iget-boolean v4, v3, Lng/r;->L:Z

    iput-boolean v4, v2, Lyf/b;->k:Z

    iget-boolean v4, v11, Lng/q;->O:Z

    iput-boolean v4, v2, Lyf/b;->m:Z

    iget-boolean v4, v3, Lng/r;->B:Z

    iput-boolean v4, v2, Lyf/b;->j:Z
    ...
    iput-object v4, v2, Lyf/b;->n:Landroid/util/Size;

    :cond_2a
    sget-object v3, Loi/a$b;->a:Loi/a;
    ...
    iget v7, v2, Lyf/b;->c:I

    if-ne v7, v5, :cond_2d

    iget-object v4, v3, Loi/a;->d:Landroid/os/HandlerThread;
    ...
    iget-object v4, v3, Loi/a;->e:Loi/a$d;
    ...
    new-instance v3, Loi/a$c;

    invoke-direct {v3, v2, v0}, Loi/a$c;-><init>(Lyf/b;Lcom/xiaomi/engine/TaskSession;)V
    ...
    invoke-virtual {v3, v2, v0}, Loi/a;->b(Lyf/b;Lcom/xiaomi/engine/TaskSession;)V

    :cond_2c
    :goto_19
    iget-object v0, v6, Lng/t$b;->a:Lng/t;

    invoke-virtual {v0}, Lng/t;->w()V
    ...
    invoke-static {v1, v7, v2}, Landroidx/appcompat/widget/c;->i(Ljava/lang/String;ILjava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v1

    invoke-static {v4, v1}, Landroidx/appcompat/widget/b;->g(Ljava/util/ArrayList;Ljava/lang/StringBuilder;)Ljava/lang/String;
    ...
    invoke-virtual {v6, v3, v4, v0}, Lng/t$b;->a(JLjava/util/ArrayList;)V
    ...
    iget-object v0, v2, Lyf/b;->w:Lyf/b$b;

    invoke-virtual {v1, v0}, Lng/p;->j(Lyf/b$b;)V
