...
.method public constructor <init>(Lng/t$e;Lcom/xiaomi/engine/BufferFormat;)V
    ...
    invoke-direct {p0, p1, p2}, Lng/b;-><init>(Lng/t$e;Lcom/xiaomi/engine/BufferFormat;)V
...
# virtual methods
.method public final C(Lyf/h;)V
    .locals 10

    iget-object v0, p1, Lyf/h;->a:Ljava/util/List;
    ...
    const-string/jumbo p0, "processImage: dataBeans is empty!"
    ...
    :cond_0
    iget-boolean v1, p1, Lyf/h;->b:Z

    if-eqz v1, :cond_1

    iget-object v1, p0, Lng/b;->r:Ljava/util/concurrent/atomic/AtomicInteger;

    invoke-virtual {v1}, Ljava/util/concurrent/atomic/AtomicInteger;->getAndIncrement()I

    :cond_1
    iget-object v1, p1, Lyf/h;->g:Lyf/d;
    ...
    iget-object v4, v1, Lyf/b$a;->d:Landroid/media/Image;

    iget-object v6, v1, Lyf/b$a;->e:Landroid/media/Image;

    invoke-static {v4}, Lng/n;->m(Landroid/media/Image;)Z

    move-result v7

    invoke-static {v6}, Lng/n;->m(Landroid/media/Image;)Z
    ...
    const-string/jumbo v1, "processImage: neither main image nor sub image is valid"
    ...
    :cond_4
    iget-object v1, v1, Lyf/b$a;->c:Lcom/xiaomi/protocol/ICustomCaptureResult;

    if-eqz v7, :cond_5

    const-string/jumbo v7, "processCaptureResult: main"

    new-array v9, v2, [Ljava/lang/Object;

    invoke-static {v3, v7, v9}, Lcom/android/camera/log/Log;->d(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V

    iget v7, p1, Lyf/h;->d:I

    invoke-virtual {p0, v1, v4, v2, v7}, Lng/h;->K(Lcom/xiaomi/protocol/ICustomCaptureResult;Landroid/media/Image;II)V

    :cond_5
    if-eqz v8, :cond_3

    const-string/jumbo v4, "processCaptureResult: sub"

    new-array v7, v2, [Ljava/lang/Object;

    invoke-static {v3, v4, v7}, Lcom/android/camera/log/Log;->d(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V

    iget v4, p1, Lyf/h;->d:I

    invoke-virtual {p0, v1, v6, v5, v4}, Lng/h;->K(Lcom/xiaomi/protocol/ICustomCaptureResult;Landroid/media/Image;II)V
    ...
    const-string/jumbo v6, "processImage: invalid main image: "
    ...
    const-string/jumbo v4, "processImage: invalid sub image: "
...
.method public final K(Lcom/xiaomi/protocol/ICustomCaptureResult;Landroid/media/Image;II)V
    ...
    const-string/jumbo v0, "processImage: update metadata with image flag: "
    ...
    const-string/jumbo v3, "processCaptureResult: cameraMetadataNative = "
    ...
    const-string/jumbo v3, "processCaptureResult: image flag = "
    ...
    const-string/jumbo v3, "processCaptureResult: image = "
    ...
    const-string/jumbo v5, "processCaptureResult: timestamp = "

    invoke-static {v1, v2, v3, v5}, Landroidx/appcompat/view/menu/b;->i(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;Ljava/lang/String;)Ljava/lang/StringBuilder;
    ...
    const-string/jumbo v1, "processImage: Exception\uff1a "

    invoke-direct {v0, v1}, Ljava/lang/StringBuilder;-><init>(Ljava/lang/String;)V

    invoke-static {p2, v0}, Landroidx/appcompat/view/menu/b;->c(Ljava/lang/Exception;Ljava/lang/StringBuilder;)Ljava/lang/String;
    ...
    :cond_2
    new-instance p1, Lng/h$a;

    invoke-direct {p1, p0}, Lng/h$a;-><init>(Lng/h;)V
    ...
    iget-object p1, p0, Lng/b;->A:Ljava/lang/Object;
    ...
    const-string/jumbo p1, "processCaptureResult: session has died"
    ...
    invoke-direct {p1}, Lng/h$b;-><init>()V
...
.method public final b(Lcom/xiaomi/engine/BufferFormat;)Ljava/util/ArrayList;
    ...
    invoke-direct {v2, p0}, Lng/e;-><init>(Lng/h;)V

    iget-object v3, p0, Lng/b;->t:Landroid/os/Handler;

    invoke-virtual {v1, v2, v3}, Landroid/media/ImageReader;->setOnImageAvailableListener(Landroid/media/ImageReader$OnImageAvailableListener;Landroid/os/Handler;)V

    new-instance v1, Landroid/hardware/camera2/params/OutputConfiguration;

    iget-object v2, p0, Lng/b;->w:Landroid/media/ImageReader;
    ...
    invoke-direct {v2, p0}, Lng/f;-><init>(Lng/h;)V

    iget-object v4, p0, Lng/b;->t:Landroid/os/Handler;
    ...
    iget-object v2, p0, Lng/b;->x:Landroid/media/ImageReader;
    ...
    iput-object p1, p0, Lng/b;->y:Landroid/media/ImageReader;

    new-instance v1, Lng/g;

    invoke-direct {v1, p0}, Lng/g;-><init>(Lng/h;)V
    ...
    iget-object p0, p0, Lng/b;->y:Landroid/media/ImageReader;
...
.method public final l()Z
    ...
    iget-object v4, p0, Lng/n;->b:Ljava/util/concurrent/atomic/AtomicInteger;
    ...
    iget-object v0, p0, Lng/n;->c:Ljava/util/concurrent/atomic/AtomicInteger;
    ...
    iget-object p0, p0, Lng/n;->d:Ljava/util/concurrent/atomic/AtomicInteger;
    ...
    invoke-virtual {v0, p0}, Lng/t$e;->b(Lng/n;)Z
