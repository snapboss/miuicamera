...
.method public constructor <init>(Landroid/net/Uri;)V
    ...
    .line 8
    iput-object v0, p0, Lv6/f;->g:Landroid/os/ParcelFileDescriptor;
    ...
    iput-object v1, p0, Lv6/f;->g:Landroid/os/ParcelFileDescriptor;
    ...
    iput-object v2, p0, Lv6/f;->a:Landroid/media/MediaMuxer;
    :try_end_0
    ...
    .line 13
    iput v0, p0, Lv6/f;->c:I

    .line 14
    iput-boolean v0, p0, Lv6/f;->d:Z
...
.method public constructor <init>(Ljava/lang/String;)V
    ...
    iput-object v0, p0, Lv6/f;->a:Landroid/media/MediaMuxer;

    .line 4
    iput v1, p0, Lv6/f;->b:I

    .line 5
    iput v1, p0, Lv6/f;->c:I

    .line 6
    iput-boolean v1, p0, Lv6/f;->d:Z
...
.method public final a()V
    ...
    iget-object v1, p0, Lv6/f;->f:Lv6/e;
    ...
    iget-object v7, v1, Lv6/e;->c:Ljava/lang/Thread;

    if-eqz v7, :cond_1

    :try_start_0
    iget-boolean v7, v1, Lv6/e;->j:Z
    ...
    :cond_0
    iput-object v6, v1, Lv6/e;->c:Ljava/lang/Thread;
    :try_end_0
    ...
    :cond_1
    :goto_0
    iput-object v6, p0, Lv6/f;->f:Lv6/e;

    :cond_2
    iget-object v1, p0, Lv6/f;->e:Lv6/e;
    ...
    :cond_4
    :goto_1
    iput-object v6, p0, Lv6/f;->e:Lv6/e;
...
.method public final b(JZ)Z
    ...
    iget-object v0, p0, Lv6/f;->e:Lv6/e;

    const/4 v2, 0x1

    if-eqz v0, :cond_1

    invoke-virtual {v0, p1, p2, p3}, Lv6/e;->h(JZ)Z
    ...
    :goto_1
    iget-object p0, p0, Lv6/f;->f:Lv6/e;

    if-eqz p0, :cond_3

    invoke-virtual {p0, p1, p2, p3}, Lv6/e;->h(JZ)Z
...
.method public final declared-synchronized c()Z
    ...
    iget v3, p0, Lv6/f;->b:I

    if-lez v3, :cond_0

    if-gtz v0, :cond_0

    iget-object v0, p0, Lv6/f;->a:Landroid/media/MediaMuxer;
...
.method public final d()V
    ...
    invoke-virtual {v1}, Lv6/e;->i()V

    :cond_0
    iget-object p0, p0, Lv6/f;->e:Lv6/e;

    if-eqz p0, :cond_1

    invoke-virtual {p0}, Lv6/e;->i()V
