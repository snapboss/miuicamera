...
# direct methods
.method public constructor <init>(Ll8/h$a;)V
    .locals 2

    invoke-direct {p0, p1}, Ll8/b;-><init>(Ll8/b$a;)V

    iget-object p1, p1, Ll8/h$a;->q:Landroid/hardware/camera2/CaptureResult;

    iput-object p1, p0, Ll8/h;->t:Landroid/hardware/camera2/CaptureResult;

    const/4 p1, 0x0

    iput-object p1, p0, Ll8/h;->u:Landroid/media/ImageWriter;

    iget-object p1, p0, Ll8/b;->d:Lng/q;

    iget-object p1, p1, Lng/q;->q:Lng/r;

    iget-object p1, p1, Lng/r;->C:Landroid/util/Size;
    ...
    :cond_0
    iget-object p1, p0, Ll8/b;->g:Landroid/media/Image;
...
.method public static d(Landroid/media/Image;Landroid/util/Size;)[B
    ...
    sget-object p1, Lvf/e;->a:Ljava/lang/String;
    ...
    invoke-static {v11, v4, v12}, Landroidx/appcompat/widget/c;->i(Ljava/lang/String;ILjava/lang/String;)Ljava/lang/StringBuilder;
    ...
    invoke-static {v5, v2, v4}, Ll8/k;->a(Landroid/media/Image$Plane;II)Ljava/nio/ByteBuffer;
    ...
    invoke-static {v0, v2, v4}, Ll8/k;->a(Landroid/media/Image$Plane;II)Ljava/nio/ByteBuffer;
...
.method public final e(Landroid/media/Image;[BZLjava/lang/String;JILjava/lang/String;IILandroid/location/Location;I)Landroid/net/Uri;
    ...
    invoke-static {v3, v15}, Landroidx/appcompat/widget/d;->d(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v15, v4}, Landroidx/activity/m;->f(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static/range {v3 .. v19}, Ll8/y;->m(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;JLjava/lang/String;ILjava/lang/String;JIILandroid/location/Location;ZZJ)Landroid/net/Uri;
    ...
    :goto_2
    const-string/jumbo v6, "saveHeif: no exif data"

    const-string/jumbo v7, "saveHeif: cost %dms"

    const-string/jumbo v8, "saveHeif exception: "
    ...
    iget-object v15, v1, Ll8/b;->m:Landroid/os/Handler;
    ...
    :try_start_3
    invoke-direct {v0, v5, v13, v14, v4}, Lsh/g$a;-><init>(Ljava/io/FileDescriptor;III)V
    ...
    new-instance v5, Lsh/g$a;

    invoke-direct {v5, v0, v13, v14, v4}, Lsh/g$a;-><init>(Ljava/lang/String;III)V
    ...
    iget-object v4, v4, Lng/q;->q:Lng/r;

    iget v4, v4, Lng/r;->v:I

    iput-object v15, v0, Lsh/g$a;->h:Landroid/os/Handler;

    move/from16 v15, p12

    invoke-virtual {v0, v15}, Lsh/g$a;->b(I)V

    invoke-virtual {v0, v4}, Lsh/g$a;->c(I)V

    invoke-virtual {v0}, Lsh/g$a;->a()Lsh/g;

    move-result-object v0

    const/4 v4, 0x0

    invoke-virtual {v0, v4}, Lsh/i;->b(Z)V

    iget v4, v0, Lsh/i;->a:I

    const/4 v5, 0x1

    if-ne v4, v5, :cond_5

    iget-object v4, v0, Lsh/i;->i:Lsh/f;

    iget v13, v4, Lsh/d;->i:I

    if-ne v13, v5, :cond_4

    iget-object v4, v4, Lsh/d;->c0:Landroid/view/Surface;
    ...
    iput-object v4, v1, Ll8/h;->u:Landroid/media/ImageWriter;
    ...
    iput-boolean v4, v0, Lsh/i;->m:Z

    iget-object v4, v0, Lsh/i;->i:Lsh/f;

    iget-object v4, v4, Lsh/d;->e:Landroid/media/MediaCodec;
    ...
    iget-object v4, v1, Ll8/h;->u:Landroid/media/ImageWriter;
    ...
    invoke-virtual {v0, v4, v2}, Lsh/i;->a(I[B)V
    ...
    invoke-virtual {v0}, Lsh/i;->close()V
    ...
    :goto_7
    iget-object v2, v1, Ll8/h;->u:Landroid/media/ImageWriter;
    ...
    iput-object v2, v1, Ll8/h;->u:Landroid/media/ImageWriter;
    ...
    iget-object v7, v1, Ll8/b;->d:Lng/q;

    iget-object v7, v7, Lng/q;->q:Lng/r;

    iget-object v7, v7, Lng/r;->C:Landroid/util/Size;

    move-object/from16 p6, v8

    iget-object v8, v1, Ll8/b;->m:Landroid/os/Handler;
    ...
    invoke-direct {v0, v5, v13, v14, v12}, Lsh/g$a;-><init>(Ljava/io/FileDescriptor;III)V
    ...
    new-instance v12, Lsh/g$a;

    invoke-direct {v12, v0, v13, v14, v5}, Lsh/g$a;-><init>(Ljava/lang/String;III)V

    move-object v0, v12

    :goto_9
    iget-object v1, v1, Ll8/b;->d:Lng/q;

    iget-object v1, v1, Lng/q;->q:Lng/r;

    iget v1, v1, Lng/r;->v:I

    iput-object v8, v0, Lsh/g$a;->h:Landroid/os/Handler;

    invoke-virtual {v0, v15}, Lsh/g$a;->b(I)V

    invoke-virtual {v0, v1}, Lsh/g$a;->c(I)V
    ...
    invoke-virtual {v1, v0}, Lsh/i;->b(Z)V

    const/4 v0, 0x1

    iput-boolean v0, v1, Lsh/i;->m:Z

    iget-object v0, v1, Lsh/i;->i:Lsh/f;

    iget-object v0, v0, Lsh/d;->e:Landroid/media/MediaCodec;
    ...
    invoke-static {v3, v0, v5}, Lcom/android/camera/log/LogC;->v(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V

    invoke-static {}, Ljava/lang/System;->currentTimeMillis()J

    move-result-wide v8

    invoke-static {v4, v7}, Ll8/h;->d(Landroid/media/Image;Landroid/util/Size;)[B

    move-result-object v0

    const-string/jumbo v4, "prepare buffer cost %dms"
    ...
    invoke-virtual {v1, v7}, Lsh/i;->b(Z)V

    iget v7, v1, Lsh/i;->a:I
    ...
    :try_start_6
    iget-object v7, v1, Lsh/i;->i:Lsh/f;

    if-eqz v7, :cond_9

    invoke-virtual {v7, v0}, Lsh/d;->a([B)V
    ...
    invoke-virtual {v1, v0, v2}, Lsh/i;->a(I[B)V
    ...
    invoke-static {v3, v6, v0}, Lcom/android/camera/log/Log;->w(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    ...
    invoke-virtual {v1}, Lsh/i;->close()V
    ...
    :goto_c
    invoke-static/range {p3 .. p3}, Lgr/b;->a(Landroid/os/ParcelFileDescriptor;)V
...
.method public final f()V
    ...
    iget-object v0, v14, Ll8/b;->d:Lng/q;

    iget-object v15, v0, Lng/q;->p:Ljava/lang/String;
    ...
    iget-wide v6, v0, Lng/q;->I:J

    iget-object v0, v0, Lng/q;->q:Lng/r;

    iget v12, v0, Lng/r;->K:I

    iget v11, v0, Lng/r;->v:I

    iget-object v10, v0, Lng/r;->z:Landroid/location/Location;

    iget v9, v0, Lng/r;->f0:I
    ...
    const-string v8, "HeifSaveRequest"
    ...
    iget-object v2, v14, Ll8/h;->t:Landroid/hardware/camera2/CaptureResult;

    iget v3, v14, Ll8/b;->i:I

    iget v4, v14, Ll8/b;->j:I

    sget-object v5, Lqd/a;->a:Ljava/nio/charset/Charset;

    new-instance v5, Lqd/b;

    invoke-direct {v5}, Lqd/b;-><init>()V

    if-eqz v2, :cond_0

    sget-object v17, Ll8/e;->b:Ljava/lang/Long;

    move/from16 v17, v9

    new-instance v9, Ll8/e$a;

    invoke-direct {v9, v5}, Ll8/e$a;-><init>(Lqd/b;)V

    invoke-virtual {v9, v11, v3, v4}, Ll8/e$a;->b(III)V

    iput-wide v6, v9, Ll8/e$a;->c:J

    iput-object v10, v9, Ll8/e$a;->j:Landroid/location/Location;

    const-wide/16 v3, 0x0

    iput-wide v3, v9, Ll8/e$a;->d:J

    invoke-virtual {v9, v2}, Ll8/e$a;->a(Landroid/hardware/camera2/CaptureResult;)V

    sget-object v2, Ljava/lang/Boolean;->FALSE:Ljava/lang/Boolean;

    sget-object v3, Ljava/lang/Boolean;->TRUE:Ljava/lang/Boolean;

    iput-object v2, v9, Ll8/e$a;->o:Ljava/lang/Boolean;

    iput-object v3, v9, Ll8/e$a;->p:Ljava/lang/Boolean;

    invoke-virtual {v9}, Ll8/e$a;->c()V
    ...
    invoke-static {v5, v2}, Lqd/a;->e(Lqd/b;Ljava/lang/Boolean;)[B

    move-result-object v3

    new-instance v2, Ljava/lang/StringBuilder;

    const-string/jumbo v4, "prepare exif cost "
    ...
    invoke-static {v8, v0, v2}, Lcom/android/camera/log/LogC;->v(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V

    invoke-static {}, Lm1/b;->b()Lp1/b;

    move-result-object v0

    invoke-virtual {v0, v15}, Lp1/b;->L(Ljava/lang/String;)Ln1/b;

    move-result-object v9

    const-string/jumbo v0, "saveHeifInfo: E. update "
    ...
    :cond_1
    invoke-static {v13}, Ll8/y;->n(Ljava/lang/String;)Z
    ...
    invoke-static {v13}, Ll8/y;->o(Ljava/lang/String;)Z
    ...
    sget-object v2, Ll8/y;->e:Ljava/lang/String;

    invoke-virtual {v0, v2}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    sget-object v2, Ljava/io/File;->separator:Ljava/lang/String;

    invoke-static {v0, v2, v13, v1}, Landroidx/appcompat/graphics/drawable/a;->f(Ljava/lang/StringBuilder;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    sget-object v2, Ll8/y;->h:Ljava/lang/String;
    ...
    iget-object v1, v9, Ln1/b;->c:Ljava/lang/Long;

    invoke-virtual {v1}, Ljava/lang/Long;->longValue()J

    move-result-wide v1

    iget-object v4, v14, Ll8/b;->a:Landroid/content/Context;

    move-object/from16 v19, v5

    const/4 v5, 0x0

    invoke-static {v4, v15, v5}, Ll8/y;->i(Landroid/content/Context;Ljava/lang/String;Z)Landroid/net/Uri;
    ...
    invoke-static {v15}, Ll8/y;->C(Ljava/lang/String;)Z

    move-result v4

    iget-object v2, v14, Ll8/b;->g:Landroid/media/Image;

    iget v1, v14, Ll8/b;->i:I

    move/from16 v20, v12

    iget v12, v14, Ll8/b;->j:I
    ...
    invoke-virtual/range {v1 .. v13}, Ll8/h;->e(Landroid/media/Image;[BZLjava/lang/String;JILjava/lang/String;IILandroid/location/Location;I)Landroid/net/Uri;
    ...
    :try_start_0
    invoke-static {v0, v15}, Lq8/a;->d(Ljava/lang/String;Ljava/lang/String;)V
    :try_end_0
    ...
    :goto_4
    iget-object v8, v12, Ll8/b;->a:Landroid/content/Context;

    iget v0, v12, Ll8/b;->i:I

    iget v1, v12, Ll8/b;->j:I

    const-string v2, "datetaken"

    const-string/jumbo v3, "updateHeifInfo update uri "
    ...
    invoke-virtual {v10, v12, v11, v9, v9}, Landroid/content/ContentResolver;->query(Landroid/net/Uri;[Ljava/lang/String;Landroid/os/Bundle;Landroid/os/CancellationSignal;)Landroid/database/Cursor;
    ...
    invoke-static {v8, v15, v2}, Ll8/y;->i(Landroid/content/Context;Ljava/lang/String;Z)Landroid/net/Uri;
    ...
    invoke-static/range {v1 .. v12}, Ll8/y;->y(IJJJLandroid/content/Context;Landroid/location/Location;Ljava/lang/String;ZZ)V
    ...
    invoke-static {v0, v15}, Landroidx/appcompat/widget/d;->d(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    :goto_b
    iget-object v1, v13, Ll8/b;->a:Landroid/content/Context;

    move-object/from16 v10, v24

    invoke-static {v1, v10}, Lr1/a;->c(Landroid/content/Context;Ln1/b;)V
    ...
    const-string/jumbo v0, "save: X. path=%s quality=%d jpegRotation=%d"
    ...
    iget-object v2, v13, Ll8/b;->g:Landroid/media/Image;

    iget v0, v13, Ll8/b;->i:I

    iget v9, v13, Ll8/b;->j:I
    ...
    iget-object v1, v15, Ll8/b;->d:Lng/q;

    iget-boolean v1, v1, Lng/q;->C:Z

    if-eqz v1, :cond_10

    iget-object v1, v15, Ll8/b;->a:Landroid/content/Context;

    invoke-static {v1, v0}, Lz/l6;->e(Landroid/content/Context;Landroid/net/Uri;)Lz/l6;

    move-result-object v1

    if-eqz v1, :cond_f

    iget-object v2, v15, Ll8/b;->b:Ll8/t;
    ...
    :cond_f
    iget-object v1, v15, Ll8/b;->b:Ll8/t;
    ...
    invoke-virtual/range {v1 .. v6}, Ll8/l;->l(Landroid/net/Uri;ZLjava/lang/String;IZ)V
    ...
    iput-object v1, v2, Ln1/b;->c:Ljava/lang/Long;

    iget-object v1, v15, Ll8/b;->a:Landroid/content/Context;

    invoke-static {v1, v2}, Lr1/a;->c(Landroid/content/Context;Ln1/b;)V
    ...
    const-string/jumbo v2, "saveHeifInfo: X. added "
...
.method public final run()V
    ...
    invoke-virtual {p0}, Ll8/h;->f()V

    iget-object v0, p0, Ll8/b;->s:Ll8/b$b;

    iget-object v1, p0, Ll8/b;->g:Landroid/media/Image;

    iget-object v2, p0, Ll8/b;->d:Lng/q;
    ...
    iget-object v0, v0, Lng/u;->a:Lng/t;
    ...
    iget-object v1, v2, Lng/q;->K:Landroid/media/Image;

    invoke-static {v0, v1}, Lng/t;->d(Lng/t;Landroid/media/Image;)V

    invoke-virtual {v2}, Lng/q;->l()V

    invoke-static {v0, v2}, Lng/t;->e(Lng/t;Lng/q;)Z
    ...
    check-cast v1, Lcom/android/camera/b$a;

    invoke-virtual {v1, v2}, Lcom/android/camera/b$a;->a(Lng/q;)V

    :cond_0
    iget-wide v1, v2, Lng/q;->e:J

    invoke-virtual {v0, v1, v2}, Lng/t;->v(J)Lng/q;
    ...
    iget-object v5, p0, Ll8/b;->d:Lng/q;

    iget-wide v5, v5, Lng/q;->f:J
    ...
    invoke-static {v4, v0, v1}, Landroidx/appcompat/widget/c;->g(Ljava/lang/String;J)Ljava/lang/String;
    ...
    const-string/jumbo v1, "shot_2_view_"

    invoke-direct {v0, v1}, Ljava/lang/StringBuilder;-><init>(Ljava/lang/String;)V

    iget-object v1, p0, Ll8/b;->d:Lng/q;

    iget-wide v4, v1, Lng/q;->f:J
    ...
    invoke-virtual {v2, v3}, Ll7/j;->e([Ljava/lang/String;)V
    ...
    iput-object v0, p0, Ll8/h;->t:Landroid/hardware/camera2/CaptureResult;
