...
.field public static final q:Lcom/xiaomi/camera/utils/lifecycle/FreshLiveData;
...
.method public static constructor <clinit>()V
    ...
    sput-object v0, Ll8/y;->a:Ljava/lang/String;
    ...
    sput-object v1, Ll8/y;->b:Ljava/lang/String;

    sput-object v0, Ll8/y;->c:Ljava/lang/String;

    sput-object v0, Ll8/y;->d:Ljava/lang/String;

    new-instance v1, Ljava/lang/StringBuilder;

    invoke-direct {v1}, Ljava/lang/StringBuilder;-><init>()V

    sget-object v2, Ll8/y;->c:Ljava/lang/String;
    ...
    sput-object v1, Ll8/y;->e:Ljava/lang/String;
    ...
    invoke-static {v1, v2, v4}, Landroidx/appcompat/widget/b;->f(Ljava/lang/StringBuilder;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;

    move-result-object v1

    sput-object v1, Ll8/y;->f:Ljava/lang/String;
    ...
    sput-object v1, Ll8/y;->g:Ljava/lang/String;
    ...
    sput-object v1, Ll8/y;->h:Ljava/lang/String;
    ...
    sget-object v4, Ll8/y;->b:Ljava/lang/String;
    ...
    sget-object v3, Ll8/y;->b:Ljava/lang/String;
    ...
    sput-object v0, Ll8/y;->n:Ljava/util/concurrent/atomic/AtomicLong;
    ...
    sput-object v0, Ll8/y;->o:[Ljava/lang/String;
    ...
    sput-object v0, Ll8/y;->q:Lcom/xiaomi/camera/utils/lifecycle/FreshLiveData;

    sput-object v0, Ll8/y;->r:Lcom/xiaomi/camera/utils/lifecycle/FreshLiveData;

    new-instance v0, Ll8/x;

    invoke-direct {v0}, Ll8/x;-><init>()V
...
.method public static A()V
    ...
    sput-object v0, Ll8/y;->e:Ljava/lang/String;
    ...
    sput-object v0, Ll8/y;->f:Ljava/lang/String;
    ...
    sput-object v0, Ll8/y;->g:Ljava/lang/String;

    sget-object v0, Ll8/y;->e:Ljava/lang/String;
...
.method public static B(Landroid/content/Context;[BZLandroid/net/Uri;Ljava/lang/String;Landroid/location/Location;IIIJLjava/lang/String;I)Landroid/net/Uri;
    ...
    const-string/jumbo v0, "updateImage:  orientation > "
    ...
    invoke-direct/range {v23 .. v30}, Lq8/c;-><init>(JLjava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Z)V
    :try_end_1
    ...
    const-string/jumbo v12, "queryImageStore error"
    ...
    iget-object v0, v6, Lq8/c;->b:Ljava/lang/String;

    if-eqz v0, :cond_4

    iget-boolean v4, v6, Lq8/c;->e:Z
    ...
    invoke-static {v2, v1}, Ll8/y;->e(Ljava/lang/String;Z)Ljava/lang/String;
    ...
    const-string/jumbo v0, "updateImage:  tmpPath = "
    ...
    const-string/jumbo v13, "updateImage uri-> "
    ...
    :goto_a
    invoke-static {v0, v15}, Ll8/y;->b(Ljava/lang/Exception;Ljava/lang/String;)V
    ...
    invoke-static {v0}, Ll8/y;->s(Ljava/lang/Exception;)Z

    move-result v0

    if-eqz v0, :cond_9

    sget-object v0, Ll8/y;->q:Lcom/xiaomi/camera/utils/lifecycle/FreshLiveData;
    ...
    const-string/jumbo v13, "updateImage  writeFile cost %s ms, fileLen: %d"
    ...
    const-string/jumbo v13, "start copy: "
    ...
    invoke-static {v13, v8, v0}, Lq8/d;->g(Landroid/content/Context;Landroid/net/Uri;Ljava/lang/String;)Z
    ...
    const-string/jumbo v0, "renameTo failed, tmpPath = "
    ...
    invoke-static/range {p4 .. p4}, Landroidx/appcompat/app/b;->i(Ljava/lang/String;)Ljava/lang/StringBuilder;
    ...
    invoke-static/range {v1 .. v6}, Ll8/y;->z(Landroid/content/Context;Landroid/net/Uri;Landroid/content/ContentValues;Ljava/lang/String;[BI)I
...
.method public static C(Ljava/lang/String;)Z
    ...
    invoke-static {p0}, Ll8/y;->u(Ljava/lang/String;)Z
...
.method public static E(Landroid/hardware/camera2/DngCreator;Ljava/io/BufferedOutputStream;Ljava/nio/ByteBuffer;)V
    .locals 8
    ...
    :try_start_0
    const-class v1, Landroid/hardware/camera2/DngCreator;
    ...
    const-string p1, "Failed to call method: writeLossLessJpeg , "
...
.method public static a(Landroid/content/Context;Ljava/lang/String;JLandroid/location/Location;I[BZIIZZJI)Landroid/net/Uri;
    ...
    invoke-static {v13, v0}, Ll8/y;->e(Ljava/lang/String;Z)Ljava/lang/String;
    ...
    invoke-static {v7}, Ll8/y;->C(Ljava/lang/String;)Z

    move-result v21

    invoke-static/range {p1 .. p1}, Ll8/y;->t(Ljava/lang/String;)Z
    ...
    :cond_2
    invoke-static {v14, v7, v2}, Ll8/y;->i(Landroid/content/Context;Ljava/lang/String;Z)Landroid/net/Uri;
    ...
    const-string/jumbo v25, "title LIKE ?"
    ...
    invoke-static {v1}, Lq8/d;->b([Landroid/net/Uri;)V

    :cond_7
    sget-boolean v22, Ll8/y;->p:Z
    ...
    invoke-static {v14, v7}, Lq8/d;->c(Landroid/content/Context;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v13, v6}, Landroidx/activity/m;->f(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v14, v0}, Ll8/y;->w(Landroid/content/Context;Landroid/net/Uri;)Z
    ...
    invoke-static {v14, v11, v8, v0}, Ll8/y;->x(Landroid/content/Context;[BLjava/lang/String;Landroid/net/Uri;)Z
    ...
    invoke-static {v8, v1}, Ll8/y;->w(Landroid/content/Context;Landroid/net/Uri;)Z
    ...
    invoke-static {v1, v10}, Landroidx/appcompat/widget/d;->d(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
...
.method public static b(Ljava/lang/Exception;Ljava/lang/String;)V
    ...
    invoke-static {p1}, Lq8/b;->a(Ljava/lang/String;)Ljava/lang/String;
...
.method public static e(Ljava/lang/String;Z)Ljava/lang/String;
    ...
    :goto_0
    invoke-static {p0, p1}, Ll8/y;->d(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
...
.method public static f(Landroid/content/Context;)J
    ...
    invoke-static {p0, v0}, Ll8/y;->g(Landroid/content/Context;Ljava/lang/String;)J
...
.method public static g(Landroid/content/Context;Ljava/lang/String;)J
    ...
    invoke-static {v0, p1, v6, v7}, Lq8/d;->e(Landroid/content/Context;Ljava/lang/String;J)Landroid/net/Uri;
    ...
    invoke-static {v0, v5, v1, v2}, Lq8/d;->e(Landroid/content/Context;Ljava/lang/String;J)Landroid/net/Uri;
    ...
    invoke-static {v0, p1, v1, v2}, Lq8/d;->e(Landroid/content/Context;Ljava/lang/String;J)Landroid/net/Uri;
    ...
    :goto_6
    :try_start_5
    invoke-static {p1}, Ll8/y;->j(Ljava/lang/String;)J
    ...
    invoke-static {p0, p1, v1}, Landroidx/activity/result/d;->e(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/StringBuilder;
...
.method public static h()J
    ...
    :cond_0
    sget-object v0, Ll8/y;->n:Ljava/util/concurrent/atomic/AtomicLong;
...
.method public static i(Landroid/content/Context;Ljava/lang/String;Z)Landroid/net/Uri;
    ...
    invoke-static {p0, p1}, Ll8/y;->r(Landroid/content/Context;Ljava/lang/String;)Z
    ...
    invoke-virtual {p1, v3, v4}, Lvg/b;->b(Ljava/lang/String;Ljava/lang/Object;)Ljava/lang/Object;
...
.method public static j(Ljava/lang/String;)J
    ...
    sget-object p0, Ll8/y;->n:Ljava/util/concurrent/atomic/AtomicLong;
    ...
    invoke-static {p0, v0, v1, v3}, Landroid/support/v4/media/session/d;->d(Ljava/lang/StringBuilder;JLjava/lang/String;)Ljava/lang/String;
    ...
    sget-object v2, Ll8/y;->q:Lcom/xiaomi/camera/utils/lifecycle/FreshLiveData;
...
.method public static m(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;JLjava/lang/String;ILjava/lang/String;JIILandroid/location/Location;ZZJ)Landroid/net/Uri;
    ...
    :cond_2
    invoke-static/range {p7 .. p7}, Ll8/y;->C(Ljava/lang/String;)Z
    ...
    invoke-static {v0, v15, v5}, Ll8/y;->i(Landroid/content/Context;Ljava/lang/String;Z)Landroid/net/Uri;
    ...
    :try_start_2
    invoke-static {v0, v15}, Lq8/d;->c(Landroid/content/Context;Ljava/lang/String;)Ljava/lang/String;
    ...
    :try_start_3
    invoke-static/range {v1 .. v16}, Lq8/d;->f(Landroid/content/Context;JLjava/lang/String;Ljava/lang/String;JLjava/lang/String;JIIILjava/lang/String;J)V
    ...
    invoke-static {v0, v12}, Landroidx/appcompat/widget/d;->c(Ljava/lang/String;Landroid/net/Uri;)Ljava/lang/String;
...
.method public static o(Ljava/lang/String;)Z
    ...
    invoke-static {p0}, Ll8/y;->p(Ljava/lang/String;)Z
...
.method public static r(Landroid/content/Context;Ljava/lang/String;)Z
    ...
    invoke-static {p0, p1}, Ll8/y;->g(Landroid/content/Context;Ljava/lang/String;)J
...
.method public static t(Ljava/lang/String;)Z
    ...
    invoke-static {p0}, Ll8/y;->n(Ljava/lang/String;)Z

    move-result v0

    if-nez v0, :cond_1

    invoke-static {p0}, Ll8/y;->o(Ljava/lang/String;)Z
...
.method public static v(JJLandroid/content/Context;Ljava/lang/String;ZZ)V
    ...
    const-string/jumbo v2, "request gallery scan, filePath: "
...
.method public static w(Landroid/content/Context;Landroid/net/Uri;)Z
    ...
    const-string/jumbo v1, "requireRecordExists: date_taken = "

    const-string/jumbo v2, "requireRecordExists: record does not exist: "
    ...
    const-string/jumbo p1, "requireRecordExists: query operation failed"
...
.method public static x(Landroid/content/Context;[BLjava/lang/String;Landroid/net/Uri;)Z
    ...
    :goto_2
    invoke-static {v3, p2}, Ll8/y;->b(Ljava/lang/Exception;Ljava/lang/String;)V
    ...
    invoke-static {v3}, Ll8/y;->s(Ljava/lang/Exception;)Z
    ...
    sget-object v1, Ll8/y;->q:Lcom/xiaomi/camera/utils/lifecycle/FreshLiveData;

    sget-object v3, Ljava/lang/Boolean;->FALSE:Ljava/lang/Boolean;

    invoke-virtual {v1, v3}, Lcom/xiaomi/camera/utils/lifecycle/FreshLiveData;->postValue(Ljava/lang/Object;)V
...
.method public static y(IJJJLandroid/content/Context;Landroid/location/Location;Ljava/lang/String;ZZ)V
    ...
    invoke-direct/range {v0 .. v12}, Ll8/w;-><init>(IJJJLandroid/content/Context;Landroid/location/Location;Ljava/lang/String;ZZ)V
...
.method public static z(Landroid/content/Context;Landroid/net/Uri;Landroid/content/ContentValues;Ljava/lang/String;[BI)I
    ...
    const-string/jumbo v6, "updateAllowingReplace: file = "
    ...
    invoke-static/range {p3 .. p3}, Landroidx/appcompat/widget/f;->i(Ljava/lang/String;)Z
    ...
    const-string/jumbo v10, "updateAllowingReplace: Exception: file stats: size = "
    ...
    :cond_2
    invoke-static {v1, v4, v6}, Ll8/y;->i(Landroid/content/Context;Ljava/lang/String;Z)Landroid/net/Uri;

    move-result-object v7

    const-string/jumbo v9, "updateAllowingReplace: baseUri: "

    invoke-static {v9, v7}, Landroidx/appcompat/widget/d;->c(Ljava/lang/String;Landroid/net/Uri;)Ljava/lang/String;
    ...
    const-string/jumbo v11, "updateAllowingReplace: owners: "
    ...
    invoke-static {v9, v6}, Landroidx/appcompat/widget/d;->d(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v6, v12, v13}, Landroidx/appcompat/widget/c;->g(Ljava/lang/String;J)Ljava/lang/String;
    ...
    invoke-static {v6, v10}, Lpj/g;->c(Ljava/lang/String;Z)Z
    ...
    invoke-static {v1, v5, v4, v2}, Ll8/y;->x(Landroid/content/Context;[BLjava/lang/String;Landroid/net/Uri;)Z
