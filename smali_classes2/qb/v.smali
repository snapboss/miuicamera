...
.method public constructor <init>(Ljava/lang/Class;)V
    ...
    .line 2
    iput-object p1, p0, Lqb/v;->e:Ljava/lang/Boolean;

    .line 3
    iput-object p1, p0, Lqb/v;->g:Lob/r;

    return-void
.end method

.method public constructor <init>(Lqb/v;Lob/r;Ljava/lang/Boolean;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 5
    iput-object p3, p0, Lqb/v;->e:Ljava/lang/Boolean;

    .line 6
    iput-object p2, p0, Lqb/v;->g:Lob/r;
...
.method public final b0(Ldb/h;Llb/f;)Ljava/lang/Object;
    ...
    iget-object v2, p0, Lqb/v;->e:Ljava/lang/Boolean;
    ...
    invoke-virtual {p0, p1, p2}, Lqb/v;->c0(Ldb/h;Llb/f;)Ljava/lang/Object;
...
.method public final c(Llb/f;Llb/c;)Llb/i;
    ...
    invoke-interface {p2}, Llb/c;->getMetadata()Llb/v;

    move-result-object v3

    iget-object v3, v3, Llb/v;->g:Lcb/h0;
    ...
    :goto_0
    sget-object v4, Lcb/h0;->a:Lcb/h0;

    if-ne v3, v4, :cond_1

    sget-object v2, Lpb/t;->b:Lpb/t;

    goto :goto_1

    :cond_1
    sget-object v4, Lcb/h0;->b:Lcb/h0;
    ...
    invoke-virtual {p1, p2}, Llb/f;->o(Ljava/lang/Class;)Llb/h;

    move-result-object p1

    new-instance p2, Lpb/u;

    invoke-direct {p2, v2, p1}, Lpb/u;-><init>(Llb/w;Llb/h;)V
    ...
    :cond_2
    invoke-interface {p2}, Llb/c;->getType()Llb/h;
    ...
    invoke-interface {p2}, Llb/c;->a()Llb/w;

    move-result-object p2

    invoke-direct {v2, p2, p1}, Lpb/u;-><init>(Llb/w;Llb/h;)V

    :cond_3
    :goto_1
    iget-object p1, p0, Lqb/v;->e:Ljava/lang/Boolean;

    if-ne v0, p1, :cond_4

    iget-object p1, p0, Lqb/v;->g:Lob/r;
    ...
    :cond_4
    invoke-virtual {p0, v2, v0}, Lqb/v;->d0(Lob/r;Ljava/lang/Boolean;)Lqb/v;
...
.method public abstract c0(Ldb/h;Llb/f;)Ljava/lang/Object;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
            "Ldb/h;",
...
.method public abstract d0(Lob/r;Ljava/lang/Boolean;)Lqb/v;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
            "Lob/r;",
...
.method public final g(Ldb/h;Llb/f;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    :cond_1
    invoke-virtual {p0, p3, p1}, Lqb/v;->Z(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
...
.method public final k(Llb/f;)Ljava/lang/Object;
    ...
    iget-object p1, p0, Lqb/v;->f:Ljava/lang/Object;

    if-nez p1, :cond_0

    invoke-virtual {p0}, Lqb/v;->a0()Ljava/lang/Object;

    move-result-object p1

    iput-object p1, p0, Lqb/v;->f:Ljava/lang/Object;
