...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lorg/jcodec/containers/mp4/boxes/SegmentIndexBox$a;
    }
.end annotation
...
.field public references:[Lorg/jcodec/containers/mp4/boxes/SegmentIndexBox$a;
...
.method public static createSegmentIndexBox()Lorg/jcodec/containers/mp4/boxes/SegmentIndexBox;
    ...
    invoke-direct {v0, v1}, Lorg/jcodec/containers/mp4/boxes/SegmentIndexBox;-><init>(Lorg/jcodec/containers/mp4/boxes/b;)V
...
.method public doWrite(Ljava/nio/ByteBuffer;)V
    ...
    iget-object v2, p0, Lorg/jcodec/containers/mp4/boxes/SegmentIndexBox;->references:[Lorg/jcodec/containers/mp4/boxes/SegmentIndexBox$a;

    aget-object v2, v2, v1

    iget-boolean v3, v2, Lorg/jcodec/containers/mp4/boxes/SegmentIndexBox$a;->a:Z

    shl-int/lit8 v3, v3, 0x1f

    int-to-long v3, v3

    iget-wide v5, v2, Lorg/jcodec/containers/mp4/boxes/SegmentIndexBox$a;->b:J

    or-long/2addr v3, v5

    long-to-int v3, v3

    iget-wide v4, v2, Lorg/jcodec/containers/mp4/boxes/SegmentIndexBox$a;->c:J

    long-to-int v4, v4

    iget-boolean v5, v2, Lorg/jcodec/containers/mp4/boxes/SegmentIndexBox$a;->d:Z
    ...
    :goto_2
    iget v6, v2, Lorg/jcodec/containers/mp4/boxes/SegmentIndexBox$a;->e:I
    ...
    iget-wide v7, v2, Lorg/jcodec/containers/mp4/boxes/SegmentIndexBox$a;->f:J
...
.method public parse(Ljava/nio/ByteBuffer;)V
    ...
    new-array v1, v1, [Lorg/jcodec/containers/mp4/boxes/SegmentIndexBox$a;

    iput-object v1, v0, Lorg/jcodec/containers/mp4/boxes/SegmentIndexBox;->references:[Lorg/jcodec/containers/mp4/boxes/SegmentIndexBox$a;
    ...
    invoke-static {v7}, Lku/a;->e(I)J

    move-result-wide v7

    new-instance v9, Lorg/jcodec/containers/mp4/boxes/SegmentIndexBox$a;

    invoke-direct {v9}, Lorg/jcodec/containers/mp4/boxes/SegmentIndexBox$a;-><init>()V
    ...
    :goto_2
    iput-boolean v11, v9, Lorg/jcodec/containers/mp4/boxes/SegmentIndexBox$a;->a:Z

    const-wide/32 v15, 0x7fffffff

    and-long/2addr v3, v15

    iput-wide v3, v9, Lorg/jcodec/containers/mp4/boxes/SegmentIndexBox$a;->b:J

    iput-wide v5, v9, Lorg/jcodec/containers/mp4/boxes/SegmentIndexBox$a;->c:J
    ...
    :goto_3
    iput-boolean v12, v9, Lorg/jcodec/containers/mp4/boxes/SegmentIndexBox$a;->d:Z
    ...
    iput v3, v9, Lorg/jcodec/containers/mp4/boxes/SegmentIndexBox$a;->e:I

    const-wide/32 v3, 0xfffffff

    and-long/2addr v3, v7

    iput-wide v3, v9, Lorg/jcodec/containers/mp4/boxes/SegmentIndexBox$a;->f:J

    iget-object v3, v0, Lorg/jcodec/containers/mp4/boxes/SegmentIndexBox;->references:[Lorg/jcodec/containers/mp4/boxes/SegmentIndexBox$a;
...
.method public toString()Ljava/lang/String;
    ...
    iget-object v1, p0, Lorg/jcodec/containers/mp4/boxes/SegmentIndexBox;->references:[Lorg/jcodec/containers/mp4/boxes/SegmentIndexBox$a;

    sget-object v2, Lku/a;->a:Ljava/util/HashMap;
