...
.method public processCharacters(Lorg/apache/poi/hwpf/HWPFDocumentCore;ILorg/apache/poi/hwpf/usermodel/Range;Lorg/w3c/dom/Element;)Z
    ...
    instance-of v13, v0, Lorg/apache/poi/hwpf/HWPFDocument;
    ...
    invoke-interface {v5, v6, v7}, Lorg/apache/poi/hwpf/usermodel/Bookmarks;->getBookmarksStartedBetween(II)Ljava/util/Map;
    ...
    check-cast v7, Lorg/apache/poi/hwpf/usermodel/Bookmark;

    iget-object v8, v9, Lorg/apache/poi/hwpf/converter/AbstractWordConverter;->bookmarkStack:Ljava/util/Set;
    ...
    invoke-direct {v8, v7}, Lorg/apache/poi/hwpf/converter/AbstractWordConverter$Structure;-><init>(Lorg/apache/poi/hwpf/usermodel/Bookmark;)V

    invoke-static {v2, v8}, Lorg/apache/poi/hwpf/converter/AbstractWordConverter;->addToStructures(Ljava/util/List;Lorg/apache/poi/hwpf/converter/AbstractWordConverter$Structure;)V
    ...
    invoke-virtual {v11, v1}, Lorg/apache/poi/hwpf/usermodel/Range;->getCharacterRun(I)Lorg/apache/poi/hwpf/usermodel/CharacterRun;
    ...
    sget-object v7, Lorg/apache/poi/hwpf/model/FieldsDocumentPart;->MAIN:Lorg/apache/poi/hwpf/model/FieldsDocumentPart;

    invoke-virtual {v6}, Lorg/apache/poi/hwpf/usermodel/Range;->getStartOffset()I

    move-result v8

    invoke-interface {v5, v7, v8}, Lorg/apache/poi/hwpf/usermodel/Fields;->getFieldByStartOffset(Lorg/apache/poi/hwpf/model/FieldsDocumentPart;I)Lorg/apache/poi/hwpf/usermodel/Field;

    move-result-object v5

    if-eqz v5, :cond_6

    new-instance v3, Lorg/apache/poi/hwpf/converter/AbstractWordConverter$Structure;

    invoke-direct {v3, v5}, Lorg/apache/poi/hwpf/converter/AbstractWordConverter$Structure;-><init>(Lorg/apache/poi/hwpf/usermodel/Field;)V

    invoke-static {v2, v3}, Lorg/apache/poi/hwpf/converter/AbstractWordConverter;->addToStructures(Ljava/util/List;Lorg/apache/poi/hwpf/converter/AbstractWordConverter$Structure;)V

    goto :goto_2

    :cond_6
    invoke-direct {v9, v0, v11, v1}, Lorg/apache/poi/hwpf/converter/AbstractWordConverter;->tryDeadField_lookupFieldSeparatorEnd(Lorg/apache/poi/hwpf/HWPFDocumentCore;Lorg/apache/poi/hwpf/usermodel/Range;I)[I

    move-result-object v5

    if-eqz v5, :cond_7

    new-instance v7, Lorg/apache/poi/hwpf/converter/AbstractWordConverter$Structure;

    new-instance v8, Lorg/apache/poi/hwpf/converter/AbstractWordConverter$DeadFieldBoundaries;

    aget v3, v5, v3

    aget v15, v5, v14

    invoke-direct {v8, v1, v3, v15}, Lorg/apache/poi/hwpf/converter/AbstractWordConverter$DeadFieldBoundaries;-><init>(III)V
    ...
    invoke-virtual {v3}, Lorg/apache/poi/hwpf/usermodel/Range;->getEndOffset()I

    move-result v3

    invoke-direct {v7, v8, v1, v3}, Lorg/apache/poi/hwpf/converter/AbstractWordConverter$Structure;-><init>(Lorg/apache/poi/hwpf/converter/AbstractWordConverter$DeadFieldBoundaries;II)V

    invoke-static {v2, v7}, Lorg/apache/poi/hwpf/converter/AbstractWordConverter;->addToStructures(Ljava/util/List;Lorg/apache/poi/hwpf/converter/AbstractWordConverter$Structure;)V
    ...
    check-cast v8, Lorg/apache/poi/hwpf/converter/AbstractWordConverter$Structure;

    iget v1, v8, Lorg/apache/poi/hwpf/converter/AbstractWordConverter$Structure;->start:I

    if-eq v1, v2, :cond_a

    new-instance v3, Lorg/apache/poi/hwpf/converter/AbstractWordConverter$1;

    invoke-direct {v3, v9, v2, v1, v11}, Lorg/apache/poi/hwpf/converter/AbstractWordConverter$1;-><init>(Lorg/apache/poi/hwpf/converter/AbstractWordConverter;IILorg/apache/poi/hwpf/usermodel/Range;)V

    invoke-virtual {v9, v0, v10, v3, v12}, Lorg/apache/poi/hwpf/converter/AbstractWordConverter;->processCharacters(Lorg/apache/poi/hwpf/HWPFDocumentCore;ILorg/apache/poi/hwpf/usermodel/Range;Lorg/w3c/dom/Element;)Z

    :cond_a
    iget-object v1, v8, Lorg/apache/poi/hwpf/converter/AbstractWordConverter$Structure;->structure:Ljava/lang/Object;
    ...
    iget v2, v8, Lorg/apache/poi/hwpf/converter/AbstractWordConverter$Structure;->start:I
    ...
    iget v4, v8, Lorg/apache/poi/hwpf/converter/AbstractWordConverter$Structure;->start:I
    ...
    iget v4, v8, Lorg/apache/poi/hwpf/converter/AbstractWordConverter$Structure;->end:I
    ...
    iget v2, v8, Lorg/apache/poi/hwpf/converter/AbstractWordConverter$Structure;->end:I
    ...
    iget v2, v14, Lorg/apache/poi/hwpf/converter/AbstractWordConverter$Structure;->end:I
    ...
    iget-object v2, v14, Lorg/apache/poi/hwpf/converter/AbstractWordConverter$Structure;->structure:Ljava/lang/Object;
    ...
    new-instance v3, Lorg/apache/poi/hwpf/converter/AbstractWordConverter$3;

    invoke-virtual/range {p3 .. p3}, Lorg/apache/poi/hwpf/usermodel/Range;->getEndOffset()I

    move-result v4

    invoke-direct {v3, v9, v2, v4, v11}, Lorg/apache/poi/hwpf/converter/AbstractWordConverter$3;-><init>(Lorg/apache/poi/hwpf/converter/AbstractWordConverter;IILorg/apache/poi/hwpf/usermodel/Range;)V
    ...
    invoke-virtual {v2, v1, v14}, Lorg/apache/poi/hwpf/model/PicturesTable;->extractPicture(Lorg/apache/poi/hwpf/usermodel/CharacterRun;Z)Lorg/apache/poi/hwpf/usermodel/Picture;
    ...
    :goto_8
    invoke-virtual {v9, v12, v14, v2}, Lorg/apache/poi/hwpf/converter/AbstractWordConverter;->processImage(Lorg/w3c/dom/Element;ZLorg/apache/poi/hwpf/usermodel/Picture;)V
    ...
    invoke-interface {v15}, Lorg/apache/poi/hwpf/usermodel/Field;->getFieldEndOffset()I
    ...
    invoke-virtual {v9, v12, v1, v14}, Lorg/apache/poi/hwpf/converter/AbstractWordConverter;->outputCharacters(Lorg/w3c/dom/Element;Lorg/apache/poi/hwpf/usermodel/CharacterRun;Ljava/lang/String;)V
...
.method public processField(Lorg/apache/poi/hwpf/HWPFDocument;Lorg/apache/poi/hwpf/usermodel/Range;ILorg/apache/poi/hwpf/usermodel/Field;Lorg/w3c/dom/Element;)V
    ...
    invoke-direct {v3, p0, v10, v2, v6}, Lorg/apache/poi/hwpf/converter/AbstractWordConverter$7;-><init>(Lorg/apache/poi/hwpf/converter/AbstractWordConverter;IILorg/apache/poi/hwpf/usermodel/Range;)V
