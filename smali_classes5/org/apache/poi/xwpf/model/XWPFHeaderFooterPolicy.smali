...
.method private getWatermarkParagraph(Ljava/lang/String;I)Lorg/apache/poi/xwpf/usermodel/XWPFParagraph;
    ...
    sget-object p1, Luu/c;->I:Lorg/apache/xmlbeans/SchemaType;
    ...
    invoke-interface {p0}, Luu/c;->k()Luu/e;

    move-result-object p0

    const-string p1, "_x0000_t136"

    invoke-interface {p0, p1}, Luu/e;->setId(Ljava/lang/String;)V

    invoke-interface {p0}, Luu/e;->h()V

    invoke-interface {p0}, Luu/e;->a()V

    invoke-interface {p0}, Luu/e;->m()V

    invoke-interface {p0}, Luu/e;->n()V

    invoke-interface {p0}, Luu/e;->f()Luu/b;
