...
.method private checkRowLengths([[Ljava/lang/Object;I)V
    ...
    const-string v1, "Array row "

    const-string v2, " has length "

    const-string v3, " but row 0 has length "

    invoke-static {v1, p0, v2, v0, v3}, Landroidx/activity/o;->c(Ljava/lang/String;ILjava/lang/String;ILjava/lang/String;)Ljava/lang/StringBuilder;
...
.method private static createAreaRef(Lorg/apache/poi/ss/formula/FormulaParser$SimpleRangePart;Lorg/apache/poi/ss/formula/FormulaParser$SimpleRangePart;)Lorg/apache/poi/ss/util/AreaReference;
    ...
    invoke-static {v1, p0, p1}, Landroidx/appcompat/widget/b;->f(Ljava/lang/StringBuilder;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
...
.method private function(Ljava/lang/String;)Lorg/apache/poi/ss/formula/ParseNode;
    ...
    const-string v1, "\' is completely unknown in the current workbook"
    ...
    const-string v0, "Attempt to use name \'"

    const-string v1, "\' as a function, but defined name in workbook does not refer to a function"
    ...
    const-string v0, "Need book to evaluate name \'"
...
.method private parseNonRange(I)Lorg/apache/poi/ss/formula/ParseNode;
    ...
    const-string v0, "Specified name \'"

    const-string v1, "\' is not a range as expected."
    ...
    const-string v0, "Specified named range \'"

    const-string v1, "\' does not exist in the current workbook."
...
.method private parseRangeable()Lorg/apache/poi/ss/formula/ParseNode;
    ...
    invoke-static {p0, v0, v1}, Landroidx/appcompat/widget/c;->h(Ljava/lang/StringBuilder;Ljava/lang/String;C)Ljava/lang/String;
    ...
    invoke-static {p0, v1, v2}, Landroidx/appcompat/widget/b;->f(Ljava/lang/StringBuilder;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    const-string v0, "\' must have exactly 2 dots."

    invoke-static {v3, v9, v0}, Landroidx/appcompat/widget/g;->b(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    const-string v0, "\' must not contain whitespace."
...
.method private validateNumArgs(ILorg/apache/poi/ss/formula/function/FunctionMetadata;)V
    ...
    invoke-static {p0, v3}, Landroidx/appcompat/view/menu/a;->h(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/StringBuilder;
    ...
    invoke-static {v0, v3, p0}, Landroidx/activity/m;->g(Ljava/lang/String;Ljava/lang/String;I)Ljava/lang/String;
