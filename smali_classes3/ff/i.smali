...
.method public constructor <init>(Lff/e;)V
    ...
    iput-object v0, p0, Lff/i;->f:Ljava/util/concurrent/ConcurrentHashMap;

    new-instance v0, Ljava/util/concurrent/CopyOnWriteArraySet;

    invoke-direct {v0}, Ljava/util/concurrent/CopyOnWriteArraySet;-><init>()V

    iput-object v0, p0, Lff/i;->g:Ljava/util/concurrent/CopyOnWriteArraySet;

    new-instance v0, Ljava/util/concurrent/ConcurrentHashMap;

    invoke-direct {v0}, Ljava/util/concurrent/ConcurrentHashMap;-><init>()V

    iput-object v0, p0, Lff/i;->h:Ljava/util/concurrent/ConcurrentHashMap;

    new-instance v0, Ljava/util/concurrent/ConcurrentHashMap;

    invoke-direct {v0}, Ljava/util/concurrent/ConcurrentHashMap;-><init>()V

    iput-object v0, p0, Lff/i;->i:Ljava/util/concurrent/ConcurrentHashMap;

    new-instance v0, Ljava/util/concurrent/CopyOnWriteArraySet;

    invoke-direct {v0}, Ljava/util/concurrent/CopyOnWriteArraySet;-><init>()V

    iput-object v0, p0, Lff/i;->j:Ljava/util/concurrent/CopyOnWriteArraySet;

    const-wide/16 v0, 0x0

    iput-wide v0, p0, Lff/i;->k:J

    const/4 v0, 0x0

    iput-boolean v0, p0, Lff/i;->l:Z

    iput-object p1, p0, Lff/i;->c:Lff/e;

    new-instance v1, Lif/a;

    invoke-direct {v1, p1}, Lif/a;-><init>(Lff/e;)V

    iput-object v1, p0, Lff/i;->d:Lif/a;

    new-instance v2, Lff/i$a;

    invoke-direct {v2, p0}, Lff/i$a;-><init>(Lff/i;)V

    new-instance v3, Lif/c;

    invoke-direct {v3, p1, v1, v2}, Lif/c;-><init>(Lff/e;Lif/a;Lff/i$a;)V

    iput-object v3, p0, Lff/i;->e:Lif/c;
    ...
    iput-object p1, p0, Lff/i;->a:Landroid/os/HandlerThread;
    ...
    new-instance v1, Lff/i$b;

    invoke-direct {v1, p0}, Lff/i$b;-><init>(Lff/i;)V

    invoke-direct {v0, p1, v1}, Landroid/os/Handler;-><init>(Landroid/os/Looper;Landroid/os/Handler$Callback;)V

    iput-object v0, p0, Lff/i;->b:Landroid/os/Handler;
...
.method public final a(Ljava/lang/String;)V
    ...
    iget-object v0, p0, Lff/i;->c:Lff/e;
    ...
    invoke-virtual {p1, v0}, Lrf/a;->b(Ljava/lang/String;)J
    ...
    invoke-virtual {p1, p0}, Lrf/a;->b(Ljava/lang/String;)J
    ...
    invoke-virtual {p1, v0, v1, p0}, Lrf/a;->e(JLjava/lang/String;)V
    ...
    invoke-virtual {p1, v5, v6, v0}, Lrf/a;->e(JLjava/lang/String;)V

    iget-wide v0, p0, Lff/i;->k:J
    ...
    iput-wide v3, p0, Lff/i;->k:J

    iget-boolean v3, p0, Lff/i;->l:Z
    ...
    :goto_2
    invoke-virtual {p1, v3}, Lrf/a;->b(Ljava/lang/String;)J
    ...
    invoke-virtual {p1, v0, v1, v3}, Lrf/a;->e(JLjava/lang/String;)V

    :cond_7
    iput-boolean v2, p0, Lff/i;->l:Z
...
.method public final b(Z)V
    ...
    :try_start_0
    iget-object v2, p0, Lff/i;->c:Lff/e;
    ...
    iget-object p0, p0, Lff/i;->b:Landroid/os/Handler;
...
.method public final c()V
    ...
    iget-object v0, v0, Lff/e;->l:Landroid/content/Context;
...
.method public final d(Lmf/f;)V
    ...
    iget-object v1, v0, Lff/e;->b:Lof/a;
    ...
    :cond_0
    iget-object v2, p1, Lmf/h;->a:Lmf/i;
    ...
    invoke-static {v2}, Lbk/a;->c(Ljava/lang/Object;)Lbk/a;

    move-result-object v4

    iget-object v5, p0, Lff/i;->j:Ljava/util/concurrent/CopyOnWriteArraySet;
    ...
    invoke-direct {v7, p0}, Lrf/a;-><init>(Lr/m;)V
    ...
    iget-object p0, v0, Lff/e;->l:Landroid/content/Context;
    ...
    invoke-virtual {v7, v6, v0}, Lrf/a;->d(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-virtual {v7, v0, p0}, Lrf/a;->c(Ljava/lang/String;I)V
    ...
    invoke-virtual {v7, v0, p0}, Lrf/a;->d(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-virtual {v7, p0, v0}, Lrf/a;->d(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {v6, v0}, Lqf/a;->b(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-virtual {p0, v2, v3, p1}, Lrf/a;->e(JLjava/lang/String;)V
    ...
    :pswitch_4
    check-cast p1, Llf/sb;

    const-wide/16 v0, 0x0

    if-eqz p1, :cond_d

    iget-object p1, p1, Llf/sb;->a:Lbk/a;
    ...
    invoke-virtual {p0, p1}, Lrf/a;->b(Ljava/lang/String;)J
    ...
    invoke-virtual {p0, v0, v1, p1}, Lrf/a;->e(JLjava/lang/String;)V
