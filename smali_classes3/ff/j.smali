...
.method public constructor <init>(Lff/e;Landroid/os/Looper;)V
    ...
    iput-object p2, p0, Lff/j;->f:Ljava/util/LinkedList;
    ...
    invoke-virtual {p2, v0, v1}, Lof/a;->e(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;

    move-result-object v0

    iput-object v0, p0, Lff/j;->e:Ljava/lang/String;
    ...
    invoke-direct {v0, p1}, Lcom/xiaomi/ai/android/codec/AudioEncoder;-><init>(Lff/a;)V

    iput-object v0, p0, Lff/j;->b:Lcom/xiaomi/ai/android/codec/AudioEncoder;
    ...
    iput-object p1, p0, Lff/j;->b:Lcom/xiaomi/ai/android/codec/AudioEncoder;

    :cond_2
    const-string p1, "asr.vad_type"

    invoke-virtual {p2, p1, v2}, Lof/a;->c(Ljava/lang/String;I)I
    ...
    :goto_1
    iput-boolean v3, p0, Lff/j;->d:Z

    if-eqz v3, :cond_5

    const-string p1, "asr.enable_new_vad"

    invoke-virtual {p2, p1, v2}, Lof/a;->b(Ljava/lang/String;Z)Z
    ...
    invoke-virtual {p2, v3, v2}, Lof/a;->c(Ljava/lang/String;I)I

    move-result v3

    const-string v4, "asr.max_length_reset"

    invoke-virtual {p2, v4, v2}, Lof/a;->c(Ljava/lang/String;I)I

    move-result p2

    invoke-direct {p1, v0, v1, v3, p2}, Lcom/xiaomi/ai/android/vad/Vad2;-><init>(IIII)V

    iput-object p1, p0, Lff/j;->c:Lkf/a;
    ...
    invoke-static {p1, p0}, Lqf/a;->b(Ljava/lang/String;Ljava/lang/String;)V
...
.method public final a([BZ)V
    ...
    iget-object v0, p0, Lff/j;->e:Ljava/lang/String;
    ...
    :cond_2
    iget-object v1, p0, Lff/j;->b:Lcom/xiaomi/ai/android/codec/AudioEncoder;
    ...
    iget-object p0, p0, Lff/j;->a:Lff/e;

    iget-object v1, p0, Lff/e;->f:Lof/b;
    ...
    iget-object p0, p0, Lff/e;->d:Lff/f;

    iget-object p0, p0, Lff/f;->b:Ljava/lang/String;

    invoke-virtual {v0, p0}, Lff/i;->a(Ljava/lang/String;)V

    invoke-virtual {v1, p1, p2}, Lof/b;->h(I[B)Z
...
.method public final b()V
    ...
    :try_start_0
    iget-object v1, p0, Lff/j;->f:Ljava/util/LinkedList;
    ...
    iget-object v0, p0, Lff/j;->f:Ljava/util/LinkedList;
...
.method public final c()V
    ...
    iget-object p0, p0, Lff/j;->f:Ljava/util/LinkedList;
...
.method public final handleMessage(Landroid/os/Message;)V
    ...
    iget-object v1, p0, Lff/j;->a:Lff/e;

    iget-object v2, v1, Lff/e;->f:Lof/b;
    ...
    iget-object v6, p0, Lff/j;->b:Lcom/xiaomi/ai/android/codec/AudioEncoder;

    iget-object v7, p0, Lff/j;->c:Lkf/a;
    ...
    :cond_1
    iget-object p1, v1, Lff/e;->l:Landroid/content/Context;
    ...
    invoke-static {v3, p1}, Lqf/a;->d(Ljava/lang/String;Ljava/lang/String;)V

    const-class p1, Lef/d;

    invoke-virtual {v1, p1}, Lff/e;->a(Ljava/lang/Class;)Lef/b;
    ...
    :cond_3
    iget-object p0, v1, Lff/e;->e:Lff/b;

    iget-object p1, p0, Lff/b;->a:Lff/e;

    iget-object p1, p1, Lff/e;->b:Lof/a;
    ...
    invoke-virtual {p0, v1}, Lff/b;->G(Z)V
    ...
    invoke-virtual {p0, v0, p1}, Lff/j;->a([BZ)V
    ...
    :cond_7
    iget-object p0, v1, Lff/e;->p:Lff/i;

    iget-object p1, v1, Lff/e;->d:Lff/f;

    iget-object p1, p1, Lff/f;->b:Ljava/lang/String;

    invoke-virtual {p0, p1}, Lff/i;->a(Ljava/lang/String;)V

    invoke-virtual {v2, v0}, Lof/b;->i([B)Z
    ...
    invoke-interface {v7, v0}, Lkf/a;->a([B)Z
    ...
    new-instance p0, Llf/ib;

    invoke-direct {p0}, Llf/ib;-><init>()V

    invoke-static {}, Lmf/a;->b()Ljava/lang/String;

    move-result-object p1

    const-class v0, Llf/ib;
    ...
    invoke-interface {v0}, Lmf/j;->namespace()Ljava/lang/String;

    move-result-object v4

    invoke-interface {v0}, Lmf/j;->name()Ljava/lang/String;

    move-result-object v0

    invoke-direct {v3, v4, v0}, Lmf/g;-><init>(Ljava/lang/String;Ljava/lang/String;)V

    iput-object p1, v3, Lmf/g;->c:Ljava/lang/String;

    invoke-direct {v2, v3, p0}, Lmf/f;-><init>(Lmf/g;Ljava/lang/Object;)V

    iget-object p0, v1, Lff/e;->d:Lff/f;
    ...
    iput-object p0, v3, Lmf/g;->d:Lbk/a;

    iget-object p0, v1, Lff/e;->p:Lff/i;

    invoke-virtual {p0, v2}, Lff/i;->d(Lmf/f;)V

    iget-object p0, v1, Lff/e;->h:Lff/d;
    ...
    invoke-interface {v7}, Lkf/a;->release()V
    ...
    invoke-interface {v7}, Lkf/a;->init()Z
    ...
    iget-object v6, p0, Lff/j;->e:Ljava/lang/String;
    ...
    :cond_b
    invoke-virtual {p0, v4, v5}, Lff/j;->a([BZ)V
    ...
    :cond_d
    iget-object v6, p0, Lff/i;->f:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    invoke-virtual {v4, v5, v6, p0}, Lrf/a;->e(JLjava/lang/String;)V
    ...
    const-class p0, Lef/c;

    invoke-virtual {v1, p0}, Lff/e;->a(Ljava/lang/Class;)Lef/b;
    ...
    :cond_13
    invoke-virtual {v2, p1}, Lof/b;->j(Lmf/d;)Z
