...
.method public constructor <init>(Lff/e;)V
    ...
    iput-object p1, p0, Lff/g;->b:Lff/e;
    ...
    :cond_0
    iput-boolean v2, p0, Lff/g;->a:Z

    new-instance v0, Lgf/a;

    invoke-direct {v0, p1}, Lgf/a;-><init>(Lff/e;)V

    iput-object v0, p0, Lff/g;->c:Lgf/a;
...
.method public final a(Lmf/f;)V
    ...
    :cond_0
    iget-object p0, p0, Lff/g;->b:Lff/e;

    iget-object p1, p0, Lff/e;->b:Lof/a;

    const/4 v0, 0x0

    const-string v1, "connection.keep_alive_type"

    invoke-virtual {p1, v1, v0}, Lof/a;->c(Ljava/lang/String;I)I
    ...
    iget-object p1, p0, Lff/e;->i:Lff/j;
    ...
    iget-object p0, p0, Lff/e;->f:Lof/b;

    if-eqz p0, :cond_1

    invoke-virtual {p0}, Lof/b;->m()V
...
.method public final b(Lmf/f;)V
    ...
    :cond_0
    iget-object p0, p0, Lff/g;->c:Lgf/a;

    if-eqz p0, :cond_14

    invoke-virtual {p0, v3, v2}, Lgf/a;->a([BZ)V
    ...
    iget-object v1, p1, Lmf/h;->b:Ljava/lang/Object;

    check-cast v1, Llf/sb;

    iget-object v4, v1, Llf/sb;->a:Lbk/a;
    ...
    :goto_0
    iget-object v5, p0, Lff/g;->b:Lff/e;

    iget-object v5, v5, Lff/e;->b:Lof/a;

    const-string v6, "tts.enable_internal_player"

    invoke-virtual {v5, v6, v2}, Lof/a;->b(Ljava/lang/String;Z)Z
    ...
    iget-object p1, p1, Lmf/h;->a:Lmf/i;
    ...
    :cond_6
    iget-object p1, p0, Lff/g;->b:Lff/e;

    iget-object p1, p1, Lff/e;->d:Lff/f;

    const/4 v6, 0x0

    if-eqz v5, :cond_7

    iget-object p1, p1, Lff/f;->a:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    :cond_b
    iget-object p1, v1, Llf/sb;->b:Lbk/a;
    ...
    invoke-virtual {v3, v7, v2}, Lof/a;->b(Ljava/lang/String;Z)Z
    ...
    :cond_d
    iget-object v3, p0, Lff/g;->c:Lgf/a;

    if-nez v3, :cond_e

    new-instance v3, Lgf/a;

    iget-object v7, p0, Lff/g;->b:Lff/e;

    invoke-direct {v3, v7, p1, v5}, Lgf/a;-><init>(Lff/e;ILjava/lang/String;)V

    iput-object v3, p0, Lff/g;->c:Lgf/a;
    ...
    invoke-virtual {v3}, Lgf/a;->f()V

    new-instance p1, Landroid/media/MediaPlayer;

    invoke-direct {p1}, Landroid/media/MediaPlayer;-><init>()V

    iput-object p1, v3, Lgf/a;->l:Landroid/media/MediaPlayer;
    ...
    :try_start_1
    iget-object v0, v3, Lgf/a;->l:Landroid/media/MediaPlayer;
    ...
    iget-object v0, p0, Lff/g;->c:Lgf/a;
    ...
    iget v1, v0, Lgf/a;->m:I

    if-ne v1, p1, :cond_10

    iget-object p1, v0, Lgf/a;->l:Landroid/media/MediaPlayer;
    ...
    invoke-static {p1, v1}, Lqf/a;->d(Ljava/lang/String;Ljava/lang/String;)V
    ...
    iget v3, v0, Lgf/a;->a:I

    if-ne p1, v3, :cond_13

    iput p1, v0, Lgf/a;->a:I
    ...
    invoke-direct {v0, v3, p1, v5}, Lgf/a;-><init>(Lff/e;ILjava/lang/String;)V
    ...
    iget-object p1, p0, Lgf/a;->o:Landroid/os/Handler;

    if-eqz p1, :cond_14

    invoke-virtual {p1, v2}, Landroid/os/Handler;->removeMessages(I)V

    iget-object p0, p0, Lgf/a;->o:Landroid/os/Handler;
