...
.field public final e:Loi/a$d;

.field public final f:Loi/a$a;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Loi/a;->c:Ljava/lang/Object;

    new-instance v0, Loi/a$a;

    invoke-direct {v0, p0}, Loi/a$a;-><init>(Loi/a;)V

    iput-object v0, p0, Loi/a;->f:Loi/a$a;
    ...
    iput-object v0, p0, Loi/a;->d:Landroid/os/HandlerThread;
    ...
    invoke-direct {v1, p0, v0}, Loi/a$d;-><init>(Loi/a;Landroid/os/Looper;)V

    iput-object v1, p0, Loi/a;->e:Loi/a$d;

    return-void
.end method

.method public static a(Loi/a;Lyf/b$a;IZ)V
    .locals 17
    ...
    new-instance v12, Loi/b;

    invoke-direct {v12, v1, v0, v2}, Loi/b;-><init>(Loi/a;Lyf/b$a;I)V

    const/4 v13, 0x1

    if-nez v2, :cond_0

    iget-object v3, v0, Lyf/b$a;->d:Landroid/media/Image;
    ...
    iget-object v3, v0, Lyf/b$a;->e:Landroid/media/Image;
    ...
    iget-object v5, v0, Lyf/b$a;->c:Lcom/xiaomi/protocol/ICustomCaptureResult;
    ...
    invoke-static {v4, v5, v2}, Landroidx/activity/m;->h(Ljava/lang/StringBuilder;Ljava/lang/String;I)Ljava/lang/String;
    ...
    invoke-static {v4, v3, v6, v13}, Lvf/e;->l(Lcom/xiaomi/camera/imagecodec/ImagePool;Landroid/media/Image;IZ)Landroid/media/Image;
    ...
    iget-object v3, v1, Loi/a;->c:Ljava/lang/Object;
    ...
    iput-wide v6, v1, Loi/a;->a:J

    iput-boolean v13, v1, Loi/a;->b:Z
    ...
    iget-object v7, v0, Lyf/b$a;->c:Lcom/xiaomi/protocol/ICustomCaptureResult;
    ...
    iget-object v4, v1, Loi/a;->c:Ljava/lang/Object;
    ...
    :try_start_2
    iget-boolean v0, v1, Loi/a;->b:Z

    if-eqz v0, :cond_1

    iget-object v0, v1, Loi/a;->c:Ljava/lang/Object;
    ...
    invoke-static {v1, v2, v3}, Landroidx/appcompat/view/menu/b;->d(Ljava/lang/String;ILjava/lang/String;)Ljava/lang/String;
...
# virtual methods
.method public final b(Lyf/b;Lcom/xiaomi/engine/TaskSession;)V
    .locals 33
    ...
    sget-boolean v0, Lva/c;->w:Z

    iget-object v4, v1, Lyf/b;->f:Ljava/util/ArrayList;

    move-object/from16 v6, p0

    iget-object v6, v6, Loi/a;->f:Loi/a$a;
    ...
    iget-object v2, v0, Lyf/b$a;->c:Lcom/xiaomi/protocol/ICustomCaptureResult;

    iput-object v2, v0, Lyf/b$a;->c:Lcom/xiaomi/protocol/ICustomCaptureResult;

    iput-boolean v7, v0, Lyf/b$a;->a:Z

    iget-boolean v2, v0, Lyf/b$a;->m:Z

    if-eqz v2, :cond_0

    invoke-virtual {v0}, Lyf/b$a;->b()V

    :cond_0
    iget-object v2, v1, Lyf/b;->p:Lng/d;
    ...
    iget-object v8, v5, Lyf/b$a;->d:Landroid/media/Image;

    iget-object v9, v5, Lyf/b$a;->e:Landroid/media/Image;

    iget-object v5, v5, Lyf/b$a;->g:Landroid/media/Image;
    ...
    check-cast v10, Lng/t$c;

    invoke-virtual {v10, v8}, Lng/t$c;->b(Landroid/media/Image;)V
    ...
    check-cast v8, Lng/t$c;

    invoke-virtual {v8, v9}, Lng/t$c;->b(Landroid/media/Image;)V
    ...
    invoke-virtual {v8, v5}, Lng/t$c;->b(Landroid/media/Image;)V
    ...
    invoke-virtual {v0}, Lyf/b$a;->c()Z

    move-result v2

    if-eqz v2, :cond_5

    iput-object v0, v1, Lyf/b;->i:Lyf/b$a;

    invoke-virtual {v6, v1, v3}, Loi/a$a;->a(Lyf/b;Z)V
    ...
    iget v14, v1, Lyf/b;->b:I

    iget-boolean v15, v1, Lyf/b;->l:Z

    iget-object v10, v1, Lyf/b;->o:Lyf/d;

    const/16 v17, 0x1

    iget-boolean v11, v1, Lyf/b;->m:Z
    ...
    invoke-direct/range {v13 .. v18}, Lyf/b$a;-><init>(IZLyf/d;ZZ)V

    new-instance v10, Ljava/lang/StringBuilder;

    invoke-direct {v10, v9}, Ljava/lang/StringBuilder;-><init>(Ljava/lang/String;)V

    invoke-static {v4, v10}, Landroidx/appcompat/widget/b;->g(Ljava/util/ArrayList;Ljava/lang/StringBuilder;)Ljava/lang/String;
    ...
    invoke-static {v12, v9, v10, v11}, Landroidx/appcompat/view/menu/b;->i(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;Ljava/lang/String;)Ljava/lang/StringBuilder;
    ...
    iget-object v14, v13, Lyf/b$a;->c:Lcom/xiaomi/protocol/ICustomCaptureResult;
    ...
    iget-object v0, v0, Lyf/b$a;->d:Landroid/media/Image;
    ...
    :cond_9
    invoke-static {v8, v5}, Landroid/support/v4/media/a;->a(Ljava/lang/String;I)Ljava/lang/String;
    ...
    iget-object v8, v5, Lyf/b$a;->c:Lcom/xiaomi/protocol/ICustomCaptureResult;
    ...
    :goto_3
    invoke-virtual {v2, v0, v3, v3}, Lyf/b$a;->d(Landroid/media/Image;IZ)V
    ...
    iget-object v0, v1, Lyf/b;->p:Lng/d;
    ...
    iget-object v11, v10, Lyf/b$a;->d:Landroid/media/Image;

    invoke-virtual {v11}, Landroid/media/Image;->close()V

    move-object v13, v0

    check-cast v13, Lng/t$c;

    invoke-virtual {v13, v11}, Lng/t$c;->b(Landroid/media/Image;)V

    iget-object v11, v10, Lyf/b$a;->e:Landroid/media/Image;
    ...
    :cond_d
    iget-object v10, v10, Lyf/b$a;->g:Landroid/media/Image;

    if-eqz v10, :cond_c

    invoke-virtual {v10}, Landroid/media/Image;->close()V

    invoke-virtual {v13, v10}, Lng/t$c;->b(Landroid/media/Image;)V
    ...
    iget-object v4, v5, Lyf/b$a;->d:Landroid/media/Image;

    invoke-virtual {v4}, Landroid/media/Image;->close()V

    check-cast v0, Lng/t$c;

    invoke-virtual {v0, v4}, Lng/t$c;->b(Landroid/media/Image;)V

    iput-object v8, v2, Lyf/b$a;->c:Lcom/xiaomi/protocol/ICustomCaptureResult;

    const/4 v0, 0x1

    iput-boolean v0, v2, Lyf/b$a;->a:Z

    iget-boolean v0, v2, Lyf/b$a;->m:Z

    if-eqz v0, :cond_f

    invoke-virtual {v2}, Lyf/b$a;->b()V

    :cond_f
    iget-boolean v0, v1, Lyf/b;->l:Z

    if-eqz v0, :cond_10

    iget-object v0, v5, Lyf/b$a;->g:Landroid/media/Image;

    iget-boolean v4, v5, Lyf/b$a;->l:Z

    const/4 v8, 0x2

    invoke-virtual {v2, v0, v8, v4}, Lyf/b$a;->d(Landroid/media/Image;IZ)V

    :cond_10
    iget-object v0, v5, Lyf/b$a;->e:Landroid/media/Image;

    const/4 v4, 0x1

    if-eqz v0, :cond_11

    invoke-virtual {v2, v0, v4, v3}, Lyf/b$a;->d(Landroid/media/Image;IZ)V

    :cond_11
    invoke-virtual {v2}, Lyf/b$a;->c()Z

    move-result v0

    if-eqz v0, :cond_12

    iput-object v2, v1, Lyf/b;->i:Lyf/b$a;

    invoke-virtual {v6, v1, v4}, Loi/a$a;->a(Lyf/b;Z)V
    ...
    iget-object v0, v1, Lyf/b;->n:Landroid/util/Size;
    ...
    invoke-static {v13, v12, v14, v0}, Landroidx/appcompat/widget/f;->c(Ljava/lang/String;ILjava/lang/String;I)Ljava/lang/String;
    ...
    new-instance v10, Lyf/b$a;

    iget v15, v1, Lyf/b;->b:I

    iget-boolean v0, v1, Lyf/b;->l:Z

    iget-object v11, v1, Lyf/b;->o:Lyf/d;

    const/16 v18, 0x1

    iget-boolean v14, v1, Lyf/b;->m:Z
    ...
    invoke-direct/range {v14 .. v19}, Lyf/b$a;-><init>(IZLyf/d;ZZ)V

    new-instance v0, Ljava/lang/StringBuilder;

    invoke-direct {v0, v9}, Ljava/lang/StringBuilder;-><init>(Ljava/lang/String;)V

    invoke-static {v4, v0}, Landroidx/appcompat/widget/b;->g(Ljava/util/ArrayList;Ljava/lang/StringBuilder;)Ljava/lang/String;
    ...
    iget-object v0, v3, Lyf/b$a;->c:Lcom/xiaomi/protocol/ICustomCaptureResult;
    ...
    sget-object v17, Loa/z;->m1:Loa/y;

    invoke-virtual/range {v17 .. v17}, Loa/a0;->b()Ljava/lang/Object;
    ...
    iget-object v6, v3, Lyf/b$a;->c:Lcom/xiaomi/protocol/ICustomCaptureResult;
    ...
    iget-object v3, v3, Lyf/b$a;->d:Landroid/media/Image;
    ...
    invoke-static {v10, v7}, Landroid/support/v4/media/a;->a(Ljava/lang/String;I)Ljava/lang/String;
    ...
    iget-object v11, v7, Lyf/b$a;->c:Lcom/xiaomi/protocol/ICustomCaptureResult;

    invoke-virtual {v11}, Lcom/xiaomi/protocol/ICustomCaptureResult;->getTimeStamp()J

    move-result-wide v12

    iget-object v0, v1, Lyf/b;->o:Lyf/d;
    ...
    check-cast v14, Lyf/b$a;

    iget-object v0, v14, Lyf/b$a;->c:Lcom/xiaomi/protocol/ICustomCaptureResult;
    ...
    sget-object v18, Loa/z;->m1:Loa/y;

    invoke-virtual/range {v18 .. v18}, Loa/a0;->b()Ljava/lang/Object;
    ...
    iget-object v3, v14, Lyf/b$a;->c:Lcom/xiaomi/protocol/ICustomCaptureResult;
    ...
    iget-object v3, v14, Lyf/b$a;->e:Landroid/media/Image;
    ...
    iget-object v3, v3, Lyf/b$a;->e:Landroid/media/Image;
    ...
    :cond_21
    invoke-static {v10, v2}, Landroid/support/v4/media/a;->a(Ljava/lang/String;I)Ljava/lang/String;
    ...
    invoke-virtual {v8, v0, v3, v2}, Lyf/b$a;->d(Landroid/media/Image;IZ)V
    ...
    :goto_13
    iput-object v11, v8, Lyf/b$a;->c:Lcom/xiaomi/protocol/ICustomCaptureResult;

    iput-boolean v3, v8, Lyf/b$a;->a:Z

    iget-boolean v0, v8, Lyf/b$a;->m:Z

    if-eqz v0, :cond_24

    invoke-virtual {v8}, Lyf/b$a;->b()V
    ...
    iget-object v0, v7, Lyf/b$a;->g:Landroid/media/Image;

    iget-boolean v2, v7, Lyf/b$a;->l:Z
    ...
    invoke-virtual {v8, v0, v2, v2}, Lyf/b$a;->d(Landroid/media/Image;IZ)V
    ...
    :cond_28
    iget-object v9, v3, Lyf/b$a;->d:Landroid/media/Image;
    ...
    invoke-virtual {v10, v9}, Lng/t$c;->b(Landroid/media/Image;)V

    iget-object v9, v3, Lyf/b$a;->e:Landroid/media/Image;
    ...
    :cond_29
    iget-object v3, v3, Lyf/b$a;->g:Landroid/media/Image;

    if-eqz v3, :cond_2a

    invoke-virtual {v3}, Landroid/media/Image;->close()V

    invoke-virtual {v10, v3}, Lng/t$c;->b(Landroid/media/Image;)V
    ...
    iget-object v2, v7, Lyf/b$a;->d:Landroid/media/Image;

    invoke-virtual {v2}, Landroid/media/Image;->close()V

    check-cast v0, Lng/t$c;

    invoke-virtual {v0, v2}, Lng/t$c;->b(Landroid/media/Image;)V

    iget-object v2, v7, Lyf/b$a;->e:Landroid/media/Image;

    if-eqz v2, :cond_2d

    iget-object v3, v1, Lyf/b;->o:Lyf/d;
    ...
    invoke-virtual {v8, v2, v3, v0}, Lyf/b$a;->d(Landroid/media/Image;IZ)V
    ...
    iput-boolean v0, v3, Lyf/b$a;->i:Z
    ...
    iput-object v6, v1, Lyf/b;->g:Ljava/util/List;

    iget-boolean v0, v1, Lyf/b;->k:Z

    xor-int/lit8 v0, v0, 0x1

    move-object/from16 v2, v24

    invoke-virtual {v2, v1, v0}, Loi/a$a;->a(Lyf/b;Z)V
    ...
    iput-object v8, v1, Lyf/b;->i:Lyf/b$a;
    ...
    invoke-static {v1, v12}, Landroid/support/v4/media/a;->a(Ljava/lang/String;I)Ljava/lang/String;
