...
# direct methods
.method public static final a([Ljava/lang/Object;Lqj/e;)V
    .locals 3
    ...
    invoke-interface {p1, v2}, Lqj/e;->apply(Ljava/lang/Object;)V
...
.method public static final e(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;)Z
    .locals 5
    ...
    const-string p1, "assets.open(assetFile)"
    ...
    :try_start_1
    invoke-static {p0, p2, v2}, Lcom/android/camera/effect/b;->r(Ljava/io/InputStream;Ljava/io/OutputStream;I)J
    ...
    invoke-static {v4}, Lqj/n;->b(Ljava/io/Closeable;)V
    ...
    invoke-static {v3}, Lqj/n;->b(Ljava/io/Closeable;)V
...
.method public static final f(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;)Z
    .locals 9
    ...
    invoke-static {p0, v6, p2}, Lqj/n;->f(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;)Z
    ...
    invoke-static {p0, p1, p2}, Lqj/n;->e(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;)Z
...
.method public static final j(Landroid/content/ContentResolver;Landroid/net/Uri;)Z
    .locals 5
...
.method public static final k(Landroid/content/Context;Ljava/lang/String;)[B
    .locals 3
    ...
    invoke-static {p0}, Lcom/android/camera/effect/b;->L(Ljava/io/InputStream;)[B
    ...
    :try_start_2
    invoke-static {p0, v0}, Lho/n;->c(Ljava/io/Closeable;Ljava/lang/Throwable;)V
    :try_end_2
    .catchall {:try_start_2 .. :try_end_2} :catchall_2
...
.method public static final l(Landroid/content/Context;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {p0, p1}, Lqj/n;->k(Landroid/content/Context;Ljava/lang/String;)[B
...
.method public static final m(Lop/l;[F)[F
    .locals 1
    ...
    invoke-direct {v0, p1}, Ldp/h;-><init>([F)V
    ...
    invoke-direct {v0, p1, p0}, Lup/r;-><init>(Lup/g;Lop/l;)V
    ...
    invoke-static {p0}, Ldp/q;->Y(Ljava/util/Collection;)[F
...
.method public static final n(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {v0, p0}, Lqj/v;->b(Ljava/util/zip/ZipInputStream;Ljava/io/File;)V
...
.method public static final o(Landroid/content/Context;Landroid/net/Uri;Ljava/lang/String;)V
    .locals 1
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
...
.method public static final p(Landroid/app/Application;Ljava/lang/String;Ljava/lang/String;)Z
    .locals 9
    ...
    invoke-static {p0, v6, p2}, Lqj/n;->p(Landroid/app/Application;Ljava/lang/String;Ljava/lang/String;)Z
    ...
    invoke-static {p0}, Lqj/f;->g([B)Ljava/lang/String;

    move-result-object p0

    invoke-static {p1}, Lcom/android/camera/effect/b;->L(Ljava/io/InputStream;)[B
    ...
    invoke-static {v2}, Lqj/n;->b(Ljava/io/Closeable;)V
    :try_end_3
