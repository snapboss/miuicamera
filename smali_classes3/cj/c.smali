...
.method public constructor <init>(Ljava/lang/String;)V
    ...
    iput-object v0, p0, Lcj/c;->a:Ljava/lang/String;

    const/4 v0, 0x0

    iput-boolean v0, p0, Lcj/c;->f:Z

    const-wide/16 v1, 0x0

    iput-wide v1, p0, Lcj/c;->g:J

    iput-wide v1, p0, Lcj/c;->h:J

    iput-boolean v0, p0, Lcj/c;->i:Z

    iput-boolean v0, p0, Lcj/c;->j:Z

    new-instance v0, Ljava/lang/Object;

    invoke-direct {v0}, Ljava/lang/Object;-><init>()V

    iput-object v0, p0, Lcj/c;->k:Ljava/lang/Object;

    iput-wide v1, p0, Lcj/c;->l:J

    iput-wide v1, p0, Lcj/c;->m:J

    const-wide/16 v3, -0x1

    iput-wide v3, p0, Lcj/c;->n:J

    iput-wide v1, p0, Lcj/c;->o:J

    iput-wide v1, p0, Lcj/c;->p:J
    ...
    iput-object v0, p0, Lcj/c;->t:Ljava/lang/Integer;

    iput-object p1, p0, Lcj/c;->b:Ljava/lang/String;

    return-void
.end method

.method public static a(Lcj/c;Landroid/media/MediaCodec;ILandroid/media/MediaCodec$BufferInfo;)V
    .locals 2
    ...
    iget-object p1, p0, Lcj/c;->a:Ljava/lang/String;

    new-instance p2, Ljava/lang/StringBuilder;

    invoke-direct {p2}, Ljava/lang/StringBuilder;-><init>()V

    iget-object p3, p0, Lcj/c;->b:Ljava/lang/String;
    ...
    iget-object p1, p0, Lcj/c;->k:Ljava/lang/Object;
    ...
    :try_start_1
    iput-boolean p2, p0, Lcj/c;->j:Z

    iget-object p2, p0, Lcj/c;->k:Ljava/lang/Object;
    ...
    iput-wide v0, p0, Lcj/c;->h:J

    invoke-virtual {p0, p1, p2, p3}, Lcj/c;->d(Landroid/media/MediaCodec;ILandroid/media/MediaCodec$BufferInfo;)V
    :try_end_2
    ...
    iget-object p2, p0, Lcj/c;->a:Ljava/lang/String;
    ...
    invoke-interface {p0}, Lcj/c$a;->b()V
...
.method public final e(Landroid/media/MediaFormat;I)V
    ...
    iput-object p1, p0, Lcj/c;->d:Landroid/media/MediaFormat;

    invoke-virtual {p0}, Lcj/c;->g()Z
    ...
    :goto_0
    iget-object v4, p0, Lcj/c;->d:Landroid/media/MediaFormat;
    ...
    :cond_3
    iget-object v4, p0, Lcj/c;->t:Ljava/lang/Integer;
    ...
    iget-object v6, p0, Lcj/c;->b:Ljava/lang/String;
    ...
    iput-object v4, p0, Lcj/c;->r:Landroid/os/HandlerThread;

    invoke-virtual {v4}, Ljava/lang/Thread;->start()V

    new-instance v2, Landroid/os/Handler;

    iget-object v4, p0, Lcj/c;->r:Landroid/os/HandlerThread;
    ...
    iput-object v2, p0, Lcj/c;->s:Landroid/os/Handler;

    iget-object v2, p0, Lcj/c;->d:Landroid/media/MediaFormat;
    ...
    invoke-virtual {p0, p1}, Lcj/c;->b(Landroid/media/MediaFormat;)Landroid/media/MediaCodec;

    move-result-object v2

    iput-object v2, p0, Lcj/c;->c:Landroid/media/MediaCodec;

    const-string v2, " mMediaCodec =  "

    invoke-static {v6, v2}, Landroidx/appcompat/view/menu/a;->h(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v2

    iget-object v4, p0, Lcj/c;->c:Landroid/media/MediaCodec;
    ...
    iget-object v5, p0, Lcj/c;->a:Ljava/lang/String;

    invoke-static {v5, v2, v4}, Lcom/android/camera/log/Log;->d(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V

    iget-object v2, p0, Lcj/c;->c:Landroid/media/MediaCodec;

    new-instance v4, Lcj/b;

    invoke-direct {v4, p0}, Lcj/b;-><init>(Lcj/c;)V

    iget-object v7, p0, Lcj/c;->s:Landroid/os/Handler;
    ...
    invoke-virtual {p0}, Lcj/c;->f()Landroid/view/Surface;

    iget-object p1, p0, Lcj/c;->q:Lcj/c$a;
    ...
    invoke-interface {p1, p0}, Lcj/c$a;->g(Landroid/media/MediaFormat;)V

    :cond_5
    const-string p0, " init End >> "

    invoke-static {v6, p0}, Landroidx/appcompat/view/menu/a;->h(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/StringBuilder;
...
.method public final g()Z
    ...
    iget-object p0, p0, Lcj/c;->d:Landroid/media/MediaFormat;
...
.method public final h(J)V
    ...
    iget-object v1, p0, Lcj/c;->b:Ljava/lang/String;
    ...
    iget-object v4, p0, Lcj/c;->a:Ljava/lang/String;
    ...
    iget-object v5, p0, Lcj/c;->c:Landroid/media/MediaCodec;

    invoke-virtual {v5, v0}, Landroid/media/MediaCodec;->setParameters(Landroid/os/Bundle;)V

    :cond_0
    iput-wide p1, p0, Lcj/c;->l:J

    const-wide/16 p1, 0x0

    iput-wide p1, p0, Lcj/c;->p:J

    iput-boolean v3, p0, Lcj/c;->f:Z

    const-string p1, "pause X mPauseTimeMs = "

    invoke-static {v1, p1}, Landroidx/appcompat/view/menu/a;->h(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object p1

    iget-wide v0, p0, Lcj/c;->l:J
...
.method public i()V
    ...
    iget-object v2, p0, Lcj/c;->b:Ljava/lang/String;
    ...
    iget-object v0, p0, Lcj/c;->k:Ljava/lang/Object;
    ...
    iget-object v4, p0, Lcj/c;->b:Ljava/lang/String;
    ...
    iput-object v1, p0, Lcj/c;->c:Landroid/media/MediaCodec;

    const-wide/16 v3, 0x0

    iput-wide v3, p0, Lcj/c;->l:J

    iput-wide v3, p0, Lcj/c;->g:J

    const-wide/16 v3, -0x1

    iput-wide v3, p0, Lcj/c;->n:J

    iget-object v1, p0, Lcj/c;->r:Landroid/os/HandlerThread;
    ...
    iget-object p0, p0, Lcj/c;->b:Ljava/lang/String;
...
.method public j(J)V
    ...
    iput-wide p1, p0, Lcj/c;->m:J

    iget-wide v5, p0, Lcj/c;->l:J

    sub-long v5, p1, v5

    iput-wide v5, p0, Lcj/c;->p:J

    iget-wide v7, p0, Lcj/c;->o:J

    add-long/2addr v7, v5

    iput-wide v7, p0, Lcj/c;->o:J
    ...
    iget-object p1, p0, Lcj/c;->c:Landroid/media/MediaCodec;

    invoke-virtual {p1, v0}, Landroid/media/MediaCodec;->setParameters(Landroid/os/Bundle;)V

    :cond_0
    iput-boolean v2, p0, Lcj/c;->f:Z
...
.method public l(J)V
    ...
    iget-wide v5, p0, Lcj/c;->o:J

    sub-long v5, p1, v5

    iput-wide v5, p0, Lcj/c;->n:J
    ...
    iget-object v6, p0, Lcj/c;->c:Landroid/media/MediaCodec;

    invoke-virtual {v6, v5}, Landroid/media/MediaCodec;->setParameters(Landroid/os/Bundle;)V

    iget-object v5, p0, Lcj/c;->k:Ljava/lang/Object;
    ...
    :goto_0
    :try_start_0
    iget-boolean v6, p0, Lcj/c;->i:Z

    if-nez v6, :cond_4

    iget-boolean v6, p0, Lcj/c;->j:Z
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    :try_start_1
    iget-object v6, p0, Lcj/c;->a:Ljava/lang/String;

    new-instance v7, Ljava/lang/StringBuilder;

    invoke-direct {v7}, Ljava/lang/StringBuilder;-><init>()V

    iget-object v8, p0, Lcj/c;->b:Ljava/lang/String;
    ...
    iget-object v6, p0, Lcj/c;->k:Ljava/lang/Object;
    ...
    :try_start_2
    iget-object v7, p0, Lcj/c;->a:Ljava/lang/String;

    new-instance v8, Ljava/lang/StringBuilder;

    invoke-direct {v8}, Ljava/lang/StringBuilder;-><init>()V

    iget-object v9, p0, Lcj/c;->b:Ljava/lang/String;
...
.method public final m()V
    ...
    iget-object v1, p0, Lcj/c;->e:Landroid/view/Surface;

    if-eqz v1, :cond_1

    iget-boolean v1, p0, Lcj/c;->j:Z
    ...
    iget-object v5, p0, Lcj/c;->b:Ljava/lang/String;
    ...
    invoke-interface {v1, p0}, Lcj/c$a;->f(Lcj/c;)V

    :cond_3
    const/4 v1, 0x1

    iput-boolean v1, p0, Lcj/c;->i:Z

    iget-object v1, p0, Lcj/c;->k:Ljava/lang/Object;
