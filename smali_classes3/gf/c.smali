...
.method public constructor <init>(Lff/a;)V
    ...
    invoke-direct {p0, p1}, Lef/h;-><init>(Lff/a;)V
    ...
    iget-object v0, p0, Lef/h;->a:Lff/e;
    ...
    iput-object p1, p0, Lgf/c;->f:Lokhttp3/OkHttpClient;

    iget-object p1, p0, Lef/h;->a:Lff/e;
    ...
    invoke-virtual {p1, v3}, Lef/g;->a(Ljava/lang/String;)Ljava/lang/String;
    ...
    sget-object v5, Lmf/a;->a:Llb/s;

    invoke-virtual {v5, v4}, Llb/s;->p(Ljava/lang/String;)Llb/k;
    ...
    invoke-virtual {v4, v1}, Lxb/r;->z(Ljava/lang/String;)Llb/k;

    move-result-object v1

    if-eqz v1, :cond_1

    invoke-virtual {v1}, Llb/k;->w()Z

    move-result v4

    if-eqz v4, :cond_1

    invoke-virtual {v1}, Llb/k;->g()I

    move-result p1

    iput p1, p0, Lgf/c;->e:I

    goto :goto_1

    :cond_1
    invoke-virtual {p1, v3}, Lef/g;->b(Ljava/lang/String;)V
    :try_end_0
...
.method public final e(Ljava/lang/String;)Z
    ...
    iget-object v1, v0, Lff/e;->l:Landroid/content/Context;
    ...
    iget v1, p0, Lgf/c;->e:I

    iget-object v2, v0, Lff/e;->b:Lof/a;

    const-string v5, "track.max_track_times"

    invoke-virtual {v2, v5, v4}, Lof/a;->c(Ljava/lang/String;I)I
    ...
    iget-object p1, v0, Lff/e;->b:Lof/a;

    invoke-virtual {p1, v5, v4}, Lof/a;->c(Ljava/lang/String;I)I
    ...
    invoke-virtual {v0, v5, v4}, Lof/a;->c(Ljava/lang/String;I)I
    ...
    iget-object v1, p0, Lgf/c;->f:Lokhttp3/OkHttpClient;

    invoke-virtual {v1, v0}, Lokhttp3/OkHttpClient;->newCall(Lokhttp3/Request;)Lokhttp3/Call;

    move-result-object v0

    new-instance v1, Lgf/c$a;

    invoke-direct {v1, p0, p1}, Lgf/c$a;-><init>(Lgf/c;Ljava/lang/String;)V
    ...
    invoke-virtual {p0, v0, p1, v1}, Lef/h;->c(Ljava/lang/String;Ljava/lang/String;Lxb/a;)Z

    move-result p1

    if-eqz p1, :cond_5

    iput-boolean v2, p0, Lef/h;->d:Z
