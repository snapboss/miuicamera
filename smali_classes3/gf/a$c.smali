...
.field public final f:Lgf/a$d;

.field public final synthetic g:Lgf/a;


# direct methods
.method public constructor <init>(Lgf/a;Lgf/a$d;)V
    .locals 0

    iput-object p1, p0, Lgf/a$c;->g:Lgf/a;

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    const/4 p1, 0x1

    iput-boolean p1, p0, Lgf/a$c;->c:Z

    const/4 p1, 0x0

    iput-boolean p1, p0, Lgf/a$c;->d:Z

    iput-boolean p1, p0, Lgf/a$c;->e:Z

    iput-object p2, p0, Lgf/a$c;->f:Lgf/a$d;
    ...
    iput-object p1, p0, Lgf/a$c;->a:Ljava/io/PipedInputStream;

    :try_start_0
    new-instance p1, Ljava/io/PipedOutputStream;

    iget-object p2, p0, Lgf/a$c;->a:Ljava/io/PipedInputStream;

    invoke-direct {p1, p2}, Ljava/io/PipedOutputStream;-><init>(Ljava/io/PipedInputStream;)V

    iput-object p1, p0, Lgf/a$c;->b:Ljava/io/PipedOutputStream;
    :try_end_0
...
.method public final a(II[B)I
    ...
    :goto_0
    iget-boolean v2, p0, Lgf/a$c;->c:Z
    ...
    :try_start_0
    iget-object v2, p0, Lgf/a$c;->a:Ljava/io/PipedInputStream;
    ...
    iget-boolean v3, p0, Lgf/a$c;->c:Z
    ...
    iget-boolean p0, p0, Lgf/a$c;->c:Z
...
.method public final b([BZ)V
    ...
    :try_start_0
    iget-object v1, p0, Lgf/a$c;->b:Ljava/io/PipedOutputStream;
    :try_end_0
    ...
    iput-object p2, p0, Lgf/a$c;->b:Ljava/io/PipedOutputStream;
    :try_end_1
    ...
    invoke-static {p2, p1}, Lqf/a;->b(Ljava/lang/String;Ljava/lang/String;)V
...
.method public final c()V
    ...
    iget-object v1, p0, Lgf/a$c;->g:Lgf/a;

    iget-object v1, v1, Lgf/a;->c:Landroid/media/MediaCodec;
    ...
    iget-object v2, p0, Lgf/a$c;->g:Lgf/a;

    iget-object v2, v2, Lgf/a;->c:Landroid/media/MediaCodec;
    ...
    iget-object v4, p0, Lgf/a$c;->f:Lgf/a$d;

    invoke-virtual {v4}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    :try_start_0
    iget-object v4, v4, Lgf/a$d;->b:Ljava/util/concurrent/LinkedBlockingQueue;
    ...
    invoke-static {v3, v4}, Lqf/a;->d(Ljava/lang/String;Ljava/lang/String;)V
    ...
    iget-object v0, p0, Lgf/a$c;->f:Lgf/a$d;
    ...
    :try_start_1
    iget-object v0, v0, Lgf/a$d;->b:Ljava/util/concurrent/LinkedBlockingQueue;
    ...
    invoke-static {v3, v0}, Lqf/a;->d(Ljava/lang/String;Ljava/lang/String;)V

    :goto_1
    iput-boolean v5, p0, Lgf/a$c;->c:Z
...
.method public final d([BZ)V
    ...
    :goto_0
    iget-boolean v0, p0, Lgf/a$c;->c:Z

    if-eqz v0, :cond_4

    iget-object v0, p0, Lgf/a$c;->g:Lgf/a;

    iget-object v0, v0, Lgf/a;->c:Landroid/media/MediaCodec;
    ...
    :goto_1
    iget-object p0, p0, Lgf/a$c;->g:Lgf/a;

    iget-object v3, p0, Lgf/a;->c:Landroid/media/MediaCodec;
...
.method public final run()V
    ...
    new-instance v4, Lgf/a$b;

    invoke-direct {v4}, Lgf/a$b;-><init>()V

    :goto_0
    iget-boolean v5, p0, Lgf/a$c;->c:Z

    if-eqz v5, :cond_5

    iget-boolean v5, p0, Lgf/a$c;->e:Z

    const/4 v6, 0x1

    if-nez v5, :cond_3

    invoke-virtual {p0, v1, v2, v3}, Lgf/a$c;->a(II[B)I
    ...
    :cond_0
    invoke-virtual {v4, v3}, Lgf/a$b;->b([B)Z
    ...
    invoke-static {v5, v7}, Lqf/a;->d(Ljava/lang/String;Ljava/lang/String;)V

    goto :goto_1

    :cond_1
    iget v5, v4, Lgf/a$b;->h:I
    ...
    invoke-virtual {p0, v2, v5, v7}, Lgf/a$c;->a(II[B)I
    ...
    :goto_1
    iput-boolean v6, p0, Lgf/a$c;->e:Z

    goto :goto_0

    :cond_2
    invoke-virtual {p0, v7, v1}, Lgf/a$c;->d([BZ)V

    goto :goto_2

    :cond_3
    iget-boolean v5, p0, Lgf/a$c;->d:Z

    if-nez v5, :cond_4

    invoke-virtual {p0, v0, v6}, Lgf/a$c;->d([BZ)V

    const-string v5, "MediaPlayerImpl"

    const-string v7, "StreamDecodeTask: put end flag"

    invoke-static {v5, v7}, Lqf/a;->b(Ljava/lang/String;Ljava/lang/String;)V

    iput-boolean v6, p0, Lgf/a$c;->d:Z

    :cond_4
    :goto_2
    invoke-virtual {p0}, Lgf/a$c;->c()V
    :try_end_0
    ...
    :cond_5
    :try_start_1
    iget-object v2, p0, Lgf/a$c;->b:Ljava/io/PipedOutputStream;
    ...
    iput-object v0, p0, Lgf/a$c;->b:Ljava/io/PipedOutputStream;
    ...
    iput-object v0, p0, Lgf/a$c;->a:Ljava/io/PipedInputStream;
    :try_end_1
    .catch Ljava/lang/Exception; {:try_start_1 .. :try_end_1} :catch_0
    ...
    iget-object v2, v0, Lgf/a;->e:Ljava/lang/Object;
    ...
    :goto_d
    :try_start_d
    iget-object v3, p0, Lgf/a$c;->b:Ljava/io/PipedOutputStream;
    ...
    :cond_f
    iget-object v3, p0, Lgf/a$c;->a:Ljava/io/PipedInputStream;
    ...
    iget-object v0, v0, Lgf/a;->e:Ljava/lang/Object;

    monitor-enter v0

    :try_start_e
    iget-object v3, p0, Lgf/a$c;->g:Lgf/a;

    iget-object v3, v3, Lgf/a;->c:Landroid/media/MediaCodec;
    ...
    invoke-static {v4, v3}, Lqf/a;->d(Ljava/lang/String;Ljava/lang/String;)V
