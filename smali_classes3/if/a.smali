...
.method public constructor <init>(Lff/e;)V
    ...
    iget-object v0, p1, Lff/e;->f:Lof/b;

    invoke-direct {p0, v0}, Lr/m;-><init>(Lof/b;)V

    iput-object p1, p0, Lif/a;->c:Lff/e;

    const-string v0, "sdk.type"

    const-string v1, "android"

    invoke-virtual {p0, v0, v1}, Lr/m;->d(Ljava/lang/String;Ljava/lang/String;)V
    ...
    :try_start_0
    iget-object v2, p0, Lr/m;->b:Ljava/lang/Iterable;

    check-cast v2, Lxb/r;

    const-string v3, "env"

    invoke-virtual {v2, v3}, Lxb/r;->z(Ljava/lang/String;)Llb/k;

    move-result-object v2

    check-cast v2, Lxb/r;

    invoke-virtual {v2, v1, v0}, Lxb/r;->C(ILjava/lang/String;)V
    ...
    invoke-virtual {v0}, Lof/b;->c()Ljava/lang/String;

    move-result-object v0

    invoke-virtual {p0, v1, v0}, Lr/m;->d(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-virtual {p0, p1, v0}, Lr/m;->d(Ljava/lang/String;Ljava/lang/String;)V
...
# virtual methods
.method public final c()Lrf/a;
    .locals 3

    invoke-super {p0}, Lr/m;->c()Lrf/a;

    move-result-object v0

    iget-object p0, p0, Lif/a;->c:Lff/e;

    iget-object v1, p0, Lff/e;->l:Landroid/content/Context;
    ...
    invoke-virtual {v0, v2, v1}, Lrf/a;->d(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-virtual {v0, v1, p0}, Lrf/a;->c(Ljava/lang/String;I)V
    ...
    invoke-virtual {v0, v1, p0}, Lrf/a;->d(Ljava/lang/String;Ljava/lang/String;)V
