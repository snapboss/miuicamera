...
.method public constructor <init>(Landroid/content/Context;I)V
    ...
    iput-object v0, p0, Lif/f;->a:Ljava/lang/Long;

    const/4 v0, 0x0

    iput v0, p0, Lif/f;->b:I

    iput p2, p0, Lif/f;->c:I

    iput-object p1, p0, Lif/f;->d:Landroid/content/Context;
...
.method public final declared-synchronized a()V
    ...
    :cond_0
    iget-object v1, p0, Lif/f;->a:Ljava/lang/Long;
    ...
    iget v1, p0, Lif/f;->b:I

    add-int/2addr v1, v2

    iput v1, p0, Lif/f;->b:I
    ...
    iput-object v1, p0, Lif/f;->a:Ljava/lang/Long;

    iput v2, p0, Lif/f;->b:I
    ...
    invoke-virtual {v1}, Llb/s;->o()Lxb/r;

    move-result-object v1

    const-string v2, "start_time"

    iget-object v3, p0, Lif/f;->a:Ljava/lang/Long;

    if-nez v3, :cond_4

    invoke-virtual {v1}, Lxb/f;->B()Lxb/p;
    ...
    iget-object v5, v1, Lxb/f;->a:Lxb/l;

    invoke-virtual {v5}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    new-instance v5, Lxb/m;

    invoke-direct {v5, v3, v4}, Lxb/m;-><init>(J)V

    move-object v3, v5

    :goto_2
    iget-object v4, v1, Lxb/r;->b:Ljava/util/LinkedHashMap;

    invoke-interface {v4, v2, v3}, Ljava/util/Map;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    const-string v2, "times"

    iget v3, p0, Lif/f;->b:I

    invoke-virtual {v1, v3, v2}, Lxb/r;->C(ILjava/lang/String;)V

    iget-object v2, p0, Lif/f;->d:Landroid/content/Context;
    ...
    iget-object v0, p0, Lif/f;->a:Ljava/lang/Long;
