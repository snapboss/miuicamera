...
.method public constructor <init>(Lof/b;)V
    ...
    iput-object p1, p0, Lsf/a;->a:Lof/b;

    new-instance p1, Lokhttp3/OkHttpClient;

    invoke-direct {p1}, Lokhttp3/OkHttpClient;-><init>()V

    iput-object p1, p0, Lsf/a;->d:Lokhttp3/OkHttpClient;
...
.method public static b(Ljava/lang/String;)Ljava/security/PublicKey;
    ...
    invoke-static {v2, p0}, Lnf/a;->a(I[B)[B
...
.method public final c(Lokhttp3/Request;Ljava/lang/String;)Lokhttp3/Request;
    ...
    iget-object v0, p0, Lsf/a;->b:Lsf/a$b;

    iget-object v0, v0, Lsf/a$b;->a:[B
    ...
    invoke-static {v6, v3}, Landroidx/appcompat/view/menu/a;->h(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v3

    invoke-virtual {p0, v2}, Lsf/a;->g(Ljava/lang/String;)Ljava/lang/String;
    ...
    iget-object v1, p0, Lsf/a;->b:Lsf/a$b;

    iget-object v1, v1, Lsf/a$b;->b:Ljava/lang/String;

    if-nez v1, :cond_1

    invoke-static {v0}, Lsf/a;->a([B)Ljava/lang/String;

    move-result-object v0

    const-string v1, "AIVS-Encryption-Key"

    invoke-virtual {p0}, Lsf/a;->j()Ljava/lang/String;
    ...
    invoke-virtual {p0, p1}, Lsf/a;->g(Ljava/lang/String;)Ljava/lang/String;
...
.method public final d(Lokhttp3/Response;)Lokhttp3/Response;
    .locals 6
    ...
    invoke-virtual {p0, v4, v5, v3}, Lsf/a;->m(JLjava/lang/String;)V
    ...
    invoke-static {v2, v1}, Lnf/a;->a(I[B)[B
    ...
    invoke-virtual {p0, v3, v1}, Lsf/a;->f(I[B)[B
...
.method public final e()Lsf/a$b;
    ...
    :try_start_0
    new-instance v3, Lsf/a$b;

    invoke-direct {v3}, Lsf/a$b;-><init>()V

    iget-object v4, p0, Lsf/a;->a:Lof/b;

    iget-object v4, v4, Lof/b;->c:Lcom/android/camera/data/data/b0;

    const-string v5, "aes_key"

    invoke-virtual {v4, v5}, Lcom/android/camera/data/data/b0;->b(Ljava/lang/String;)Ljava/lang/String;

    move-result-object v4

    iget-object v5, p0, Lsf/a;->a:Lof/b;

    iget-object v5, v5, Lof/b;->c:Lcom/android/camera/data/data/b0;

    const-string v6, "aes_token"

    invoke-virtual {v5, v6}, Lcom/android/camera/data/data/b0;->b(Ljava/lang/String;)Ljava/lang/String;

    move-result-object v5

    iget-object v6, p0, Lsf/a;->a:Lof/b;

    iget-object v6, v6, Lof/b;->c:Lcom/android/camera/data/data/b0;

    const-string v7, "aes_expire_at"

    invoke-virtual {v6, v7}, Lcom/android/camera/data/data/b0;->b(Ljava/lang/String;)Ljava/lang/String;

    move-result-object v6

    invoke-static {v6}, Lb/a;->i(Ljava/lang/String;)Z
    ...
    invoke-static {}, Lsf/a;->l()[B

    move-result-object v0

    iput-object v0, v3, Lsf/a$b;->a:[B

    invoke-virtual {p0}, Lsf/a;->h()V

    iget-object p0, p0, Lsf/a;->a:Lof/b;

    iget-object p0, p0, Lof/b;->c:Lcom/android/camera/data/data/b0;

    const-string v0, "aes_key"

    iget-object v1, v3, Lsf/a$b;->a:[B

    invoke-static {v8, v1}, Lnf/a;->b(I[B)Ljava/lang/String;

    move-result-object v1

    invoke-virtual {p0, v0, v1}, Lcom/android/camera/data/data/b0;->h(Ljava/lang/String;Ljava/lang/String;)Z
    ...
    invoke-static {v8, p0}, Lnf/a;->a(I[B)[B

    move-result-object p0

    iput-object p0, v3, Lsf/a$b;->a:[B

    iput-object v5, v3, Lsf/a$b;->b:Ljava/lang/String;
    :try_end_0
...
.method public final f(I[B)[B
    ...
    iget-object v2, p0, Lsf/a;->b:Lsf/a$b;

    iget-object v2, v2, Lsf/a$b;->a:[B
...
.method public final g(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-virtual {p0, v0, p1}, Lsf/a;->f(I[B)[B
...
.method public final h()V
    ...
    :try_start_0
    iget-object v1, p0, Lsf/a;->a:Lof/b;

    iget-object v1, v1, Lof/b;->c:Lcom/android/camera/data/data/b0;

    const-string v2, "aes_key"

    invoke-virtual {v1, v2}, Lcom/android/camera/data/data/b0;->l(Ljava/lang/String;)V
    ...
    invoke-virtual {p0, v1}, Lcom/android/camera/data/data/b0;->l(Ljava/lang/String;)V
...
.method public final intercept(Lokhttp3/Interceptor$Chain;)Lokhttp3/Response;
    ...
    invoke-virtual {p0}, Lsf/a;->e()Lsf/a$b;

    move-result-object v1

    iput-object v1, p0, Lsf/a;->b:Lsf/a$b;
    ...
    invoke-static {v2}, Lqf/a;->e(Ljava/lang/Throwable;)Ljava/lang/String;

    move-result-object v2

    invoke-static {v0, v2}, Lqf/a;->d(Ljava/lang/String;Ljava/lang/String;)V

    const/4 v2, 0x0

    :goto_0
    iput-object v2, p0, Lsf/a;->c:[B
    ...
    invoke-virtual {p0, v2, v1}, Lsf/a;->c(Lokhttp3/Request;Ljava/lang/String;)Lokhttp3/Request;
    ...
    invoke-virtual {p0, p1}, Lsf/a;->d(Lokhttp3/Response;)Lokhttp3/Response;
...
.method public final j()Ljava/lang/String;
    ...
    :try_start_0
    iget-object v2, p0, Lsf/a;->a:Lof/b;
    ...
    invoke-virtual {v2, v3}, Llb/k;->u(Ljava/lang/String;)Z
    ...
    invoke-virtual {v2, v3}, Llb/k;->z(Ljava/lang/String;)Llb/k;
    ...
    :cond_2
    :goto_0
    invoke-virtual {p0}, Lsf/a;->k()Llb/k;
    ...
    :goto_2
    iget-object p0, p0, Lsf/a;->b:Lsf/a$b;

    iget-object p0, p0, Lsf/a$b;->a:[B

    const-string v1, "public_key"

    invoke-virtual {v0, v1}, Llb/k;->z(Ljava/lang/String;)Llb/k;

    move-result-object v1

    invoke-virtual {v1}, Llb/k;->k()Ljava/lang/String;

    move-result-object v1

    invoke-static {v1}, Lsf/a;->b(Ljava/lang/String;)Ljava/security/PublicKey;
    ...
    invoke-static {v1, p0}, Lnf/a;->b(I[B)Ljava/lang/String;
    ...
    invoke-virtual {v0, v2}, Llb/k;->z(Ljava/lang/String;)Llb/k;
...
.method public final k()Llb/k;
    ...
    iget-object v3, p0, Lsf/a;->a:Lof/b;
    ...
    invoke-virtual {v4, v5, v6}, Lof/a;->c(Ljava/lang/String;I)I
    ...
    iget-object v8, v3, Lof/b;->a:Lof/a;

    invoke-virtual {v8, v4}, Lof/a;->d(Ljava/lang/String;)Ljava/lang/String;

    move-result-object v4

    iget-object v3, v3, Lof/b;->e:Llf/da;

    iget-object v9, v3, Llf/da;->a:Lbk/a;

    invoke-virtual {v9}, Lbk/a;->b()Z

    move-result v9

    if-eqz v9, :cond_2

    iget-object v3, v3, Llf/da;->a:Lbk/a;

    invoke-virtual {v3}, Lbk/a;->a()Ljava/lang/Object;
    ...
    iget-object v2, p0, Lsf/a;->d:Lokhttp3/OkHttpClient;

    invoke-virtual {v2, v0}, Lokhttp3/OkHttpClient;->newCall(Lokhttp3/Request;)Lokhttp3/Call;

    move-result-object v0

    new-instance v2, Lsf/a$a;

    invoke-direct {v2, p0}, Lsf/a$a;-><init>(Lsf/a;)V

    invoke-interface {v0, v2}, Lokhttp3/Call;->enqueue(Lokhttp3/Callback;)V

    :try_start_0
    invoke-virtual {v8, v5, v6}, Lof/a;->c(Ljava/lang/String;I)I

    move-result p0

    if-ne p0, v7, :cond_1

    sget-object p0, Lmf/a;->a:Llb/s;
    ...
    invoke-virtual {p0, v0}, Llb/s;->p(Ljava/lang/String;)Llb/k;
...
.method public final m(JLjava/lang/String;)V
    ...
    invoke-virtual {v1, v2, p3}, Lcom/android/camera/data/data/b0;->h(Ljava/lang/String;Ljava/lang/String;)Z
    ...
    invoke-virtual {p0, p3, p1}, Lcom/android/camera/data/data/b0;->h(Ljava/lang/String;Ljava/lang/String;)Z
