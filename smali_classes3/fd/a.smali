...
.method public static a(Ljava/lang/String;)Lcom/miui/camerainfra/cloudconfig/data/http/bean/BizCloudConfigBean;
    ...
    invoke-static {p0}, Lqc/k;->d([B)Lqc/k;

    move-result-object p0

    invoke-virtual {p0}, Lqc/k;->b()Lcom/google/protobuf/ByteString;
    ...
    invoke-virtual {p0}, Lqc/k;->c()Lcom/google/protobuf/ByteString;
    ...
    sget-object v3, Lfd/b;->a:Ljava/nio/charset/CharsetDecoder;
    ...
    sget-object p0, Lfd/b;->a:Ljava/nio/charset/CharsetDecoder;
    ...
    :try_start_3
    sget-object v4, Lfd/b;->a:Ljava/nio/charset/CharsetDecoder;
    ...
    sget-object v4, Lfd/b;->b:Ljava/nio/charset/CharsetDecoder;
    ...
    :try_start_7
    sget-object p0, Lfd/b;->b:Ljava/nio/charset/CharsetDecoder;
    ...
    invoke-direct {v3, p0}, Lve/y;-><init>(Lve/y$a;)V

    const-class p0, Lcom/miui/camerainfra/cloudconfig/data/http/bean/BizCloudConfigBean;

    invoke-virtual {v3, p0}, Lve/y;->a(Ljava/lang/Class;)Lve/l;
    ...
    :goto_6
    :try_start_8
    sget-object v0, Lfd/b;->b:Ljava/nio/charset/CharsetDecoder;
    ...
    :goto_7
    :try_start_9
    sget-object v1, Lfd/b;->a:Ljava/nio/charset/CharsetDecoder;
