...
.field public m:Laj/b;

.field public n:I

.field public o:Lbj/b$b;
...
.method public constructor <init>()V
    ...
    iput-object v1, p0, Lbj/b;->i:Lbj/a;

    new-instance v1, Ljava/lang/Object;

    invoke-direct {v1}, Ljava/lang/Object;-><init>()V

    iput-object v1, p0, Lbj/b;->j:Ljava/lang/Object;

    new-instance v1, Landroid/media/AudioTimestamp;

    invoke-direct {v1}, Landroid/media/AudioTimestamp;-><init>()V

    iput-object v1, p0, Lbj/b;->k:Landroid/media/AudioTimestamp;

    iput-boolean v0, p0, Lbj/b;->l:Z

    iput v0, p0, Lbj/b;->n:I

    const-wide/16 v0, 0x0

    iput-wide v0, p0, Lbj/b;->p:J

    return-void
.end method

.method public static a(Lbj/b;Ljava/lang/String;I)V
    .locals 4
    ...
    invoke-static {p1, v0, p2}, Landroidx/activity/m;->g(Ljava/lang/String;Ljava/lang/String;I)Ljava/lang/String;
    ...
    iput-wide p1, p0, Lbj/b;->p:J

    :cond_0
    return-void
.end method

.method public static b(Lbj/b;)V
    .locals 5
    ...
    iget-object v3, p0, Lbj/b;->a:Landroid/media/AudioRecord;
    ...
    iget-object v1, p0, Lbj/b;->j:Ljava/lang/Object;

    monitor-enter v1

    :try_start_0
    iget-object v2, p0, Lbj/b;->a:Landroid/media/AudioRecord;
...
.method public final c()V
    ...
    iget-object v0, p0, Lbj/b;->b:Ljava/lang/Thread;

    if-nez v0, :cond_2

    iget-boolean v0, p0, Lbj/b;->l:Z
    ...
    invoke-direct {v0, p0}, Lbj/d;-><init>(Lbj/b;)V

    iput-object v0, p0, Lbj/b;->b:Ljava/lang/Thread;
    ...
    invoke-direct {v0, p0}, Lbj/c;-><init>(Lbj/b;)V
...
.method public final d(Landroid/media/AudioFormat;IIII)V
    ...
    iput-object p1, p0, Lbj/b;->e:Landroid/media/AudioFormat;

    iput p2, p0, Lbj/b;->g:I

    iput p3, p0, Lbj/b;->f:I

    iput p4, p0, Lbj/b;->h:I

    iput p5, p0, Lbj/b;->n:I
    ...
    iput-boolean p3, p0, Lbj/b;->l:Z

    new-instance p3, Laj/b;

    invoke-virtual {p1}, Landroid/media/AudioFormat;->getSampleRate()I

    move-result p1

    invoke-direct {p3, p1}, Laj/b;-><init>(I)V

    iput-object p3, p0, Lbj/b;->m:Laj/b;

    new-instance p1, Lbj/b$a;

    invoke-direct {p1, p0}, Lbj/b$a;-><init>(Lbj/b;)V

    iput-object p1, p3, Laj/b;->g:Laj/a;

    goto :goto_0

    :cond_0
    iput-boolean p5, p0, Lbj/b;->l:Z
    ...
    iget-object p2, p0, Lbj/b;->e:Landroid/media/AudioFormat;
    ...
    iput-object p1, p0, Lbj/b;->a:Landroid/media/AudioRecord;
    :try_end_0
    .catch Ljava/lang/UnsupportedOperationException; {:try_start_0 .. :try_end_0} :catch_0

    invoke-virtual {p0}, Lbj/b;->c()V
...
.method public final e()V
    ...
    iput-boolean v2, p0, Lbj/b;->c:Z

    iget-object v0, p0, Lbj/b;->j:Ljava/lang/Object;

    monitor-enter v0

    :try_start_0
    iget-object v1, p0, Lbj/b;->a:Landroid/media/AudioRecord;
    ...
    iput-object v1, p0, Lbj/b;->a:Landroid/media/AudioRecord;

    iget-object v3, p0, Lbj/b;->i:Lbj/a;

    invoke-virtual {v3}, Lbj/a;->a()V

    monitor-exit v0
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0

    iget-object v0, p0, Lbj/b;->m:Laj/b;

    if-eqz v0, :cond_3

    iput-object v1, v0, Laj/b;->b:Ljava/nio/ByteBuffer;

    iput-object v1, v0, Laj/b;->c:Ljava/nio/ByteBuffer;

    iput-object v1, v0, Laj/b;->g:Laj/a;

    const-wide/16 v3, -0x1

    iput-wide v3, v0, Laj/b;->d:J

    const-wide/16 v3, 0x0

    iput-wide v3, v0, Laj/b;->e:J

    :cond_3
    iput-object v1, p0, Lbj/b;->m:Laj/b;

    iput-object v1, p0, Lbj/b;->b:Ljava/lang/Thread;

    iput-boolean v2, p0, Lbj/b;->l:Z
...
.method public final f()V
    ...
    const-string v2, "startRecorder E"
    ...
    iput-boolean v1, p0, Lbj/b;->c:Z

    iget-object v1, p0, Lbj/b;->i:Lbj/a;

    invoke-virtual {v1}, Lbj/a;->a()V

    iget-object v1, p0, Lbj/b;->b:Ljava/lang/Thread;
    ...
    :cond_0
    iget-object p0, p0, Lbj/b;->b:Ljava/lang/Thread;
...
.method public final g()V
    ...
    :try_start_1
    iget-object v3, p0, Lbj/b;->m:Laj/b;

    iget-object v4, v3, Laj/b;->b:Ljava/nio/ByteBuffer;
    ...
    :cond_1
    iput-object v1, v3, Laj/b;->b:Ljava/nio/ByteBuffer;

    iget-object v4, v3, Laj/b;->c:Ljava/nio/ByteBuffer;
