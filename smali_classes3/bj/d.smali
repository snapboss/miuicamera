...
.method public constructor <init>(Lbj/b;)V
    ...
    iput-object p1, p0, Lbj/d;->c:Lbj/b;
    ...
    iput-wide v0, p0, Lbj/d;->a:J

    const-wide/16 v0, -0x1

    iput-wide v0, p0, Lbj/d;->b:J
...
.method public final a(ILandroid/media/AudioTimestamp;Ljava/nio/ByteBuffer;I)V
    ...
    iget-object v0, v1, Lbj/d;->c:Lbj/b;
    ...
    iput-wide v8, v1, Lbj/d;->b:J

    :goto_0
    iget-object v0, v1, Lbj/d;->c:Lbj/b;

    iget-object v0, v0, Lbj/b;->m:Laj/b;

    iget-wide v8, v1, Lbj/d;->b:J

    iput-wide v8, v0, Laj/b;->d:J
    ...
    iget-object v8, v0, Lbj/b;->m:Laj/b;

    iget-wide v9, v8, Laj/b;->d:J
    ...
    :cond_2
    :try_start_0
    iget-object v0, v8, Laj/b;->c:Ljava/nio/ByteBuffer;

    invoke-virtual {v0}, Ljava/nio/ByteBuffer;->clear()Ljava/nio/Buffer;

    iget-object v0, v8, Laj/b;->b:Ljava/nio/ByteBuffer;
    ...
    iget-object v6, v8, Laj/b;->b:Ljava/nio/ByteBuffer;
    ...
    iput-object v6, v8, Laj/b;->b:Ljava/nio/ByteBuffer;
    ...
    iget-object v6, v8, Laj/b;->c:Ljava/nio/ByteBuffer;
    ...
    iget-object v9, v8, Laj/b;->c:Ljava/nio/ByteBuffer;
    ...
    iget-object v3, v8, Laj/b;->c:Ljava/nio/ByteBuffer;
    ...
    iget-object v11, v8, Laj/b;->c:Ljava/nio/ByteBuffer;
    ...
    :cond_5
    iget-wide v10, v8, Laj/b;->e:J

    const-wide/16 v12, 0x400

    add-long/2addr v10, v12

    iput-wide v10, v8, Laj/b;->e:J

    iget-wide v12, v8, Laj/b;->d:J

    const-wide/32 v14, 0xf4240

    mul-long/2addr v10, v14

    iget v0, v8, Laj/b;->a:I
    ...
    iget-object v0, v8, Laj/b;->g:Laj/a;
    ...
    iget-object v12, v0, Lbj/b$a;->a:Lbj/b;

    iget-boolean v12, v12, Lbj/b;->d:Z

    if-nez v12, :cond_7

    new-instance v12, Lcj/f;

    invoke-direct {v12, v10, v11, v7, v9}, Lcj/f;-><init>(JILjava/nio/ByteBuffer;)V

    iget-object v0, v0, Lbj/b$a;->a:Lbj/b;

    iget-object v13, v0, Lbj/b;->o:Lbj/b$b;

    if-eqz v13, :cond_6

    check-cast v13, Landroidx/core/view/inputmethod/a;

    iget-object v0, v13, Landroidx/core/view/inputmethod/a;->b:Ljava/lang/Object;

    check-cast v0, Lwh/a;

    sget-boolean v12, Lwh/a;->E:Z
    ...
    invoke-virtual {v0, v9, v12}, Lwh/c;->a(Ljava/nio/ByteBuffer;Landroid/media/MediaCodec$BufferInfo;)V
    ...
    :cond_a
    iget-object v3, v8, Laj/b;->b:Ljava/nio/ByteBuffer;
    ...
    iput-object v3, v8, Laj/b;->b:Ljava/nio/ByteBuffer;
    ...
    iget-object v4, v8, Laj/b;->c:Ljava/nio/ByteBuffer;
    ...
    iget-wide v4, v1, Lbj/d;->a:J

    cmp-long v0, v2, v4

    if-lez v0, :cond_d

    iput-wide v2, v1, Lbj/d;->a:J
...
.method public final run()V
    ...
    iget-object v0, p0, Lbj/d;->c:Lbj/b;

    iget v0, v0, Lbj/b;->g:I

    invoke-static {v0}, Ljava/nio/ByteBuffer;->allocateDirect(I)Ljava/nio/ByteBuffer;

    move-result-object v0

    iget-object v1, p0, Lbj/d;->c:Lbj/b;

    invoke-static {v1}, Lbj/b;->b(Lbj/b;)V

    const-wide/16 v3, -0x1

    iput-wide v3, p0, Lbj/d;->b:J

    :goto_0
    iget-object v1, p0, Lbj/d;->c:Lbj/b;

    iget-boolean v1, v1, Lbj/b;->c:Z

    if-eqz v1, :cond_2

    iget-object v1, p0, Lbj/d;->c:Lbj/b;

    iget-object v1, v1, Lbj/b;->j:Ljava/lang/Object;

    monitor-enter v1

    :try_start_0
    iget-object v3, p0, Lbj/d;->c:Lbj/b;

    iget-object v4, v3, Lbj/b;->a:Landroid/media/AudioRecord;

    if-eqz v4, :cond_1

    iget v3, v3, Lbj/b;->g:I

    invoke-virtual {v4, v0, v3}, Landroid/media/AudioRecord;->read(Ljava/nio/ByteBuffer;I)I

    move-result v3

    iget-object v4, p0, Lbj/d;->c:Lbj/b;

    iget-object v5, v4, Lbj/b;->a:Landroid/media/AudioRecord;

    iget-object v6, v4, Lbj/b;->k:Landroid/media/AudioTimestamp;

    iget v4, v4, Lbj/b;->n:I
    ...
    iget-object v5, p0, Lbj/d;->c:Lbj/b;

    iget-object v5, v5, Lbj/b;->k:Landroid/media/AudioTimestamp;

    invoke-virtual {p0, v4, v5, v0, v3}, Lbj/d;->a(ILandroid/media/AudioTimestamp;Ljava/nio/ByteBuffer;I)V
    ...
    invoke-static {v4, v5, v3}, Lbj/b;->a(Lbj/b;Ljava/lang/String;I)V
    ...
    :cond_2
    :try_start_1
    iget-object p0, p0, Lbj/d;->c:Lbj/b;
