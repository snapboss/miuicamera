...
.method public constructor <init>(Lbj/b;)V
    ...
    iput-object p1, p0, Lbj/c;->c:Lbj/b;
    ...
    iput-wide v0, p0, Lbj/c;->a:J

    iput-wide v0, p0, Lbj/c;->b:J
...
.method public final a(ILandroid/media/AudioTimestamp;Ljava/nio/ByteBuffer;I)V
    ...
    iget-object p1, v0, Lbj/b;->a:Landroid/media/AudioRecord;
    ...
    iput-wide v5, p0, Lbj/c;->b:J

    :cond_0
    new-instance p1, Lcj/f;

    iget-wide v1, p0, Lbj/c;->b:J

    invoke-direct {p1, v1, v2, p4, p3}, Lcj/f;-><init>(JILjava/nio/ByteBuffer;)V

    iget-object p3, v0, Lbj/b;->i:Lbj/a;

    invoke-virtual {p3}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    :try_start_0
    iget-object p3, p3, Lbj/a;->a:Ljava/util/concurrent/ArrayBlockingQueue;
    ...
    iget-wide p3, p0, Lbj/c;->a:J

    cmp-long p3, p1, p3

    if-lez p3, :cond_1

    iput-wide p1, p0, Lbj/c;->a:J
...
.method public final run()V
    ...
    invoke-static {v0}, Lbj/b;->b(Lbj/b;)V

    :goto_0
    iget-object v0, p0, Lbj/c;->c:Lbj/b;

    iget-boolean v0, v0, Lbj/b;->c:Z
    ...
    :goto_1
    :try_start_0
    iget-object v1, p0, Lbj/c;->c:Lbj/b;

    iget-boolean v1, v1, Lbj/b;->d:Z
    :try_end_0
    ...
    iget-object v2, v1, Lbj/b;->a:Landroid/media/AudioRecord;

    if-eqz v2, :cond_2

    iget v1, v1, Lbj/b;->g:I

    invoke-static {v1}, Ljava/nio/ByteBuffer;->allocateDirect(I)Ljava/nio/ByteBuffer;

    move-result-object v1

    iget-object v2, p0, Lbj/c;->c:Lbj/b;

    iget-object v3, v2, Lbj/b;->a:Landroid/media/AudioRecord;
    ...
    iget-object v3, p0, Lbj/c;->c:Lbj/b;

    iget-object v4, v3, Lbj/b;->a:Landroid/media/AudioRecord;

    iget-object v5, v3, Lbj/b;->k:Landroid/media/AudioTimestamp;

    iget v3, v3, Lbj/b;->n:I
    ...
    iget-object v4, p0, Lbj/c;->c:Lbj/b;

    iget-boolean v4, v4, Lbj/b;->d:Z

    if-nez v4, :cond_1

    iget-object v4, p0, Lbj/c;->c:Lbj/b;

    iget-object v4, v4, Lbj/b;->k:Landroid/media/AudioTimestamp;

    invoke-virtual {p0, v3, v4, v1, v2}, Lbj/c;->a(ILandroid/media/AudioTimestamp;Ljava/nio/ByteBuffer;I)V
    ...
    invoke-static {v3, v4, v2}, Lbj/b;->a(Lbj/b;Ljava/lang/String;I)V
    ...
    :cond_3
    :try_start_3
    iget-object p0, p0, Lbj/c;->c:Lbj/b;
