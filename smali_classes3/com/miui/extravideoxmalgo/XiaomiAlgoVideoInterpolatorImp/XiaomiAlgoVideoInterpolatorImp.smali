...
.method public constructor <init>(IILjava/lang/String;Ljava/lang/String;IIIJLandroid/graphics/Bitmap;[FZZ)V
    ...
    iput v5, v0, Lcom/miui/extravideoxmalgo/XiaomiAlgoVideoInterpolatorImp/XiaomiAlgoVideoInterpolatorImp;->mTargetFPS:I
    ...
    iput v6, v0, Lcom/miui/extravideoxmalgo/XiaomiAlgoVideoInterpolatorImp/XiaomiAlgoVideoInterpolatorImp;->mFirstNormalFrameQuantity:I

    const/16 v6, 0x78

    iput v6, v0, Lcom/miui/extravideoxmalgo/XiaomiAlgoVideoInterpolatorImp/XiaomiAlgoVideoInterpolatorImp;->mFirstAndInsertFrameQuantity:I

    const/16 v6, 0x96

    iput v6, v0, Lcom/miui/extravideoxmalgo/XiaomiAlgoVideoInterpolatorImp/XiaomiAlgoVideoInterpolatorImp;->mDecodedFrameNumber:I

    const/4 v6, 0x1

    iput v6, v0, Lcom/miui/extravideoxmalgo/XiaomiAlgoVideoInterpolatorImp/XiaomiAlgoVideoInterpolatorImp;->mVideoEndNormalTime:I
    ...
    iput v6, v0, Lcom/miui/extravideoxmalgo/XiaomiAlgoVideoInterpolatorImp/XiaomiAlgoVideoInterpolatorImp;->mSkipSizeTarget2Normal:I

    const/16 v6, 0x3c0

    div-int/2addr v6, v5

    iput v6, v0, Lcom/miui/extravideoxmalgo/XiaomiAlgoVideoInterpolatorImp/XiaomiAlgoVideoInterpolatorImp;->mSkipSizeTarget2Origin:I
    ...
    iput v6, v0, Lcom/miui/extravideoxmalgo/XiaomiAlgoVideoInterpolatorImp/XiaomiAlgoVideoInterpolatorImp;->mFrameSizeInterpolation:I

    iput v7, v0, Lcom/miui/extravideoxmalgo/XiaomiAlgoVideoInterpolatorImp/XiaomiAlgoVideoInterpolatorImp;->mFrameIndexBeginInterpolation:I

    const/16 v5, 0x186

    iput v5, v0, Lcom/miui/extravideoxmalgo/XiaomiAlgoVideoInterpolatorImp/XiaomiAlgoVideoInterpolatorImp;->mFrameIndexStopInterpolation:I
    ...
    iput-object v5, v0, Lcom/miui/extravideoxmalgo/XiaomiAlgoVideoInterpolatorImp/XiaomiAlgoVideoInterpolatorImp;->mQueue:Ljava/util/concurrent/BlockingQueue;

    const/4 v5, 0x4

    new-array v6, v5, [Ljava/nio/ByteBuffer;

    iput-object v6, v0, Lcom/miui/extravideoxmalgo/XiaomiAlgoVideoInterpolatorImp/XiaomiAlgoVideoInterpolatorImp;->mFrameBuffer:[Ljava/nio/ByteBuffer;

    const/16 v6, 0x1a9

    new-array v6, v6, [I

    iput-object v6, v0, Lcom/miui/extravideoxmalgo/XiaomiAlgoVideoInterpolatorImp/XiaomiAlgoVideoInterpolatorImp;->mFrameMapping:[I

    const/4 v6, 0x0

    iput-boolean v6, v0, Lcom/miui/extravideoxmalgo/XiaomiAlgoVideoInterpolatorImp/XiaomiAlgoVideoInterpolatorImp;->mNeedDump:Z

    const/4 v6, 0x0

    iput-object v6, v0, Lcom/miui/extravideoxmalgo/XiaomiAlgoVideoInterpolatorImp/XiaomiAlgoVideoInterpolatorImp;->mYuvFile:Ljava/io/File;
    ...
    div-int/lit8 v8, v2, 0x1e

    iput v8, v0, Lcom/miui/extravideoxmalgo/XiaomiAlgoVideoInterpolatorImp/XiaomiAlgoVideoInterpolatorImp;->mSkipSizeTarget2Normal:I
    ...
    invoke-static {v3, v2, v5, v1}, Lae/e;->a(IIII)I
    ...
    mul-int/lit8 v2, v4, 0x1e

    add-int/2addr v2, v1

    iput v2, v0, Lcom/miui/extravideoxmalgo/XiaomiAlgoVideoInterpolatorImp/XiaomiAlgoVideoInterpolatorImp;->mDecodedFrameNumber:I

    iput v4, v0, Lcom/miui/extravideoxmalgo/XiaomiAlgoVideoInterpolatorImp/XiaomiAlgoVideoInterpolatorImp;->mVideoEndNormalTime:I
    ...
    iget v12, v0, Lcom/miui/extravideoxmalgo/XiaomiAlgoVideoInterpolatorImp/XiaomiAlgoVideoInterpolatorImp;->mDecodedFrameNumber:I
    ...
    invoke-direct/range {v7 .. v12}, Lcom/miui/extravideoxmalgo/xaiomiAlogMedia/XiaomiAlgoDecoderAsync;-><init>(Ljava/lang/String;Landroid/os/Handler;JI)V
    ...
    invoke-virtual {v3}, Lcom/miui/extravideoxmalgo/xaiomiAlogMedia/XiaomiAlgoDecoderAsync;->getMediaParamsHolder()Lcom/miui/extravideoxmalgo/xaiomiAlogMedia/MediaParamsHolder;

    move-result-object v2

    iget v3, v2, Lcom/miui/extravideoxmalgo/xaiomiAlogMedia/MediaParamsHolder;->videoDegree:I
    ...
    iget v5, v2, Lcom/miui/extravideoxmalgo/xaiomiAlogMedia/MediaParamsHolder;->videoWidth:I

    iget v7, v2, Lcom/miui/extravideoxmalgo/xaiomiAlogMedia/MediaParamsHolder;->videoHeight:I

    iget-object v8, v2, Lcom/miui/extravideoxmalgo/xaiomiAlogMedia/MediaParamsHolder;->mimeType:Ljava/lang/String;
    ...
    invoke-direct {v3, p0, v2}, Lcom/miui/extravideoxmalgo/XiaomiAlgoVideoInterpolatorImp/XiaomiAlgoVideoInterpolatorImp$DecodeUpdateListener;-><init>(Lcom/miui/extravideoxmalgo/XiaomiAlgoVideoInterpolatorImp/XiaomiAlgoVideoInterpolatorImp;Lcom/miui/extravideoxmalgo/xaiomiAlogMedia/MediaParamsHolder;)V
...
.method private addMetaData()V
    ...
    invoke-static {v2}, Lju/d;->a(Ljava/io/File;)Lju/d;

    move-result-object v2

    iget-object v3, v2, Lju/d;->a:Ljava/util/Map;
...
.method private notifyTaskFinish()V
    ...
    iput-object v1, p0, Lcom/miui/extravideoxmalgo/XiaomiAlgoVideoInterpolatorImp/XiaomiAlgoVideoInterpolatorImp;->mEncodeListener:Lcom/miui/extravideoxmalgo/xiaomiAlgoInterpolator/EncodeListener;
    ...
    invoke-interface {v0}, Lcom/miui/extravideoxmalgo/xiaomiAlgoInterpolator/EncodeListener;->onEncodeFinish()V
