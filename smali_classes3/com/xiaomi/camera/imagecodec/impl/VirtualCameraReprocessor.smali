...
.method private createCaptureSessionIfNeed(Lcom/xiaomi/camera/imagecodec/ReprocessData;)Z
    ...
    const-string v0, "createCaptureSessionIfNeed: expected device changed. oldId="
    ...
    invoke-direct {v5, v6, v7, v2}, Landroid/hardware/camera2/params/InputConfiguration;-><init>(III)V
    ...
    invoke-direct {v2, v6, v7, v8}, Lcom/xiaomi/camera/imagecodec/OutputConfiguration;-><init>(III)V
    ...
    iget-object v6, p0, Lcom/xiaomi/camera/imagecodec/impl/VirtualCameraReprocessor;->mFrontVtCameraId:Ljava/lang/String;

    goto :goto_0

    :cond_1
    iget-object v6, p0, Lcom/xiaomi/camera/imagecodec/impl/VirtualCameraReprocessor;->mBackVtCameraId:Ljava/lang/String;

    :goto_0
    iget-object v7, p0, Lcom/xiaomi/camera/imagecodec/impl/VirtualCameraReprocessor;->mVTCameraDevice:Landroid/hardware/camera2/CameraDevice;
    ...
    iput-boolean v3, p0, Lcom/xiaomi/camera/imagecodec/impl/VirtualCameraReprocessor;->mCreatingReprocessSession:Z
    ...
    invoke-direct {p0, v6}, Lcom/xiaomi/camera/imagecodec/impl/VirtualCameraReprocessor;->openVTCamera(Ljava/lang/String;)V
    ...
    iput-boolean v3, p0, Lcom/xiaomi/camera/imagecodec/impl/VirtualCameraReprocessor;->mNeedReopenCamera:Z
    ...
    :cond_6
    invoke-virtual {v2}, Lcom/xiaomi/camera/imagecodec/OutputConfiguration;->getFormat()I
    ...
    invoke-virtual {v5, v8}, Landroid/hardware/camera2/params/InputConfiguration;->equals(Ljava/lang/Object;)Z

    move-result v8

    if-eqz v8, :cond_9

    invoke-virtual {v2, v7}, Lcom/xiaomi/camera/imagecodec/OutputConfiguration;->equals(Ljava/lang/Object;)Z
    ...
    invoke-virtual {v5}, Landroid/hardware/camera2/params/InputConfiguration;->getWidth()I
    ...
    invoke-virtual {v5}, Landroid/hardware/camera2/params/InputConfiguration;->getHeight()I
    ...
    invoke-virtual {v2}, Lcom/xiaomi/camera/imagecodec/OutputConfiguration;->getWidth()I
    ...
    invoke-virtual {v2}, Lcom/xiaomi/camera/imagecodec/OutputConfiguration;->getHeight()I
    ...
    invoke-static {v8, v4}, Lcom/xiaomi/engine/Log;->i(Ljava/lang/String;Ljava/lang/String;)I
    ...
    iput-object v5, p0, Lcom/xiaomi/camera/imagecodec/impl/VirtualCameraReprocessor;->mInputConfiguration:Landroid/hardware/camera2/params/InputConfiguration;
    ...
    invoke-direct {v0, v3, v2, v6}, Lcom/xiaomi/camera/imagecodec/OutputConfiguration;-><init>(III)V
    ...
    invoke-direct {v0, v3, v2, v9}, Lcom/xiaomi/camera/imagecodec/OutputConfiguration;-><init>(III)V
    ...
    :goto_c
    iget-object v0, p0, Lcom/xiaomi/camera/imagecodec/impl/VirtualCameraReprocessor;->mInputConfiguration:Landroid/hardware/camera2/params/InputConfiguration;
    ...
    iget-object v3, p0, Lcom/xiaomi/camera/imagecodec/impl/VirtualCameraReprocessor;->mPicOutputConfiguration:Lcom/xiaomi/camera/imagecodec/OutputConfiguration;

    invoke-direct {p0, v0, v2, v3, p1}, Lcom/xiaomi/camera/imagecodec/impl/VirtualCameraReprocessor;->createReprocessSession(Landroid/hardware/camera2/params/InputConfiguration;Lcom/xiaomi/camera/imagecodec/OutputConfiguration;Lcom/xiaomi/camera/imagecodec/OutputConfiguration;Lcom/xiaomi/camera/imagecodec/ReprocessData;)V
...
.method private reprocessImage()V
    ...
    const-string v2, "reprocessImage: failed to set XIAOMI_JPEG_ORIENTATION. "
    ...
    invoke-static {v7, v0, v2}, Lcom/xiaomi/camera/imagecodec/CaptureRequestVendorTags;->setValueSafely(Landroid/hardware/camera2/CaptureRequest$Builder;Lcom/xiaomi/camera/imagecodec/VendorTag;Ljava/lang/Object;)V
