...
.method private initImageReader(IIILandroid/media/ImageReader$OnImageAvailableListener;)Landroid/media/ImageReader;
    ...
    const-string v1, "initImageReader>>"

    const-string v2, "x"

    const-string v3, "@"

    invoke-static {v1, p1, v2, p2, v3}, Landroidx/activity/o;->c(Ljava/lang/String;ILjava/lang/String;ILjava/lang/String;)Ljava/lang/StringBuilder;
...
.method private reprocessImage()V
    ...
    const-string v1, "reprocessImage: skip raw task "

    const-string v2, "reprocessImage: skip task "

    const-string v3, "reprocessImage: tag="

    iget-object v4, v0, Lcom/xiaomi/camera/imagecodec/impl/IspInterfaceReprocessor;->TAG:Ljava/lang/String;

    const-string v5, "reprocessImage>>"

    invoke-static {v4, v5}, Lcom/xiaomi/engine/Log;->d(Ljava/lang/String;Ljava/lang/String;)I

    iget-object v4, v0, Lcom/xiaomi/camera/imagecodec/impl/IspInterfaceReprocessor;->mDataLock:Ljava/lang/Object;

    monitor-enter v4

    :try_start_0
    iget-object v5, v0, Lcom/xiaomi/camera/imagecodec/impl/IspInterfaceReprocessor;->mTaskDataList:Ljava/util/LinkedList;
    ...
    const-string v1, "processingData is null!"
    ...
    :cond_0
    iput-object v5, v0, Lcom/xiaomi/camera/imagecodec/impl/IspInterfaceReprocessor;->mCurrentProcessingData:Lcom/xiaomi/camera/imagecodec/ReprocessData;

    iget-object v6, v0, Lcom/xiaomi/camera/imagecodec/impl/IspInterfaceReprocessor;->TAG:Ljava/lang/String;
    ...
    invoke-static {v6, v3}, Lcom/xiaomi/engine/Log;->d(Ljava/lang/String;Ljava/lang/String;)I

    monitor-exit v4
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_3

    invoke-virtual {v5}, Lcom/xiaomi/camera/imagecodec/ReprocessData;->getTotalCaptureResult()Lcom/xiaomi/protocol/ICustomCaptureResult;
    ...
    iget-object v14, v0, Lcom/xiaomi/camera/imagecodec/impl/IspInterfaceReprocessor;->mDataLock:Ljava/lang/Object;

    monitor-enter v14

    :try_start_1
    iget-object v2, v0, Lcom/xiaomi/camera/imagecodec/impl/IspInterfaceReprocessor;->mRaw2YuvStatusMap:Ljava/util/HashMap;

    new-instance v15, Lcom/xiaomi/camera/imagecodec/impl/IspInterfaceReprocessor$Raw2YuvStatus;

    invoke-direct {v15, v0, v13}, Lcom/xiaomi/camera/imagecodec/impl/IspInterfaceReprocessor$Raw2YuvStatus;-><init>(Lcom/xiaomi/camera/imagecodec/impl/IspInterfaceReprocessor;Lcom/xiaomi/camera/imagecodec/impl/IspInterfaceReprocessor$1;)V
    ...
    iget-object v2, v0, Lcom/xiaomi/camera/imagecodec/impl/IspInterfaceReprocessor;->mCodecLock:Ljava/lang/Object;

    monitor-enter v2

    :try_start_2
    iget-object v14, v0, Lcom/xiaomi/camera/imagecodec/impl/IspInterfaceReprocessor;->mActiveIspInterface:Lcom/xiaomi/camera/isp/IspInterface;
    ...
    :cond_5
    iget-object v1, v0, Lcom/xiaomi/camera/imagecodec/impl/IspInterfaceReprocessor;->mRawInputSize:Landroid/util/Size;
    ...
    invoke-virtual {v14, v1, v15, v7}, Lcom/xiaomi/camera/isp/IspInterface;->getInputStreamId(III)J
    ...
    :cond_6
    iget-object v1, v0, Lcom/xiaomi/camera/imagecodec/impl/IspInterfaceReprocessor;->mCodecLock:Ljava/lang/Object;

    monitor-enter v1

    :try_start_4
    iget-object v7, v0, Lcom/xiaomi/camera/imagecodec/impl/IspInterfaceReprocessor;->mActiveIspInterface:Lcom/xiaomi/camera/isp/IspInterface;
    ...
    invoke-static {v0, v2}, Lcom/xiaomi/engine/Log;->e(Ljava/lang/String;Ljava/lang/String;)I
    ...
    invoke-virtual {v7, v2, v14, v15}, Lcom/xiaomi/camera/isp/IspInterface;->getInputStreamId(III)J
    ...
    invoke-virtual {v5}, Lcom/xiaomi/camera/imagecodec/ReprocessData;->getTuningImage()Ljava/util/ArrayList;
    ...
    :goto_4
    invoke-direct {v10, v14, v15, v13, v11}, Lcom/xiaomi/camera/isp/IspBuffer;-><init>(JLandroid/media/Image;Landroid/media/Image;)V
    ...
    :cond_9
    invoke-virtual {v5}, Lcom/xiaomi/camera/imagecodec/ReprocessData;->getReprocessFunctionType()I
    ...
    :cond_b
    invoke-virtual {v5}, Lcom/xiaomi/camera/imagecodec/ReprocessData;->getOutputFormat()I
    ...
    invoke-virtual {v5}, Lcom/xiaomi/camera/imagecodec/ReprocessData;->getCropRegion()[I

    move-result-object v22

    invoke-virtual {v5}, Lcom/xiaomi/camera/imagecodec/ReprocessData;->getOrientation()I
    ...
    invoke-virtual {v5}, Lcom/xiaomi/camera/imagecodec/ReprocessData;->isFrontMirror()Z

    move-result v19

    invoke-virtual {v3}, Lcom/xiaomi/protocol/ICustomCaptureResult;->getResults()Landroid/os/Parcelable;

    move-result-object v20

    invoke-virtual {v5}, Lcom/xiaomi/camera/imagecodec/ReprocessData;->isRemosaic()I
