...
.method private constructor <init>(Ljava/lang/String;)V
    ...
    iput-object v0, p0, Lcom/xiaomi/camera/mivi/pool/ImagePool;->mImageWriterHandlerThread:Landroid/os/HandlerThread;
    ...
    iput-object v1, p0, Lcom/xiaomi/camera/mivi/pool/ImagePool;->mImageReaderHandlerThread:Landroid/os/HandlerThread;
    ...
    iput-object v2, p0, Lcom/xiaomi/camera/mivi/pool/ImagePool;->mImageQueueMap:Ljava/util/Map;
    ...
    iput-object v2, p0, Lcom/xiaomi/camera/mivi/pool/ImagePool;->mHoldImages:Ljava/util/Map;
    ...
    iput-object v2, p0, Lcom/xiaomi/camera/mivi/pool/ImagePool;->mAcquiredImageCountMap:Ljava/util/Map;
    ...
    iput-object v2, p0, Lcom/xiaomi/camera/mivi/pool/ImagePool;->mPooledImageCountMap:Ljava/util/Map;
    ...
    iput-object v2, p0, Lcom/xiaomi/camera/mivi/pool/ImagePool;->mQueueSizeLock:Ljava/lang/Object;
    ...
    iput-object v2, p0, Lcom/xiaomi/camera/mivi/pool/ImagePool;->mImageQueueLock:Ljava/lang/Object;
    ...
    iput-object v2, p0, Lcom/xiaomi/camera/mivi/pool/ImagePool;->mRowStrides:Ljava/util/Map;
    ...
    iput-object p1, p0, Lcom/xiaomi/camera/mivi/pool/ImagePool;->mImageReaderHandler:Landroid/os/Handler;
    ...
    iput-object p1, p0, Lcom/xiaomi/camera/mivi/pool/ImagePool;->mImageWriterHandler:Landroid/os/Handler;

    return-void
.end method

.method public synthetic constructor <init>(Ljava/lang/String;Lcom/xiaomi/camera/mivi/pool/ImagePool$1;)V
    .locals 0
...
.method private createImageQueue(Lcom/xiaomi/camera/mivi/pool/ImagePool$ImageFormat;Z)Lcom/xiaomi/camera/mivi/pool/ImageQueue;
    ...
    new-instance v6, Lcom/xiaomi/camera/mivi/pool/ImageQueue;

    iget-object v2, p0, Lcom/xiaomi/camera/mivi/pool/ImagePool;->mImageReaderHandler:Landroid/os/Handler;

    iget-object v3, p0, Lcom/xiaomi/camera/mivi/pool/ImagePool;->mImageWriterHandler:Landroid/os/Handler;

    iget v4, p0, Lcom/xiaomi/camera/mivi/pool/ImagePool;->sMaxAcquireImageCount:I

    iget v5, p0, Lcom/xiaomi/camera/mivi/pool/ImagePool;->sMaxDequeueImageCount:I

    move-object v0, v6

    move-object v1, p1

    invoke-direct/range {v0 .. v5}, Lcom/xiaomi/camera/mivi/pool/ImageQueue;-><init>(Lcom/xiaomi/camera/mivi/pool/ImagePool$ImageFormat;Landroid/os/Handler;Landroid/os/Handler;II)V

    if-eqz p2, :cond_1

    iget-object p2, p0, Lcom/xiaomi/camera/mivi/pool/ImagePool;->mImageQueueLock:Ljava/lang/Object;

    monitor-enter p2

    :try_start_0
    iget-object v0, p0, Lcom/xiaomi/camera/mivi/pool/ImagePool;->mImageQueueMap:Ljava/util/Map;

    invoke-interface {v0, p1, v6}, Ljava/util/Map;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    iget-object p1, p0, Lcom/xiaomi/camera/mivi/pool/ImagePool;->mImageQueueMap:Ljava/util/Map;
    ...
    iget-object p1, p0, Lcom/xiaomi/camera/mivi/pool/ImagePool;->TAG:Ljava/lang/String;
...
.method public static makeImageWriter(Landroid/view/Surface;IZ)Landroid/media/ImageWriter;
    ...
    :catch_0
    const-string p2, "could not find our method, try android method"
...
.method public init(III)V
    ...
    .line 6
    :cond_2
    iput-boolean v4, p0, Lcom/xiaomi/camera/mivi/pool/ImagePool;->sInited:Z
    ...
    .line 14
    invoke-static {v2, p1, v0, p2, v3}, Landroidx/activity/o;->c(Ljava/lang/String;ILjava/lang/String;ILjava/lang/String;)Ljava/lang/StringBuilder;
...
.method public releaseImage(Landroid/media/Image;)V
    ...
    const-string v0, "releaseImage: image: "

    const-string v1, "releaseImage: not hold image "
    ...
    iget-object v1, p0, Lcom/xiaomi/camera/mivi/pool/ImagePool;->mHoldImages:Ljava/util/Map;

    invoke-interface {v1, p1}, Ljava/util/Map;->remove(Ljava/lang/Object;)Ljava/lang/Object;

    const/4 v1, -0x1

    invoke-direct {p0, v3, v1}, Lcom/xiaomi/camera/mivi/pool/ImagePool;->changeAcquiredImageCountLocked(Lcom/xiaomi/camera/mivi/pool/ImagePool$ImageFormat;I)I
