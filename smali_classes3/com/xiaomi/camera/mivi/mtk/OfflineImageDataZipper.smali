...
.method public static synthetic a(Ljava/util/concurrent/atomic/AtomicInteger;Ljava/lang/Long;Lng/q;)V
    .locals 0

    invoke-static {p0, p1, p2}, Lcom/xiaomi/camera/mivi/mtk/OfflineImageDataZipper;->lambda$getParallelTaskSize$0(Ljava/util/concurrent/atomic/AtomicInteger;Ljava/lang/Long;Lng/q;)V
...
.method private doJpeg(Lng/q;Landroid/media/Image;I)V
    .locals 9
    ...
    invoke-static {v1, v2, p3}, Landroidx/activity/m;->h(Ljava/lang/StringBuilder;Ljava/lang/String;I)Ljava/lang/String;
    ...
    invoke-direct/range {v3 .. v8}, Lcom/xiaomi/camera/mivi/mtk/OfflineImageDataZipper;->generateReprocessData(Lng/q;Landroid/media/Image;Ljava/lang/String;IZ)Lcom/xiaomi/camera/imagecodec/ReprocessData;
...
.method private generateReprocessData(Lng/q;Landroid/media/Image;Ljava/lang/String;IZ)Lcom/xiaomi/camera/imagecodec/ReprocessData;
    .locals 18
    ...
    iget-object v13, v1, Lng/q;->q:Lng/r;

    iget-object v2, v1, Lng/q;->h:Landroid/hardware/camera2/TotalCaptureResult;

    iget-boolean v5, v1, Lng/q;->g0:Z
    ...
    invoke-static {v2, v4}, Lvf/a;->a(Landroid/hardware/camera2/CaptureResult;Ljava/lang/String;)Lcom/xiaomi/protocol/ICustomCaptureResult;

    move-result-object v7

    iget-boolean v8, v13, Lng/r;->B:Z

    iget-object v2, v13, Lng/r;->C:Landroid/util/Size;
    ...
    iget v3, v13, Lng/r;->D:I

    iget-object v2, v0, Lcom/xiaomi/camera/mivi/mtk/OfflineImageDataZipper;->mJpegEncoderListener:Lcom/xiaomi/camera/imagecodec/ReprocessData$OnDataAvailableListener;
    ...
    iget-object v4, v1, Lng/q;->K:Landroid/media/Image;
    ...
    :cond_1
    iget-boolean v2, v13, Lng/r;->T:Z

    if-eqz v2, :cond_2

    iget v2, v13, Lng/r;->v:I

    invoke-virtual {v14, v2}, Lcom/xiaomi/camera/imagecodec/ReprocessData;->setOrientation(I)V

    :cond_2
    iget-byte v2, v13, Lng/r;->U:B

    invoke-virtual {v14, v2}, Lcom/xiaomi/camera/imagecodec/ReprocessData;->setSiqeType(B)V

    iget-object v2, v13, Lng/r;->i:Landroid/util/Size;

    invoke-virtual {v2}, Landroid/util/Size;->getWidth()I

    move-result v2

    iget-object v3, v13, Lng/r;->i:Landroid/util/Size;
...
.method private handTimeoutTask(J)V
    ...
    invoke-static {v1, p1, p2, v2}, Lae/e;->g(Ljava/lang/String;JLjava/lang/String;)Ljava/lang/StringBuilder;
...
.method private handleDataBeanIfReady(Lcom/xiaomi/camera/mivi/mtk/OfflineImageData;Z)V
    ...
    invoke-virtual {p2, v0}, Ll7/j;->d(Ljava/lang/String;)J

    invoke-virtual {p1}, Lcom/xiaomi/camera/mivi/mtk/OfflineImageData;->getTimestamp()J

    move-result-wide v0

    invoke-virtual {p0, v0, v1}, Lcom/xiaomi/camera/mivi/mtk/OfflineImageDataZipper;->getParallelTaskData(J)Lng/q;
    ...
    :cond_1
    iget-wide v0, p2, Lng/q;->a0:J

    iget-object v3, p2, Lng/q;->V:Ljava/lang/String;

    iget-wide v4, p2, Lng/q;->e:J
    ...
    invoke-virtual {p2, v1, v0}, Lng/q;->a(I[B)V
    ...
    invoke-static {v1, v3, v4}, Landroidx/activity/m;->h(Ljava/lang/StringBuilder;Ljava/lang/String;I)Ljava/lang/String;
    ...
    iput-object v0, p2, Lng/q;->K:Landroid/media/Image;
    ...
    iget-object v1, p2, Lng/q;->q:Lng/r;

    iget-boolean v1, v1, Lng/r;->a:Z
    ...
    invoke-direct {p0, v1, p2, v0}, Lcom/xiaomi/camera/mivi/mtk/OfflineImageDataZipper;->postCvWaterMark(Landroid/media/Image;Lng/q;I)V
    ...
    invoke-direct {p0, p2, v0, v1}, Lcom/xiaomi/camera/mivi/mtk/OfflineImageDataZipper;->doJpeg(Lng/q;Landroid/media/Image;I)V
...
.method private handleRawImageData([BLjava/lang/String;)V
    ...
    invoke-virtual {p0, p2, p1}, Lng/q;->a(I[B)V
    ...
    invoke-static {p0, p1}, Lcom/xiaomi/camera/mivi/MIVICaptureManager;->notifyFinish(Lng/q;Ljava/lang/String;)V
...
.method private static synthetic lambda$getParallelTaskSize$0(Ljava/util/concurrent/atomic/AtomicInteger;Ljava/lang/Long;Lng/q;)V
    .locals 0

    invoke-virtual {p2}, Lng/q;->c()I
...
.method private postCvWaterMark(Landroid/media/Image;Lng/q;I)V
    .locals 4
    ...
    invoke-static {p1, v2}, Lvf/e;->g(Landroid/media/Image;Z)[B

    move-result-object v2

    const-string v3, ""

    invoke-static {p3, v3}, Lae/e;->c(ILjava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v0, v1, p1, v3}, Landroidx/activity/m;->d(JLjava/lang/StringBuilder;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {p1, p2, p3}, Landroidx/activity/m;->h(Ljava/lang/StringBuilder;Ljava/lang/String;I)Ljava/lang/String;
...
.method public getParallelTaskData(J)Lng/q;
    .locals 3
...
.method public getParallelTaskSize()Ljava/lang/String;
    ...
    invoke-direct {v2, v0, v3}, Le5/d;-><init>(Ljava/io/Serializable;I)V
...
.method public putParallelTaskData(JLng/q;)V
    .locals 5
