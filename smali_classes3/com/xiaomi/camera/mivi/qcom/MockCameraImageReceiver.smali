...
.method public static synthetic access$1000(Lcom/xiaomi/camera/mivi/qcom/MockCameraImageReceiver;JLjava/lang/String;)V
    .locals 0
...
.method public static synthetic access$900(Lcom/xiaomi/camera/mivi/qcom/MockCameraImageReceiver;Landroid/hardware/camera2/TotalCaptureResult;J)V
    .locals 0
...
.method private join(JJ)V
    ...
    const-string v2, "join: notify shutterTs: %d, shootingTs: %d"
    ...
    const-string v3, "getResultImageData return null"
...
.method private join(Landroid/hardware/camera2/TotalCaptureResult;J)V
    ...
    const-string v0, "join: captureResult shootingTs: %d, pictureName: %s"
    ...
    const-string v3, "join: add MIVI2 exif "

    .line 23
    invoke-static {v1, v3, p1}, Landroid/support/v4/media/session/d;->c(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    .line 25
    invoke-virtual {v0, v6}, Lcom/xiaomi/camera/mivi/qcom/bean/ResultImageData;->setType(I)V
    ...
    .line 29
    invoke-static {v1, p1}, Landroidx/activity/m;->f(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
...
.method private join(Landroid/media/Image;I)V
    ...
    const-string v4, "join: image shutterTs: %d"
    ...
    .line 47
    invoke-static {p1, p2, v8, v5}, Lcom/xiaomi/camera/mivi/ImagePoolAdapter;->queueImageToPool(Landroid/media/Image;IIZ)Landroid/media/Image;
...
.method private synthetic lambda$createCaptureSession$0(ILandroid/media/ImageReader;)V
    ...
    const-string v5, "onImageAvailable: %d, shutterTs: %d"
...
.method private notifyError(JLjava/lang/String;)V
    ...
    invoke-static {p3}, Landroidx/appcompat/app/b;->i(Ljava/lang/String;)Ljava/lang/StringBuilder;
    ...
    iget v7, p0, Lcom/xiaomi/camera/mivi/qcom/MockCameraImageReceiver;->mState:I

    invoke-static {v7}, Lcom/xiaomi/camera/mivi/qcom/MockCameraState;->toString(I)Ljava/lang/String;
...
.method private putResultImageData(JLcom/xiaomi/camera/mivi/qcom/bean/ResultImageData;Ljava/lang/String;)Z
    ...
    const-string v1, "putResultImageData : data for %d already existed !!!"
    ...
    invoke-static {v1, p4, v3}, Lcom/android/camera/log/Log;->d(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
...
.method private tryFinish(J)V
    ...
    const-string v5, "tryFinish:  receive all image and result, shootingTs: %d"
...
.method private waitPrepareResultAsync()V
    ...
    invoke-direct {v2, p0, v4}, Landroidx/core/app/a;-><init>(Ljava/lang/Object;I)V
    ...
    invoke-direct {v2, p0, v10}, Loh/b;-><init>(Ljava/lang/Object;I)V
...
.method public createCaptureSession()V
    ...
    new-instance v7, Lcom/xiaomi/camera/mivi/qcom/d;

    invoke-direct {v7, p0, v5}, Lcom/xiaomi/camera/mivi/qcom/d;-><init>(Lcom/xiaomi/camera/mivi/qcom/MockCameraImageReceiver;I)V
...
.method public doRequest(Lcom/xiaomi/camera/mivi/qcom/bean/RequestData;Ljava/lang/String;)V
    ...
    iget v8, p0, Lcom/xiaomi/camera/mivi/qcom/MockCameraImageReceiver;->mState:I

    invoke-static {v8}, Lcom/xiaomi/camera/mivi/qcom/MockCameraState;->toString(I)Ljava/lang/String;
    ...
    invoke-static {v3, v2, v8}, Lcom/android/camera/log/LogC;->v(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    :try_end_3
    ...
    const-string v10, "doRequest: data: %s, shootingTs: %d, frameNumber: %d, session id: %d"
    ...
    invoke-static {v2, v3, v4}, Loa/b0;->i(Landroid/hardware/camera2/CaptureRequest$Builder;Loa/a0;Ljava/lang/Object;)V

    sget-object v3, Loa/x;->o4:Loa/w;
    ...
    invoke-virtual {p1, v3}, Lcom/xiaomi/camera/mivi/qcom/bean/RequestData;->getMetadataValueOf(Ljava/lang/String;)Ljava/lang/String;
    ...
    const-string v10, "doRequest: jpeg_quality: %d"
    ...
    const-string v9, "doRequest: jpeg_quality:"
    ...
    invoke-static {v4, v3, v8}, Lcom/android/camera/log/Log;->w(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    ...
    const-string v10, "doRequest: jpeg_name: %s"
    ...
    sget-object v4, Loa/x;->E3:Loa/w;

    invoke-static {v2, v4, v3}, Loa/b0;->i(Landroid/hardware/camera2/CaptureRequest$Builder;Loa/a0;Ljava/lang/Object;)V

    :cond_6
    iget-object v4, p0, Lcom/xiaomi/camera/mivi/qcom/MockCameraImageReceiver;->mSession:Landroid/hardware/camera2/CameraCaptureSession;

    invoke-virtual {v2}, Landroid/hardware/camera2/CaptureRequest$Builder;->build()Landroid/hardware/camera2/CaptureRequest;

    move-result-object v2

    new-instance v8, Lcom/xiaomi/camera/mivi/qcom/MockCameraImageReceiver$3;

    invoke-direct {v8, p0, v3, p2, p1}, Lcom/xiaomi/camera/mivi/qcom/MockCameraImageReceiver$3;-><init>(Lcom/xiaomi/camera/mivi/qcom/MockCameraImageReceiver;Ljava/lang/String;Ljava/lang/String;Lcom/xiaomi/camera/mivi/qcom/bean/RequestData;)V

    iget-object v9, p0, Lcom/xiaomi/camera/mivi/qcom/ICameraImageReceiver;->mCallbackHandler:Landroid/os/Handler;

    invoke-virtual {v4, v2, v8, v9}, Landroid/hardware/camera2/CameraCaptureSession;->capture(Landroid/hardware/camera2/CaptureRequest;Landroid/hardware/camera2/CameraCaptureSession$CaptureCallback;Landroid/os/Handler;)I
    ...
    invoke-static {v9, v10, v3}, Lcom/xiaomi/camera/mivi/util/LogPrefixUtil;->getPrefix(Ljava/lang/String;ILjava/lang/String;)Ljava/lang/String;
    ...
    const-string v8, "doRequest: data: %s, request fail: %s"
...
.method public prepareSync(Lcom/xiaomi/camera/mivi/qcom/bean/RequestData;)Z
    ...
    iget-object v7, p0, Lcom/xiaomi/camera/mivi/qcom/MockCameraImageReceiver;->mIsPreparing:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    const-string v7, "prepareSync: mState: %s, isPreparing: %s"
    ...
    invoke-static {v0, v5}, Landroidx/activity/m;->f(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-direct {p0, v8}, Lcom/xiaomi/camera/mivi/qcom/MockCameraImageReceiver;->setState(I)V

    new-instance p1, Landroidx/activity/l;

    invoke-direct {p1, p0, v4}, Landroidx/activity/l;-><init>(Ljava/lang/Object;I)V
    ...
    invoke-direct {p1, p0, v4}, Landroidx/activity/n;-><init>(Ljava/lang/Object;I)V
    ...
    invoke-static {v0, v4}, Landroidx/activity/m;->f(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
...
.method public releaseAll()V
    ...
    const-string v2, "releaseAll: acquire X "

    const-string v3, "releaseAll: acquire E "
    ...
    invoke-direct {p0, v2}, Lcom/xiaomi/camera/mivi/qcom/MockCameraImageReceiver;->logInfo(Ljava/lang/String;)V
    ...
    iget-object v2, p0, Lcom/xiaomi/camera/mivi/qcom/MockCameraImageReceiver;->mIsPreparing:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    const-string v4, "releaseAll: skip because of isPreparing: %s, mState: %s"
