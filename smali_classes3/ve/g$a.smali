...
.method public final a(Ljava/lang/reflect/Type;Ljava/util/Set;Lve/y;)Lve/l;
    ...
    :cond_0
    invoke-static/range {p1 .. p1}, Lve/b0;->c(Ljava/lang/reflect/Type;)Ljava/lang/Class;
    ...
    :cond_2
    invoke-static {v2}, Lwe/c;->d(Ljava/lang/Class;)Z
    ...
    invoke-static {v0, v1}, Lve/g$a;->b(Ljava/lang/reflect/Type;Ljava/lang/Class;)V
    ...
    sget-object v4, Lwe/c;->d:Ljava/lang/Class;
    ...
    invoke-direct {v10, v9, v2}, Lve/b;-><init>(Ljava/lang/reflect/Constructor;Ljava/lang/Class;)V
    :try_end_0
    ...
    invoke-direct {v11, v9, v10, v2}, Lve/c;-><init>(Ljava/lang/reflect/Method;Ljava/lang/Object;Ljava/lang/Class;)V
    :try_end_1
    ...
    invoke-direct {v11, v7, v2, v10}, Lve/d;-><init>(Ljava/lang/reflect/Method;Ljava/lang/Class;I)V
    :try_end_2
    ...
    invoke-direct {v10, v4, v2}, Lve/e;-><init>(Ljava/lang/reflect/Method;Ljava/lang/Class;)V
    :try_end_3
    ...
    invoke-static {v0}, Lve/b0;->c(Ljava/lang/reflect/Type;)Ljava/lang/Class;

    move-result-object v4

    invoke-static {v4}, Lwe/c;->d(Ljava/lang/Class;)Z
    ...
    invoke-interface {v6}, Lve/k;->ignore()Z
    ...
    invoke-static {v0, v4, v11, v13}, Lwe/c;->f(Ljava/lang/reflect/Type;Ljava/lang/Class;Ljava/lang/reflect/Type;Ljava/util/LinkedHashSet;)Ljava/lang/reflect/Type;
    ...
    invoke-virtual {v4, v11, v1, v3}, Lve/y;->c(Ljava/lang/reflect/Type;Ljava/util/Set;Ljava/lang/String;)Lve/l;
    ...
    :cond_11
    invoke-interface {v6}, Lve/k;->name()Ljava/lang/String;
    ...
    :goto_a
    new-instance v6, Lve/g$b;

    invoke-direct {v6, v3, v12, v1}, Lve/g$b;-><init>(Ljava/lang/String;Ljava/lang/reflect/Field;Lve/l;)V

    invoke-virtual {v2, v3, v6}, Ljava/util/TreeMap;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    move-result-object v1

    check-cast v1, Lve/g$b;
    ...
    iget-object v1, v1, Lve/g$b;->b:Ljava/lang/reflect/Field;
    ...
    invoke-static {v0, v1, v3, v5}, Lwe/c;->f(Ljava/lang/reflect/Type;Ljava/lang/Class;Ljava/lang/reflect/Type;Ljava/util/LinkedHashSet;)Ljava/lang/reflect/Type;
    ...
    invoke-direct {v0, v10, v2}, Lve/g;-><init>(Lve/f;Ljava/util/TreeMap;)V

    invoke-virtual {v0}, Lve/l;->nullSafe()Lve/l;
    ...
    invoke-static {v0}, Lwe/c;->g(Ljava/lang/reflect/InvocationTargetException;)V
    ...
    invoke-static {v2, v1, v3}, Landroidx/core/location/f;->d(Ljava/lang/Class;Ljava/lang/StringBuilder;Ljava/lang/String;)Ljava/lang/String;
